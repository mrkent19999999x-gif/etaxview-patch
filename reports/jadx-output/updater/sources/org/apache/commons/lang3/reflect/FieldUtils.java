...
/* loaded from: updater.jar:commons-lang3-3.4.jar:org/apache/commons/lang3/reflect/FieldUtils.class */
public class FieldUtils {
    ...
    public static List<Field> getAllFieldsList(Class<?> cls) {
        ...
        Class<?> cls2 = cls;
        while (true) {
            Class<?> currentClass = cls2;
            if (currentClass != null) {
                Field[] declaredFields = currentClass.getDeclaredFields();
                for (Field field : declaredFields) {
                    allFields.add(field);
                }
                cls2 = currentClass.getSuperclass();
            } else {
                return allFields;
            }
        }
