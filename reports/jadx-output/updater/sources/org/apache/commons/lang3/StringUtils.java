...
/* loaded from: updater.jar:commons-lang3-3.4.jar:org/apache/commons/lang3/StringUtils.class */
    ...
    public static String normalizeSpace(String str) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!isWhitespace) {
                ...
                int i2 = count;
                count++;
                newChars[i2] = actualChar == 160 ? ' ' : actualChar;
                whitespacesCount = 0;
            } else {
                if (whitespacesCount == 0 && !startWhitespaces) {
                    int i3 = count;
                    count++;
                    newChars[i3] = SPACE.charAt(0);
                }
                whitespacesCount++;
            }
        }
