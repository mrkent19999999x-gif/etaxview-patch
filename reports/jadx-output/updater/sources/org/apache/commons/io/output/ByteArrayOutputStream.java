...
/* loaded from: updater.jar:commons-io.jar:org/apache/commons/io/output/ByteArrayOutputStream.class */
public class ByteArrayOutputStream extends OutputStream {
    ...
    public ByteArrayOutputStream(int size) {
        ...
        if (size < 0) {
            throw new IllegalArgumentException(new StringBuffer().append("Negative initial size: ").append(size).toString());
        }
        needNewBuffer(size);
    }
