...
/* loaded from: updater.jar:commons-io.jar:org/apache/commons/io/IOCase.class */
public final class IOCase implements Serializable {
    ...
    public static IOCase forName(String name) {
        ...
        throw new IllegalArgumentException(new StringBuffer().append("Invalid IOCase name: ").append(name).toString());
    }
