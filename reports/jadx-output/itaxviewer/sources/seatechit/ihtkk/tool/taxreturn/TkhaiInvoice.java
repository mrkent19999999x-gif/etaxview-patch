...
/* loaded from: itaxviewer.jar:seatechit/ihtkk/tool/taxreturn/TkhaiInvoice.class */
public class TkhaiInvoice extends HSoThue {
    public TkhaiInvoice(Document tkhaiDoc, String tkhaiFileName, ConfigInfo config) throws IOException, ParserConfigurationException, ITaxViewerException {
        ...
        if (tkhaiDoc.getElementsByTagName(nodeName4).item(0) == null && !this.maHSo.equals("01/ĐKTĐ-HĐĐT") && !this.maHSo.equals("01/ĐKTĐ-CTĐT")) {
            throw new ITaxViewerException("Cấu trúc tệp hồ sơ không đúng: không có thẻ dữ liệu 'LKTThue'");
        }
