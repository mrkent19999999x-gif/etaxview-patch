...
/* loaded from: itaxviewer.jar:seatechit/ihtkk/tool/taxreturn/TKhaiHDDTInvoice.class */
public class TKhaiHDDTInvoice extends HSoThue {
    public TKhaiHDDTInvoice(Document tkhaiDoc, String tkhaiFileName, ConfigInfo config) throws IOException, ParserConfigurationException, ITaxViewerException {
