...
/* loaded from: itaxviewer.jar:seatechit/ihtkk/tool/hquanform1/HquanForm1.class */
public class HquanForm1 extends HSoThue {
    public HquanForm1(Document tkhaiDoc, String tkhaiFileName, ConfigInfo config) throws IOException, ParserConfigurationException, ITaxViewerException {
        super(tkhaiDoc, tkhaiFileName, config);
        String nodeName;
        String nodeName2;
        DMucHquan1 dmucHquan = config.getDmHquan1();
        if (this.prefix != null) {
            nodeName = String.valueOf(this.prefix) + ":MA_LH_XNK";
        } else {
            nodeName = "MA_LH_XNK";
        }
