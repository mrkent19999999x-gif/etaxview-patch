...
/* loaded from: itaxviewer.jar:seatechit/ihtkk/tool/taxmessagekdtt/BKeKDTT.class */
public class BKeKDTT extends HSoThue {
    public BKeKDTT(Document tkhaiDoc, String tkhaiFileName, ConfigInfo config) throws IOException, ParserConfigurationException, ITaxViewerException {
        ...
        if (node == null) {
            if (this.prefix != null) {
                nodeName3 = String.valueOf(this.prefix) + ":MA_BK";
            } else {
                nodeName3 = "MA_BK";
            }
        ...
        this.xsdFile = dmBKeKDTT.getXSDTBao(this.maHSo, this.pbanHSoXML);
        if (this.xsdFile == null) {
            throw new ITaxViewerException("Mã Bảng kê (" + this.maHSo + ") hoặc phiên bản Bảng kê (" + this.pbanHSoXML + ") không đúng");
        }
        this.viewMethod = dmBKeKDTT.getTBaoViewType(this.maHSo, this.pbanHSoXML);
        this.excelFile = dmBKeKDTT.getExcelTemplateTTBao(this.maHSo, this.pbanHSoXML);
        this.xsltFile = dmBKeKDTT.getXSLTTBao(this.maHSo, this.pbanHSoXML);
        this.orientation = dmBKeKDTT.getTKhaiOrientation(this.maHSo, this.pbanHSoXML);
        this.plucList = getPLucList(dmBKeKDTT);
    ...
    private Collection getPLucList(DMucBKeKDTT dmBKeKDTT) {
        ...
        for (int i = 0; i < len; i++) {
            if (plucList.item(i).getNodeType() == 1) {
                ...
                pluc.setPlucName(dmBKeKDTT.getTenPLuc(this.maHSo, this.pbanHSoXML, plucID));
                pluc.setPlucViewMethod(dmBKeKDTT.getPLucViewType(this.maHSo, this.pbanHSoXML, plucID));
                pluc.setOrientation(dmBKeKDTT.getPLucOrientation(this.maHSo, this.pbanHSoXML, plucID));
                pluc.setPlucExcelFile(dmBKeKDTT.getExcelTemplatePLuc(this.maHSo, this.pbanHSoXML, plucID));
                pluc.setPlucXSLTFile(dmBKeKDTT.getXSLTPLuc(this.maHSo, this.pbanHSoXML, plucID));
                collPLuc.add(pluc);
            }
        }
        return collPLuc;
