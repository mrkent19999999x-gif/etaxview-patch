...
/* loaded from: itaxviewer.jar:seatechit/ihtkk/tool/taxMessageNtdt/TBaoThueNtdt.class */
public class TBaoThueNtdt extends HSoThue {
    public TBaoThueNtdt(Document tkhaiDoc, String tkhaiFileName, ConfigInfo config) throws IOException, ParserConfigurationException, ITaxViewerException {
    ...
    private Collection getPLucList(DMucTBaoNtdt dmTBao) {
        String plucID;
