					...
					<table class="tkhai_table"  >
							...
							<tr>
							 ...
							 <tr>
							   ...
							   <td class="align-l"><xsl:value-of select="$tkchinh/TTDuAnDauTu/soNha"/>, <xsl:value-of select="$tkchinh/TTDuAnDauTu/ten_Phuong_Xa"/>, <xsl:value-of select="$tkchinh/TTDuAnDauTu/ten_Quan_Huyen"/>, <xsl:value-of select="$tkchinh/TTDuAnDauTu/ten_Tinh_ThanhPho"/>  </td>
							 </tr>  
							 <tr>
