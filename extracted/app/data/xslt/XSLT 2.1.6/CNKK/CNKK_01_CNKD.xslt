            ...
            <div class="content">
                      ...
                      <table class="tkhai_table">
                        <tr>
							...
							<td class="align-c" colspan ='2'><b>Thuế Giá trị gia tăng (GTGT)</b></td>
							<td class="align-c" colspan ='2'><b>Thuế Thu nhập cá nhân (TNCN)</b></td>
							</tr>
						<tr>
								<td class="align-c">Doanh thu <br/> (a) </td>
								<td class="align-c">Số thuế phát sinh <br/>(b)</td>
								<td class="align-c">Doanh thu <br/>(c) </td>
								<td class="align-c">Số thuế phát sinh <br/>(d)</td>
						</tr>
						<tr>
							<td class="align-c">(1)</td>
							<td>Phân phối, cung cấp hàng hóa (Tỷ lệ thuế GTGT 1%, thuế TNCN 0,5%)</td>
							...
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueGTGTPhatSinh/ct30)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThuThueTNCN/ct30)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueTNCNPhatSinh/ct30)"/></td>
						</tr>
						<tr>
							<td class="align-c">(2)</td>
							<td>Dịch vụ, xây dựng không bao thầu  nguyên vật liệu (Tỷ lệ thuế GTGT 5%, thuế TNCN 2%)</td>
							...
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueGTGTPhatSinh/ct31)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThuThueTNCN/ct31)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueTNCNPhatSinh/ct31)"/></td>
						</tr>
						<tr>
							<td class="align-c">(3)</td>
							<td>Sản xuất, vận tải, dịch vụ có gắn với hàng hóa, xây dựng có bao thầu nguyên vật liệu (Tỷ lệ thuế GTGT 3%, thuế TNCN 1,5%)</td>
							<td class="align-c"><b>[32]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThuThueGTGT/ct32)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueGTGTPhatSinh/ct32)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThuThueTNCN/ct32)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueTNCNPhatSinh/ct32)"/></td>
						</tr>
						<tr>
							<td class="align-c">(4)</td>
							<td>Hoạt động kinh doanh khác (Tỷ lệ thuế GTGT 2%, thuế TNCN 1%)</td>
							<td class="align-c"><b>[33]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThuThueGTGT/ct33)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueGTGTPhatSinh/ct33)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThuThueTNCN/ct33)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueTNCNPhatSinh/ct33)"/></td>
						</tr>
						<tr>
							<td class="align-c"></td>
							<td class="align-c"><b>Tổng cộng:</b></td>
							<td class="align-c"><b>[34]</b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThuThueGTGT/ct34)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueGTGTPhatSinh/ct34)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThuThueTNCN/ct34)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/ThueTNCNPhatSinh/ct34)"/></b></td>
						</tr>
					</table>
					<br/>
				...
				<div> <b>B. KÊ KHAI THUẾ TIÊU THỤ ĐẶC BIỆT (TTĐB)</b> </div>	<br/>
					<table class="tkhai_table">
						<tr>
							<td class="align-c"><b>STT</b></td>
							<td class="align-c"><b>Hàng hoá, dịch vụ chịu thuế tiêu thụ đặc biệt (TTĐB)</b></td>
							<td class="align-c"><b>Mã chỉ tiêu</b></td>
