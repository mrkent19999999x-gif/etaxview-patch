            ...
            <div class="content">
				...
				<table class="tkhai_table">
					...
					<tr>
						...
						<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/CTietDThuTThue/KThueKhac/CT35/doanhThu)"/></td>
						<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/CTietDThuTThue/KThueKhac/CT35/soThuePNop)"/></td>
					</tr>
				</table>
