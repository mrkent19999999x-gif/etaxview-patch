...
<!-- KẾT QUẢ HOẠT ĐỘNG SẢN XUẤT KINH DOANH  -->
	...
	<xsl:if test="$tkchinh/hoatDongLienTuc = 'true' or $tkchinh/hoatDongLienTuc = '1'">
		...
		<xsl:with-param name="mauTKhai"   select="'B 02 – DN-HN'"/>
		...
		<xsl:call-template name="tkhaiHeader-plucBCTC200">
		<xsl:with-param name="mauTKhai"   select="'B02/CDHĐ – DNKLT-HN'"/>
		<xsl:with-param name="moTaBieuMau"   select="$moTaBieuMau"/>
		<xsl:with-param name="tenPL"   select="'BÁO CÁO KẾT QUẢ HOẠT ĐỘNG KINH DOANH (HỢP NHẤT)'"/>
		<xsl:with-param name="ghiChuPL"   select="$ghiChuPL1"/>
	  </xsl:call-template>
 ...
 -->
    ...
    <table class="tkhai_table">
        ...
        <tr>
          ...
          <tr>
            <td>8. Phần lãi hoặc lỗ trong công ty liên doanh, liên kết</td>
        ...
        <tr>
            <b>
            <td><b>11 Lợi nhuận thuần từ hoạt động kinh doanh {30 = 20 + (21 - 22) - (25 + 26) + 24}</b></td>
        ...
        <tr>
            <b>
            <td><b>14. Lợi nhuận khác (40 = 31 - 32)</b></td>
        ...
        <tr>
            <b>
            <td><b>15. Tổng lợi nhuận kế toán trước thuế (50 = 30 + 40)</b></td>
        ...
        <tr>
            <b>
            <td><b>18. Lợi nhuận sau thuế thu nhập doanh nghiệp (60 = 50 - 51 - 52)</b></td>
        ...
        <tr>
            ...
            <td><b>19. Lợi nhuận sau thuế của công ty mẹ</b></td>
         ...
         <tr>
            ...
            <td><b>20. Lợi nhuận sau thuế của cổ đông không kiểm soát</b></td>
