...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:with-param name="mauTKhai"   select="'B01 - DNNKLT'"/>
		<xsl:with-param name="moTaBieuMau"   select="$moTaBieuMau"/>
		<xsl:with-param name="ghuchuTK"   select="'(Áp dụng cho doanh nghiệp không đáp ứng giả định hoạt động liên tục)'"/>
	  </xsl:call-template>
...
<div class="content">
<br/>
<div class="align-r"><i>Đơn vị tiền: đồng VN</i></div><br/>
...
<!-- Tai san -->
        ...
        <tr>
            <td class="align-l"><b>II. Đầu tư tài chính</b></td>
        ...
        <tr>
            <td class="align-l">2. Đầu tư nắm giữ đến ngày đáo hạn</td>
        ...
        <tr>
            <td class="align-l"><b>III. Các khoản phải thu </b></td>
         ...
         <tr>
            <td class="align-l">1. Phải thu của khách hàng</td>
        ...
        <tr>
            <td class="align-l">2. Trả trước cho người bán</td>
        ...
        <tr>
            <td class="align-l">4. Phải thu khác</td>
        ...
        <tr>
            <td class="align-l">5. Tài sản thiếu chờ xử lý</td>
        ...
        <tr>
            <td class="align-l"><b>V. Tài sản cố định và bất động sản đầu tư</b></td>
        ...
        <tr>
            <td class="align-l"><b>VI. Xây dựng cơ bản dở dang</b></td>
            <td class="align-c"><b>160</b></td>
            <td class="align-l"><b><xsl:value-of select="$tkchinh/ThuyetMinh/ct160"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoCuoiNam/ct160)"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoDauNam/ct160)"/></b></td>
        </tr>
        <tr>
            <td class="align-l"><b>VII. Tài sản khác</b></td>
            <td class="align-c"><b>170</b></td>
            <td class="align-l"><b><xsl:value-of select="$tkchinh/ThuyetMinh/ct170"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoCuoiNam/ct170)"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoDauNam/ct170)"/></b></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="align-l">2. Tài sản khác</td>
		...
		<tr>
            <td class="align-l"><b>I. Nợ phải trả</b></td>
         ...
         <tr>
            <td class="align-l">1. Phải trả người bán</td>
          ...
          <tr>
            <td class="align-l">2. Người mua trả tiền trước </td>
        ...
        <tr>
            <td class="align-l">5. Phải trả khác</td>
        ...
        <tr>
            <td class="align-l">6. Vay và nợ thuê tài chính</td>
        ...
        <tr>
            <td class="align-l">7. Phải trả nội bộ về vốn kinh doanh</td>
        ...
        <tr>
            <td class="align-l">8. Dự phòng phải trả</td>
        ...
        <tr>
            <td class="align-l"><b>9. Quỹ khen thưởng, phúc lợi</b></td>
            <td class="align-c"><b>319</b></td>
            <td class="align-l"><b><xsl:value-of select="$tkchinh/ThuyetMinh/ct319"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoCuoiNam/ct319)"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoDauNam/ct319)"/></b></td>

        </tr>
        <tr>
            <td class="align-l">10. Quỹ phát triển khoa học và công nghệ</td>
        ...
        <tr>
            <td class="align-l"><b>II. Vốn chủ sở hữu</b></td>
