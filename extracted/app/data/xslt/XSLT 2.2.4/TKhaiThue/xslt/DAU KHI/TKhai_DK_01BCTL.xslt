...
<td>	  			
			...
			<div class="ghichu">
						<div><i><b><u>Ghi chú:</u></b></i></div><br/>
							<i>- Chỉ tiêu [04]: Tên người nộp thuế là tên người điều hành, doanh nghiệp liên doanh hoặc công ty điều hành chung được các bên nhà thầu tham gia trong HĐDK ủy quyền thực hiện kê khai các khoản thuế phát sinh theo quy định. </i><br/>
