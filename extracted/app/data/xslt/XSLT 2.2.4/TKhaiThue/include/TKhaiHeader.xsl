...
<!-- start tkhai header TKhai_DK_02TNDN Theo TT36  -->
	<xsl:template name="tkhaiHeader-DK_02TNDN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<b>[01]</b> Dầu thô: [<xsl:if test="$tkchinh/LoaiDauKhi/ct01 = 'true' ">x</xsl:if> <xsl:if test="$tkchinh/LoaiDauKhi/ct01 = '1' ">x</xsl:if>]      
                        <b>[02]</b> Condensate: [<xsl:if test="$tkchinh/LoaiDauKhi/ct02 = 'true' ">x</xsl:if> <xsl:if test="$tkchinh/LoaiDauKhi/ct02 = '1' ">x</xsl:if>]     
                        <b>[03]</b> Khí thiên nhiên: [<xsl:if test="$tkchinh/LoaiDauKhi/ct03 = 'true' ">x</xsl:if> <xsl:if test="$tkchinh/LoaiDauKhi/ct03 = '1' ">x</xsl:if>] 
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[16] Tên đơn vị được uỷ quyền</b> [<xsl:if test="$tkchinh/LoaiHinhUyQuyen/donViUyQuyen = 'true' "> X </xsl:if>] hoặc <b> Đại lý thuế</b> [<xsl:if test="$tkchinh/LoaiHinhUyQuyen/daiLyThue = 'true' "> X </xsl:if>]: 
                                            <xsl:if test="$tkchinh/LoaiHinhUyQuyen/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/tenDonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/LoaiHinhUyQuyen/daiLyThue = 'true' ">
	...
	<!-- start tkhai header TKhai_DK_02TAIN Theo TT36  -->
	<xsl:template name="tkhaiHeader-DK_02TAIN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<b>[01]</b> Dầu thô: [<xsl:if test="$tkchinh/LoaiDauKhi/dauTho = 'true' ">x</xsl:if> <xsl:if test="$tkchinh/LoaiDauKhi/dauTho = '1' ">x</xsl:if>]   
                        <b>[02]</b> Condensate: [<xsl:if test="$tkchinh/LoaiDauKhi/condensate = 'true' ">x</xsl:if> <xsl:if test="$tkchinh/LoaiDauKhi/condensate = '1' ">x</xsl:if>]    
                        <b>[03]</b> Khí thiên nhiên: [<xsl:if test="$tkchinh/LoaiDauKhi/khiThienNhien = 'true' ">x</xsl:if> <xsl:if test="$tkchinh/LoaiDauKhi/khiThienNhien = '1' ">x</xsl:if>] 
                    </td>
				</tr>
	...
	<xsl:template name="tkhaiHeader-pluc-02-1-BK-QTT-TNCN">
    	...
    	<!-- start tkhai header DAU LAI  -->
	<xsl:template name="tkhaiHeader-DauLai">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<b>[01]</b> Dầu thô: [ <xsl:if test="$tkchinh/Header/LoaiDauKhi/ct01 = 'true' "> X </xsl:if>]      
                        <b>[02]</b> Condensate: [<xsl:if test="$tkchinh/Header/LoaiDauKhi/ct02 = 'true' "> X </xsl:if>]     
                        <b>[03]</b> Khí thiên nhiên: [<xsl:if test="$tkchinh/Header/LoaiDauKhi/ct03 = 'true' "> X </xsl:if>] 
                    </td>
				</tr>
				<tr>
					<td class="align-c">
			...
			<tr>
					<td class="align-c">
						<b>[08]</b> Xuất khẩu: [ <xsl:if test="$tkchinh/Header/ct08 = 'true' "> X </xsl:if>]      
                        <b>[09]</b> Xuất bán tại Việt Nam: [<xsl:if test="$tkchinh/Header/ct09= 'true' "> X </xsl:if>]     
                    </td>
				</tr>
					<tr>
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[20] </b> Giấy phép đầu tư số: <xsl:value-of select="$tkchinh/Header/ct20_so"/>
ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct20_ngay,'dd/mm/yyyy')" /> Do Bộ KH&amp;ĐT cấp
								</td>
							</tr>
						   <tr>
								<td colspan="3">
									<b>[21]</b>Tài khoản tiền gửi số: <xsl:value-of select="$tkchinh/Header/ct21_so"/>  mở tại NH: <xsl:value-of select="$tkchinh/Header/ct21_ten"/>
								</td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[22] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT22/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT22/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT22/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tendonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT22/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
								...
								<tr colspan="3">
									<td>
										<b>[24]</b> Địa chỉ: <xsl:value-of select="$ttkthue/DLyThue/dchiDLyThue"/>
									</td>
								</tr>
								<tr>
									<td>
										<b>[25]</b> Quận/Huyện: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
										<b>[26] </b>Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
									</td>
								</tr>
								<tr>
									<td>
										<b>[27]</b> Điện thoại: <xsl:value-of select="$ttkthue/DLyThue/dthoaiDLyThue"/>
									</td>
									<td>
										<b>[28]</b> Fax: <xsl:value-of select="$ttkthue/DLyThue/faxDLyThue"/>
									</td>
									<td>
										<b>[29]</b> E-mail: <xsl:value-of select="$ttkthue/DLyThue/emailDLyThue"/>
									</td>
								</tr>
								<tr>
									<td>
										<b>[30] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
									</td>
									<td colspan="2"> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'yyyy')"/>
									</td>
								</tr>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										...
										<b>[22] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT22/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT22/daiLyThue = 'true' "> X </xsl:if>]:
											...
											<xsl:if test="$tkchinh/Header/CT22/daiLyThue = 'true' "> </xsl:if>
										</b>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										<b>[30] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: 
                                    </td>
									<td colspan="2"> ngày  tháng  năm 
                                    </td>
								</tr>
		...
		<!-- start tkhai header 01C/TNS-->
	<xsl:template name="tkhaiHeader_01C_TNS">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
							...
							<tr>
								<td colspan="3">
									<b>[13] </b> Giấy phép đầu tư số: <xsl:value-of select="$tkchinh/Header/ct13_so"/>
ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct13_ngay,'dd/mm/yyyy')" /> Do Bộ KH&amp;ĐT cấp
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[14]</b>Tài khoản tiền gửi số: <xsl:value-of select="$tkchinh/Header/ct14_so"/>  mở tại NH: <xsl:value-of select="$tkchinh/Header/ct14_ten"/>
								</td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[15] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT15/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT15/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT15/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tendonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT15/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
								...
								<tr>
									<td>
										<b>[23] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
									</td>
									<td colspan="2"> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'yyyy')"/>
									</td>
								</tr>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										...
										<b>[15] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT15/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT15/daiLyThue = 'true' "> X </xsl:if>]:
											...
											<xsl:if test="$tkchinh/Header/CT15/daiLyThue = 'true' "> </xsl:if>
										</b>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										<b>[23] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: 
                                    </td>
									<td colspan="2"> ngày  tháng  năm 
                                    </td>
								</tr>
		...
		<div class="giahan_div">
			...
			<!-- start tkhai header  02TNDN_VSP gói XML 2.2.3-->
	<xsl:template name="tkhaiHeader-02TNDN_VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					...
					<td>
						<br/>
							...
							<tr>
								<td colspan="3"><b>[07] Tên người nộp thuế</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/></td>
							</tr>
							<tr>
							    <td colspan="3"><b>[08] Mã số thuế: </b><xsl:value-of select="$ttkthue/NNT/mst"/></td>
							</tr>
							<tr>
						        <td><b>[09] </b> Địa chỉ: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/></td>
								<td><b>[10]</b> Quận/Huyện: <xsl:value-of select="$ttkthue/NNT/tenHuyenNNT"/></td>
								<td><b>[11]</b> Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/></td>
							</tr>
							<tr>
								<td><b>[12] </b> Điện thoại: <xsl:value-of select="$ttkthue/NNT/dthoaiNNT"/></td>
								<td><b>[13] </b>Fax: <xsl:value-of select="$ttkthue/NNT/faxNNT"/></td>
								<td><b>[14]</b> E-mail: <xsl:value-of select="$ttkthue/NNT/emailNNT"/></td>
							</tr>
							<tr>
								<td colspan="3"><b>[15]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct15"/></td>
							</tr>
							<tr>
								<td colspan="3"><b>[16] </b> Mã số thuế nhà điều hành hợp đồng dầu khí: <xsl:value-of select="$tkchinh/Header/ct16"/></td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[17] Tên Người nộp thuế [<xsl:if test="$tkchinh/Header/CT17/nguoiNopThue = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT17/nguoiNopThue = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThue"/> 
											</xsl:if>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										...
										<b>[17]  Tên Người nộp thuế [<xsl:if test="$tkchinh/Header/CT17/nguoiNopThue = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT17/nguoiNopThue = 'true' ">
												<xsl:value-of select="$tkchinh/tenNguoiNopThue"/>
											</xsl:if>
	...
	<!-- start tkhai header  02TAIN_VSP gói XML 2.2.3-->
	<xsl:template name="tkhaiHeader-02TAIN_VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
						...
						<br/>
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[17] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT17/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
	...
	<xsl:template name="tkhaiHeader-pluc_02_1TAIN_VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
			...
			<table>
				...
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[07] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT17/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT17/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' ">
		...
		<!-- start header Phuluc Vietsovpetro 02-1_PTHU-->
		...
		<div class="header_div">
			<table>
				...
				<tr>
						...
						<td><b>[01]</b> Dầu thô: [ <xsl:if test="$tkchinh/Header/LoaiDauKhi/ct01 = 'true' "> X </xsl:if>]     
                       <b> [02]</b> Condensate: [<xsl:if test="$tkchinh/Header/LoaiDauKhi/ct02 = 'true' "> X </xsl:if>]       </td>  
				</tr>
				<tr>
					<td  colspan="3">
	...
	<!-- start tkhai header  02PTHU_VSP gói XML 2.2.3-->
	<xsl:template name="tkhaiHeader-02PTHU_VSP">
				...
				<tr>
					...
					<td>
						<br/>
							...
							<tr>
								<td colspan="3"><b>[06] Tên người nộp thuế</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/></td>
							</tr>
							<tr>
							    <td colspan="3"><b>[07] Mã số thuế: </b><xsl:value-of select="$ttkthue/NNT/mst"/></td>
							</tr>
							<tr>
						        <td><b>[08] </b> Địa chỉ: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/></td>
								<td><b>[09]</b> Quận/Huyện: <xsl:value-of select="$ttkthue/NNT/tenHuyenNNT"/></td>
								<td><b>[10]</b> Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/></td>
							</tr>
							<tr>
								<td><b>[11] </b> Điện thoại: <xsl:value-of select="$ttkthue/NNT/dthoaiNNT"/></td>
								<td><b>[12] </b>Fax: <xsl:value-of select="$ttkthue/NNT/faxNNT"/></td>
								<td><b>[13]</b> E-mail: <xsl:value-of select="$ttkthue/NNT/emailNNT"/></td>
							</tr>
							<tr>
								<td colspan="3"><b>[14]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct14"/></td>
							</tr>
							<tr>
								<td colspan="3"><b>[15] </b> Mã số thuế nhà điều hành hợp đồng dầu khí: <xsl:value-of select="$tkchinh/Header/ct15"/></td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[16] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT16/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT16/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' ">
		...
		<!-- start tkhai header  01TK_VSP gói XML 2.2.3-->
	<xsl:template name="tkhaiHeader-01TK_VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
            ...
            <table class="ttinnnt_table">
				...
				<tr>
					<td colspan="3" class="align-c"><b>[05]</b> Lần xuất bán thứ: <xsl:value-of select="$tkchinh/Header/ct05"/></td>
				</tr>
					<tr>
					<td colspan="3" class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
				    ...
				    <tr>
						<td colspan="3" class="align-c"><b>[10] </b>Ngày xuất hóa đơn đối với xuất bán tại Việt Nam: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct10,'dd/mm/yyyy') " /></td>
					</tr>

							<tr>
								<td colspan="3"><b>[11] Tên người nộp thuế</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/></td>
							</tr>
							<tr>
							    <td colspan="3"><b>[12] Mã số thuế: </b><xsl:value-of select="$ttkthue/NNT/mst"/></td>
							</tr>
							<tr>
						        <td><b>[13] </b> Địa chỉ: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/></td>
								<td><b>[14]</b> Quận/Huyện: <xsl:value-of select="$ttkthue/NNT/tenHuyenNNT"/></td>
								<td><b>[15]</b> Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/></td>
							</tr>
							<tr>
								<td><b>[16] </b> Điện thoại: <xsl:value-of select="$ttkthue/NNT/dthoaiNNT"/></td>
								<td><b>[17] </b>Fax: <xsl:value-of select="$ttkthue/NNT/faxNNT"/></td>
								<td><b>[18]</b> E-mail: <xsl:value-of select="$ttkthue/NNT/emailNNT"/></td>
							</tr>
							<tr>
								<td colspan="3"><b>[19]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct19"/></td>
							</tr>
							<tr>
								<td colspan="3"><b>[20] </b> Mã số thuế nhà điều hành hợp đồng dầu khí: <xsl:value-of select="$tkchinh/Header/ct20"/></td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[21] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT21/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT21/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT21/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT21/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
		...
		<!-- start tkhai header Vietsopevtro 01/DCXK-->
	<xsl:template name="tkhaiHeader_01DCXK_VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[12] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT12/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT12/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT12/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
	...
	<xsl:template name="tkhaiHeader_01_1TNDN_VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c">
						<b>[02]</b> Kỳ kết dư: từ ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct02_tuNgay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct02_tuNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct02_tuNgay,'yyyy')"/>
						đến ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct02_denNgay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct02_denNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct02_denNgay,'yyyy')"/>
					</td>
				</tr>
					<tr>
					<td colspan="3" class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b>[03]</b> Khai lần đầu: [X] <b>[04] </b>Khai bổ sung lần thứ: [&#32;]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[03]</b>Khai lần đầu: [&#32;] <b>[04] </b>Khai bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td colspan="3"><b>[13]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct13"/></td>
				</tr>
				<tr>
					<td colspan="3"><b>[14] </b> Mã số thuế nhà điều hành hợp đồng dầu khí: <xsl:value-of select="$tkchinh/Header/ct14"/></td>
				</tr>
				...
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[15] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT15/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT15/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT15/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT15/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
	...
	<!-- Start tkhai header Tem ruou-->
	<xsl:template name="tkhaiHeader_TemRuou">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<xsl:param name="ttkthue_" select="$ttkthue"/>
		...
		<div class="header_div">
			...
			<table style="width:100%;">
				...
				<tr>
					<td> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Kính gửi: <xsl:value-of select="$tkchinh/kinhGui"/>
					</td>
				</tr>
				<tr>
					<td>
						<table class="ttinnnt_table">
							...
							<tr>
								<td>Mã số thuế: <xsl:value-of select="$ttkthue/NNT/mst"/></td>
							</tr>
							<tr>
								<td>Địa chỉ: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/> 
								</td>
							</tr>
						</table>
					</td>
...
<tr>
		...
		<!-- start tkhai header 01/TNDN-DK-TT36  -->
	<xsl:template name="tkhaiHeader-01TNDN-DK">
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td  class="align-c"><b>[05]</b> Lần xuất bán thứ: <xsl:value-of select="$tkchinh/ct05"/></td>
					<td></td>
				</tr>
				<tr>
					<td class="align-c">
			...
			<tr>
					<td class="align-c">
						<b>[08]</b> Xuất khẩu: [<xsl:if test="$tkchinh/ct08 = 'true' ">x</xsl:if>]      
                        <b>[09]</b> Xuất bán tại Việt Nam: [<xsl:if test="$tkchinh/ct09= 'true' ">x</xsl:if>]     
                    </td>
				</tr>
					<tr>
					<td  class="align-c"><b>[10]</b> Ngày xuất hóa đơn đối với xuất bán tại Việt Nam: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ct10,'dd/mm/yyyy')" /></td>
					<td></td>
				</tr>
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[20] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT20/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT20/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT20/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT20/daiLyThue = 'true' ">
		...
		<!-- start tkhai header 01/TAIN-DK-TT36  -->
	<xsl:template name="tkhaiHeader-01TAIN-DK">
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<b>[01]</b> Dầu thô: [<xsl:if test="$tkchinh/LoaiDauKhi/ct01 = 'true'  or $tkchinh/LoaiDauKhi/ct01 = '1' ">x</xsl:if>]      
                        <b>[02]</b> Condensate: [<xsl:if test="$tkchinh/LoaiDauKhi/ct02 = 'true' or $tkchinh/LoaiDauKhi/ct02 = '1' ">x</xsl:if>]     
                        <b>[03]</b> Khí thiên nhiên: [<xsl:if test="$tkchinh/LoaiDauKhi/ct03 = 'true' or $tkchinh/LoaiDauKhi/ct03 = '1' ">x</xsl:if>] 
                    </td>
				</tr>
				<tr>
					<td class="align-c">
			...
			<tr>
					<td class="align-c">
						<b>[08]</b> Xuất khẩu: [<xsl:if test="$tkchinh/LoaiXuatBan/ct08 = 'true' or $tkchinh/LoaiXuatBan/ct08 = '1'  ">x</xsl:if>]      
                        <b>[09]</b> Xuất bán tại Việt Nam: [<xsl:if test="$tkchinh/LoaiXuatBan/ct09= 'true' or $tkchinh/LoaiXuatBan/ct09 = '1' "> x </xsl:if>]     
                    </td>
				</tr>
					<tr>
					<td  class="align-c"><b>[10]</b> Ngày xuất hóa đơn đối với xuất bán tại Việt Nam: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ct10,'dd/mm/yyyy')" /></td>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									...
									<td colspan="2"><b>[29]</b> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'yyyy')"/>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="not($ttkthue/DLyThue)">
								...
								<tr>
									...
									<td colspan="2"><b>[29]</b> ngày  tháng  năm 
                                    </td>
								</tr>
							</xsl:if>
						</table>
	...
	<!-- start tkhai header BCTL-DK Theo TT36-->
	<xsl:template name="tkhaiHeader_BCTL_DK">
		...
		<!-- start tkhai header 03TNDN-DK Theo TT36 -->
		...
		<div class="header_div">
			...
			<!-- Bên chuyển nhượng quyền lợi: -->
				...
				<tr>
					<td><b>[05]</b>Tên tổ chức chuyển nhượng: <xsl:value-of select="$tkchinh/Header/BenChuyenbNhuong/ct05"/> </td>
				</tr>
				<tr>
					<td colspan="3"><b>[06] Mã số thuế (nếu có): </b><xsl:value-of select="$tkchinh/Header/BenChuyenbNhuong/ct06"/></td>
				</tr>
				<tr>
					<td>
						<b>[07] </b> Địa chỉ trụ sở chính: <xsl:value-of select="$tkchinh/Header/BenChuyenbNhuong/ct07"/>
					</td>
				</tr>
				<tr>
					<td><b>[08]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/BenChuyenbNhuong/ct08"/>   </td>
				</tr>
				<tr>
					<td><b>[09] </b> Hợp đồng chuyển nhượng số:  <xsl:value-of select="$tkchinh/Header/BenChuyenbNhuong/ct09_so"/></td>
					<td colspan="2"> Ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/BenChuyenbNhuong/ct09_ngay,'dd/mm/yyyy')"/></td>
				</tr>
				...
				<tr>
					<td colspan="3"><b>[12] Mã số thuế (đối với doanh nghiệp): </b><xsl:value-of select="$tkchinh/Header/BenNhanChuyenNhuong/ct12"/></td>
				</tr>
				...
				<xsl:if test="$ttkthue/DLyThue">
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								...
								<tr>
									<td><b>[24] Mã số thuế: </b><xsl:value-of select="$tkchinh/Header/ct24"/></td>
								</tr>
								<tr>
