...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/1999/XSL/Transform" xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" exclude-result-prefixes="xsl xsi ihtkk">
	...
	<xsl:variable name="ttchunghddt1" select="BCTHSDBLai/DLBCTHSDBLai/TTChung"/>
	<xsl:param name="kyKKhaihddt" select="$ttchunghddt1/KDLieu"/>
	<xsl:param name="kieuKyhddt" select="$ttchunghddt1/LKDLieu"/>	
	<xsl:param name="kyKKhaihddttn" select="BCTHSDBLai/DLBCTHSDBLai/TTChung/KTThue"/>														  
	...
	<xsl:template name="tkhaiHeader_01_CNKD">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>o	[10.1] Xã/phường/đặc khu: <xsl:value-of select="$tkchinh/Header/CT10/ct10.1_ten"/></td>
				</tr>
				<tr>
...
<!--20DK-TH-TCT-->
	...
	<!-- start tkhai header 06_PS_PSDT -->
	<xsl:template name="tkhaiHeader_06_PS_PSDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					...
					<td style="width:17% ; vertical-align: top;" rowSpan="5" align="top"></td>
				</tr>
				<tr>
					<td class="tentkhai">
...
<!-- 					</td> -->
				...
				<tr>
					<td class="align-c">
						<xsl:if test="TKhai/DLTKhai/TTChung/HThuc ='1'">
							<i>[01] Cấp mới : [X] &#160;&#160;&#160;&#160;[02] Điều chỉnh : [&#32;]  &#160;&#160;&#160;&#160;[03] Thay thế  : [&#32;] </i> 
                        </xsl:if>
						<xsl:if test="TKhai/DLTKhai/TTChung/HThuc ='2'">
							<i>[01] Cấp mới : [X] &#160;&#160;&#160;&#160;[02] Điều chỉnh : [&#32;]  &#160;&#160;&#160;&#160;[03] Thay thế  : [&#32;]  </i> 
                        </xsl:if>
						<xsl:if test="TKhai/DLTKhai/TTChung/HThuc ='3'">
							<i>[01] Cấp mới : [&#32;] &#160;&#160;&#160;&#160;[02] Điều chỉnh : [X]  &#160;&#160;&#160;&#160;[03] Thay thế  : [&#32;]  </i> 
                        </xsl:if>
					</td>
				</tr>
				<tr>
					<td class="align-c">
						Kính gửi: <xsl:value-of select="TKhai/DLTKhai/TTChung/TCQT"/>
					</td>
				</tr>
				<tr>
				
					<td colspan="3">
						<b>I. TỔ CHỨC, CÁ NHÂN ĐỀ NGHỊ CẤP HÓA ĐƠN THEO TỪNG LẦN PHÁT SINH</b>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						1. Tên tổ chức, cá nhân: <xsl:value-of select="TKhai/DLTKhai/TTChung/TTCCNhan"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						2. Địa chỉ liên hệ: <xsl:value-of select="TKhai/DLTKhai/TTChung/DCLHe"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						&#160;&#160;&#160;&#160;Địa chỉ thư điện tử: <xsl:value-of select="TKhai/DLTKhai/TTChung/DCTDTu"/>
					</td>
					<td>
						Điện thoại liên hệ: <xsl:value-of select="TKhai/DLTKhai/TTChung/DTLHe"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						3. Số Quyết định thành lập tổ chức (nếu có): <xsl:value-of select="TKhai/DLTKhai/TTChung/SQDTLap"/>
					</td>
				</tr>
				<tr>
					<td>
						&#160;&#160;&#160;&#160;Cấp ngày: <xsl:value-of select="TKhai/DLTKhai/TTChung/NCQDTLap"/>
					</td>
					<td colspan="2">
						Cơ quan cấp: <xsl:value-of select="TKhai/DLTKhai/TTChung/CQCQDTLap"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						4. Mã số thuế/Mã số QHVNS (nếu có): <xsl:value-of select="TKhai/DLTKhai/TTChung/MST"/>
						<xsl:value-of select="TKhai/DLTKhai/TTChung/MDVQHNSach"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
				...
				<tr>
					<td colspan="3">
						...
						<xsl:value-of select="TKhai/DLTKhai/TTChung/CCCDDDPLuat"/>
					<xsl:value-of select="TKhai/DLTKhai/TTChung/SHChieu"/>	
					</td>
				</tr>
				<tr>
					<td>
						&#160;&#160;&#160;&#160;Ngày cấp: <xsl:value-of select="TKhai/DLTKhai/TTChung/NgCap"/>
					</td>
					<td colspan="2">
						Nơi cấp: <xsl:value-of select="TKhai/DLTKhai/TTChung/NCap"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						7. Mã hồ sơ (nếu có): <xsl:value-of select="TKhai/DLTKhai/NDDNghi/TTHDDCTThe/TTHDBDCTThe/HDBDCTThe/MHSo"/>
					</td>
				</tr>
			</table>
		</div>
	...
	<!-- start tkhai header 01_DKTD_HDDT -->
	<xsl:template name="tkhaiHeader_01_DKTD_HDDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<br/>
				<tr>
					<td class="align-c">
						Kỳ tính thuế: Theo lần phát sinh  <xsl:value-of select="ihtkk:stringDatetime(TKhai/DLTKhai/TTChung/NLap,'dd/mm/yyyy')"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
...
<!-- start tkhai header 04_SS_HDDT -->
<xsl:template name="tkhaiHeader_04_SS_HDDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>  
		<xsl:variable name="dltb" select="TBao/DLTBao"/>
		<div class="header_div">
			<table class="ttinnnt_table">			
			<tr>
			<td style="width:1%;text-align:center">
				...
				<td style="width:99%; vertical-align: top;"  align="top">
						<div style="width:200px"  class="bieu_mau_div">
							<div>Mẫu số: <b>
									<xsl:value-of select="$MSo"/>
			...
			<tr>
				...
				<tr>
					<td class="tentkhai">
						<xsl:value-of select="translate($dltb/Ten,$smallcase,$uppercase)"/>
					</td>
				</tr>
				
				<tr>
					<td class="align-c">Kính gửi: <xsl:value-of select="$dltb/TCQT"/></td>
				</tr>
			...
			<table class="ttinnnt_table">
			    ...
			    <tr>
					<td>
						Tên người nộp thuế: <xsl:value-of select="$dltb/TNNT"/>  
					</td>
				</tr>
				<tr>
					<td colspan="3">
						Mã số thuế:  <xsl:value-of select="$dltb/MST"/> 
					</td>
				</tr>
				<tr>
					<td>
		...
		<!-- start tkhai header 04_SS_CTDT -->
<xsl:template name="tkhaiHeader_04_SS_CTDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>  
		<xsl:variable name="dltbao" select="TBao/DLTBao"/>
		<div class="header_div">
			<table class="ttinnnt_table">			
			<tr>
			<td style="width:1%;text-align:center">
			...
			<tr>
				...
				<tr>
					<td class="tentkhai">
						<xsl:value-of select="translate($dltbao/Ten,$smallcase,$uppercase)"/>
					</td>
				</tr>
				
				<tr>
					<td class="align-c" style = "font-weight:Bold">Kính gửi: <xsl:value-of select="$dltbao/TCQT"/></td>
				</tr>
			...
			<table class="ttinnnt_table">
			    ...
			    <tr>
					<td>
						Tên tổ chức, cá nhân lập chứng từ: <xsl:value-of select="$dltbao/TNNT"/>  
					</td>
				</tr>
				<tr>
					<td colspan="3">
						Mã số thuế:  <xsl:value-of select="$dltbao/MST"/> 
					</td>
				</tr>
				<tr>
					<td>
	...
	<!-- start tkhai header BC26_BLDT -->
<xsl:template name="tkhaiHeader_BC26_BLDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>  
		<xsl:variable name="ttchungctdt" select="BCTHSDBLai/DLBCTHSDBLai/TTChung"/>
		<div class="header_div">
			<table class="ttinnnt_table">			
			<tr>
			<td style="width:1%;text-align:center">
			...
			<tr>
				...
				<tr>
					<td class="tentkhai">
						<xsl:value-of select="translate($ttchungctdt/Ten,$smallcase,$uppercase)"/>
					</td>
					</tr> 
					
					<tr>
					<td  style="width:90%;text-align:center">
						<b></b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue_hddt($kyKKhaihddt,$kieuKyhddt,$ttchunghddt1/NLap,$ttchunghddt1/NLap)"/>
					</td>
				</tr> 
			...
			<table class="ttinnnt_table">
			    ...
			    <tr>
					<td>
						1. Tên đơn vị:  <xsl:value-of select="$ttchungctdt/TDVi"/>  
					</td>
				</tr>
				<tr>
					<td colspan="3">
						2. Mã số thuế (nếu có):  <xsl:value-of select="$ttchungctdt/MST"/> 
					</td>
				</tr>
				<tr>
					<td colspan="3">
						3. Địa chỉ:  <xsl:value-of select="$ttchungctdt/DChi"/> 
					</td>
				</tr>
...
<!-- start tkhai header 01_DKTD_CTDT -->
	<xsl:template name="tkhaiHeader_01_DKTD_CTDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					...
					<td style="width:12% ; vertical-align: top;" rowSpan="5" align="top"></td>
				</tr>
				<tr>
					<td class="tentkhai">
					    TỜ KHAI
	...
	<!-- start tkhai header 06_PS_PSDT -->
	<xsl:template name="tkhaiHeader_06_DN_PSDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c">
						<xsl:if test="DNghi/DLDNghi/TTChung/HThuc ='1'">
							<i>[01] Cấp mới : [X] &#160;&#160;[02] Điều chỉnh : [&#32;]  &#160;&#160;[03] Thay thế  : [&#32;] </i> 
                        </xsl:if>
						<xsl:if test="DNghi/DLDNghi/TTChung/HThuc ='2'">
							<i>[01] Cấp mới : [X] &#160;&#160;[02] Điều chỉnh : [&#32;]  &#160;&#160;[03] Thay thế  : [&#32;]  </i> 
                        </xsl:if>
						<xsl:if test="DNghi/DLDNghi/TTChung/HThuc ='3'">
							<i>[01] Cấp mới : [&#32;] &#160;&#160;[02] Điều chỉnh : [X]  &#160;&#160;[03] Thay thế  : [&#32;]  </i> 
                        </xsl:if>
					</td>
				</tr>
				<tr>
					<td class="align-c">
						Kính gửi: <xsl:value-of select="DNghi/DLDNghi/TTChung/TCQT"/>
					</td>
				</tr>
				<tr>
				...
				<!--<tr>
					<td colspan="3">
						1. Mã số thuế/Mã số QHVNS (nếu có): <xsl:value-of select="DNghi/DLDNghi/TTChung/MST"/>
						<xsl:value-of select="DNghi/DLDNghi/TTChung/MDVQHNSach"/>
					</td>
				</tr>-->
				<tr>
					<td colspan="2">
						1. Mã số thuế: <xsl:value-of select="DNghi/DLDNghi/TTChung/MST"/>
					</td>
					<td>
						Mã số QHVNS (nếu có): <xsl:value-of select="DNghi/DLDNghi/TTChung/MDVQHNSach"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						2. Tên tổ chức, cá nhân: <xsl:value-of select="DNghi/DLDNghi/TTChung/TTCCNhan"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						3. Địa chỉ liên hệ: <xsl:value-of select="DNghi/DLDNghi/TTChung/DCLHe"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						&#160;&#160;&#160;&#160;Địa chỉ thư điện tử: <xsl:value-of select="DNghi/DLDNghi/TTChung/DCTDTu"/>
					</td>
					<td>
						Điện thoại liên hệ: <xsl:value-of select="DNghi/DLDNghi/TTChung/DTLHe"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						4. Số Quyết định thành lập tổ chức (nếu có): <xsl:value-of select="DNghi/DLDNghi/TTChung/SQDTLap"/>
					</td>
				</tr>
				<tr>
					<td>
						&#160;&#160;&#160;&#160;Cấp ngày: <xsl:value-of select="ihtkk:stringDatetime(DNghi/DLDNghi/TTChung/NCQDTLap,'dd/mm/yyyy')"/>
					</td>
					<td colspan="2">
						Cơ quan cấp: <xsl:value-of select="DNghi/DLDNghi/TTChung/CQCQDTLap"/>
					</td>
				</tr>
				...
				<tr>
					<td colspan="3">
						5. Tên người đại diện theo pháp luật hoặc Hộ kinh doanh, cá nhân kinh doanh: 
						<xsl:value-of select="DNghi/DLDNghi/TTChung/TNDDPLuat"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						6. Số CC/CCCD/Mã định danh/Hộ chiếu của người đại diện theo pháp luật: 
						<xsl:value-of select="DNghi/DLDNghi/TTChung/CCCD"/>
					<xsl:value-of select="TKDNghi/DLDNghi/TTChung/SHChieu"/>	
					</td>
				</tr>
				<tr>
					<td>
						&#160;&#160;&#160;&#160;Ngày cấp: <xsl:value-of select="ihtkk:stringDatetime(DNghi/DLDNghi/TTChung/NgCap,'dd/mm/yyyy')"/>
					</td>
					<td colspan="2">
						Nơi cấp: <xsl:value-of select="DNghi/DLDNghi/TTChung/NCap"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						7. Mã hồ sơ (nếu có): <xsl:value-of select="DNghi/DLDNghi/TTChung/MHSo"/>
					</td>
				</tr>
			</table>
		</div>
...
<!-- start header 01-1/KHBS TT80-->
	...
	<!-- start tkhai header 01/CNKD TMĐT-->
	<xsl:template name="tkhaiHeader_01_CNKD_TMDT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c">
						...
						<xsl:if test="$ttkthue/TKhaiThue/KyKKhaiThue/kieuKy='M'">
							<b>[01]</b> Kỳ tính thuế: <b> </b> <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>    
                        </xsl:if>
			...
			<table class="ttinnnt_table" width="100%" border="0" cellpadding="0" cellspacing="0" style="width:1100px;">
				<tr>
					<td colspan="3">
					<!--<td colspan="1"> bỏ colspan để hệ thống tự căn chỉnh-->
						<b>[04] Tên của tổ chức quản lý nền tảng thương mại điện tử</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				...
				<tr>
					<td colspan="3">
						<b>[05] Mã số thuế khấu trừ, nộp thay: </b>
						<xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
	...
	<!--start header Phuluc 01-1/CNKD_TMDT-->
	<xsl:template name="tkhaiHeader_pluc_01_1_CNKD_TMDT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-l">
						<b>[04] Tên của tổ chức quản lý nền tảng thương mại điện tử </b>
						<xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
					<!--style:height="25"-->
				</tr>
				<tr>
					<td class="align-l"><b>[05] </b>Mã số thuế khấu trừ, nộp thay: <xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<xsl:if test="not($ttkthue/DLyThue)">
					<tr>
	...
	<!-- start tkhai header 02/CNKD TMĐT-->
	<xsl:template name="tkhaiHeader_02_CNKD_TMDT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-l">
						[<xsl:if test="$tkchinh/Header/hkdcn_keKhaiThang='true' or $tkchinh/Header/hkdcn_keKhaiThang='1' ">x</xsl:if>]: Hộ, cá nhân có hoạt động kinh doanh trên nền tảng thương mại điện tử thực hiện kê khai theo tháng<br/>
						[<xsl:if test="$tkchinh/Header/hkdcn_keKhaiLPS='true' or $tkchinh/Header/hkdcn_keKhaiLPS='1'">x</xsl:if>]: Hộ, cá nhân có hoạt động kinh doanh không thường xuyên trên nền tảng thương mại điện tử thực hiện kê khai theo từng lần phát sinh<br/>
				...
				<tr>
					<td class="align-c">
						...
						<xsl:if test="$ttkthue/TKhaiThue/KyKKhaiThue/kieuKy='M'">
							<b>[01]</b> Kỳ tính thuế: <b>[01a] </b> <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>    
                        </xsl:if>
						
						<xsl:if test="$ttkthue/TKhaiThue/KyKKhaiThue/kieuKy='D'">
							<b>[01]</b> Kỳ tính thuế: <b>[01b] </b> Lần phát sinh:  <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>    
                        </xsl:if>
					</td>
				</tr>
				<tr>
			...
			<table class="ttinnnt_table" width="100%" border="0" cellpadding="0" cellspacing="0" style="width:1100px;">
				...
				<tr>
					<td colspan="3"><b>[09] Tên của tổ chức khai thay (nếu có): </b><xsl:value-of select="$tkchinh/Header/ct09"/></td>
				</tr>
				<tr>
					<td colspan="3"><b>[10]</b> Mã số thuế: <xsl:value-of select="$tkchinh/Header/ct10"/></td>
				</tr>
	...
	<!-- start tkhai header 03/CNNN TMĐT-->
	<xsl:template name="tkhaiHeader_03_CNNN_TMDT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c">
						...
						<xsl:if test="$ttkthue/TKhaiThue/KyKKhaiThue/kieuKy='D'">
							<b>[01]</b> Kỳ tính thuế: <b></b> Lần phát sinh:  <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>    
                        </xsl:if>
					</td>
				</tr>
				<tr>
			...
			<table class="ttinnnt_table" width="100%" border="0" cellpadding="0" cellspacing="0" style="width:1100px;">
				...
				<tr>
					<td colspan="3">
						<b>[06] Thông tin trong trường hợp người nộp thuế chưa được cấp mã số thuế: </b>
						
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[06.1] Số hộ chiếu/ Số giấy thông hành/ Số CMND biên giới/ Số giấy tờ định danh cá nhân khác: </b>
						<xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/CT6/ct6_1_ten"/>, <b>Số: </b>
						<xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/CT6/ct6_1_soGiayTo"/>,<b>Ngày cấp: </b>
						<xsl:value-of select="ihtkk:stringDatetime (HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/CT6/ct6_1_ngayCap,'dd/mm/yyyy')"/>,
						<b>Nơi cấp: </b>
						<xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/CT6/ct6_1_noiCap_ten"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[06.2] Ngày, tháng, năm sinh: </b>
				<xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct6_2,'dd/mm/yyyy')"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[06.3] Địa chỉ: </b>
				<xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct6_3_diachi"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[06.4] Quốc tịch: </b>
						<xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct6_4_ten"/>
					</td>
				</tr>
				...
				<tr>
					<td colspan="3">
						<b>[07] Email: </b>
						<xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct7"/>
					</td>
				</tr>
...
[04] Mã số thuế: </td>
	...
	<!-- start header Danh sách chi tiết nộp TNCN cho từng cá nhân-->
	<xsl:template name="tkhaiHeader_DS_TNCN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table  class="ttinnnt_table"  width="100%">
				...
				<tr>
					<td class="align-c"><b>BẢNG KÊ CHI TIẾT SỐ TIỀN NỘP THUẾ CỦA TỔ CHỨC QUẢN LÝ NỀN TẢNG THƯƠNG MẠI ĐIỆN TỬ</b> 
					</td>
				</tr>
					<td class="align-c"><i> (Kèm theo chứng từ nộp NSNN:<br/> Số: </i> <xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/soChungTu"/>, <i>số tham chiếu: </i><xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/soThamChieu"/>, <i>ngày </i> <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ngay,'dd/mm/yyyy')"/> <i>) </i> 
					</td>
				<tr>
					<td class="align-c"><b>[01] </b>Ngày lập: <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/ngayKy,'dd/mm/yyyy')"/>
					</td>
				</tr>
				<tr>
					<td class="align-c"><b>[02] </b>Lần gửi thứ:<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[03] Tên của tổ chức quản lý nền tảng thương mại điện tử: </b><xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[04] Mã số thuế khấu trừ, nộp thay: </b>
							<xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<!--<tr>
