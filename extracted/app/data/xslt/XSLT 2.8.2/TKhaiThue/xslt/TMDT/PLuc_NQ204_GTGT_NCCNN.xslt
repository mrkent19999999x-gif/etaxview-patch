  ...
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="''"/>
      ...
      <!-- Phụ lục PL_NQ101_GTGT -->
		...
		<xsl:with-param name="tenPL"   select="'GIẢM THUẾ GIÁ TRỊ GIA TĂNG THEO NGHỊ QUYẾT SỐ 204/2025/QH15'"/>
		<xsl:with-param name="ghiChuPL"   select="''"/>
	  </xsl:call-template>
			<div class="ndungtkhai_div">	
			<div class="content">
		     	<div class="donvitien"> <i>Đơn vị tiền: <xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ten_loaitien"/></i></div>
				...
				<td class="align-l">II. Hàng hóa, dịch vụ bán ra trong kỳ</td>
						<table class="tkhai_table"  >
							<tr>
							   <td class="align-c"><b>STT</b></td>
							   <td class="align-c"><b>Tên hàng hóa, dịch vụ</b></td>
							   <td class="align-c"><b>Doanh thu hàng hóa, dịch vụ chịu thuế</b></td>
