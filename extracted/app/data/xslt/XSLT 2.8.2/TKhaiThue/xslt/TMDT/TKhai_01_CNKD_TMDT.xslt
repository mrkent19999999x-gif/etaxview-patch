 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Nghị định số 117-NĐ-CP/2025/NĐ-CP ngày 09 tháng 06 năm 2025 của Chính Phủ'" />
		 <xsl:call-template name="tkhaiHeader_01_CNKD_TMDT">
		<xsl:with-param name="mauTKhai"   select="'01/CNKD-TMĐT'"/>
            ...
            <div  class="align-l"><i>A. KÊ KHAI THUẾ GIÁ TRỊ GIA TĂNG (GTGT), THUẾ THU NHẬP CÁ NHÂN (TNCN)</i></div>
                     <div class="align-r">Đơn vị tính: <xsl:value-of select="$tkchinh/KKThueGTGT_TNCN/ten_loaitien"/>
                      ...
                      <table class="tkhai_table">
						...
						<tr>
								<td class="align-c"><b>Thuế GTGT </b> <br/></td>
								<td class="align-c"><b>Thuế TNCN </b><br/></td>
						...
						<tr>
								...
								<td class="align-c">(7) = (5) + (6)<br/></td>
						</tr>
						<tr>
							<td class="align-c">(1)</td>
							<td>Cung cấp hàng hóa </td>
							<td class="align-c"><b>[09]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThu/ct09)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/SoThueGTGT/ct09)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/SoThueTNCN/ct09)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/TongSoThueDaKhauTru/ct09)"/></td>
						</tr>
						<tr>
							<td class="align-c">(2)</td>
							<td>Cung cấp dịch vụ</td>
							<td class="align-c"><b>[10]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThu/ct10)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/SoThueGTGT/ct10)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/SoThueTNCN/ct10)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/TongSoThueDaKhauTru/ct10)"/></td>
						</tr>
						<tr>
							<td class="align-c">(3)</td>
							<td>Vận tải, dịch vụ có gắn với hàng hóa</td>
							<td class="align-c"><b>[11]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThu/ct11)"/></td>
							...
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/TongSoThueDaKhauTru/ct11)"/></td>
						</tr>
						<tr>
							<td class="align-c">(4)</td>
							<td>Hoạt động kinh doanh khác</td>
							<td class="align-c"><b>[12]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/DoanhThu/ct12)"/></td>
							...
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/TongSoThueDaKhauTru/ct12)"/></td>
						</tr>
						<tr>
							<td class="align-c"></td>
							<td class="align-c"><b>Tổng cộng:</b></td>
							<td class="align-c"><b>[13]</b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/TongCong/ct13_1)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/TongCong/ct13_2)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/TongCong/ct13_3)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KKThueGTGT_TNCN/TongCong/ct13_4)"/></b></td>
						</tr>
					</table>
					<br/>
