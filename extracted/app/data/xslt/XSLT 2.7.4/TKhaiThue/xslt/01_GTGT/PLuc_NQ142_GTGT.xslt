      ...
      <!-- Phụ lục PL_NQ101_GTGT -->
		...
		<xsl:with-param name="ghiChuPL"   select="''"/>
			...
			<div class="content">
				...
				<td class="align-l"><b>I. Hàng hóa, dịch vụ mua vào trong kỳ được áp dụng mức thuế suất thuế giá trị gia tăng 8% (áp dụng cho người nộp thuế kê khai theo phương pháp khấu trừ thuế)</b></td>
				...
				<td class="align-l"><b>II. Hàng hóa, dịch vụ bán ra trong kỳ</b></td>
						<table class="tkhai_table"  >
							<tr>
							   <td class="align-c"><b>STT</b></td>
							   <td class="align-c"><b>Tên hàng hóa, dịch vụ</b></td>
							   <td class="align-c"><b>Giá trị hàng hóa, dịch vụ chưa có thuế GTGT</b></td>
							   <td class="align-c"><b>Thuế suất thuế GTGT theo quy định</b></td>
							   <td class="align-c"><b>Thuế suất  thuế GTGT sau giảm</b></td>
