			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="bketitle" colspan="3">
						<b>
							<!--<xsl:value-of select="$tenPL"/>-->
							<xsl:if test="ihtkk:stringDatetime($kkthue/kyKKhaiDenNgay,'yyyy')='2023'">GIẢM THUẾ GIÁ TRỊ GIA TĂNG THEO NGHỊ QUYẾT SỐ 101/2023/QH15 
							</xsl:if>
							<xsl:if test="ihtkk:stringDatetime($kkthue/kyKKhaiDenNgay,'yyyy')&gt;='2024' and ihtkk:stringDatetime($kkthue/kyKKhaiTuNgay,'yyyy')='2024'">GIẢM THUẾ GIÁ TRỊ GIA TĂNG THEO NGHỊ QUYẾT SỐ 110/2023/QH15
							</xsl:if>
							<xsl:if test="ihtkk:stringDatetime($kkthue/kyKKhaiDenNgay,'yyyy')&gt;='2024' and ihtkk:stringDatetime($kkthue/kyKKhaiTuNgay,'yyyy')&lt;='2023'">GIẢM THUẾ GIÁ TRỊ GIA TĂNG THEO NGHỊ QUYẾT SỐ 101/2023/QH15 VÀ NGHỊ QUYẾT SỐ 110/2023/QH15
							</xsl:if>
						</b>
					</td>
				</tr>
