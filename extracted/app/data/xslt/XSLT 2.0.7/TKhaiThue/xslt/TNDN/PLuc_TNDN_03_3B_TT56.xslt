					...
					<div class="ndungtkhai_div">	
		             <div class="content">	
		             	  <xsl:for-each select="$pl03-3b_tndn/NoiDungPL03_3B">
					        ...
					        <tr>
             				  <td class="align-l"> <xsl:if test="dieuKienUuDaiNN1 = 'true' "> [x] </xsl:if> <xsl:if test="dieuKienUuDaiNN1 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDaiNN1 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDaiNN1 = '0'">[]</xsl:if> Đầu tư  lắp đặt dây chuyền sản xuất mới không thuộc ngành nghề, lĩnh vực, địa bàn khuyến khích đầu tư. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"> <xsl:if test="dieuKienUuDaiNN2 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDaiNN2 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDaiNN2 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDaiNN2 = '0'">[]</xsl:if> Đầu tư vào ngành nghề, lĩnh vực thuộc Danh mục lĩnh vực ưu đãi đầu tư.</td>
			                </tr>
					        <tr>
             				  <td class="align-l"> <xsl:if test="dieuKienUuDaiNN3 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDaiNN3 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDaiNN3 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDaiNN3 = '0'">[]</xsl:if> Đầu tư vào ngành nghề, lĩnh vực thuộc Danh mục lĩnh vực đặc biệt ưu đãi đầu tư </td>
			                </tr>
					        <tr>
             				  <td class="align-l"> <xsl:if test="dieuKienUuDaiNN4 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDaiNN4 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDaiNN4 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDaiNN4 = '0'">[]</xsl:if> Đầu tư vào địa bàn thuộc Danh mục địa bàn có điều kiện kinh tế - xã hội khó khăn. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"> <xsl:if test="dieuKienUuDaiNN5 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDaiNN5 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDaiNN5 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDaiNN5 = '0'">[]</xsl:if> Đầu tư vào địa bàn thuộc Danh mục địa bàn có điều kiện kinh tế - xã hội đặc biệt khó khăn.  </td>
			                </tr><br/>
    						<tr>
                              <td class="align-l">- Dự án đầu tư:</td>
							</tr>	
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDaiDA1 = 'true' "> [x] </xsl:if>   <xsl:if test="dieuKienUuDaiDA1 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDaiDA1 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDaiDA1 = '0'">[]</xsl:if> Đầu tư xây dựng dây chuyền sản xuất mới </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDaiDA2 = 'true' "> [x] </xsl:if>   <xsl:if test="dieuKienUuDaiDA2 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDaiDA2 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDaiDA2 = '0'">[]</xsl:if> Đầu tư mở rộng quy mô, đổi mới công nghệ, cải thiện môi trường sinh thái, nâng cao năng lực sản xuất </td>
			                </tr>
            				<tr>
