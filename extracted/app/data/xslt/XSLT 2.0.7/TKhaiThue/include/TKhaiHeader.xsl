            ...
            <table class="tb_header">						
                ...
                <tr>
                    <td class="align-c">	
                      ...
                      <tr>
                    <td class="align-c" >
                        <xsl:if test="$tkchinh/doanhNghiepCoQuyMoVuaVaNho = 'true' "> [x] </xsl:if>  <xsl:if test="$tkchinh/doanhNghiepCoQuyMoVuaVaNho = 'false'">[]</xsl:if> <xsl:if test="$tkchinh/doanhNghiepCoQuyMoVuaVaNho = '1'">[x]</xsl:if> <xsl:if test="$tkchinh/doanhNghiepCoQuyMoVuaVaNho = '0'">[]</xsl:if> Doanh nghiệp có quy mô vừa và nhỏ
                    </td>
                </tr>	
                        <tr>
                    <td class="align-c" >
                       <xsl:if test="$tkchinh/doanhNghiepCoCSoHToanPThuoc = 'true' ">[x]</xsl:if>  <xsl:if test="$tkchinh/doanhNghiepCoCSoHToanPThuoc = 'false'">[]</xsl:if>			 <xsl:if test="$tkchinh/doanhNghiepCoCSoHToanPThuoc = '1'"> [x]</xsl:if> <xsl:if test="$tkchinh/doanhNghiepCoCSoHToanPThuoc = '0'">[]</xsl:if> Doanh nghiệp có cơ sở sản xuất hạch toán phụ thuộc
                    </td>
                </tr>	
                       <tr>
                    <td class="align-c" >
                        <xsl:if test="$tkchinh/doanhNghiepKeKhaiTTinLienKet = 'true' ">[x]</xsl:if>  <xsl:if test="$tkchinh/doanhNghiepKeKhaiTTinLienKet = 'false'">[]</xsl:if>			 <xsl:if test="$tkchinh/doanhNghiepKeKhaiTTinLienKet = '1'"> [x]</xsl:if> <xsl:if test="$tkchinh/doanhNghiepKeKhaiTTinLienKet = '0'">[]</xsl:if> Doanh nghiệp thuộc đối tượng kê khai thông tin giao dịch liên kết
                    </td>
                </tr>	
                    <tr>
                    <td class="align-c" > <b>[04]</b> Ngành nghề có tỷ lệ doanh thu cao nhất: <xsl:value-of select="$tkchinh/ct_04_ten"/></td>
                </tr>	
                    <tr>
    ...
    <xsl:template name="tkhaiHeader-02TNDN">
        ...
        <div class="header_div">			
            <table class="tb_header">						
                ...
                <tr>
                    <td class="align-c" >       
                        <xsl:if test="$tkchinh/dnQuiMoVuaVaNho = 'true' "> [x]  </xsl:if>  <xsl:if test="$tkchinh/dnQuiMoVuaVaNho = 'false'">[]</xsl:if>			 <xsl:if test="$tkchinh/dnQuiMoVuaVaNho = '1'"> [x]</xsl:if> <xsl:if test="$tkchinh/dnQuiMoVuaVaNho = '0'">[]</xsl:if> Doanh nghiệp có quy mô vừa và nhỏ
                    </td>
                </tr>
                <tr>
                    <td>
