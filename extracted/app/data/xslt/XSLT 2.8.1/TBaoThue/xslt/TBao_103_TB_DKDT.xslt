...
table.center {
  ...
  margin-right: auto;
		...
		<xsl:call-template name="tbaoHeader_103_TB_KTDT">
			<xsl:with-param name="mauTBao"   select="'01/TB-ĐKĐT'"/>
	...
	<xsl:if test="TBao/DLTBao/HTDKy='1'">
		<xsl:if test="TBao/DLTBao/Ten='Thông báo về việc chấp nhận đăng ký sử dụng hóa đơn điện tử'"> 
			    ...
			    <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Sau khi xem xét tờ khai đăng ký sử dụng hóa đơn điện tử 
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế thông báo chấp nhận đề nghị đăng ký sử dụng hóa đơn điện tử của đơn vị</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
		...
		<xsl:if test="TBao/DLTBao/Ten='Thông báo về việc không chấp nhận đăng ký sử dụng hóa đơn điện tử'"> 
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế thông báo không chấp nhận đề nghị đăng ký sử dụng hóa đơn điện tử của đơn vị</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế không chấp nhận người nộp thuế đăng ký sử dụng hóa đơn điện tử)
				<br/>
	...
	<xsl:if test="TBao/DLTBao/HTDKy='2'">
		<xsl:if test="TBao/DLTBao/Ten='Thông báo về việc chấp nhận thay đổi thông tin sử dụng hóa đơn điện tử'"> 
			    ...
			    <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Sau khi xem xét tờ khai thay đổi thông tin sử dụng hóa đơn điện tử 
					   ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'yyyy')"/>
				</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế thông báo chấp nhận đề nghị thay đổi thông tin sử dụng hóa đơn điện tử của đơn vị</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Tài khoản đã được gửi đến hộp thư điện tử của người nộp thuế/điện thoại liên hệ, đề nghị người nộp thuế thực hiện khai báo các thông tin liên quan theo nội dung hướng dẫn của cơ quan thuế tại thư điện tử này</div>
		...
		<xsl:if test="TBao/DLTBao/Ten='Thông báo về việc không chấp nhận thay đổi thông tin sử dụng hóa đơn điện tử'"> 
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế thông báo không chấp nhận đề nghị thay đổi thông tin sử dụng hóa đơn điện tử của đơn vị</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế không chấp nhận người nộp thuế thay đổi thông tin sử dụng hóa đơn điện tử). Lý do: <xsl:value-of select="TBao/DLTBao/DSLDKCNhan/LDo/MTa"/></div>
		</xsl:if>
		
	</xsl:if>
	<!--Doi voi to 1/DKTD-CTDT-->
	<xsl:if test="TBao/DLTBao/HTDKy='1'">
		<xsl:if test="TBao/DLTBao/Ten='Thông báo về việc chấp nhận đăng ký sử dụng chứng từ điện tử'"> 
			    <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Sau khi xem xét tờ khai đăng ký sử dụng chứng từ điện tử 
					   ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'yyyy')"/>
				</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế thông báo chấp nhận đề nghị đăng ký sử dụng chứng từ điện tử của đơn vị</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Tài khoản đã được gửi đến hộp thư điện tử của người nộp thuế/điện thoại liên hệ, đề nghị người nộp thuế thực hiện khai báo các thông tin liên quan theo nội dung hướng dẫn của cơ quan thuế tại thư điện tử này</div>
		</xsl:if>
		<xsl:if test="TBao/DLTBao/Ten='Thông báo về việc không chấp nhận đăng ký sử dụng chứng từ điện tử'"> 
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế thông báo không chấp nhận đề nghị đăng ký sử dụng chứng từ điện tử của đơn vị</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế không chấp nhận người nộp thuế đăng ký sử dụng chứng từ điện tử)
				<br/>
				Lý do: <xsl:value-of select="TBao/DLTBao/DSLDKCNhan/LDo/MTa"/></div>
		</xsl:if>
	</xsl:if>
	<xsl:if test="TBao/DLTBao/HTDKy='2'">
		<xsl:if test="TBao/DLTBao/Ten='Thông báo về việc chấp nhận thay đổi thông tin sử dụng chứng từ điện tử'"> 
			    <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Sau khi xem xét tờ khai thay đổi thông tin sử dụng chứng từ điện tử 
					   ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/Ngay,'yyyy')"/>
				</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế thông báo chấp nhận đề nghị thay đổi thông tin sử dụng chứng từ điện tử của đơn vị</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Tài khoản đã được gửi đến hộp thư điện tử của người nộp thuế/điện thoại liên hệ, đề nghị người nộp thuế thực hiện khai báo các thông tin liên quan theo nội dung hướng dẫn của cơ quan thuế tại thư điện tử này</div>
		</xsl:if>
		<xsl:if test="TBao/DLTBao/Ten='Thông báo về việc không chấp nhận thay đổi thông tin sử dụng chứng từ điện tử'"> 
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế thông báo không chấp nhận đề nghị thay đổi thông tin sử dụng chứng từ điện tử của đơn vị</div>
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
				Cơ quan thuế không chấp nhận người nộp thuế thay đổi thông tin sử dụng chứng từ điện tử). Lý do: <xsl:value-of select="TBao/DLTBao/DSLDKCNhan/LDo/MTa"/></div>
		</xsl:if>
