...
table.center {
  ...
  margin-right: auto;
		...
		<xsl:call-template name="tbaoHeader_01_1_TB_NTDT">
	...
	<xsl:if test="TBao/DLTBao/TTKhai='Đăng ký/thay đổi thông tin sử dụng hóa đơn điện tử'"> 
		<xsl:if test="TBao/DLTBao/THop='1'">
			           ...
			           <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ Tờ khai đăng ký sử dụng hóa đơn điện tử - Mẫu số 01 - 
					  ...
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'yyyy')"/>
						, cơ quan thuế tiếp nhận Tờ khai đăng ký sử dụng hóa đơn điện tử - Mẫu số 01 - 
					  Ban hành kèm theo Nghị định số 70/NĐ-CP của người nộp thuế, cụ thể như sau:
					  </div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Tên tờ khai: Tờ khai đăng ký sử dụng hóa đơn điện tử</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Mã giao dịch điện tử: <xsl:value-of select="TBao/DLTBao/MHSo"/></div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Tờ khai đăng ký sử dụng hóa đơn điện tử của người nộp thuế đã được cơ quan thuế tiếp nhận vào
					  ...
					  . Tờ khai đăng ký sử dụng hóa đơn điện tử của người nộp thuế sẽ được cơ quan thuế tiếp tục kiểm tra</div>
		...
		<xsl:if test="TBao/DLTBao/THop='3'">
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử - Mẫu số 01 - 
					  Ban hành kèm theo Nghị định số 70/NĐ-CP của của người nộp thuế (NNT) gửi tới cơ quan thuế
					  lúc <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'hh')"/> 
					  giờ <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'mi')"/> 
					  phút ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'yyyy')"/>
						, cơ quan thuế tiếp nhận Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử - Mẫu số 01 - 
					  Ban hành kèm theo Nghị định số 70/NĐ-CP của người nộp thuế, cụ thể như sau:
					  </div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Tên tờ khai: Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Mã giao dịch điện tử: <xsl:value-of select="TBao/DLTBao/MHSo"/></div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử của người nộp thuế đã được cơ quan thuế tiếp nhận vào
						lúc <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'hh')"/> 
					  giờ <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'mi')"/> 
					  phút ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'yyyy')"/>
					  . Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử của người nộp thuế sẽ được cơ quan thuế tiếp tục kiểm tra</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Trong thời gian 01 ngày làm việc kể từ ngày cơ quan thuế tiếp nhận Tờ khai ghi trên thông báo này, cơ quan thuế sẽ trả Thông báo Mẫu 02 ban hành kèm theo Nghị định số 70/NĐ-CP về việc chấp nhận hoặc không chấp nhận đăng ký của NNT, trường hợp không chấp nhận, cơ quan thuế nêu rõ lý do không chấp nhận.</div> 
	...
	<xsl:if test="TBao/DLTBao/TTKhai='Đăng ký/thay đổi thông tin sử dụng chứng từ điện tử'">
		<xsl:if test="TBao/DLTBao/THop='1'">
					  ...
					  phút ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'yyyy')"/>, cơ quan thuế tiếp nhận Tờ khai đăng ký sử dụng chứng từ điện tử - Mẫu số 01 - 
					  Ban hành kèm theo Nghị định số 70/NĐ-CP của người nộp thuế, cụ thể như sau:
					  </div>
					  ...
					  phút ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'yyyy')"/>. Tờ khai đăng ký sử dụng chứng từ điện tử của người nộp thuế sẽ được cơ quan thuế tiếp tục kiểm tra.</div>	
                      <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Trong thời gian 01 ngày làm việc kể từ ngày cơ quan thuế tiếp nhận Tờ khai ghi trên thông báo này, cơ quan thuế sẽ trả Thông báo về việc chấp nhận hoặc không chấp nhận đăng ký của NNT, trường hợp không chấp nhận, cơ quan thuế nêu rõ lý do không chấp nhận.</div>					  
		</xsl:if>
		<xsl:if test="TBao/DLTBao/THop='3'">
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ Tờ khai đăng ký thay đổi thông tin sử dụng chứng từ điện tử - Mẫu số 01 - 
					  ...
					  phút ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'yyyy')"/>, cơ quan thuế tiếp nhận Tờ khai đăng ký thay đổi thông tin sử dụng chứng từ điện tử - Mẫu số 01 - 
					  Ban hành kèm theo Nghị định số 70/NĐ-CP của người nộp thuế, cụ thể như sau:
					  </div>
					  ...
					  phút ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'yyyy')"/>. Tờ khai đăng ký thay đổi thông tin sử dụng chứng từ điện tử của người nộp thuế sẽ được cơ quan thuế tiếp tục kiểm tra.</div>
                      <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Cơ quan thuế sẽ trả Thông báo Mẫu số 01/TB-ĐKĐT ban hành kèm theo Nghị định số 70/2025/NĐ-CP về việc chấp nhận hoặc không chấp nhận đăng ký của NNT, trường hợp không chấp nhận, cơ quan thuế nêu rõ lý do không chấp nhận (sau 01 ngày làm việc).</div>					  
		</xsl:if>
	</xsl:if>
	

			<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Trường hợp NNT/Quý đơn vị cần biết thêm thông tin chi tiết, xin vui lòng liên hệ với <xsl:value-of select="TBao/DLTBao/DMXLy"/> để được hỗ trợ.</div> 
