...
<!-- 		<xsl:variable name="ndungTBao" select='TBaoThueDTu/TBaoThue/NDungTBao' /> -->
		<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Nghị định xxxx/2025/NĐ-CP ngày 20 tháng 3 năm 2025 của Bộ trưởng Bộ Tài chính'"/>
<style type="text/css">
table.center {
  margin-left: auto; 
  margin-right: auto;
		...
		<xsl:call-template name="tbaoHeader_01_1_TB_NTDT">
			<xsl:with-param name="mauTBao"   select="'01/TB-TNĐT-HKD'"/>
	...
	<xsl:if test="TBao/DLTBao/TTKhai='Đăng ký/thay đổi thông tin sử dụng hóa đơn điện tử'"> 
		<xsl:if test="TBao/DLTBao/THop='1'">
			           ...
			           <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ Tờ khai đăng ký sử dụng hóa đơn điện tử; chứng từ điện tử - Mẫu số 01 - 
					  ...
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'yyyy')"/>
						, cơ quan thuế tiếp nhận Tờ khai đăng ký sử dụng hóa đơn điện tử; chứng từ điện tử - Mẫu số 01 - 
					  Ban hành kèm theo Nghị định số 70/NĐ-CP của người nộp thuế, cụ thể như sau:
					  </div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Tên tờ khai: Tờ khai đăng ký sử dụng hóa đơn điện tử; chứng từ điện tử</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Mã giao dịch điện tử: <xsl:value-of select="TBao/DLTBao/MHSo"/></div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Tờ khai đăng ký sử dụng hóa đơn điện tử; chứng từ điện tử của người nộp thuế đã được cơ quan thuế tiếp nhận vào
					  ...
					  . Tờ khai đăng ký sử dụng hóa đơn điện tử; chứng từ điện tử của người nộp thuế sẽ được cơ quan thuế tiếp tục kiểm tra</div>
		...
		<xsl:if test="TBao/DLTBao/THop='3'">
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử; chứng từ điện tử - Mẫu số 01 - 
					  Ban hành kèm theo Nghị định số 70/NĐ-CP của của người nộp thuế (NNT) gửi tới cơ quan thuế
					  lúc <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'hh')"/> 
					  giờ <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'mi')"/> 
					  phút ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGGui,'yyyy')"/>
						, cơ quan thuế tiếp nhận Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử; chứng từ điện tử - Mẫu số 01 - 
					  Ban hành kèm theo Nghị định số 70/NĐ-CP của người nộp thuế, cụ thể như sau:
					  </div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Tên tờ khai: Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử; chứng từ điện tử</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Mã giao dịch điện tử: <xsl:value-of select="TBao/DLTBao/MHSo"/></div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử; chứng từ điện tử của người nộp thuế đã được cơ quan thuế tiếp nhận vào
						lúc <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'hh')"/> 
					  giờ <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'mi')"/> 
					  phút ngày <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'dd')"/> 
					  tháng <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'mm')"/> 
					  năm <xsl:value-of select="ihtkk:stringDatetime(TBao/DLTBao/TGNhan,'yyyy')"/>
					  . Tờ khai đăng ký thay đổi thông tin sử dụng hóa đơn điện tử; chứng từ điện tử của người nộp thuế sẽ được cơ quan thuế tiếp tục kiểm tra</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Trong thời gian 01 ngày làm việc kể từ ngày cơ quan thuế tiếp nhận Tờ khai ghi trên thông báo này, cơ quan thuế sẽ trả Thông báo Mẫu 02 ban hành kèm theo Nghị định số 70/NĐ-CP về việc chấp nhận hoặc không chấp nhận đăng ký của NNT, trường hợp không chấp nhận, cơ quan thuế nêu rõ lý do không chấp nhận.</div> 
