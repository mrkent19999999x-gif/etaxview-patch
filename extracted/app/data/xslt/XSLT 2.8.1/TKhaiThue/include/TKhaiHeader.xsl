...
<!-- start tkhai header 01_DKTD_CTDT -->
	<xsl:template name="tkhaiHeader_01_DKTD_CTDT">
		...
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td style="width:100%;text-align:center">
						<br/><b>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM<br/>Độc lập-Tự do-Hạnh phúc</b>
						<br/>-------------------------
					</td>
	...
	<!-- start tkhai header 06_DN_PSDT -->
	<xsl:template name="tkhaiHeader_06_DN_PSDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<div class="bieu_mau_div" style="float: right; margin-bottom: 4px; width: 30%;">    <div >
                 <b>Mẫu số:       <xsl:value-of select="$MSo"/></b>    
            </div>
            </div>
			<br/>
				...
				<table class="ttinnnt_table" style="width:100%">
					...
					<tr>
						<td  colspan="2" style="text-align:center">
							<b class="tentkhai">ĐỀ NGHỊ CẤP HÓA ĐƠN ĐIỆN TỬ CÓ MÃ CỦA CƠ QUAN THUẾ</b>
							<br/>
							<span>(Theo từng lần phát sinh)</span>
						</td>
					</tr>
				</table>
				<table class="ttinnnt_table" style="width:100%; text-align:center;margin-top: -18px;">
					<tr>
						<td class="align-c" colspan="2" style="width:100%; text-align:center;">
							...
							<xsl:if test="DNghi/DLDNghi/TTChung/HThuc ='3'">
								<i>[01] Cấp mới : [&#32;] &#160;&#160;&#160;&#160;[02] Điều chỉnh : [&#32;]  &#160;&#160;&#160;&#160;[03] Thay thế  : [X]  </i>
							</xsl:if>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" class="align-l">
							6. Số CC/CCCD/Mã định danh/Hộ chiếu của người đại diện theo pháp luật:
							<xsl:choose>
								<xsl:when test="DNghi/DLDNghi/TTChung/CCCD">
									<xsl:value-of select="DNghi/DLDNghi/TTChung/CCCD"/>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="DNghi/DLDNghi/TTChung/SHChieu"/>
								</xsl:otherwise>
							</xsl:choose>
						</td>
					</tr>
	...
	<!-- start tkhai header CTT50 -->
	<xsl:template name="tkhaiHeader_CTT50">	
		...
		<tbody>
			<tr>
				<td width="30%">
					...
					<div class="align-c">Cơ quan thu: <xsl:value-of select="BLai/DLBLai/TTChung/CQThu"/>
					</div>
				</td>
				<td width="40%">
					<div align="center" style="margin:0; padding:0;">
				...
				<td width="30%">
					<div class="align-l">
						<div ><b>Mẫu số: CTT50</b>
								<!-- <xsl:value-of select="$mauTBao"/> -->
							 <br/>
                        <i><span class="mtatentkhai" style="font-size:9pt">
						(Ban hành kèm theo Thông tư số số 32/2025/TT-BTC ngày 31 tháng 5 năm 2025 của Bộ Tài chính) </span></i>
                            
						</div>
						<br/>
					</div>
					<div class="align-l">Ký hiệu: <b>25T</b></div>
					<div class="align-l">Số: <b><xsl:value-of select="BLai/DLBLai/TTChung/SCTu"/></b>
					</div>
				</td>
			</tr>
		...
		<tbody>
			<tr>
				<td colspan="2" align="center">
					<br/><br/>
					<b>THÔNG BÁO</b><br/>
				<b>(Ban hành kèm theo Thông báo số…./……….ngày …………của <xsl:value-of select="TBao/DLTBao/TCQT"/>)</b>
				</td>
			</tr>
		</tbody>
	</table>
...
<!-- start tkhai header 01/CCCT-DK -->
	<xsl:template name="tkhaiHeader_01_CCTT_DK">	
	<xsl:param name="mauTBao" />
	<xsl:param name="soTBao" />
	<xsl:param name="ngayTBao" />
	<xsl:param name="motaTBao" />
		...
		<tbody>
			<tr>
				<td width="30%">
					<div align="center" style="margin:0; padding:0;">
						<br/>
						<b><xsl:value-of select="TKhai/DLTKhai/TTChung/CQTQLy"/></b><br/>
						 _______________<br/>
					</div>
					<div class="align-c">Số: <xsl:value-of select="TKhai/DLTKhai/TTChung/So"/>
					</div>
					<div>V/v Đăng ký tài khoản truy cập Cổng thông tin hóa đơn điện tử, chứng từ điện tử</div>
				</td>
				<td width="70%">
					<div align="center" style="margin:0; padding:0;">
					<b>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM<br/>
					Độc lập - Tự do - Hạnh phúc</b><br/>
					_______________<br/>
					<i><xsl:value-of select="TKhai/DLTKhai/TTChung/DDanh"/>, ngày <xsl:value-of select="ihtkk:stringDatetime(TKhai/DLTKhai/TTChung/NLap,'dd')"/> 
					tháng <xsl:value-of select="ihtkk:stringDatetime(TKhai/DLTKhai/TTChung/NLap,'mm')"/>
					năm <xsl:value-of select="ihtkk:stringDatetime(TKhai/DLTKhai/TTChung/NLap,'yyyy')"/></i>
					</div>
				</td>
				<br></br>
			</tr>
			...
			<br></br>
				<td colspan="2" align="center">
					Kính gửi: Tổng cục Thuế<br/>
				</td>
			</tr>
			<br></br>
			<tr>
						<td></td>
						<td class="align-l" colspan="2" style="width:100%; text-align:center;">
							<xsl:if test="TKhai/DLTKhai/TTChung/HThuc ='1'">
								[X]&#160;&#160;&#160;&#160;Đăng ký mới
								<br></br>[&#32;]&#160;&#160;&#160;&#160; Thay đổi thông tin
								<br></br>[&#32;]&#160;&#160;&#160;&#160; Chấm dứt
							</xsl:if>
							<xsl:if test="TKhai/DLTKhai/TTChung/HThuc ='2'">
								[&#160;]&#160;&#160;&#160;&#160; Đăng ký mới
								<br></br>[X]&#160;&#160;&#160;&#160;Thay đổi thông tin
								<br></br>[&#32;]&#160;&#160;&#160;&#160; Chấm dứt
							</xsl:if>
							<xsl:if test="TKhai/DLTKhai/TTChung/HThuc ='3'">
								[&#160;]&#160;&#160;&#160;&#160; Đăng ký mới
