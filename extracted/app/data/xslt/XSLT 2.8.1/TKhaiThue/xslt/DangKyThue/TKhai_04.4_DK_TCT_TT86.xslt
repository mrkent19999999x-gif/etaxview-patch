   ...
   <div class="ndungtkhai_div">
	...
	<div class="dv-title">
				...
				<div class="col-md-12">
				  <table>
				   <tr>
					...
					<tr>
						<td>
						<i>(Dùng cho cơ quan, tổ chức, cá nhân được cơ quan thuế ủy nhiệm thu)</i>
						</td>
					</tr>
					<!-- /Title left -->
		...
		<div class="col-md-12 sparent">
			<div class="parent-100 col-md-12 l-div" id="pr100-1-1">
				<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
					<label class="parent-label no-b">1. Tên cơ quan, tổ chức, cá nhân được cơ quan thuế ủy nhiệm thu:</label>
		...
		<div class="col-md-12 sparent">
			<div class="parent-100 col-md-12 l-div" id="pr100-1-1">	
				<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
					<label class="parent-label no-b">3. Hợp đồng ủy nhiệm thu</label>
				</div>
				<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
							<label class="content-label">&#160;
								a. Số: 
								<xsl:value-of select="$tkchinh/CT3/ct3_a" />
							</label>
				</div>
				<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
							<label class="content-label">&#160;
								b. Ngày:
								<xsl:value-of select="ihtkk:stringDatetime($tkchinh/CT3/ct3_b,'dd/mm/yyyy')" />
							</label>
				</div>
				<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
							<label class="content-label">&#160;
								c. Tên cơ quan thuế ủy nhiệm thu:
								<xsl:value-of select="$tkchinh/CT3/ct3_c" />
							</label>
				</div>
				<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
						<label class="content-label">&#160;
							<span class="content-label-child">
								d. Thời gian thực hiện hợp đồng: Từ ngày:
								<xsl:value-of select="ihtkk:stringDatetime($tkchinh/CT3/ct3_d_TuNgay,'dd/mm/yyyy')" />
							</span>
							<span class="content-label-child">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
								đến ngày:  
								<xsl:value-of select="ihtkk:stringDatetime($tkchinh/CT3/ct3_d_DenNgay,'dd/mm/yyyy')" />
							</span>
						</label>
				</div>
			</div>
		...
		<tr>
			<td>	  	
			<xsl:call-template name="tkhaiFooter_04_4">   
			</xsl:call-template>
			<div id="sigDiv"></div>
			</td>
		</tr>	
