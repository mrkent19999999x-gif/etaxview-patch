	...
	<div class="col-md-12 parent-div">
			...
			<div class="dv-title">
				...
				<div class="col-md-12" style="text-align: center;">
					<label class="f-bold">VĂN BẢN</label>
					<br />
...
<!--						<xsl:if test="$tkchinh/nghiepVuTKhai = '01'"><label class="f-bold">Đăng ký tạm ngừng hoạt động, kinh doanh  </label></xsl:if>-->
					<label class="f-bold">Đăng ký tạm ngừng hoạt động, kinh doanh hoặc tiếp tục hoạt động sau tạm ngừng hoạt động, kinh doanh trước thời hạn </label>
				</div>
				<div class="col-md-12 no-p col-sm-offset-1" style="margin-top: 30px; text-align: center; padding: 2px 0px 0px 20px !important">
			...
			<div class="col-md-12 full-header" style="margin-top: 30px; width:100%;">
				...
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					...
					<div class="col-md-6">
						<label><xsl:value-of select="$tkchinh/thoiGianTN" />
				...
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-6">
						<label class="col-md-12">b) Thời điểm bắt đầu tạm ngừng:</label>
					</div>
					<div class="col-md-6">
				...
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-6">
						<label class="col-md-12">c) Thời điểm kết thúc tạm ngừng:</label>
					</div>
					<div class="col-md-6">
				...
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-6">
						<label class="col-md-12">a) Thời điểm tiếp tục hoạt động sau tạm ngừng hoạt động, kinh doanh trước thời hạn:</label>
					</div>
					<div class="col-md-6">
