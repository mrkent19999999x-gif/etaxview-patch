...
.parent-label1 {
   ...
   <div class="ndungtkhai_div">
	...
	<div class="dv-title">
				...
				<div class="col-md-12">
				  <table>
				   <tr>
					...
					<tr>
						<td>
							<i>(Dùng cho các cơ quan ngoại giao, cơ quan lãnh sự, cơ quan đại diện tổ chức quốc tế)</i>
							<br/>(Use for diplomatic, consulate, international organization)
						</td>
					</tr>
					<tr>
						<td>&#160;
				 ...
				 <!-- <table>
				   <tr>
						<td style= "width:40%;text-align:left">
							<b>MÃ SỐ THUẾ <br/>TAX IDENTIFICATION NUMBER</b></td>
						<td style="width:35%;text-align:right">
							&#160;&#160;&#160;<i>Dành cho cơ quan thuế ghi<br/>For tax office only</i>
			            </td>
						<td style="width:25% ; vertical-align: top;" rowSpan="5" align="top">
							<div class="bieu_mau_div">
								<div><label>DÙNG CHO CÁC CƠ QUAN NGOẠI GIAO, CƠ QUAN LÃNH SỰ, CƠ QUAN ĐẠI DIỆN TỔ CHỨC QUỐC TẾ</label>
								<br/>Use for diplomatic, consulate, international organization
								<br><span>&#160;</span></br>
				...
				<div class="col-md-12 sparent">
							...
							<td rowSpan="1" style="width:49%; vertical-align: top;">
								<div class="parent-100 col-md-12 l-div" id="pr100-1-1">
									...
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
										<xsl:value-of select="$tkchinh/ct1_tenCoQuan" />
										</label>
									</div>
								</div>
							</td>
					...
					<table>
						<tr>
							...
							<td rowSpan="1" style="width:49%; vertical-align: top;">
								<div class="parent-100 col-md-12 l-div" id="pr50-1-1">
								    <div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="parent-label">
									...
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
											2b. Phường/ xã:
											<xsl:value-of select="$tkchinh/CT2/ct2b_tenPhuong" />
										</label>
									</div>
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
									...
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
											2c. Quận/ Huyện:
											<xsl:value-of select="$tkchinh/CT2/ct2c_tenQuan" />
										</label>
									</div>
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
									...
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
											2d. Tỉnh/ Thành phố: 
											<xsl:value-of select="$tkchinh/CT2/ct2d_tenTinh" />
										</label>
									</div>
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
									...
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
											<span class="content-label-child">
												2e. Điện thoại (Tel):
												<xsl:value-of select="$tkchinh/CT2/ct2e_dienThoai" />
											</span>
											<span class="content-label-child">
												/Fax:
												<xsl:value-of select="$tkchinh/CT2/ct2e_fax" />
											</span>
										</label>
										<label class="content-label">&#160;
											Email:
											<xsl:value-of select="$tkchinh/CT2/ct2e_email" />
										</label>
									</div>
									<!-- <div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
							...
							<td rowSpan="1" style="width:49%; vertical-align: top;">
								<div class="parent-100 col-md-12 l-div" id="pr100-1-1">
									<div style="width: 100%; height: 4;  padding: 2px 0px 0px 0px !important;">
										...
										3. Tài liệu kèm theo: 
										<label class="content-label">&#160;
										<xsl:value-of select="$tkchinh/ct3" />
										</label>
										</label>
									</div>  
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
		...
		<tr>
			<td>	  	
			<xsl:call-template name="tkhaiFooter_06_105">   
			</xsl:call-template>
			<div id="sigDiv"></div>
			</td>
		</tr>	
