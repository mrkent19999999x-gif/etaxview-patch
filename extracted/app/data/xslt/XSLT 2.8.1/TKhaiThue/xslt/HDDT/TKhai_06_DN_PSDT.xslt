 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="''"/>
	  <xsl:call-template name="tkhaiHeader_06_DN_PSDT">
		<xsl:with-param name="MSo"   select="'06/ĐN-PSĐT'"/>
		...
		<div class="content">
				...
				<br/>
					<table class="tkhai_table">
						 <tr>
						   ...
						   <td class="align-c"><b>Mã số QHVNS</b></td>
						 ...
						 <tr>
						   ...
						   <td colspan='2' class="align-c">(2)</td>
						   ...
						   <td class="align-c">(9)</td>
							...
							<xsl:for-each select="DNghi/DLDNghi/NDDNghi/NDDTPSinh/DSDLieu/DLieu">
								...
								<tr>
								  ...
								  <td class="align-c"><xsl:value-of select="MDVQHNSach"/></td>
								  <td class="align-l"><xsl:value-of select="Ten"/></td>
								  <td class="align-l"><xsl:value-of select="DChi"/></td>
								  <td class="align-c"><xsl:value-of select="SHDong"/>, <xsl:value-of select="ihtkk:stringDatetime(NHDong,'dd/mm/yyyy')"/></td>
			...
			<xsl:if test="DNghi/DLDNghi/TTChung/HThuc != '1'">
				<tr>
					...
					<xsl:if test="DNghi/DLDNghi/TTChung/HThuc !='1'">
					<td><b>II. THÔNG TIN HÓA ĐƠN ĐIỀU CHỈNH/THAY THẾ</b></td>
				</xsl:if>
				...
				<table class="tkhai_table">
						 <tr>
						   ...
						   <td class="align-c"><b>Tên người mua</b></td>
							...
							<td class="align-c"><b>Ngày hóa đơn</b></td>
							<td class="align-c"><b>Số, ngày hợp đồng mua bán hàng hóa, dịch vụ</b></td>
							<td class="align-c"><b>Tên hàng hóa, dịch vụ</b></td>
							<td class="align-c"><b>Số lượng</b></td>
							<td class="align-c"><b>Đơn giá</b></td>
						 ...
						 <tr>
						   ...
						   <td class="align-c">(10)</td>
							...
							<xsl:for-each select="DNghi/DLDNghi/NDDNghi/TTHDDCTThe/TTHDBDCTThe">
									<xsl:variable name="currentRows1" select='position()'/>
								<tr>
								  <td class="align-c"><xsl:value-of select="$currentRows1" /></td>
								  <td class="align-c"><xsl:value-of select="MST"/></td>
								  ...
								  <td class="align-c"><xsl:value-of select="SHDon"/></td>
								  <td class="align-c"><xsl:value-of select="ihtkk:stringDatetime(NHDon,'dd/mm/yyyy')"/></td>
								  <td class="align-c"><xsl:value-of select="SHDong"/>, <xsl:value-of select="ihtkk:stringDatetime(NHDong,'dd/mm/yyyy')"/></td>
								  <td class="align-c"><xsl:value-of select="HDBDCTThe/THHDVu"/></td>
								  <td class="align-r"><xsl:value-of select="ihtkk:formatNumber(HDBDCTThe/SLuong)"/></td>
								  <td class="align-r"><xsl:value-of select="ihtkk:formatNumber(HDBDCTThe/DGia)"/></td>
	      						  <td class="align-r"><xsl:value-of select="ihtkk:formatNumber(HDBDCTThe/ThTien)"/></td>	
								  <td class="align-c"><xsl:value-of select="HDBDCTThe/TSuat"/></td>
								 </tr>
							</xsl:for-each>
				</table>
				<br/>
				...
				<table class="tkhai_table">
						 <tr>
							...
							<td rowspan="2" class="align-c"><b>Số hóa đơn</b></td>
							<td rowspan="2" class="align-c"><b>Ngày hóa đơn</b></td>
...
<tr>
<td>		  
		<xsl:call-template name="tkhaiFooter_06_DN_PSDT"/>
<div id="sigDiv"></div>
</td>
</tr>
</table>		
