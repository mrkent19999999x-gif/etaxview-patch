...
<!--start Footer tờ khai NTNN - TT80-->		
   ...
   <xsl:template name="tkhaiFooter_PL_01TCKT_BDS">
	...
	<!-- Footer Bao cao tai chinh TT125-->
	<xsl:template name="tkhaiFooter-BCTC125">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
                                    <b>Người lập </b><br/>(Ký, họ tên) 
	...
	<!-- Footer Bao cao tai chinh TT24 năm 2024 liên tục-->
	<xsl:template name="tkhaiFooter-BCTC24-LienTuc">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "30%">								
                                    <b>Người lập biểu</b><br/>(Ký, họ tên) 
            ...
            <td class="align-c" width = "40%">								
                                    <i>Lập, ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/PhanKy/ngayLap,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/PhanKy/ngayLap,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/PhanKy/ngayLap,'yyyy')"/></i><br/>
									<b>THỦ TRƯỞNG ĐƠN VỊ </b><br/><i>(Ký, họ tên, đóng dấu) </i>
								
									<br/><br/><br/><xsl:value-of select="$tkchinh/PhanKy/thuTruongDonVi"/>
									<br/>
			</td>
	    </table>		
