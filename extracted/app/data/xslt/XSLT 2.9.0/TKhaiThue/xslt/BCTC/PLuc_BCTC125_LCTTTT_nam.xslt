 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="ghiChuPL2"   select="'(Theo phương pháp trực tiếp) (*)'"/>
			<xsl:call-template name="tkhaiHeader-plucBCTC125_LCTTTT">
    ...
    <table class="tkhai_table">
        ...
        <tr>
		 ...
		 <i>
            ...
            <td class="align-c"><i><b>20</b></i></td>
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct20"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct20"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct20"/></td>
        </i>
		</tr>
        <tr>
