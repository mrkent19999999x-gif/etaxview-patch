...
<!-- KẾT QUẢ HOẠT ĐỘNG SẢN XUẤT KINH DOANH  -->
	...
	<xsl:variable name="pluc01" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_BCKQHDR' />	
		...
		<xsl:call-template name="PLuc_BCTC209_KQHDSXKD_GiuaNienDo">
		<xsl:with-param name="mauTKhai"   select="'B02a - ĐTĐP'"/>
...
<div class="align-r">Đơn vị tính: Đồng Việt Nam</div><br/>
    <table class="tkhai_table">
        ...
        <tr>
            ...
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc01/Quy/NamNay/ct10"/></b></td>
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct10"/></b></td>
            </b>
        </tr>
        <tr>
		...
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamNay/ct12"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct12"/></td>
        </tr>
		<tr>
            <td>5. Thu nhập thuần từ hoạt động tài chính</td>
            <td class="align-c">13</td>
            <td class="align-l"><xsl:value-of select="$pluc01/ThuyetMinh/ct13"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamNay/ct13"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct13"/></td>
        </tr>
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamNay/ct14"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct14"/></td>
        </tr>
		<tr>
            <td>5.2. Chi phí tài chính</td>
            <td class="align-c">15</td>
            <td class="align-l"><xsl:value-of select="$pluc01/ThuyetMinh/ct15"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamNay/ct15"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct15"/></td>
        </tr>
		<tr>
            <td>6. Chi phí hoạt động kinh doanh</td>
            <td class="align-c">16</td>
            <td class="align-l"><xsl:value-of select="$pluc01/ThuyetMinh/ct16"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamNay/ct16"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct16"/></td>
        </tr>
		...
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamNay/ct17"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct17"/></td>
        </tr>
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamNay/ct18"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct18"/></td>
        </tr>
		<tr>
            <td>7.2. Chi phí khác</td>
            <td class="align-c">19</td>
            <td class="align-l"><xsl:value-of select="$pluc01/ThuyetMinh/ct19"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamNay/ct19"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct19"/></td>
        </tr>
        <tr>
            <b>
            ...
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc01/Quy/NamNay/ct20"/></b></td>
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct20"/></b></td>
            </b>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc01/Quy/NamNay/ct60"/></b></td>
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc01/Quy/NamTruoc/ct60"/></b></td>
            </b>
        </tr>
