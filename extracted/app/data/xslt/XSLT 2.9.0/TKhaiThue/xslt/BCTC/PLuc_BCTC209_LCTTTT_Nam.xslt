...
<!-- LƯU CHUYỂN TIỀN TỆ TRỰC TIẾP  -->
	...
	<xsl:variable name="pluc02" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_LCTTTT' />	
		...
		<xsl:call-template name="tkhaiHeader-plucBCTC200_LCTTTT">
...
<div class="align-r">Đơn vị tính: Đồng Việt Nam</div><br/>
    <table class="tkhai_table">
		...
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct14"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct14"/></td>
        </tr>
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct15"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct15"/></td>
        </tr>
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct16"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct16"/></td>
        </tr>
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct17"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct17"/></td>
        </tr>
		<tr>
            <td>18. Thuế TNDN đã nộp</td>
            <td class="align-c">18</td>
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct18"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct18"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct18"/></td>
        </tr>
		<tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct19"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct19"/></td>
        </tr>
        ...
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct40"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct40"/></td>
        </tr>
        ...
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct41"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct41"/></td>
        </tr>
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct42"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct42"/></td>
        </tr>
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct43"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct43"/></td>
        </tr>
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct50"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct50"/></td>
        </tr>
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct60"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct60"/></td>
        </tr>
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc02/NamNay/ct70"/></td>
            <td class="number align-r"><xsl:value-of select="$pluc02/NamTruoc/ct70"/></td>
        </tr>
        <tr>
            <b>
            ...
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc02/NamNay/ct71"/></b></td>
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc02/NamTruoc/ct71"/></b></td></b>
        </tr>
        <tr>
            <b>
