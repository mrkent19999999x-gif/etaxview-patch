		...
		<tbody>
			...
			<tr>
				<td colspan="2" align="center">
					<br/><br/><br/>
					<b>THÔNG BÁO</b><br/>
					<b>V/v: Tiếp nhận hồ sơ khai thuế điện tử</b><br/>
					_______________<br/>
				</td>
			</tr>
		</tbody>
...
<!-- thông báo bước 1 Hóa đơn điện tử mẫu số 01_TB_KTDL-->
	<xsl:template name="tbaoHeader_01TB_KTDL">
		<xsl:param name="mauTBao"/>
		<xsl:param name="soTBao"/>
		<xsl:param name="ngayTBao"/>
		<xsl:param name="motaTBao"/>
			...
			<tbody>
				...
				<tr>
					...
					Độc lập - Tự do - Hạnh phúc</b>
							<br/>
					_______________<br/>
							<i>Hà Nội, ngày <xsl:value-of select="ihtkk:stringDatetime(TBaoThueDTu/TBaoThue/TTinChung/TTinTBaoThue/ngayTBao,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime(TBaoThueDTu/TBaoThue/TTinChung/TTinTBaoThue/ngayTBao,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime(TBaoThueDTu/TBaoThue/TTinChung/TTinTBaoThue/ngayTBao,'yyyy')"/>
							</i>
						</div>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center">
						...
						<b>THÔNG BÁO</b>
						<br/>
							<b>Về việc kết quả kiểm tra dữ liệu hóa đơn diện tử</b>
				...
				<tr>
					<td colspan="3" align="center">
						...
						<div> Kính gửi: <xsl:value-of select="TBaoThueDTu/TBaoThue/TTinChung/NNhanTBaoThue/tenNNhan"/></div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="TBaoThueDTu/TBaoThue/TTinChung/NNhanTBaoThue/maNNhan"/></div>
