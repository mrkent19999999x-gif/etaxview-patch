...
Doanh nghiệp, tổ chức kinh tế khai thuế thay, nộp thuế thay theo pháp luật thuế<xsl:if test="$tkchinh/Header/khaiTheoPLuatThue= 'true' ">[x]</xsl:if> 
		...
		<!-- start header Phuluc 01BK_TTS (TT40/2021)-->
	...
	<xsl:template name="tkhaiHeader_01_XSBHDC_TT40">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_01TKN_CNKD">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table" with="100%" border="0" cellpadding="0" cellspacing="0" stype="width:1100px;" >
				...
				<tr>
					<td colspan="3">[06b] Phường/Xã/Thị trấn: <xsl:value-of select="$ttkthue/NNT/phuongXa"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3">[10g.2] Phường/Xã/Thị trấn: <xsl:value-of select="$tkchinh/Header/CT10g/ct10g_tenPhuong"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3">[10h.2] Phường/Xã/Thị trấn: <xsl:value-of select="$tkchinh/Header/CT10h/ct10h_tenPhuong"/>
					</td>
				</tr>
				<tr>
