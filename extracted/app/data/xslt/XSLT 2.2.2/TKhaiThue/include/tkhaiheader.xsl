...
ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct13_ngay,'dd/mm/yyyy')" /> Do Bộ KH&amp;ĐT cấp
	...
	<!-- start tkhai header 01/ĐNHT goi 2.2.2-->
	<xsl:template name="tkhaiHeader_01DNHT_2.2.2">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<td   colspan="6"  align="right" >
					<div></div>
					<div class="bieu_mau_div" style="width: 25%; float: right;">
						<div >Mẫu số: <b>
								<xsl:value-of select="$mauTKhai"/>
							</b>
							 <br/>
			...
			<tr>
				...
				<tr>
				    <td></td>
					<td>Số giấy đề nghị hoàn: <xsl:value-of select="$tkchinh/Header/so"/></td>
				</tr>
				<tr>
				    <td></td>
					<td class="align-c">&#160;&#160;&#160;&#160;&#160;&#160; &#160;&#160; &#160;&#160;&#160;&#160;&#160; &#160;&#160;&#160;&#160; &#160;&#160;<b>[01]</b> Trường hợp hoàn thuế trước, kiểm tra sau [<xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_1='true'">x</xsl:if>] <br/>&#160;&#160;&#160; &#160;&#160;&#160;&#160;&#160; &#160;&#160;&#160;&#160; &#160;&#160;&#160;&#160; &#160;&#160;&#160;&#160;&#160;&#160;&#160;    Trường hợp kiểm tra trước, hoàn thuế sau  [<xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_2='true'">x</xsl:if>]
					</td>
				</tr>
				<tr>
				    <td></td>
					<td class="align-c">&#160;&#160;&#160;&#160;&#160; &#160;&#160;&#160; &#160; &#160;&#160;&#160;&#160; &#160; Loại hoàn thuế: <xsl:value-of select="$tkchinh/Header/tenLoaiHoan"/></td>
				</tr>
				<tr>
					<td></td>
				</tr>
				...
				<tr>
			<td></td> 
				<td class="align-c">Kính gửi: <xsl:value-of select="$tkchinh/Header/tenCoQuanThu"/></td>
			</tr>
			</table>
			<table class="ttinnnt_table">
			<tr>
				<td><b>I- Thông tin về tổ chức, cá nhân đề nghị hoàn trả:  </b></td>
			</tr>
				<tr>
					<td colspan="4">
						<b>[02] Tên người nộp thuế</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>
				...
				<tr>
					<td><b>[04]</b> CMND/Hộ chiếu số: <xsl:value-of select="$tkchinh/Header/soCMND_HoChieu"/></td>
					<td>Ngày cấp: <xsl:value-of select="$tkchinh/Header/ngayCap"/></td>
					<td>Nơi cấp: <xsl:value-of select="$tkchinh/Header/noiCap"/> </td>
					<td>Quốc tịch: <xsl:value-of select="$tkchinh/Header/quocTich"/></td>
				</tr>
				<tr>
					<td>
						<b>[05] </b> Địa chỉ: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/>
