            ...
            <div class="content">
				...
				<table class="tkhai_table">
					...
					<tr>
						...
						<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/BangChiTietThueTTDB/DVuChiuThueTTDB/tongDongIIcot10)"/></b></td>
						<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/BangChiTietThueTTDB/DVuChiuThueTTDB/tongDongIIcot11)"/></b></td>
					</tr>
