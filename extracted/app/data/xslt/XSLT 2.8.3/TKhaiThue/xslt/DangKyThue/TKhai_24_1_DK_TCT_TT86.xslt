   ...
   <div class="ndungtkhai_div">
	...
	<div class="col-md-12 parent-div">
			...
			<div class="col-md-12" style="text-align: center;">
					...
					<br/>Về việc chấm dứt hoạt động địa điểm kinh doanh của cá nhân kinh doanh
			...
			<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid" >
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">Thông báo chấm dứt hoạt động địa điểm kinh doanh sau:
							</label>
						</div>
			...
			<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid" >
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">3. Địa chỉ của địa điểm kinh doanh:</label>
						</div>
						<div class="col-md-6">&#160;
							<xsl:if test="$tkchinh/DiaChiKD/soNha != ''"><label><xsl:value-of select="$tkchinh/DiaChiKD/soNha" />, <xsl:value-of select="$tkchinh/DiaChiKD/tenPhuong" />, <xsl:value-of select="$tkchinh/DiaChiKD/tenTinh" /></label></xsl:if>
		...
		<tr>
		<td>	  	
		<xsl:call-template name="tkhaiFooter_24_1_DK_TCT">   
		</xsl:call-template>
		<div id="sigDiv"></div>
		</td>
		</tr>
