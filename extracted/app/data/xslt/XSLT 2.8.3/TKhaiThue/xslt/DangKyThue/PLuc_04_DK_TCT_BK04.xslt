...
<xsl:template match="/">
		...
		<xsl:variable name="PL" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_04_01_DK_TCT'/>
		<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Thông tư số 105/2020/TT-BTC ngày 03/12/2020 của Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader_04_DK_TCT_BK04">
		<xsl:with-param name="mauTKhai"   select="'01-ĐK-TCT-BK04'"/>
 	...
 	<div class="ndungtkhai_div">
		...
		<table  class="tkhai_table">
							  <tr>
								...
								<td class="align-c" rowspan="2"><b>Mã số thuế của nhà <br/>thầu nước ngoài, <br/>nhà thầu phụ nước ngoài <br/> tại Việt Nam (nếu có)</b></td>
								...
								<td class="align-c" colspan="3"><b>Địa điểm thực hiện hợp đồng</b></td>
						...
						<xsl:for-each select="$PL/NhaThauNN/ChiTietNhaThauNN">
								...
								<td class="align-c"> <xsl:value-of select="diaDiemHD/tenPhuong"/></td>
								<td class="align-c"> <xsl:value-of select="diaDiemHD/tenQuan"/></td>
								<td class="align-c"> <xsl:value-of select="diaDiemHD/tenTinh"/></td>
								<td class="align-c"> <xsl:value-of select="ihtkk:stringDatetime(thoiGianHD/Tu,'dd/mm/yyyy')"/>  - <xsl:value-of select="ihtkk:stringDatetime(thoiGianHD/Den,'dd/mm/yyyy')"/></td>
								</tr>
								</xsl:for-each>
