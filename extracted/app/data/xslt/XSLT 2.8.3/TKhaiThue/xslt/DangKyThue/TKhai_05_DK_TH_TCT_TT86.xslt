 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'Kèm theo Thông tư số 86/2024/TT-BTC ngày 23/12/2024 của Bộ Trưởng Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader_05DK_TH">
            ...
            <div class="content">
				...
				<table class="tkhai_table">
					<tr>
						...
						<td class="align-c" rowspan="2"><b>Mã số thuế-nếu có (ghi trong trường hợp thay đổi thông tin)</b></td>
						...
						<td class="align-c" colspan="4"><b>Số định danh cá nhân/Hộ chiếu</b></td>
                    ...
                    <xsl:for-each select="$tkchinh/DSachCNDangkyMST">
						...
						<tr>
							 ...
							 <td class="align-l">
							 <xsl:if test="ct12_ma!= '2080'">
								<xsl:value-of select="ct13" />
							</xsl:if>
							 ...
							 <td class="align-c">
							 <xsl:if test="ct12_ma!= '2080'">
								<xsl:value-of select="ihtkk:stringDatetime(ct14,'dd/mm/yyyy')"/>
							</xsl:if>
							 </td>
							 <td class="align-l">
							 <xsl:if test="ct12_ma!= '2080'">
								<xsl:value-of select="ct15_ten"/>
							</xsl:if>
							 </td>
...
<tr>
<td>	   
	 <xsl:call-template name="tkhaiFooter_05DK_TH"/>
	<br/>
<div id="sigDiv"></div>
</td>
</tr>
