 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Thông tư số 80/2021/TT-BTC ngày 29 tháng 9 năm 2021 của Bộ trưởng Bộ Tài chính'" />
		 ...
		 <xsl:call-template name="tkhaiHeader_01_PBVMT_TT80_283">
		<xsl:with-param name="mauTKhai"   select="'01/PBVMT'"/>
					...
					<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
                      <table class="tkhai_table">
                        <tr>
							...
							<td class="align-c" rowspan="2"><b>Số phí phải nộp trong kỳ</b></td>
						</tr>
						 <tr>
						    ...
						    <td></td>
	          				...
	          				<xsl:for-each select="$tkchinh/PhiBVMT/KSDoCSoTuKhaiThac/TTinKhoangSan/KhoangSan">
								...
								<tr>
								 ...
								 <td class="align-r"><xsl:value-of select="ihtkk:formatNumber(soPhiPhaiNopTrongKy)"/></td>	
								</tr>
							</xsl:for-each>	       				 
						...
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/PhiBVMT/tongPhiPNop)"/></b></td>
						</tr>
					</table>
				</div>
