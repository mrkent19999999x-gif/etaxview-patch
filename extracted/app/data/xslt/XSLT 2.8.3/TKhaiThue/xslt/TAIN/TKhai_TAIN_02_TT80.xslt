...
xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt">
	...
	<xsl:template match="/">
		...
		<xsl:call-template name="tkhaiHeader_02_TAIN_283">
				...
				<div class="donvitien"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table"  >
						<tr>
							...
							<td class="align-c" rowspan="2"><b>Thuế tài nguyên phải nộp theo quyết toán năm</b></td>                            
							<td class="align-c" rowspan="2"><b>Thuế tài nguyên đã kê khai trong năm </b></td>		   						   						   
							<td class="align-c" rowspan="2"><b>Chênh lệch giữa số quyết toán với đã kê khai</b></td>						   						   						   						   						   
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/BangChiTietTNguyen/tongThueDaKhai)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/BangChiTietTNguyen/tongChenhLech)"/></b></td>
  						</tr>
					</table>
				</div>		
			</div>
		...
		<div><i>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Đối với tài nguyên khai thác được ấn định số thuế tài nguyên phải nộp trên 1 đơn vị sản lượng tài nguyên thì thuế tài nguyên phải nộp theo quyết toán năm tại chỉ tiêu (8)= (4) x (7).</i></div>
		...
		<div><i>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Chỉ tiêu tại cột (9) “Thuế tài nguyên đã kê khai trong năm”: tổng hợp từ số liệu tại cột (8) của các tờ khai tài nguyên mẫu số 01/TAIN của các tháng trong năm tính thuế đã nộp cho cơ quan thuế.</i></div>
