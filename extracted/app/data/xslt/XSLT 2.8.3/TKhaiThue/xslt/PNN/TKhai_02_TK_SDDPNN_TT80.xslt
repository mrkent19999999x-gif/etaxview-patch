 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Thông tư số 80/2021/TT-BTC ngày 29 tháng 9 năm 2021 của Bộ trưởng Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader_02TK_SDDPNN_TT80_283">
			...
			<div><b>[10]</b> Thông tin người sử dụng đất:</div>
				...
				<table class="ttinnnt_table">
				    ...
				    <tr>
					     ...
					     <td><b>[11.4]</b>  Xã/phường/đặc khu: <xsl:value-of select="$tkchinh/ThuaDatChiuThue/DiaChiThuaDat/ct11_4_ten"/> </td>
				    </tr>
<tr>
