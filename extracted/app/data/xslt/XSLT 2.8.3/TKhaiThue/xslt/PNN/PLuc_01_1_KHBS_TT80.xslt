				...
				<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table">
                        <tr>
							...
							<td class="align-c"><b>Kỳ thuế</b></td>
						...
						<xsl:for-each select="$KHBS01_1/Muc_A/DSachHSo/BKeHSo">
							...
							<xsl:for-each select="CTietHSo/ChiTiet">
									<tr>
										<td class="align-l"></td>
										<td class="align-l"><xsl:value-of select="ct2_ten"/>
										<xsl:if test="ct2_ten != ''" >
										...
										<td class="align-c"><xsl:value-of select="ct3a"/></td>
