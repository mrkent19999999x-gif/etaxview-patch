 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'TỜ KHAI KHẤU TRỪ THUẾ THU NHẬP CÁ NHÂN'" />
		 <xsl:call-template name="tkhaiHeader_06_TNCN_TT80_283">
		...
		<xsl:with-param name="ghuchuTK"   select="'(Áp dụng đối với tổ chức, cá nhân trả thu nhập khấu trừ thuế đối với thu nhập từ đầu tư vốn, từ chuyển nhượng chứng khoán, từ bản quyền, từ nhượng quyền thương mại, từ trúng thưởng của cá nhân cư trú và cá nhân không cư trú; từ kinh doanh của cá nhân không cư trú; tổ chức, cá nhân nhận chuyển nhượng vốn của cá nhân không cư trú)'"/>
	  </xsl:call-template>
            ...
            <div class="content">  
					...
					<table class="tkhai_table">
						...
						<tr>
							...
							<td>Tổng số cá nhân có thu nhập</td>
							<td class="align-c"><b>[23]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoPhatSinh/ct23)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoLuyke/ct23)"/></td>
						</tr>
						<tr>
							<td class="align-c">2</td>
							<td>Tổng thu nhập tính thuế</td>
							<td class="align-c"><b>[24]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoPhatSinh/ct24)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoLuyke/ct24)"/></td>
						</tr>
						<tr>
							<td class="align-c">3</td>
							<td>Tổng số thuế thu nhập cá nhân (TNCN) đã khấu trừ</td>
							<td class="align-c"><b>[25]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoPhatSinh/ct25)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoLuyke/ct25)"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoPhatSinh/ct26)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoLuyke/ct26)"/></td>
						</tr>
						<tr>
							<td class="align-c">2</td>
							<td>Tổng giá trị chuyển nhượng chứng khoán</td>
							<td class="align-c"><b>[27]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoPhatSinh/ct27)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoLuyke/ct27)"/></td>
						</tr>
						<tr>
							<td class="align-c">3</td>
							<td>Tổng số thuế TNCN đã khấu trừ</td>
							<td class="align-c"><b>[28]</b></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoPhatSinh/ct28)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoLuyke/ct28)"/></td>
						</tr>
						<tr>
...
<tr>
<td>	  	   
	 <xsl:call-template name="tkhaiFooter_06_TNCN_TT80"/>
<div id="sigDiv"></div>
</td>
</tr>
</table>	 
