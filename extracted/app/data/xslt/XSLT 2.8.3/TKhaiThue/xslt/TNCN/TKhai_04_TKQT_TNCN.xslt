...
xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt">
 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:call-template name="tkhaiHeader_04_TKQT_TNCN_283">
		...
		<div class="ndungtkhai_div">
			<div class="content">
					...
					<tr>
						<td>
							<b>[17]</b> Làm tại <xsl:value-of select="$tkchinh/VanBanGiaoNhan/ct17_diaDiem"/>
								ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/VanBanGiaoNhan/ct17_ngay_lam,'dd/mm/yyyy')"/>
								đã được Cơ quan công chứng chứng nhận ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/VanBanGiaoNhan/ct17_ngay_chungNhan,'dd/mm/yyyy')"/>
						</td>
					</tr>
				</table>
				<table>
					...
					<tr>
						<td>
							<b>[22a]</b> Xã/phường/đặc khu: <xsl:value-of select="$tkchinh/ThongTinCaNhan/ct22_tenPhuongXa"/>
						</td>
						<td colspan="2">
				...
				<table>
					...
					<tr>
						...
						<td colspan="2">
							...
							<xsl:if test="$tkchinh/LoaiTaiSan/ct26_chungKhoan= '1'">[X]</xsl:if>
							<xsl:if test="$tkchinh/LoaiTaiSan/ct26_chungKhoan= '0'">[&#32;]</xsl:if>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td  colspan="2" class="align-l">
							...
							<xsl:if test="$tkchinh/LoaiTaiSan/ct27_vonGop= '1'">[X]</xsl:if>
						    <xsl:if test="$tkchinh/LoaiTaiSan/ct27_vonGop= '0'">[&#32;]</xsl:if>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td colspan="2" class="align-l">
							...
							<xsl:if test="$tkchinh/LoaiTaiSan/ct28_taiSan= '1'">[X]</xsl:if>
							<xsl:if test="$tkchinh/LoaiTaiSan/ct28_taiSan= '0'">[&#32;]</xsl:if>
						</td>
					</tr>
				</table>
				<table>
				...
				<table>
					...
					<tr>
						<td>
							<b>[33]</b> Xã/phường/đặc khu: <xsl:value-of select="$tkchinh/ToChucPhatHanh/ct33_tenXa"/>
						</td>
						<td colspan="2">
