 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<!--start phu luc PL_01_ND20-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL_02_ND20">	
		<xsl:variable name="pl02_nd20" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_02_ND20' />
		...
		<div>Công ty báo cáo các thông tin, tài liệu đã chuẩn bị và lưu trữ theo quy định tại Mẫu số 02, như sau:</div>
		    <table class="tkhai_table">
						...
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_1.1/daLapVaLuu = 'true' or $pl02_nd20/Dong_1.1/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_1.1/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_1.2/daLapVaLuu = 'true' or $pl02_nd20/Dong_1.2/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_1.2/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_1.3/daLapVaLuu = 'true' or $pl02_nd20/Dong_1.3/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_1.3/ghiChu"/></td>
						</tr>
						<tr>
						...
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.1/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.1/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.1/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.2/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.2/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.2/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.3/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.3/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.3/ghiChu"/></td>
						</tr>
						<tr>
							 <td class="align-c">2.4</td>
							 <td>Bản sao các thỏa thuận, hợp đồng giao dịch liên kết</td>
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.4/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.4/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.4/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.5/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.5/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.5/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.6/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.6/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.6/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.7/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.7/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.7/ghiChu"/></td>
						</tr>
						<tr>
							 <td class="align-c">2.8</td>
							 <td>Tóm tắt các giả định trọng yếu khi áp dụng phương pháp xác định giá đề xuất</td>
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.8/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.8/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.8/ghiChu"/></td>
						</tr>
						<tr>
							 <td class="align-c">2.9</td>
							 <td>Giải trình các lý do thực hiện phân tích dữ liệu nhiều năm (nếu có)</td>
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.9/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.9/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.9/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.10/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.10/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.10/ghiChu"/></td>
						</tr>
						<tr>
							 <td class="align-c">2.11</td>
							 <td>Mô tả các khoản điều chỉnh so sánh đã thực hiện, lý do, tài liệu về kết quả điều chỉnh</td>
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.11/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.11/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.11/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.12/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.12/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.12/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.13/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.13/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.13/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_2.14/daLapVaLuu = 'true' or $pl02_nd20/Dong_2.14/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_2.14/ghiChu"/></td>
						</tr>
						<tr>
						...
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_3.1/daLapVaLuu = 'true' or $pl02_nd20/Dong_3.1/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_3.1/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_3.2/daLapVaLuu = 'true' or $pl02_nd20/Dong_3.2/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_3.2/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_3.3/daLapVaLuu = 'true' or $pl02_nd20/Dong_3.3/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_3.3/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl02_nd20/Dong_3.4/daLapVaLuu = 'true' or $pl02_nd20/Dong_3.4/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl02_nd20/Dong_3.4/ghiChu"/></td>
						</tr>
