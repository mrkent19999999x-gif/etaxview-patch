...
<!-- LƯU CHUYỂN TIỀN TỆ TRỰC TIẾP  -->
    ...
    <table class="tkhai_table">
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNay/lcThuan_KD_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNgoai/lcThuan_KD_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
            <b>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNay/ctI_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNgoai/ctI_nNgoai"/></b></td></b>
        </tr>
         <tr>
            <b>
            <td class="align-c"><b></b></td>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNay/ctII_nNay_PLLCTT"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNgoai/ctII_nNgoai_PLLCTT"/></b></td></b>
        </tr>
        <tr>
            <b>
            <td class="align-c"><b></b></td>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNay/ctIII_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNgoai/ctIII_nNgoai"/></b></td></b>
        </tr>
        <tr>
            <b>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNay/ctIV_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNgoai/ctIV_nNgoai"/></b></td></b>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNay/ctVII_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc02/SoNamNgoai/ctVII_nNgoai"/></b></td></b>
        </tr>
</table>
 </div>	
 </div>
