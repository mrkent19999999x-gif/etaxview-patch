...
<!-- LƯU CHUYỂN TIỀN TỆ GIÁN TIẾP  -->
    ...
    <table class="tkhai_table">
        ...
        <tr>
            <b>
            <td class="align-c"><b></b></td>
            <td colspan="5"><b>Điều chỉnh cho các khoản:</b></td>
            </b>
        </tr>
        <tr>
        ...
        <tr>
            <b>
            <td class="align-c"><b></b></td>
            <td><b>Lưu chuyển tiền thuần từ hoạt động kinh doanh trước thuế thu nhập</b></td>
            <td class="align-c"><b></b></td>
            <td class="align-l"><b><xsl:value-of select="$pluc03/ThuyetMinh/lcThuan_KD_tMinh"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNay/lcThuan_KD_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNgoai/lcThuan_KD_nNgoai"/></b></td></b>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNay/ctI_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNgoai/ctI_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
            <b>
        ...
        <tr>
            ...
            <td><b>Lưu chuyển từ hoạt động đầu tư</b></td>
            <td class="align-c"><b></b></td>
            <td class="align-l"><b><xsl:value-of select="$pluc03/ThuyetMinh/ctII_tMinh"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNay/ctII_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNgoai/ctII_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
            <b>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNay/ctIII_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNgoai/ctIII_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
            <b>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNay/ctIV_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNgoai/ctIV_nNgoai"/></b></td>
            </b>
        </tr>   
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc03/SoNamNgoai/ctV_nNgoai"/></td>
        </tr> 
        <tr>
            ...
            <td class="number align-r"><xsl:value-of select="$pluc03/SoNamNgoai/ctVI_nNgoai"/></td>
        </tr>   
        <tr>
            <b>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNay/ctVII_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc03/SoNamNgoai/ctVII_nNgoai"/></b></td>
            </b>
        </tr>  
  </table>
 </div>	
