...
<!-- KẾT QUẢ HOẠT ĐỘNG SẢN XUẤT KINH DOANH  -->
    ...
    <table class="tkhai_table">
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNay/ct10_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNgoai/ct10_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNay/ct20_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNgoai/ct20_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNay/ct30_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNgoai/ct30_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
            <td class="align-c">11</td>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNay/ct40_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNgoai/ct40_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
            <b>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNay/ct50_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNgoai/ct50_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNay/ct60_nNay"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="$pluc01/SoNamNgoai/ct60_nNgoai"/></b></td>
            </b>
        </tr>
 </table>
 </div>	
