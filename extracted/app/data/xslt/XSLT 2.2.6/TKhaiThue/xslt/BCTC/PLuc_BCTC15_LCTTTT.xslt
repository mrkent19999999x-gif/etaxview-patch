...
<!-- LƯU CHUYỂN TIỀN TỆ TRỰC TIẾP  -->
    ...
    <table class="tkhai_table">
        ...
        <tr>
            ...
            <td><b>Lưu chuyển tiền thuần từ hoạt động kinh doanh (20=01+02+...+06+07)</b> </td>
            <td class="align-c"><b>20</b></td>
            <td class="align-l"><b><xsl:value-of select="$pluc02/ThuyetMinh/ct20_tMinh"/></b></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct23_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct24_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct25_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct26_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct27_tMinh"/></td>
        ...
        <tr>
            <b>
            <td class="align-c"><b></b></td>
            <td><b>Lưu chuyển tiền thuần từ hoạt động đầu tư (30=21+22+...+26+27) </b></td>
            <td class="align-c"><b>30</b></td>
            <td class="align-l"><b><xsl:value-of select="$pluc02/ThuyetMinh/ct30_tMinh"/></b></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct31_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct32_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct33_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct34_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct35_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct36_tMinh"/></td>
        ...
        <tr>
            <b>
            <td class="align-c"><b></b></td>
            <td><b>Lưu chuyển thuần từ hoạt động tài chính (40=31+32+33+34+35+36) </b></td>
            <td class="align-c"><b>40</b></td>
            <td class="align-l"><b><xsl:value-of select="$pluc02/ThuyetMinh/ct40_tMinh"/></b></td>
        ...
        <tr>
            ...
            <td class="align-l"><b><xsl:value-of select="$pluc02/ThuyetMinh/ct50_tMinh"/></b></td>
        ...
        <tr>
            ...
            <td class="align-l"><b><xsl:value-of select="$pluc02/ThuyetMinh/ct60_tMinh"/></b></td>
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc02/SoNamNay/ct60_nNay"/></b></td>
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc02/SoNamNgoai/ct60_nNgoai"/></b></td>
        </tr>
        <tr>
            <td class="align-c"></td>
            <td>Ảnh hưởng của thay đổi tỷ giá hối đoái quy đổi ngoại tệ</td>
            <td class="align-c">61</td>
            <td class="align-l"><xsl:value-of select="$pluc02/ThuyetMinh/ct61_tMinh"/></td>
        ...
        <tr>
            ...
            <td class="align-l"><b><xsl:value-of select="$pluc02/ThuyetMinh/ct70_tMinh"/></b></td>
...
<br/><br/><br/>
<div class="ghichu"><b><i>Ghi chú (*): </i></b>Những chỉ tiêu không có số liệu có thể không phải trình bày nhưng không được đánh lại số thứ tự chỉ tiêu và “Mã số”.</div>
<div id="sigDiv"></div>
</td>
</tr>
</table>
