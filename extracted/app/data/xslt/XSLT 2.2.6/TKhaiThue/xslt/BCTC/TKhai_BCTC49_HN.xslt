 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'Ban hành theo Thông tư số 49/2014/TT-NHNN ngày 31/12/2014'" />
		 <xsl:call-template name="tkhaiHeader-BCTC49_HN">
...
<!-- Tai san -->
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctA_XI_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctA_XI_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c">1</td>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/tongTsan_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/tongTsan_nNgoai)"/></b></td>
        </tr>
...
<!--Nợ phải trả và vốn chủ sở hữu-->
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctB_I_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctB_I_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c"><b>II</b></td>
            <td><b>Tiền gửi và vay các TCTD khác</b></td>
            <td class="align-l"><b><xsl:value-of select="$tkchinh/ThuyetMinh/ctB_II_tMinh"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctB_II_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctB_II_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c">1</td>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctB_III_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctB_III_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c"><b>IV</b></td>
            ...
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctB_IV_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctB_IV_nNgoai)"/></b></td>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctB_V_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctB_V_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c"><b>VI</b></td>
            <td><b>Phát hành giấy tờ có giá</b></td>
            <td class="align-l"><b><xsl:value-of select="$tkchinh/ThuyetMinh/ctB_VI_tMinh"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctB_VI_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctB_VI_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c"><b>VII</b></td>
            <td><b>Các khoản nợ khác</b></td>
            <td class="align-l"><b><xsl:value-of select="$tkchinh/ThuyetMinh/ctB_VII_tMinh"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctB_VII_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctB_VII_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c">1</td>
        ...
        <tr>
            ...
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/tongNoPTRa_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/tongNoPTRa_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c"><b>VIII</b></td>
            <td><b>Vốn chủ sở hữu</b></td>
            <td class="align-l"><b><xsl:value-of select="$tkchinh/ThuyetMinh/ctB_VIII_tMinh"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNay/ctB_VIII_nNay)"/></b></td>
            <td class="number align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoNamNgoai/ctB_VIII_nNgoai)"/></b></td>
        </tr>
        <tr>
            <td class="align-c">1</td>
            <td>Vốn của TCTD</td>
        ...
        <tr>
            ...
            <td class="number align-r"><b class="number"><xsl:value-of select="$tkchinh/SoNamNay/tongNoVon_nNay"/></b></td>
            <td class="number align-r"><b class="number"><xsl:value-of select="$tkchinh/SoNamNgoai/tongNoVon_nNgoai"/></b></td>
        </tr>
