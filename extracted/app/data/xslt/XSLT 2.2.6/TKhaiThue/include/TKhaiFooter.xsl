...
xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" exclude-result-prefixes="xsl xsi ihtkk">
 <xsl:include href="../common/common.xsl"/> 
   ...
   <xsl:template name="tkhaiFooter_DK_TVAN">
	...
	<!-- Footer Bao cao tai chinh TT200 giữa niên độ đầy đủ-->
	<xsl:template name="tkhaiFooter-BCTC200-GND">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
									...
									<br/><br/><br/><xsl:value-of select="$tkchinh/nguoiLapBieu"/>
									<br/>
			</td>       
			<td class="align-c" width = "33%">								
                                    <b>Kế toán trưởng </b><br/>(Ký, họ tên) 
									
									<br/><br/><br/><xsl:value-of select="$tkchinh/keToanTruong"/>
									<br/>
			</td>       
            <td class="align-c" width = "33%">								
                                    <i>Lập, ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayLap,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayLap,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayLap,'yyyy')"/></i><br/>
									...
									<br/><br/><br/><xsl:value-of select="$tkchinh/giamDoc"/>
									<br/>
			</td>
	    </table>		
	...
	<!-- Footer Bao cao tai chinh TT49 -->
	<xsl:template name="tkhaiFooter-BCTC49">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
                                    <b>Lập bảng</b><br/>(Ký, họ tên) 
	...
	<!-- Footer Bao cao tai chinh giữa niên độ-->
	<xsl:template name="tkhaiFooter-BCTC_GND">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
