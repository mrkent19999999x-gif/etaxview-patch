...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/1999/XSL/Transform" xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" exclude-result-prefixes="xsl xsi ihtkk">
	...
	<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 49 năm-->
		...
		<tr>
			...
			<xsl:template name="BieuNguDatNuoc_BCTC49_GND_DD">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b>BẢNG CÂN ĐỐI KẾ TOÁN (HỢP NHẤT) GIỮA NIÊN ĐỘ <br/> Dạng đầy đủ
</b></td>
		</tr>
		<tr>
					<td class="align-c">
...
-->
				<tr>
					<td>
                     ...
                     <tr>
				<td colspan="3"><b>BCTC đã được kiểm toán:</b> [<xsl:if test="$tkchinh/bctcDaKiemToan = 'true' or $tkchinh/hoatDongLienTuc = '1'" >x</xsl:if>] </td>
	...
	<xsl:template name="tkhaiHeader-BCTC49_HN">
		...
		<div class="header_div">
			<table>
				...
				<tr>
				<td><div class="align-c">BCTC đã được kiểm toán: [<xsl:if test="$tkchinh/bctcDaKiemToan = 'true' or $tkchinh/hoatDongLienTuc = '1'" >x</xsl:if>]    </div></td>
		...
		<xsl:template name="tkhaiHeader-BCTC49_GND_DD">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC49_GND_DD">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
...
<tr>
					...
					<div class="align-c">BCTC đã được kiểm toán: [<xsl:if test="$tkchinh/bctcDaKiemToan = 'true' or $tkchinh/hoatDongLienTuc = '1'" >x</xsl:if>]    </div>
