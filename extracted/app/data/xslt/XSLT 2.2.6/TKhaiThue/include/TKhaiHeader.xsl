...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/1999/XSL/Transform" xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" exclude-result-prefixes="xsl xsi ihtkk">
	...
	<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư  năm-->
		<xsl:template name="BieuNguDatNuoc_BCTC49_Nam">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			...
			<td/>
				...
				<xsl:template name="BieuNguDatNuoc_DD">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b>BẢNG CÂN ĐỐI KẾ TOÁN GIỮA NIÊN ĐỘ <br/> Dạng đầy đủ
</b></td>
		</tr>
		<tr>
					<td class="align-c">
		...
		<tr>
			...
			<td/>
					...
					<xsl:template name="BieuNguDatNuoc_DD_HN">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b>BẢNG CÂN ĐỐI KẾ TOÁN GIỮA NIÊN ĐỘ HỢP NHẤT <br/> Dạng đầy đủ
</b></td>
		</tr>
		<tr>
					<td class="align-c">
		...
		<tr>
			...
			<td/>
					...
					<xsl:template name="BieuNguDatNuoc_TL_HN">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b>BẢNG CÂN ĐỐI KẾ TOÁN GIỮA NIÊN ĐỘ HỢP NHẤT<br/> Dạng tóm lược
</b></td>
		</tr>
		<tr>
					<td class="align-c">
	...
	<xsl:template name="BieuNguDatNuoc_TL">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b>BẢNG CÂN ĐỐI KẾ TOÁN GIỮA NIÊN ĐỘ<br/> Dạng tóm lược
</b></td>
		</tr>
		<tr>
					<td class="align-c">
	...
	<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 49 hợp nhất-->
		<xsl:template name="BieuNguDatNuoc_BCTC49_HN">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
...
<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 200 hợp nhất-->
	...
	<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 200 giữa niên độ đầy đủ-->
		<xsl:template name="BieuNguDatNuoc_BCTC200_GND_day_du">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b> BẢNG CÂN ĐỐI KẾ TOÁN GIỮA NIÊN ĐỘ (Dạng đầy đủ)</b></td>
		</tr>
		<!--
		<tr>
			<td class="align-c"><i>Cho năm tài chính kết thúc ngày <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'dd')"/>  tháng <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'yyyy')"/></i></td>
...
<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 200 giữa niên độ đầy đủ hợp nhất-->
		<xsl:template name="BieuNguDatNuoc_BCTC200_GND_day_du_HN">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b> BẢNG CÂN ĐỐI KẾ TOÁN GIỮA NIÊN ĐỘ HỢP NHẤT (Dạng đầy đủ)</b></td>
		</tr>
		<!--
		<tr>
			<td class="align-c"><i>Cho năm tài chính kết thúc ngày <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'dd')"/>  tháng <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'yyyy')"/></i></td>
...
<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 200 giữa niên độ tóm lược-->
		<xsl:template name="BieuNguDatNuoc_BCTC200_GND_Tom_luoc">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b> BẢNG CÂN ĐỐI KẾ TOÁN GIỮA NIÊN ĐỘ (Dạng tóm lược)</b></td>
		</tr>
		<!--
		<tr>
			<td class="align-c"><i>Cho năm tài chính kết thúc ngày <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'dd')"/>  tháng <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'yyyy')"/></i></td>
...
<!-- Start Header BCTC_TT49 Năm-->
	<xsl:template name="tkhaiHeader-BCTC49_Nam">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC49_Nam">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
...
<!-- Start Header BCTC_TT49 Hợp nhất-->
	<xsl:template name="tkhaiHeader-BCTC49_HN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC49_HN">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
...
<tr>
	...
	<!-- Start tkhai header BCTC_TT200_ giữa niên độ dạng đầy đủ-->
	<xsl:template name="tkhaiHeader_BCTC200_GND_day_du">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC200_GND_day_du">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
	...
	<!-- Start tkhai header BCTC_TT200_ giữa niên độ dạng đầy đủ hợp nhất-->
	<xsl:template name="tkhaiHeader_BCTC200_GND_day_du_HN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC200_GND_day_du_HN">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
		...
		<!-- Start tkhai header BCTC_TT200_ giữa niên độ dạng tóm lược-->
	<xsl:template name="tkhaiHeader-BCTC200_GND_Tom_luoc">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC200_GND_Tom_luoc">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
	...
	<xsl:template name="tkhaiHeader-plucBCTC200">
		...
		<!-- start header giữa niên độ tóm lược hợp nhất -->
			<xsl:template name="tkhaiHeader-BCTC200_TL_HN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_TL_HN">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
			...
			<!-- start header giữa niên độ tóm lược -->
			<xsl:template name="tkhaiHeader-BCTC200_TL">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_TL">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
			...
			<!-- start header BCTC giữa niên độ đầy đủ -->
			<xsl:template name="tkhaiHeader-DD">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_DD">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
				...
				<!-- start header BCTC giữa niên độ đầy đủ hợp nhất-->
			<xsl:template name="tkhaiHeader-DD-HN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_DD_HN">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
			...
			<!-- start header Phuluc BCTC 49 giữa niên độ đầy đủ-->
	<xsl:template name="tkhaiHeader-plucBCTC49-GNDDD">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table>
				<!-- mới -->
				<tr>
					<td class="align-c" colspan="3" style="width:82%">
						<b>PHỤ LỤC</b>
					</td>
					<td style="width:18% vertical-align: top;" rowSpan="5" align="top">
						<div class="bieu_mau_div">
							<div>Mẫu số: <b>
									<xsl:value-of select="$mauTKhai"/>
								</b>
	...
	<!-- start header Phuluc BCTC 49-->
	<xsl:template name="tkhaiHeader-plucBCTC49">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
