...
<!-- start header tờ khai Cổ tức lợi nhuận được chia 01/QT-LNCL-->
  <xsl:template name="tkhaiHeader_QT-LNCL_01">
     ...
     <!-- hết header tờ khai Cổ tức lợi nhuận được chia 01/QT-LNCL-->      
      	<!-- start tkhai header -->
	<xsl:template name="tkhaiHeader_02TK_SDDPNN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				<tr>
					<td colspan="3">	[04] Tên tổ chức: <xsl:value-of select="$ttkthue/NNT/tenNNT"/></td>
				</tr>
				<tr>
					<td colspan="3"> [05] Mã số thuế: <xsl:value-of select="$ttkthue/NNT/mst"/></td>
				</tr>
				<tr>
					<td> [06] Địa chỉ nhận thông báo thuế: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/>	</td>
				</tr>
				<tr>
					<td>[06.1] Tổ/thôn: <xsl:value-of select="$tkchinh/NguoiNopThue/ct06_1"/></td>
					<td colspan="2">[06.2] Phường/xã/thị trấn: <xsl:value-of select="$ttkthue/NNT/phuongXa"/>	</td>
				</tr>
				<tr>
					<td>[06.3]Quận/Huyện: <xsl:value-of select="$ttkthue/NNT/tenHuyenNNT"/>				</td>
					<td colspan="2">[06.4]  Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/>					</td>
				</tr>
				<tr>
					<td>[07]  Điện thoại: <xsl:value-of select="$ttkthue/NNT/dthoaiNNT"/>					</td>
					<td>[08] Số tài khoản-tại ngân hàng (nếu có): <xsl:value-of select="$tkchinh/NguoiNopThue/ct08"/>					</td>
				</tr>
				<tr>
					<td>[09] Tên tổ chức: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>					</td>
				</tr>
				<tr>
				...
				<xsl:if test="not($ttkthue/DLyThue)">
					<tr>
						<td colspan="3">[10] Mã số thuế: 	</td>
					</tr>
					<tr colspan="3">
						<td>[11] Địa chỉ nhận thông báo thuế:                   </td>
					</tr>
					<tr colspan="3">
						<td>[11.1] Phường/xã/thị trấn:                         </td>
					</tr>
					<tr>
						<td>[11.2] Quận/Huyện:                         </td>
						<td colspan="2">[11.3] Tỉnh/Thành phố:                         </td>
					</tr>
					<tr>
						<td>[11.4] Điện thoại:                         </td>
						<td>[11.5] Fax:                         </td>
						<td>[11.6] E-mail:                         </td>
					</tr>
					<tr>
						<td>[11.7]  Hợp đồng đại lý thuế: Số                          </td>
						<td colspan="2"> Ngày: 
                        </td>
					</tr>
				</xsl:if>
				<xsl:if test="$ttkthue/DLyThue">
					...
					<tr colspan="3">
						<td>
							[11] Địa chỉ nhận thông báo thuế: <xsl:value-of select="$ttkthue/DLyThue/dchiDLyThue"/>
						</td>
					</tr>
					<tr colspan="3">
						<td>
							[11.1] Phường/xã/thị trấn: <xsl:value-of select="$tkchinh/DaiLyThue/ct11_1"/>
						</td>
					</tr>
					<tr>
						<td>
							[11.2] Quận/Huyện: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
						</td>
						<td colspan="2">
							[11.3] Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
						</td>
					</tr>
					<tr>
						<td>
							[11.4] Điện thoại: <xsl:value-of select="$ttkthue/DLyThue/dthoaiDLyThue"/>
						</td>
						<td>
							[11.5] Fax: <xsl:value-of select="$ttkthue/DLyThue/faxDLyThue"/>
						</td>
						<td>
							[11.6] E-mail: <xsl:value-of select="$ttkthue/DLyThue/emailDLyThue"/>
						</td>
					</tr>
					<tr>
						<td>
							[11.7]  Hợp đồng đại lý thuế: Số  <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
						</td>
						<td colspan="2"> Ngày: <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd/mm/yyyy')"/>
						</td>
					</tr>
