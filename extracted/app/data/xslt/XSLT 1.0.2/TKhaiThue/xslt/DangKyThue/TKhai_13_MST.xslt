...
<div class="col-md-12">
			...
			<div class="col-md-12" style="text-align: center;">
					<label class="f-bold">VĂN BẢN ĐỀ NGHỊ CẤP LẠI
					<br></br>
					<br/>Giấy chứng nhận đăng ký thuế/Thông báo mã số thuế
					</label>
					<br></br>		
			</div>
			<div>
				<div>
					<label class="align-l">
						<xsl:if test="$tkchinh/gcnMSTTBMST= 'true'"> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;[X] Giấy chứng nhận ĐKT/Thông báo MST/Giấy chứng nhận ĐKT cá nhân
						</xsl:if>
						<xsl:if test="$tkchinh/gcnMSTTBMST= 'false'">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;[&#32;] Giấy chứng nhận ĐKT/Thông báo MST/Giấy chứng nhận ĐKT cá nhân
						</xsl:if>
					</label>
				</div>
				<div>
					<label class="align-l">
						<xsl:if test="$tkchinh/tBaoMSTNPT= 'true'"> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;[X] Thông báo MST NPT
						</xsl:if>
						<xsl:if test="$tkchinh/tBaoMSTNPT= 'false'">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;[&#32;] Thông báo MST NPT
						</xsl:if>
					</label>
				</div>
			</div>
			<div class="col-md-12 no-p col-sm-offset-1" style="margin-top: 30px;  padding: 2px 0px 0px 30px !important">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
		...
		<div class="col-md-12 full-header" style="margin-top: 30px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">1. Tên người nộp thuế, cá nhân (Ghi theo thông tin đăng ký thuế):
							</label>
						</div>
						<div class="col-md-6">
		...
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">Địa chỉ trụ sở chính (Ghi theo thông tin đăng ký thuế):
							</label>
						</div>
						<div class="col-md-6">
		...
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">Địa chỉ kinh doanh (Nếu có):</label>
						</div>
						<div class="col-md-6">
							<xsl:value-of select="$tkchinh/diaChiKD" />
						</div>
					</div>
				</div>
			</div>
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">2. Tên đại lý thuế (Nếu có):
							</label>
						</div>
			...
			<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">Mã số thuế: 
							</label>
						</div>
						<div class="col-md-6" style="word-wrap:break-word; ">
			...
			<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">Hợp đồng đại lý thuế: số
							<xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue" />
							</label>
						</div>
						<div class="col-md-6">
							<label class="col-md-12">ngày
		...
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">3. Lý do đề nghị cấp lại:
							</label>
						</div>
						<div class="col-md-6" style="word-wrap:break-word; ">
							<xsl:value-of select="$tkchinh/lyDoDeNghiCapLai" />
							<br></br>
							<br></br>
						</div>
					</div>
		...
		<xsl:if test="$ttkthue/mst != ''">
				...
				<lable>&#160;Không nhận kết quả tại trụ sở cơ quan thuế</lable>
			</xsl:if>
		</td>
		</tr>
		...
		<tr>
			<td>	  	
				<xsl:call-template name="tkhaiFooter_13MST">   
				</xsl:call-template>
				<div id="sigDiv"></div>
			</td>
			</tr>
