	...
	<div class="col-md-12 parent-div">
		...
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-6">
							<xsl:if test="$tkchinh/DiaChiKD/soNha != ''"><xsl:value-of select="$tkchinh/DiaChiKD/soNha" /><!--, <xsl:value-of select="$tkchinh/DiaChiKD/tenPhuong" />, <xsl:value-of select="$tkchinh/DiaChiKD/tenQuan" />, <xsl:value-of select="$tkchinh/DiaChiKD/tenTinh" />--></xsl:if>
		...
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">5. Lý do đề nghị khôi phục mã số thuế:
							</label>
						</div>
