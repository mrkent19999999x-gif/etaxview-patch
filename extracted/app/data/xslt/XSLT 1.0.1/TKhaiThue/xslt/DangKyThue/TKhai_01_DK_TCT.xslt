								...
								<span class="content-span">&#160;
									<table style="width: 100%">
										<tr>
											...
											<td class="ngay_nhan">	
											<label>
												<xsl:if test="$tkchinh/toChucKT = 'true'">
													X
												</xsl:if>
												<xsl:if test="$tkchinh/toChucKT = 'false'">
													&#160;
												</xsl:if>
											</label>
											</td>
											<td><label class="check-content">Tổ chức kinh tế</label></td>
											<td ><label>&#160;</label></td>
											<td ><label>&#160;</label></td>
											<td class="ngay_nhan">	
											<label>
												<xsl:if test="$tkchinh/toChucKhac = 'true'">
													X
												</xsl:if>
												<xsl:if test="$tkchinh/toChucKhac = 'false'">
													&#160;
												</xsl:if>
											</label>
											</td>
											<td><label class="check-content">Tổ chức khác</label></td>
											<td ><label>&#160;</label></td>
											<td class="ngay_nhan">
											<label>
												<xsl:if test="$tkchinh/toChucDHoanThue = 'true'">
													X
												</xsl:if>
												<xsl:if test="$tkchinh/toChucDHoanThue = 'false'">
													&#160;
												</xsl:if>
												</label>
											</td>
											<td ><label class="check-content">Tổ chức được hoàn thuế</label></td>
											<td ><label>&#160;</label></td>												
											<td class="ngay_nhan">
											<label>
												<xsl:if test="$tkchinh/hopDDauKhi = 'true'">
													X
												</xsl:if>
												<xsl:if test="$tkchinh/hopDDauKhi = 'false'">
													&#160;
												</xsl:if>
											</label>
											</td>
											<td ><label class="check-content">Hợp đồng dầu khí</label></td>
											
										</tr>
										<tr>
											<td colspan="5"><label>&#160;</label></td>
											<td class="ngay_nhan_right">	
											<label>
												<xsl:if test="$tkchinh/toChucNNKDChoBG = 'true'">
													X
												</xsl:if>
												<xsl:if test="$tkchinh/toChucNNKDChoBG = 'false'">
													&#160;
												</xsl:if>
											</label>
											</td>
											<td colspan="5"><label class="check-content">Tổ chức nước ngoài KD tại chợ biên giới, cửa khẩu</label></td>
										...
										<td ><label>&#160;</label></td>	
											...
											<td class="ngay_nhan" style="text-align: center;vertical-align: middle;"><label class="check-content">Tổ chức nước ngoài KD tại chợ biên giới, cửa khẩu</label></td>
										</tr> -->
											<!--<tr>
											<td ><label>&#160;</label></td>
											<td class="ngay_nhan">
											...
											<td ><label class="check-content">Tổ chức nước ngoài KD tại chợ biên giới, cửa khẩu</label></td>
										</tr>	-->	
									</table>
								</span>
							</div>
							<!-- <div style="width: 100%; height: 4; padding: 0px 0px 0px 0px !important;">
								<span class="content-span">
						...
						<tr>
								...
								<div class="parent-50 col-md-6 l-div" id="pr50-1-1">
									...
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
											...
											<span class="content-label-child">
												3e. Fax (nếu có):
												<xsl:value-of select="$tkchinh/CT3/ct3e_fax" />
											</span>
										</label>
									</div>
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
											3g. Email:
											<xsl:value-of select="$tkchinh/CT3/ct3g_e_mail" />
										</label>
									</div>
								</div>
							</td>
							...
							<td style="vertical-align: top;">
								<div class="parent-50 col-md-6 l-div" id="pr50-1-1">
								    <div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="parent-label">
											4. Địa chỉ nhận thông báo thuế <i>(chỉ kê khai nếu
											địa chỉ nhận thông báo thuế khác địa chỉ trụ sở chính)</i>
										</label>
									</div>
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
									...
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
											...
											<span class="content-label-child">
												4e. Fax:
												<xsl:value-of select="$tkchinh/CT4/ct4e_fax" />
											</span>
										</label>
									</div>
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
											4g. Email:
											<xsl:value-of select="$tkchinh/CT4/ct4g_e_mail" />
										</label>
									</div>
			...
			<div class="col-md-12 sparent">
					<table>
						<tr>
							...
							<td style="vertical-align: top;">
								<div class="parent-50 col-md-6 l-div" id="pr50-1-1">
								    <div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 90px 0px !important;">
										<label class="parent-label">
				...
				<span class="content-span list-check">
					<table style="width: 100%; PAGE-BREAK-inside: avoid;">
						...
						<tr>
						 ...
						 <td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
							<label>
							<xsl:if test="$tkchinh/CT10/ct10_ma = '0802' or $tkchinh/CT10/ct10_ma = '0803'">
								X
							</xsl:if>
							<xsl:if test="$tkchinh/CT10/ct10_ma != '0802' or $tkchinh/CT10/ct10_ma != '0803'">
								&#160;
						...
						<tr>
						 <td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
						 	<label>
							<xsl:if test="$tkchinh/CT10/ct10_ma = '24'">
								X
							</xsl:if>
							<xsl:if test="$tkchinh/CT10/ct10_ma != '24'">
								&#160;
						 ...
						 <td class="ngay_nhan" style="text-align: center;vertical-align: middle;">
							<label>
							<xsl:if test="$tkchinh/CT10/ct10_ma = '0801'">
								X
							</xsl:if>
							<xsl:if test="$tkchinh/CT10/ct10_ma != '0801'">
								&#160;
						...
						<tr>
						 ...
						 <td style="width: 40%;"><label class="check-content">Công ty hợp doanh</label></td>
						 <td class="ngay_nhan" style="text-align: center;vertical-align: middle;">
							<label>
					...
					<tr>
						...
						<tr>
						 ...
						 <td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
						 	<label>
							<xsl:if test="$tkchinh/CT10/ct10_ma = '25'">
								X
							</xsl:if>
							<xsl:if test="$tkchinh/CT10/ct10_ma != '25'">
								&#160;
						...
						<tr>
						 <td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
						 	<label>
							<xsl:if test="$tkchinh/CT10/ct10_ma = '10'">
								X
							</xsl:if>
							<xsl:if test="$tkchinh/CT10/ct10_ma != '10'">
								&#160;
										...
										<span class="content-span">&#160;
											<table style="width: 100%">
												...
												<tr>
												 ...
												 <td class="ngay_nhan">	
												 	<label>
													 	<xsl:if test="$tkchinh/CT11/baoCaoTCHopNhat = 'true'">
															X
														</xsl:if>
														<xsl:if test="$tkchinh/CT11/baoCaoTCHopNhat != 'true'">
															&#160;
												 ...
												 <td><label class="check-content">Có báo cáo tài chính hợp nhất</label></td>
												</tr>
						...
						<tr>
							<td rowSpan="2" style="width:49%; vertical-align: top;">
								<div class="parent-50 col-md-6 l-div" id="pr50-1-1">
									...
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 510px 0px !important;">
										<label class="content-label">&#160;
							...
							<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
									<span class="content-span list-check">
										...
										<tr>
											<td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
												<label>
													...
													<xsl:if test="$tkchinh/CT14D/ct14d_ma != '2030'">
														&#160;
													</xsl:if>
												</label>
											</td>
											...
											<td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
												<label>
													<xsl:if test="$tkchinh/CT14/CT14D/ct14d_ma = '1020'">
														X
													</xsl:if>
													<xsl:if test="$tkchinh/CT14/CT14D/ct14d_ma != '1020'">
														&#160;
										...
										<tr>
												<td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
												<label>
													<xsl:if test="$tkchinh/CT14/CT14D/ct14d_ma = '1070'">
														X
													</xsl:if>
													<xsl:if test="$tkchinh/CT14/CT14D/ct14d_ma != '1070'">
														&#160;
											...
											<td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
												<label>
													<xsl:if test="$tkchinh/CT14/CT14D/ct14d_ma = '1040'">
														X
													</xsl:if>
													<xsl:if test="$tkchinh/CT14/CT14D/ct14d_ma != '1040'">
														&#160;
											...
											<!-- <td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
												<label>
													<xsl:if test="$tkchinh/CT14/CT14D/ct14d_ma = '99'">
														X
													</xsl:if>
													<xsl:if test="$tkchinh/CT14/CT14D/ct14d_ma != '99'">
														&#160;
									...
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;&#160;&#160;&#160;&#160;&#160;
											Số nhà, ngách, hẻm, ngõ, đường phố/xóm/ấp/thôn
											<xsl:value-of select="$tkchinh/CT14/CT14D_1/ct14d_soNha" />
										</label>
									</div>
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;&#160;&#160;&#160;&#160;&#160;
											...
											<xsl:value-of select="$tkchinh/CT14/CT14D_1/ct14d_tenPhuong" />
										</label>
									</div>
									...
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;&#160;&#160;&#160;&#160;&#160;
											...
											<xsl:value-of select="$tkchinh/CT14/CT14D_1/ct14d_tenQuan" />
										</label>
									</div>
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;&#160;&#160;&#160;&#160;&#160;
											Tỉnh/Thành phố trực thuộc trung ương:
											<xsl:value-of select="$tkchinh/CT14/CT14D_1/ct14d_tenTinh" />
										</label>
									</div>
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;&#160;&#160;&#160;&#160;&#160;
											Quốc gia:
											<xsl:value-of select="$tkchinh/CT14/CT14D_1/ct14d_tenQuocGia" />
										</label>
									</div>
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">&#160;
									...
									<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">
											...
											<span class="content-label-child">
												/Fax:
												<xsl:value-of select="$tkchinh/CT14/CT14G/ct14g_fax" />
											</span>
										</label>
									</div>
									<div style="width: 100%; height: 4; padding: 5px 0px 0px 0px !important;">
										<label class="content-label">
											...
											<span class="content-label-child">
												Website:
												<xsl:value-of select="$tkchinh/CT14/CT14G/ct14g_website" />
											</span>
										</label>
									</div>
								</div>
				...
				<span class="content-span list-check">
					<table style="width: 100%; PAGE-BREAK-inside: avoid;">
						<tr>
						 ...
						 <td><label class="check-content">Có công ty con, công ty thành viên</label></td>
						  <td class="ngay_nhan" style="text-align: center; vertical-align: middle;">	
						 		<label>
								<xsl:if test="$tkchinh/CT16/ChiTietCT16/ct16_ma = 'BK03'">
									X
								</xsl:if>
								<xsl:if test="$tkchinh/CT16/ChiTietCT16/ct16_ma != 'BK03'">
									&#160;
						 ...
						 <td class="ngay_nhan" style="text-align: center; vertical-align: middle;">	
						 		<label>
								<xsl:if test="$tkchinh/CT16/ChiTietCT16/ct16_ma = 'BK04'">
									X
								</xsl:if>
								<xsl:if test="$tkchinh/CT16/ChiTietCT16/ct16_ma != 'BK04'">
									&#160;
						...
						<td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
						 ...
						 <tr>
						  <td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
							<label>
							<xsl:if test="$tkchinh/CT16/ChiTietCT16/ct16_ma = 'BK05'">
								X
							</xsl:if>
							<xsl:if test="$tkchinh/CT16/ChiTietCT16/ct16_ma != 'BK05'">
								&#160;
				...
				<span class="content-span list-check">
					<table style="width: 100%; PAGE-BREAK-inside: avoid;">
						<tr>
						 <!--<td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
						 	<label>
								<xsl:if test="$tkchinh/CT18/ct18_ma = '01'">
									X
								</xsl:if>
								<xsl:if test="$tkchinh/CT18/ct18_ma != '01'">
									&#160;
						 ...
						 <td><label class="check-content">Sáp nhập</label></td>-->
						  <td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
						 	<label>
						 ...
						 <td><label class="check-content">Tách</label></td>
						  <td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
						 	<label>
						...
						<!-- <td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
						 	<label>
								<xsl:if test="$tkchinh/CT18/ct18_ma = '05'">
									X
								</xsl:if>
								<xsl:if test="$tkchinh/CT18/ct18_ma != '05'">
									&#160;
