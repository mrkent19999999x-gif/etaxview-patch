	...
	<div class="col-md-12 parent-div">
				   ...
				   <tr>
						...
						<td style="width:30% ; vertical-align: top;" rowSpan="5" align="top">
							<div class="dv-mau-so" style="height: 80px;">
								<b>Mẫu số: 23/ĐK-TCT</b><br />
								<i>(Ban hành kèm theo Thông tư số 105/2020/TT-BTC ngày
									03/12/2020
									của Bộ Tài chính)</i>
			...
			<div class="dv-title">
						...
						<table>
							<tr>
							 <td align="center" border="1px">
								 <label class="f-bold">TÊN NGƯỜI NỘP THUẾ</label>
								 <br/>
							...
							<!--<tr>
							 <td align="left" ><label class="lbl-noi-nhan">&#160;&#160;Nơi nhận:................</label></td>
							</tr>-->
							</table>
					</td>
					<td >
				...
				<div class="col-md-12" style="text-align: center;">
					<label class="f-bold">THÔNG BÁO</label> 
					<br />
						<xsl:if test="$tkchinh/nghiepVuTKhai = '02'"><label class="f-bold">Đăng ký tiếp tục hoạt động sau tạm ngừng hoạt động, kinh doanh trước thời hạn </label></xsl:if>
						<xsl:if test="$tkchinh/nghiepVuTKhai = '01'"><label class="f-bold">Đăng ký tạm ngừng hoạt động, kinh doanh  </label></xsl:if>
				</div>
				<!--<div class="col-md-12 no-p col-sm-offset-1" style="margin-top: 30px;  padding: 2px 0px 0px 20px !important">
					<label>Kính gửi: &#160;</label>
					<label><xsl:value-of select="$ttkthue/tenCQTQuanLy" /></label>
				</div>-->
		</div>
		
			<div class="col-md-12 full-header" style="margin-top: 30px; width:100%;">
				<div class="container-fluid">
					<div class="form-ctl-2 dv-lvl15" style="padding: 5px 0px !important">
						<div class="col-md-6">
						...
						<div class="col-md-6">
								...
								<label><xsl:value-of select="$ttkthue/tenNNT" /></label>
					...
					<div class="form-ctl-2 dv-lvl15" style="padding: 5px 0px !important">
						...
						<div class="col-md-6">
								...
								<label><xsl:value-of select="$ttkthue/mst" /></label>
					...
					<div class="form-ctl-2 dv-lvl15" style="padding: 5px 0px !important">
						...
						<div class="col-md-6">
							<label><xsl:value-of select="$tkchinh/diaChiTSChinh" /></label>
						</div>
					</div>
					<div class="form-ctl-2 dv-lvl15" style="padding: 5px 0px !important">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<xsl:if test="$tkchinh/DiaChiKD/soNha != ''"><label><xsl:value-of select="$tkchinh/DiaChiKD/soNha" /><!--, <xsl:value-of select="$tkchinh/DiaChiKD/tenPhuong" />, <xsl:value-of select="$tkchinh/DiaChiKD/tenQuan" />, <xsl:value-of select="$tkchinh/DiaChiKD/tenTinh" />--></label></xsl:if>
							<xsl:if test="$tkchinh/DiaChiKD/soNha = ''"></xsl:if>
						</div>
					</div>
				<xsl:if test="$tkchinh/nghiepVuTKhai = '01'">
				<div class="form-ctl-2 dv-lvl15" style="padding: 5px 0px !important">
					<div class="col-md-6">
						<label class="col-md-12">5. Trường hợp tạm ngừng kinh doanh:</label>
					</div>
				</div>
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-6">
						<label class="col-md-12">a) Thời gian tạm ngừng:</label>
					</div>
					<div class="col-md-6">
						<label><xsl:value-of select="$tkchinh/thoiGianTN" /></label>
						
					</div>
				</div>
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-6">
						<label class="col-md-12">b) Thời điểm bắt đầu tạm ngừng: Ngày</label>
					</div>
					<div class="col-md-6">
						<xsl:if test="$tkchinh/tamNTuNgay = ''">
								</xsl:if>
								<xsl:if test="$tkchinh/tamNTuNgay != ''">
									<xsl:value-of select="ihtkk:stringDatetime($tkchinh/tamNTuNgay,'dd/mm/yyyy')"/>
						</xsl:if>	
				...
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-6">
						<label class="col-md-12">c) Thời điểm kết thúc tạm ngừng: Ngày</label>
					</div>
					<div class="col-md-6">
						<xsl:if test="$tkchinh/tamNKetThuc = ''">
						</xsl:if>
						<xsl:if test="$tkchinh/tamNKetThuc != ''">
							<xsl:value-of select="ihtkk:stringDatetime($tkchinh/tamNKetThuc,'dd/mm/yyyy')"/>
						</xsl:if>	
				...
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-6">
						<label class="col-md-12">d) Lý do tạm ngừng kinh doanh</label>
					</div>
					<div class="col-md-6" style="word-wrap:break-word; ">
						<label><xsl:value-of select="$tkchinh/lyDoTN" /></label>
						
					</div>
				</div>
				</xsl:if>
				<xsl:if test="$tkchinh/nghiepVuTKhai = '02'">
				<div class="form-ctl-2 dv-lvl15" style="padding: 5px 0px !important">
					<div class="col-md-8">
						<label class="col-md-12">5. Trường hợp tiếp tục hoạt động sau tạm ngừng hoạt động, kinh doanh trước thời hạn:</label>
					</div>
					<div class="col-md-4">
					</div>
				</div>
				<div class="col-md-12" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-8">
						<label class="col-md-12">a) Thời điểm tiếp tục hoạt động sau tạm ngừng hoạt động, kinh doanh trước thời hạn: Ngày </label>
					</div>
					<div class="col-md-4">
						<label><xsl:if test="$tkchinh/kdTruocThoiHan = ''">
								</xsl:if>
								<xsl:if test="$tkchinh/kdTruocThoiHan != ''">
									<xsl:value-of select="ihtkk:stringDatetime($tkchinh/kdTruocThoiHan,'dd/mm/yyyy')"/>
						</xsl:if>
						</label>	
						
					</div>
				</div>
				<div class="col-md-16" style="padding: 5px 0px 0px 10px !important">
					<div class="col-md-8">
						<label class="col-md-12">b) Lý do tiếp tục hoạt động sau tạm ngừng hoạt động, kinh doanh trước thời hạn:</label>
					</div>
					<div class="col-md-4" style="word-wrap:break-word; ">
						<label><xsl:value-of select="$tkchinh/lyDoKDTruocTH" /></label>
					</div>
				</div>
				</xsl:if>
				</div>
...
<tr>			
            ...
            <br/>
			<br/>
			<td><span><i><b>Ghi chú:</b></i><i> Người nộp thuế là tổ chức không phải đóng dấu khi đăng ký thuế và hộ kinh doanh, cá nhân kinh doanh, cá nhân khác không cần đóng dấu.</i></span></td>
		</tr>
</xsl:template>		
</xsl:stylesheet>
