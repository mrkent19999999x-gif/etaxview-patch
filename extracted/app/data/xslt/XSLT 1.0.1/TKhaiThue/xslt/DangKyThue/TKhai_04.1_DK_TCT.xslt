	...
	<div class="dv-title">
										...
										<span class="content-span list-check">
											<table style="width: 100%; PAGE-BREAK-inside: avoid;">
												<tr>
												 ...
												 <td ><label class="check-content">Hợp tác kinh doanh</label></td>
												 <td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
													<label>
													 	<xsl:if test="$tkchinh/khac = 'true'">
															X
														</xsl:if>
														<xsl:if test="$tkchinh/khac = 'false'">
															&#160;
														</xsl:if>
													</label>
												 </td>
		...
		<div class="col-md-12 sparent">
			...
			<xsl:if test="$ttkthue/mst != ''">
				...
				&#160;Không nhận kết quả tại trụ sở cơ quan thuế
			</xsl:if>
		</td></tr>
		<tr>
			<td>	  	
