   ...
   <div class="ndungtkhai_div">
	...
	<div class="col-md-12 parent-div">
				   ...
				   <tr>
					<td width="25%">
						<table>
							...
							<tr>
							<td>&#160;&#160;&#160;&#160;&#160;&#160;V/v Đề nghị cấp giấy chứng nhận đăng ký thuế dành cho cá nhân</td>
							</tr>
							</table>
					</td>
					<td >
			...
			<!--<div class="col-md-12" style="text-align: center;">
					<label class="f-bold">Văn bản đề nghị cấp Giấy chứng nhận đăng ký thuế dành cho cá nhân
					</label>
					<br></br>
			</div>-->
		...
		<div class="col-md-12 full-header" style="margin-top: 30px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">1. Tên người nộp thuế <i>(ghi theo đăng ký thuế):</i>
							</label>
						</div>
						<div class="col-md-6">
		...
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">3. Địa chỉ nơi thường trú <i>(ghi theo đăng ký thuế):</i>
							</label>
						</div>
						<div class="col-md-6">
							<xsl:value-of select="$tkchinh/diaChiThuongTru" />
						</div>
					</div>
				</div>
			</div>
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">4. Địa chỉ hiện tại <i>(nếu có):</i></label>
						</div>
						<div class="col-md-6">
							<xsl:if test="$tkchinh/DiaChiHienTai/soNha != ''"><xsl:value-of select="$tkchinh/DiaChiHienTai/soNha" />, <xsl:value-of select="$tkchinh/DiaChiHienTai/tenPhuong" />, <xsl:value-of select="$tkchinh/DiaChiHienTai/tenQuan" />, <xsl:value-of select="$tkchinh/DiaChiHienTai/tenTinh" /></xsl:if>
							<xsl:if test="$tkchinh/DiaChiHienTai/soNha = ''"></xsl:if>
						</div>
					</div>
				</div>
			</div>
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">5. Thông tin đại lý thuế (nếu có): 
							</label>
						</div>
					</div>
				</div>
		...
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
			...
			<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">b) Mã số thuế: 
							</label>
						</div>
						<div class="col-md-6" style="word-wrap:break-word; ">
			...
			<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">c) Số hợp đồng đại lý thuế:  
							<xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue" />
							</label>
						</div>
						<div class="col-md-6">
							<label class="col-md-12">ngày ký hợp đồng: 
		...
		<div class="col-md-12 full-header" style="margin-top: 15px; width:100%;">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							<label class="col-md-12">6. Lý do đề nghị cấp giấy chứng nhận mã số thuế cá nhân: 
							</label>
						</div>
						<div class="col-md-6" style="word-wrap:break-word; ">
							<xsl:value-of select="$tkchinh/lyDoDNCapLaiGCN" />
						</div>
					</div>
				</div>
			</div>
		...
		<tr>
			<td>	  	
				<xsl:call-template name="tkhaiFooter_pluc_32">   
				</xsl:call-template>
				<div id="sigDiv"></div>
			</td>
		</tr>
