...
<xsl:template match="/">
		...
		<xsl:variable name="PL" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_03_01_DK_TCT'/>
		<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Thông tư số 105/2020/TT-BTC ngày 03/12/2020 của Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader_01_DK_TCT_BK03">
		<xsl:with-param name="mauTKhai"   select="'01-ĐK-TCT-BK03'"/>
 	...
 	<div class="ndungtkhai_div">
		...
		<table  class="tkhai_table">
							  <tr>
								...
								<td class="align-c" rowspan="1"><b>Tên địa điểm kinh doanh, kho hàng</b></td>
