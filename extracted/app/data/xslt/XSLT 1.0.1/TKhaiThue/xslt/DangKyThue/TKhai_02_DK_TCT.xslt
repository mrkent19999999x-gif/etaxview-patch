										  ...
										  <td ><label>&#160;</label></td>
											<td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
												<label>
													...
													<td><label class="check-content">Đơn vị phụ thuộc, địa điểm KD của tổ chức của VN </label></td>
											<td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
												<label>
							...
							<div style="width: 100%; height: 4; border-bottom: solid 1px #9a9ba9; padding: 5px 0px 0px 0px !important;">
									<span class="content-span list-check">
										...
										<tr>
											...
											<td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
												<label>
													<xsl:if test="$tkchinh/CT14/CT14/CT14d/ct14d_ma = '1020'">
														X
													</xsl:if>
													<xsl:if test="$tkchinh/CT14/CT14/CT14d/ct14d_ma != '1020'">
														&#160;
										...
										<tr>
												...
												<td class="ngay_nhan" style="text-align: center;vertical-align: middle;">	
												<label>
													<xsl:if test="$tkchinh/CT14/CT14/CT14d/ct14d_ma = '1070'">
														X
													</xsl:if>
													<xsl:if test="$tkchinh/CT14/CT14/CT14d/ct14d_ma != '1070'">
														&#160;
											...
											<td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
												<label>
													<xsl:if test="$tkchinh/CT14/CT14/CT14d/ct14d_ma = '1040'">
														X
													</xsl:if>
													<xsl:if test="$tkchinh/CT14/CT14/CT14d/ct14d_ma != '1040'">
														&#160;
											...
											<!-- <td class="ngay_nhan" style="text-align: center; vertical-align: middle;">
												<label>
													<xsl:if test="$tkchinh/CT14/CT14/CT14d/ct14d_ma = '99'">
														X
													</xsl:if>
													<xsl:if test="$tkchinh/CT14/CT14/CT14d/ct14d_ma != '99'">
														&#160;
