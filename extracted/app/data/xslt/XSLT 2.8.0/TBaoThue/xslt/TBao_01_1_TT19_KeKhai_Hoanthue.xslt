...
table.center {
  ...
  margin-right: auto;
		...
		<xsl:call-template name="tbaoHeader_01_1TDT_02QTT">
		...
		<br/>
			...
			<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ quy định tại Thông tư số 19/2021/TT-BTC ngày 18/3/2021 của Bộ trưởng Bộ Tài chính hướng dẫn giao dịch điện tử trong lĩnh vực thuế.</div>
				...
				<xsl:if test="$ndungTBao/trangThai='N'">
						...
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Loại tờ khai:  <xsl:value-of select="$ndungTBao/HoSoThue/CTietHoSoThue/loaiToKhai"/>
			...
			<xsl:if test="$ndungTBao/trangThai='Y' or $ndungTBao/trangThai='0'">
						...
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Tên tờ khai/Phụ lục: <xsl:value-of select="$ndungTBao/HoSoThue/CTietHoSoThue/tokhai-phuluc"/>; Đề nghị hoàn thuế tại hồ sơ quyết toán thuế thu nhập cá nhân</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Loại tờ khai: <!--<xsl:value-of select="$ndungTBao/HoSoThue/CTietHoSoThue/loaiToKhai"/>-->
						<xsl:if test="$ndungTBao/HoSoThue/CTietHoSoThue/loaiToKhai='C'">Chính thức
						</xsl:if>
						<xsl:if test="$ndungTBao/HoSoThue/CTietHoSoThue/loaiToKhai='B'">Bổ sung
						</xsl:if> </div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Kỳ tính thuế: <xsl:value-of select="$ndungTBao/HoSoThue/CTietHoSoThue/kyTinhThue"/></div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Lần nộp hoặc lần bổ sung: <xsl:value-of select="$ndungTBao/HoSoThue/CTietHoSoThue/lanNop"/></div>
						...
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Hồ sơ khai thuế, hồ sơ đề nghị hoàn thuế của NNT sẽ được cơ quan thuế tiếp tục kiểm tra và được giải quyết trong thời gian chậm nhất là 06 (sáu) ngày làm việc kể từ ngày cơ quan thuế tiếp nhận hồ sơ của người nộp thuế ghi trên Thông báo này.</div>
			</xsl:if>	
