...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt">
	...
	<xsl:template match="/">
		...
		<xsl:call-template name="tkhaiHeader-DK5">
			...
			<tr>
				<td>
					...
					<div class="ghichu">
						...
						<br/>
						<div>
							<i>- Trường hợp một NNT khai thác đồng thời dầu thô, condensate và khí thiên nhiên thì kê khai thành từng tờ khai riêng biệt.</i>
						</div>
						<br/>
						<div>
							<i>- TNDN: Thu nhập doanh nghiệp</i>
						</div>
						<br/>
					</div>
					<div id="sigDiv"></div>
