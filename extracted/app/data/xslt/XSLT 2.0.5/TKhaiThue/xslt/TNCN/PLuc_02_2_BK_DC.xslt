...
6/11/2013 của Bộ Tài chính'" />
	...
	<!--start phu luc 02_2/BK-DC-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_02_2_BK_DC">	
		<xsl:variable name="pl02" select='HSoThueDTu/HSoKhaiThue/PLuc/PLuc_02_2_BK_DC' />
			<xsl:call-template name="tkhaiHeader-pluc">
		<xsl:with-param name="mauTKhai"   select="'02-2/BK-ĐC'"/>
		<xsl:with-param name="moTaBieuMau"   select="$moTaBieuMau"/>
		<xsl:with-param name="tenPL"   select="'PHỤ LỤC  BẢNG KÊ THU NHẬP CHỊU THUẾ VÀ THUẾ THU NHẬP CÁ NHÂN 
ĐÃ KHẤU TRỪ ĐỐI VỚI THU NHẬP CỦA CÁ NHÂN THAM GIA MẠNG LƯỚI BÁN HÀNG ĐA CẤP'"/>
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo Tờ khai quyết toán thuế thu nhập cá nhân mẫu số 02/KK-BHĐC)'"/>
			...
			<div class="content">
				...
				<table class="tkhai_table">
                        ...
                        <xsl:for-each select="$pl02/BangThuNhapBHangDCap/chiTietTNhapBHangDCap">
