				...
				<div class="content">
					...
					<table class="tkhai_table">
						...
						<tr>
							<td/>
							<td class="align-l">
								<b>Kết quả kinh doanh ghi nhận theo báo cáo tài chính.</b>
							</td>
							<td/>
							<td/>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct01"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct02"/>
							</td>
						</tr>
						<tr>
							<td class="align-c">
							...
							<td class="align-l">
								<b>Các khoản giảm trừ doanh thu ([03]=[04]+[05]+[06]+[07])</b>
							</td>
							<td class="align-c">
								<b>[03]</b>
							</td>
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct03"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct04"/>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct05"/>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct06"/>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct07"/>
							</td>
						</tr>
						<tr>
							<td class="align-c">
							...
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct08"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="align-l">
								<b>Chi phí sản xuất, kinh doanh hàng hoá, dịch vụ ([09]=[10]+[11]+[12])</b>
							</td>
							<td class="align-c">
								<b>[09]</b>
							</td>
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct09"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct10"/>
							</td>
						</tr>
						<tr>
							<td class="align-c">b</td>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct11"/>
							</td>
						</tr>
						<tr>
							<td class="align-c">c</td>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct12"/>
							</td>
						</tr>
						<tr>
							<td class="align-c">
							...
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct13"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<xsl:value-of select="$pl03-1a_tndn/ct14"/>
							</td>
						</tr>
						<tr>
							<td class="align-c">
							...
							<td class="align-l">
								<b>Lợi nhuận thuần từ hoạt động kinh doanh ([15]=[01]-[03]+[08]-[09]-[13])</b>
							</td>
							<td class="align-c">
								<b>[15]</b>
							</td>
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct15"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct16"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct17"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct18"/>
								</b>
							</td>
						</tr>
						<tr>
							...
							<td class="align-l">
								<b>Tổng lợi nhuận kế toán trước thuế thu nhập doanh nghiệp ([19] = [15] + [18])</b>
							</td>
							<td class="align-c">
								<b>[19]</b>
							</td>
							<td class="number align-r">
								<b>
									<xsl:value-of select="$pl03-1a_tndn/ct19"/>
								</b>
							</td>
						</tr>
					</table>
					...
					<td>
						...
						<div>
							<i>
								<b>
									<u>Ghi chú:</u>
								</b> - Số liệu tại chỉ tiêu [19] của Phụ lục này được ghi vào chỉ tiêu mã số A1 của Tờ khai quyết toán thuế TNDN của cùng kỳ tính thuế. </i>
						</div>
						<div id="sigDiv"/>
					</td>
				</tr>
