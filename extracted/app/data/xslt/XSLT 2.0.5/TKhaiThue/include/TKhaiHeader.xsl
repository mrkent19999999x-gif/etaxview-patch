    ...
    <xsl:template name="tkhaiHeader-03TNDN_TT56">
        ...
        <div class="header_div">			
            <table class="tb_header">						
                ...
                <tr>
                    <td class="align-c">
                        <b>[01]</b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy_,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>								
    ...
    <xsl:template name="tkhaiHeader-DK1">
        ...
        <div class="header_div">			
            <table class="tb_header">						
                ...
                <tr>
                    <td class="align-c">
                                <b>[01]</b> Dầu thô: [<xsl:if test="$tkchinh/LoaiDauKhi/ct01 = 'true' ">x</xsl:if> <xsl:if test="$tkchinh/LoaiDauKhict01 = '1' ">x</xsl:if>] 
...
<!-- start tkhai header 02/DK-TNDN  -->	
    <xsl:template name="tkhaiHeader-DK5">
        <xsl:param name="mauTKhai" />
        <xsl:param name="moTaBieuMau" />
        <xsl:param name="ghuchuTK" />
...
<!-- Kết thúc header phụ lục 09-3/PL-TNCN -->
    ...
    <xsl:template name="tkhaiHeader_CapMST">
        <div class="header_div">			
            <table  class="ttinnnt_table">						
                <tr>
                     <td style="width:80%;text-align:center" ><b>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM<br/>Độc lập-Tự do-Hạnh phúc</b><br/>------------------------- </td>
                </tr> 
                <tr>
                     <td class="tentkhai">
                         <xsl:value-of select="translate($ttkthue/TKhaiThue/tenTKhai,$smallcase,$uppercase)" />
    ...
    <xsl:template name="tkhaiHeader-pluc02_1DK">	
        ...
        <div class="header_div">			
            <table class="tb_header">
                ...
                <tr>
                    <td class="align-c" colspan="3"> <b>[04]</b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/></td>
                </tr>
                <tr>
                    <td  class="align-l">
                        <b>[05] Tên người nộp thuế: </b>  
        ...
        <xsl:template name="tkhaiHeaderNTNN">
        <xsl:param name="mauTKhai" />
        <xsl:param name="moTaBieuMau" />
        <xsl:param name="ghuchuTK" />
        <xsl:variable  name="kieuKy_">
     ...
     <xsl:template name="tkhaiHeaderNTNN1">
        <xsl:param name="mauTKhai" />
        <xsl:param name="moTaBieuMau" />
        <xsl:param name="ghuchuTK" />
        <xsl:variable  name="kieuKy_">
	...
	<!-- start header Phuluc-->
    <xsl:template name="tkhaiHeader-pluc-NTNN0204">	
        <xsl:param name="mauTKhai" />
        <xsl:param name="moTaBieuMau" />
        <xsl:param name="tKhai" />
        <xsl:param name="tenPL" />
