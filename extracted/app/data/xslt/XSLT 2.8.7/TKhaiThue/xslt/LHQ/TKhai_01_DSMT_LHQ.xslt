 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:call-template name="tkhaiHeader_01_DSMT_LHQ">
			<xsl:with-param name="mauTKhai"   select="'01/DSMT-LHQ'"/>
		...
		<div style="padding-top: 5pt">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Danh sách Nhân viên Việt Nam dưới đây thuộc đối tượng được miễn thuế thu nhập cá nhân theo quy định tại Quyết định số 07/2016/QĐ -TTg ngày 22/2/2016 của Thủ tướng Chính phủ và hướng dẫn tại Thông tư số 97/2016/TT-BTC ngày 28/6/2016 của Bộ Tài chính:</div>
