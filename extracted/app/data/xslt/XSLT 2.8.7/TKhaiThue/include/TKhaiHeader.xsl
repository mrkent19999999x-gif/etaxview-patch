...
<!-- start header 06/MGTH (TT80/2021)-->
	...
	<!-- start header CV_DNMT-->
	<xsl:template name="tkhaiHeader_CV_DNMT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghchuTKT"/>
		...
		<div style="width:100%; text-align:center; line-height:1.5; margin-top:10px;">
			<b style="font-size:13pt; text-transform:uppercase;">
				TỜ KHAI XÁC NHẬN CHUYÊN GIA NƯỚC NGOÀI<br/>
				THỰC HIỆN CHƯƠNG TRÌNH, DỰ ÁN ODA TẠI<br/>
				VIỆT NAM
			</b>
		</div>
	</xsl:template>
