...
<!--start Footer tờ khai NTNN - TT80-->		
   ...
   <xsl:template name="tkhaiFooter_Pluc02-TBVMT-TT80">
	...
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Tôi xin cam kết hoàn toàn chịu trách nhiệm trước pháp luật về việc quản lý, sử dụng tem điện tử thuốc lá hoặc tem điện tử rượu theo đúng quy định./.</span>
	<div class="footer_div">
		<table>
		<tr>
				<td width="25%">
	...
	<xsl:template name="tkhaiFooter_04_TEM_TT23">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
		<div class="footer_div">
		<table>
		<tr>
	...
	<!--start Footer to khai 07/TEM -->	
	<xsl:template name="tkhaiFooter_07_TEM_TT23">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	...
	<!--start Footer Phieu xuat tem dien tu tu nha in -->	
	<xsl:template name="tkhaiFooter_Pxuat_NhaIn">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
	<br/>
	<div class="footer_div">
		...
		<tr>
			...
			<tr>
				...
				<br/>
				<br/>					
					<xsl:value-of select="$tkchinh/nguoiLapBieu"/>
					</td>
				<td width="35%" class="align-c">
				<br/>
				<br/>					
					<xsl:value-of select="$tkchinh/nguoiNhanHang"/>
				</td>
				<td  width="30%" class="align-c">
				<br/>
				<br/>					
					<xsl:value-of select="$tkchinh/thuTruongDV"/>
				</td>
			</tr>
		</table>
		<br/>
	...
	<!--start Footer phu luc 01 Phieu tong hop DN kem to 01/TTDB (TT146/2017)-->	
	<xsl:template name="tkhaiFooter_PL01_TT146">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<xsl:variable name="tkpl01" select='HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_TT146/PLPhieuTHDoanhThu' />
	<br/>
	<div class="footer_div">
		<table width='100%'>
		<tr>
			...
			<tr>
				...
				<br/>
				<br/>					
					<xsl:value-of select="$tkpl01/giamDoc"/>
					</td>
				<td width="25%" class="align-c">
				<br/>
				<br/>					
					<xsl:value-of select="$tkpl01/keToan"/>
				</td>
				<td  width="25%" class="align-c">
				<br/>
				<br/>					
					<xsl:value-of select="$tkpl01/thuQuy"/>
				</td>
				<td  width="25%" class="align-c">
				<br/>
				<br/>					
					<xsl:value-of select="$tkpl01/khoQuy"/>
				</td>
			</tr>
		</table>
		<br/>
