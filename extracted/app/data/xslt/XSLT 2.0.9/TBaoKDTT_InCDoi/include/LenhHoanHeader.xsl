...
<xsl:template name="tbaoHeader">	
	...
	<br/>
					...
					<div align="left" style="margin-left:50px; padding:0;">
						...
						<td  style="float:left;font-size:13px; margin-top:14px;" align="center">
							Mẫu số: <span style="font-weight:bold;"><xsl:value-of select="$mauTBao"/></span>
							<br/>
							<span>
							(Theo TT số 19/2020/TT-BTC ngày 31/3/2020 của Bộ trưởng Bộ Tài Chính)<br/>
