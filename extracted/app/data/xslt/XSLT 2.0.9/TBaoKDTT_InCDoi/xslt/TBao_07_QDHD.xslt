		...
		<tbody>
			...
			<tr>
				<td colspan="2" align="center">
					<br/>
					<p style="font-weight:bold;font-size:14px;">QUYẾT ĐỊNH</p>
					<div style="font-weight:bold;">
					Về việc áp dụng cưỡng chế bằng biện pháp<br/>thông báo hóa đơn không còn giá trị sử dụng
					</div>
				</td>
			</tr>
		</tbody>
...
<xsl:if test="$NDungTBao/TTinCanCuQD/ccuTHanhQDHChinhThueSo!=''">
								...
								<xsl:if test="$NDungTBao/TTinCanCuQD/ccuTHanhQDHChinhThueCua !=''">
									<span>
									của<xsl:value-of select="$NDungTBao/TTinCanCuQD/ccuTHanhQDHChinhThueCua" />
									</span>
								</xsl:if>				
							...
							<div>
							&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<b>Điều 1. </b>Cưỡng chế bằng biện pháp thông báo hóa đơn không còn giá trị sử dụng để thi hành quyết định hành chính thuế số 
