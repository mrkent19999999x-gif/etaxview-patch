	...
	<xsl:template match="/">
		...
		<tbody>
			...
			<tr>
				...
				<td width="70%">
					<div align="center" style="margin:0; padding:0; ">
					<span style="font-weight:bold;font-size:14px;">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM Nguyễn Văn Nam</span><br/>
			...
			<tr>
				<td colspan="2" align="center">
					<br/>
					<p style="font-weight:bold;font-size:14px;">THƯ NHẮC NỘP HỒ SƠ KHAI THUẾ</p>
