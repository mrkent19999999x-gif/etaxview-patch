		...
		<tbody>
			...
			<tr>
				<td colspan="2" align="center">
					...
					bằng biện pháp trích tiền từ tài khoản của đối tượng bị cưỡng chế <br/>
						...
						<xsl:if test="$NDungTBao/TTinCanCuQD/ccuTHanhQDHChinhThueSo!=''">
							...
							<p class="align-j fz18_5px">
								<xsl:if test="$NDungTBao/TTinCanCuQD/theoDNghiCua !=''">
									<span>
										&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Xét đề nghị của <xsl:value-of select="$NDungTBao/TTinCanCuQD/theoDNghiCua" />,
									</span>
								</xsl:if>
							</p>
							...
							<p class="align-j fz18_5px">
								...
								</xsl:if> để thi hành quyết định hành chính thuế số
							...
							<p class="align-j fz18_5px">
								...
								<xsl:if test="$NDungTBao/QuyetDinh/Dieu2/ttinDTuongNChinhTHienQD !=''">
									<span>
									&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<b>Điều 2.</b> <xsl:value-of select="$NDungTBao/QuyetDinh/Dieu2/ttinDTuongNChinhTHienQD" />
									</span>
								</xsl:if>
							...
							<p class="align-j fz18_5px">
								...
								.Trường hợp trên tài khoản của 
								<xsl:if test="$NDungTBao/QuyetDinh/Dieu2/ttinDTuongNChinhTHienQD !=''">
									<span>
										<xsl:value-of select="$NDungTBao/QuyetDinh/Dieu2/ttinDTuongNChinhTHienQD" />
									</span>
								</xsl:if>
								nhỏ hơn số tiền trên Quyết định cưỡng chế nợ thì 
								<xsl:if test="$NDungTBao/QuyetDinh/Dieu2/ttinToChucCoTrachNhiemTrichNo !=''">
									<span>
										<xsl:value-of select="$NDungTBao/QuyetDinh/Dieu2/ttinToChucCoTrachNhiemTrichNo" />
									</span>
