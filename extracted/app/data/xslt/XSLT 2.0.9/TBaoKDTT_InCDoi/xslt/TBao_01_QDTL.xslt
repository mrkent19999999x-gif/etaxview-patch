			...
			<tr>
				...
				bằng biện pháp khấu trừ một phần tiền lương hoặc thu nhập
					...
					<br/>
						...
						<xsl:if test="$NDungTBao/TTinCanCuQD/ccuTHanhQDHChinhThueSo!=''">
                            ...
                            <br/>							
								<xsl:if test="$NDungTBao/QuyetDinh/Dieu1/tenDTuongQLTNhap !=''">
										...
										&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Tên : <xsl:value-of select="$NDungTBao/QuyetDinh/Dieu1/tenDTuongQLTNhap" />
					          ...
					          <br/>
								...
								<xsl:if test="$NDungTBao/QuyetDinh/Dieu1/diaChiDTuongQLTNhap !=''">
									
										&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Địa chỉ : <xsl:value-of select="$NDungTBao/QuyetDinh/Dieu1/diaChiDTuongQLTNhap" />
						...
						<div>
							&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Quyết định này (mới) thay thế cho quyết định 23QĐ-CCT - TR thi hành
quyết định hành chính thuế bằng biện pháp thông báo hóa đơn không còn giá trị
sử dụng - TR1.
									</div>
							<div>
							&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Quyết định có
