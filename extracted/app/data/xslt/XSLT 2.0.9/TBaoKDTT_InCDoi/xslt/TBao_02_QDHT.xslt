...
xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt">
	...
	<xsl:template match="/">
		<xsl:for-each select="TBaoThueDTu">
			...
			<xsl:with-param name="mauTBao"   select="'02/QĐHT'"/>
			...
			<xsl:with-param name="diaDanh"   select="$ndungTBao/diaDanh" />
					...
					<div class="content" >	
							<p class="align-c fz17px">
								<b>CHỨC DANH THỦ TRƯỞNG CƠ QUAN THUẾ RA QUYẾT ĐỊNH</b>
							</p>
							...
							<p class="align-j fz18_5px">
								...
								quy định chức năng, nhiệm vụ, quyền hạn và cơ cấu tổ chức của Tổng cục Thuế/Cục Thuế/Chi cục Thuế;
							</p>
							<p class="align-j fz18_5px">
								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ vào Giấy đề nghị hoàn trả khoản thu NSNN số 
							...
							<table class="tkhai_table fz14px" cellpadding="0" cellspacing="0"  border ="1px" width="100%">
									<tbody >
										<tr class="align-c" style="height:50px;">
											...
											<td id="td_table" style="width:17%;">
												<b>Số tiền thuế được hoàn</b>
											</td>
											<td id="td_table" style="width:33%;">
										...
										<tr>
											<td id="td_table" class="align-c" colspan="4">
												<b>Cộng</b>
											</td>
											<td id="td_table" class="align-r">
												<xsl:if test="tongCong !=''">
													<xsl:value-of select="ihtkk:formatNumber(tongCong)" />
												</xsl:if>
											</td>
											<td> 
											</td>
							...
							<p class="align-j fz18_5px">
								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<b>Điều 2: </b>Phần bù trừ với các khoản phải nộp Ngân sách Nhà nước (NSNN)
								<br />
								<table cellpadding="0" cellspacing="0" class="tkhai_table fz14px" border ="1px" width="100%" >
									<tbody>
										<tr class="align-c" style="height:50px;">
											<td rowspan="2" id="td_table" width="20px;">
												<b>STT</b>
											</td >
											<td rowspan="2" id="td_table">
												<b>Loại thuế/ Khoản phạt</b>
											</td>
											<td colspan="3" id="td_table">
												<b>Cơ quan thu</b>
											</td>
											<td rowspan="2" id="td_table">
												<b>Kỳ tính thuế</b>
											</td>
											<td colspan="2" id="td_table">
												<b>Quyết định thu/Tờ khai hải quan</b>
											</td>
											<td colspan="2" id="td_table">
												<b>Tài khoản bù trừ</b>
											</td>
											<td rowspan="2" id="td_table"> 
												<b>Số tiền</b>
											</td>
										...
										<tr class="align-c">
											...
											<td id="td_table">(8)</td>
											<td id="td_table">(9)</td>
											<td id="td_table">(10)</td>
											<td id="td_table">(11)</td>
										</tr>
										<xsl:for-each select="$ndungTBao/Dieu2/BuTruKhoanNopNSNN/ChiTiet">
											<tr>
												<td id="td_table" class="align-c">
													<countNo>
														<xsl:value-of select="position()" />
												...
												<td id="td_table" class="align-l">
													<xsl:if test="tenCQT !=''">
														<xsl:value-of select="tenCQT" />
													</xsl:if>
												</td>
												<td id="td_table" class="align-l">
													<xsl:if test="tenCQHaiQuan !=''">
														<xsl:value-of select="tenCQHaiQuan" />
													</xsl:if>
												</td>
												<td id="td_table" class="align-l">
													<xsl:if test="tenCQKhac !=''">
														<xsl:value-of select="tenCQKhac" />
													</xsl:if>
												</td>
												<td id="td_table" class="align-l">
													<xsl:if test="kyTinhThue !=''">
												...
												<td id="td_table" class="align-l">
													<xsl:if test="soQuyetDinhThu !=''">
														<xsl:value-of select="soQuyetDinhThu" />
													</xsl:if>
												</td >
												<td id="td_table" class="align-r">
													<xsl:if test="ngayQuyetDinhThu !=''">
														<xsl:value-of select="concat(substring(ngayQuyetDinhThu, 9,2),'/',substring(ngayQuyetDinhThu, 6,2),'/',substring(ngayQuyetDinhThu, 1,4)) " />
													</xsl:if>
												</td>
												<td id="td_table" class="align-c">
													<xsl:if test="nsnn ='true'">
														[X]
													</xsl:if>
													<xsl:if test="nsnn ='false'">
														[&#160;&#160;&#160;]
													</xsl:if>
												</td>
												<td id="td_table" class="align-c">
													<xsl:if test="tamThu ='true'">
														[X]
													</xsl:if>
													<xsl:if test="tamThu ='false'">
														[&#160;&#160;&#160;]
													</xsl:if>
												</td>
												<td id="td_table" class="align-r">
													<xsl:if test="soTien !=''">
														<xsl:value-of select="ihtkk:formatNumber(soTien)" />
													</xsl:if>
												</td>
											</tr>
										</xsl:for-each>
										<tr>
											<td colspan = "10" id="td_table" class="align-r">
												<b>TỔNG CỘNG</b>
											</td>
											<td id="td_table" class="align-r">
												<xsl:if test="$ndungTBao/Dieu2/BuTruKhoanNopNSNN/tongCong !=''">
													<xsl:value-of select="ihtkk:formatNumber($ndungTBao/Dieu2/BuTruKhoanNopNSNN/tongCong)" />
												</xsl:if>
											</td>
										</tr>
									</tbody>
							...
							<p class="align-j fz18_5px">
								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<b>Điều 3: </b>Phần còn lại được hoàn trả sau khi bù trừ với các khoản còn phải nộp Ngân sách Nhà nước:
								<xsl:if test="$ndungTBao/Dieu3/soTienConLai !=''">
									<span>
										<xsl:value-of select="ihtkk:formatNumber($ndungTBao/Dieu3/soTienConLai)" />
									</span>
								</xsl:if>
								đồng <i>(Bằng chữ: 
								<xsl:if test="$ndungTBao/Dieu3/soTienConLai !=''">
									<span>
										<xsl:value-of select="ihtkk:DocTienBangChu($ndungTBao/Dieu3/soTienConLai)" />
									</span>
								</xsl:if>)</i>
								<br />
								<table cellpadding="0" cellspacing="0" class="tkhai_table fz14px" border ="1px" >
									<tbody>
										<tr class="align-c" height="50px;">
										...
										<xsl:for-each select="$ndungTBao/Dieu3/PhanConLai/ChiTiet">
											<tr>
												<td id="td_table" class="align-c">
													<countNo>
														<xsl:value-of select="position()" />
										...
										<tr>
											...
											<td id="td_table" class="align-r">
												<xsl:if test="$ndungTBao/Dieu3/PhanConLai/tongCong !=''">
													<xsl:value-of select="ihtkk:formatNumber($ndungTBao/Dieu3/PhanConLai/tongCong)" />
												</xsl:if>
											</td>
											<td> 
											</td>
							...
							<div>
							&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
								<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/chuyenKhoan != 'false'">
									[X]
								</xsl:if>
								<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/chuyenKhoan != 'true'">
									[&#160;&#160;&#160;]
								</xsl:if>
								&#160;&#160;&#160;Chuyển khoản 
							</div>
							<div>
							&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Số tài khoản
								<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/chuyenKhoan = 'true' and $ndungTBao/Dieu3/HinhThucHoanTra/soTaiKhoan !=''">
									<xsl:value-of select="$ndungTBao/Dieu3/HinhThucHoanTra/soTaiKhoan" />
								</xsl:if>
								<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/chuyenKhoan = 'true' and $ndungTBao/Dieu3/HinhThucHoanTra/soTaiKhoan =''">
									.........
								</xsl:if>
								...
								Tại ngân hàng (KBNN) 
								<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/chuyenKhoan = 'true'">
									<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/taiNganHang !=''">
										<span>
											<xsl:value-of select="$ndungTBao/Dieu3/HinhThucHoanTra/taiNganHang" />
										</span>
									</xsl:if>
									<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/taiNganHang =''">
										<span>
							...
							<div>
							&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
								<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/tienMat = 'true'">
									[X]
								</xsl:if>
								<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/tienMat = 'false'">
									[&#160;&#160;&#160;]
								</xsl:if>
								&#160;&#160;&#160;Tiền mặt
							</div>
							<div>
								...
								<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/tienMat = 'true'">
									<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/noiNhanTienHoan !=''">
										<span>
											<xsl:value-of select="$ndungTBao/Dieu3/HinhThucHoanTra/noiNhanTienHoan" />
										</span>
									</xsl:if>
									<xsl:if test="$ndungTBao/Dieu3/HinhThucHoanTra/noiNhanTienHoan =''">
										<span>
							...
							<div>
								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<b>Điều 4: </b>Trả tiền lãi cho thời gian
								<xsl:if test="$ndungTBao/Dieu4/soNgayCham !=''">
									<span>
										<xsl:value-of select="$ndungTBao/Dieu4/soNgayCham" />
									</span>
								</xsl:if>
								chậm giải quyết hồ sơ hoàn thuế của cơ quan thuế là 
								<xsl:if test="$ndungTBao/Dieu4/soTienLai !=''">
									<span>
										<xsl:value-of select="ihtkk:formatNumber($ndungTBao/Dieu4/soTienLai)" />
									</span>
								</xsl:if>
								đồng.
							</div>
							<div>
								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<b>Điều 5: </b>Quyết định này có hiệu lực kể từ ngày ký. 
							</div>
							<div>
								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
								<xsl:if test="$ttinChung/NNhanTBaoThue/tenNNhan !=''">
								...
								<xsl:if test="$ndungTBao/truongBoPhanLQuan !=''">
									<span>
										<xsl:value-of select="$ndungTBao/truongBoPhanLQuan" />
									</span>
								</xsl:if>
