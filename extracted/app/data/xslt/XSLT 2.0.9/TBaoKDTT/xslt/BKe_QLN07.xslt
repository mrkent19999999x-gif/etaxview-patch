			...
			<html>
				<body>
					<div class="content_bke">
						<table cellpadding="0" cellspacing="0" class="fz18_5px" width="100%">
							<tr class="align-c">
						...
						<table cellpadding="0" cellspacing="0" class="tkhai_table fz17px" width="100%">
							<tbody >
								...
								<xsl:for-each select="$NDungBKe/TBaoThueDTu">
									<tr>
										<td id="td_table" class="align-c" height="23px">
											<countNo>
												<xsl:value-of select="position()" />
											</countNo>
										</td>
										<td id="td_table" class="align-l" height="23px">
										...
										<td id="td_table" class="align-l" height="23px">
										<xsl:if test="TBaoThue/NDungTBao/ThongTinCQT/soDienThoai !=''">
												<xsl:value-of select="TBaoThue/NDungTBao/ThongTinCQT/soDienThoai" />
											</xsl:if>
										</td>
										<td id="td_table" class="align-l" height="23px">
											<xsl:if test="TBaoThue/NDungTBao/ThongTinCQT/email !=''">
												<xsl:value-of select="TBaoThue/NDungTBao/ThongTinCQT/email" />
											</xsl:if>
										</td>
										<td id="td_table" class="align-l" height="23px">
