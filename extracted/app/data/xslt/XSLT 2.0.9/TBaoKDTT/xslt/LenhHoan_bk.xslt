	...
	<xsl:template match="/">
		<xsl:for-each select="TBaoThueDTu">
			...
			<br/>
				...
				<div style="margin-left:30px;">Chi tiết nội dung khoản hoàn trả:</div><br/>
			...
			<br/>
			<br/>
				<div style="margin-left:30px;" >Căn cứ Quyết định về việc hoàn thuế kiêm bù trừ ngân sách nhà nước số <span><xsl:if test="$NDungTBao/HDR/SO_QD_HOAN !=''"><xsl:value-of select="$NDungTBao/HDR/SO_QD_HOAN" /></xsl:if></span>&#160;
				...
				<div style="margin-left:30px;">Đề nghị KBNN A: <span><xsl:if test="$NDungTBao/HDR/TEN_KBNN !=''"><xsl:value-of select="$NDungTBao/HDR/TEN_KBNN" /></xsl:if></span>. Tỉnh, TP: <span><xsl:if test="$NDungTBao/TINH_KBNN !=''"><xsl:value-of select="$NDungTBao/TINH_KBNN" /></xsl:if></span></div>
				<div style="margin-left:30px;"><span style="font-weight:bold">1) Hoàn trả cho: </span> <span><xsl:if test="$NDungTBao/HDR/TEN_NGUOI_NHAN_TIEN !=''"><xsl:value-of select="$NDungTBao/HDR/TEN_NGUOI_NHAN_TIEN" /></xsl:if></span>. &#160;&#160;&#160;&#160;&#160;&#160;Mã số thuế: <span><xsl:if test="$NDungTBao/HDR/MST !=''"><xsl:value-of select="$NDungTBao/HDR/MST" /></xsl:if></span></div>
				<div style="margin-left:30px;">Địa chỉ: <span><xsl:if test="$NDungTBao/HDR/DIA_CHI !=''"><xsl:value-of select="$NDungTBao/HDR/DIA_CHI" /></xsl:if></span>.&#160;&#160; Quận/Huyện: <span><xsl:if test="$NDungTBao/HDR/QUAN_HUYEN !=''"><xsl:value-of select="$NDungTBao/HDR/QUAN_HUYEN" /></xsl:if></span>.&#160;&#160; Tỉnh/TP: <span><xsl:if test="$NDungTBao/HDR/TINH_TP !=''"><xsl:value-of select="$NDungTBao/HDR/TINH_TP" /></xsl:if></span></div>
				<div style="margin-left:30px;">Lý do hoàn trả: <span><xsl:if test="$NDungTBao/HDR/LY_DO !=''"><xsl:value-of select="$NDungTBao/HDR/LY_DO" /></xsl:if></span></div>
				<div style="margin-left:30px;">Chi tiết nội dung khoản hoàn trả:</div><br/>
				<div align="center" style="text-align:center;">
				...
				<br/>
				<div style="margin-left:30px;font-weight:bold;">2) Khấu trừ khoản hoàn trả để thu NSNN:</div><br/>
				
				<div style="margin-left:30px;">Chi tiết nội dung khoản thu:</div><br/>
