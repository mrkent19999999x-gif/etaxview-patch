            ...
            <div class="content_A4">
                                ...
                                <td width="40%">
                                    <div align="center" style="margin:0; padding:0;">
                                        <span style="text-transform:uppercase">
                                            <xsl:value-of select="$TTinChung/CQT/coQuanCapTren"/>
                                        </span> 
                                        <br/>
                                        <span style="font-weight:bold;text-transform:uppercase;">
                                            <xsl:value-of select="$TTinChung/CQT/coQuanCapDuoi"/>
                                        </span>
                                        <br/>
                                        Số: <xsl:value-of select="$TTinChung/TTinTBaoThue/soTBao" />&#160;
                                        <input type="text" name="SignSo" value="" readonly="readonly" style="width: 10px; height:20px; border: none" />&#160;
                                    </div>
                                </td>
                                <td width="60%">
                                    <div align="center" style="margin:0; padding:0; ">
                                        ...
                                        ----------oOo----------<br/>
                                        <i>
                                            <xsl:value-of select="$TTinChung/CQT/diaDanh" />, Ngày <xsl:value-of select="kdtxslt:stringDatetime($TTinChung/TTinTBaoThue/ngayTBao,'dd')"/>&#160;&#160;
                                            <input type="text" name="SignNgay" value="" readonly="readonly" style="width: 10px; height:20px; border: none" />&#160;&#160;  tháng <xsl:value-of select="kdtxslt:stringDatetime($TTinChung/TTinTBaoThue/ngayTBao,'mm')"/>&#160;&#160;
                                            <input type="text" name="SignThang" value="" readonly="readonly" style="width: 10px; height:20px; border: none" />&#160;&#160;  năm <xsl:value-of select="kdtxslt:stringDatetime($TTinChung/TTinTBaoThue/ngayTBao,'yyyy')"/>&#160;&#160;
                                            <input type="text" name="SignNam" value="" readonly="readonly" style="width: 10px; height:20px; border: none" />&#160;&#160;
                                        </i>
                                    </div>
                                </td>
                            </tr>
                ...
                <div  class="align-j">
                    ...
                    <p class="align-c b" style="text-transform:uppercase;">
                        <span>
                            <xsl:if test="$TTinChung/CQT/coQuanBanHanhQuyetDinh !=''">
                                <xsl:value-of select="$TTinChung/CQT/coQuanBanHanhQuyetDinh"/>
                            </xsl:if>
                            <xsl:if test="$TTinChung/CQT/coQuanBanHanhQuyetDinh =''">
                    ...
                    <xsl:if test="$NDungTBao/TTinCanCuQD/ttinCanCuVBan !=''">
                        <span>
										&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ văn bản giao quyền số <xsl:value-of select="$NDungTBao/TTinCanCuQD/ttinCanCuVBan" />;<br/>
                        </span>
                    </xsl:if>
                    ...
                    ngày <xsl:value-of select="kdtxslt:stringDatetime($NDungTBao/TTinCanCuQD/ccuTHanhQDHChinhThueNgay,'dd')"/> tháng <xsl:value-of select="kdtxslt:stringDatetime($NDungTBao/TTinCanCuQD/ccuTHanhQDHChinhThueNgay,'mm')"/> năm <xsl:value-of select="kdtxslt:stringDatetime($NDungTBao/TTinCanCuQD/ccuTHanhQDHChinhThueNgay,'yyyy')"/>
                    ...
                    Ngày <xsl:value-of select="kdtxslt:stringDatetime($NDungTBao/QuyetDinh/Dieu1/TTinBienPhapCChe/thiHanhQDHChinhThueNgay,'dd')"/> tháng <xsl:value-of select="kdtxslt:stringDatetime($NDungTBao/QuyetDinh/Dieu1/TTinBienPhapCChe/thiHanhQDHChinhThueNgay,'mm')"/> năm <xsl:value-of select="kdtxslt:stringDatetime($NDungTBao/QuyetDinh/Dieu1/TTinBienPhapCChe/thiHanhQDHChinhThueNgay,'yyyy')"/>
                    của
                    ...
                    <xsl:if test="$NDungTBao/QuyetDinh/Dieu1/soTienBiCChe !=''">
                        <span>
                            <xsl:value-of select="kdtxslt:formatNumber($NDungTBao/QuyetDinh/Dieu1/soTienBiCChe)" />;
                        </span>
                    </xsl:if>
                    <br/>
							&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
                    <i>( Số tiền bằng chữ: 
                        <xsl:if test="$NDungTBao/QuyetDinh/Dieu1/soTienBiCChe !=''">
                            <span>
                                <xsl:value-of select="kdtxslt:DocTienBangChu($NDungTBao/QuyetDinh/Dieu1/soTienBiCChe)"/>
                            </span>
                        </xsl:if>) </i>.
                    <br/>
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
                    ...
                    <br/>
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
                    Quyết định này (mới) thay thế cho quyết định 23 QĐ-CCT về việc cưỡng
                    chế thi hành quyết định hành chính thuế bằng biện pháp thông báo hóa đơn
                ...
                <table style="page-break-inside: avoid;width:100%">
                    <tr>
                        <td style="width:40%;padding-left:50px;">
                            <span style="font-style:italic;font-weight:bold">Nơi nhận:<input type="text" name="SignNhay" value="" readonly="readonly" style="width: 10px; height:20px; border: none" /></span>
                            <br/>
                            ...
                            <xsl:for-each select="$NDungTBao/NoiNhan/CTietLuu/luu">
                                -&#160;Lưu: <xsl:value-of select="." />
                                <br/>
                            </xsl:for-each>
                        </td>
                        <td style="width:60%;text-align:center;">
                            <input type="text" name="SignHThuc" value="" readonly="readonly" style="width: 10px; height:20px; border: none" />                                     
                            <br />
                            <input type="text" name="SignDinhDanh" value="" readonly="readonly" style="width: 10px; height:20px; border: none" />
                            <input type="text" name="SignDau" value="" readonly="readonly" style="width: 10px; height:20px; border: none" />
                            ...
                            <xsl:if test="$TTinChung/TTinKy/hThucKT !=''">
                                <span style="font-weight:bold;text-transform:uppercase;">KT: <xsl:value-of select="$TTinChung/TTinKy/chucDanhCBTKT" /></span>
                                <br/>
                            </xsl:if>
                            ...
                            <input type="text" name="SignDinhDanhName" value="" readonly="readonly" style="width: 10px; height:20px; border: none" />                                
                        </td>
                    </tr>
                </table>
            </div>
