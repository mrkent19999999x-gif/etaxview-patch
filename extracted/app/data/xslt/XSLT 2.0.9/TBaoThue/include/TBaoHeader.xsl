...
<xsl:template name="tbaoHeader_01_DK_TVAN">	
	<xsl:param name="mauTBao" />
	<xsl:param name="soTBao" />
	<xsl:param name="ngayTBao" />
	<xsl:param name="motaTBao" />
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tbody>
				...
				<td   colspan="2"  align="right" >
					...
					<div class="bieu_mau_div" style="width: 30%; float: right;">
						<div >Mẫu số: <b>
							 ...
							 <br/>
                        <span class="mtatentkhai" style="font-size:9pt">(Ban hành kèm theo Thông tư số 19/2021/TT-BTC ngày 18/3/2021 của Bộ trưởng Bộ Tài chính) </span>
			...
			<tr>
				<td colspan="2" align="center">
					<br/><b>TỜ KHAI</b><br/>
					<b>Đăng ký sử dụng dịch vụ T-VAN</b><br/>
...
<xsl:template name="tbaoHeader_02_DK_TVAN">	
	<xsl:param name="mauTBao" />
	<xsl:param name="soTBao" />
	<xsl:param name="ngayTBao" />
	<xsl:param name="motaTBao" />
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			...
			<tr>
				<td colspan="2" align="center">
					<br/><b>TỜ KHAI</b><br/>
					<b>Thay đổi, bổ sung thông tin đăng ký sử dụng dịch vụ T-VAN</b><br/>
...
<xsl:template name="tbaoHeader_03_DK_TVAN">	
	<xsl:param name="mauTBao" />
	<xsl:param name="soTBao" />
	<xsl:param name="ngayTBao" />
	<xsl:param name="motaTBao" />
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			...
			<tr>
				<td colspan="2" align="center">
					<br/><b>TỜ KHAI</b><br/>
					<b>Đăng ký ngừng sử dụng dịch vụ T-VAN</b><br/>
