...
<xsl:include href="../common/common.xsl"/>
	<xsl:template match="/">
		...
		<xsl:variable name="noiDung03GDTVAN" select='TBaoThueDTu/TBaoThue/NDungTBao/CTietGDich/NoiDung03GDTVAN' />
		<xsl:call-template name="tbaoHeaderTVan">
			<xsl:with-param name="mauTBao"   select="'03-GD/T-VAN'"/>
					...
					<td colspan="2">
						<table width="100%" cellpadding="3" cellspacing="2" style="border-collapse: collapse; text-align: center;">
							<tr bgcolor="#f0f0f0" style="font-weight: bold;">
								...
								<th style="border: 1px solid #000;">Kỳ bắt đầu</th>
							...
							<xsl:for-each select="$noiDung03GDTVAN">
							<tr>
