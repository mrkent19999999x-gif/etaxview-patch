...
<xsl:include href="../common/common.xsl"/>
	<xsl:template match="/">
		...
		<xsl:variable name="tTinTBaoThue" select='TBaoThueDTu/TBaoThue/TTinChung/TTinTBaoThue' />
		...
		<xsl:call-template name="tbaoHeaderTVan">
			<xsl:with-param name="mauTBao"   select="'02-GD/TVAN-ĐLT'"/>
			<xsl:with-param name="ngayTBao"   select="$tTinTBaoThue/ngayTBao" />
			<xsl:with-param name="tenTBao"   select="$tTinTBaoThue/tenTBao" />
		</xsl:call-template>
		<br/>
		<div>
			<table width="100%">
				...
				<tr>
					...
					<td>
						<table width="100%">
							...
							<tr>
								<td>Thư điện tử:</td>
								<td style="background-color: #DDE4FF;"><xsl:value-of select="$cTietGDich/email" /></td>
							</tr>
							<tr>
								<td>Điện thoại:</td>
								<td style="background-color: #DDE4FF;"><xsl:value-of select="$cTietGDich/tel" /></td>
							</tr>
							<tr>
								<td>Tên ĐLT:</td>
