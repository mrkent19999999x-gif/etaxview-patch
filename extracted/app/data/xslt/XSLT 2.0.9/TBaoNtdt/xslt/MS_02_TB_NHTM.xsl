...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    <style type="text/css">ol { margin: 0; padding: 0 }
      #wrapper { background: none repeat scroll 0 0 #FFFFFF; min-height: 100%; margin: auto; padding: 40px; position: relative; }
      ...
      #conten .table_hd1 { border-collapse: collapse; border-color: #000000; float: left; margin: 10px 0px; position: relative; width: 230px; color: #404040;}
      ...
      .div_tablehd1{float: left; position: relative; width: 100%;}
      ...
      <xsl:for-each select="TBAO_TKHOAN_NH">
        ...
        <xsl:for-each select="$TBAO_TKHOAN_NH">
          <div id="headermct">
            ...
            <p class="c3 c11">
              <span class="c1 c0 c4">
                V/v Không chấp nhận đăng ký sử dụng dịch vụ nộp thuế điện tử qua NHTM.
              </span>
            </p>
            <hr class="table_hr3" />
            <p class="c2 c11">&#160;</p>
            ...
            <p class="c1" style="margin-left: 62px;">Mã số thuế: &#160;
              <span class="c1">
                <xsl:if test="MST !=''">
            ...
            <p class="c3">
              <span class="c1 ">Ngân hàng&#160;
                ...
                không chấp thuận đăng ký sử dụng dịch vụ Nộp thuế điện tử thông qua tài khoản của Ngân hàng&#160;
                <xsl:if test="TEN_NHANG !=''">
                  <span>
                    <xsl:value-of select="TEN_NHANG"/>
                  </span>
          ...
          <div id="conten">
            ...
            <p class="c3">
              <span class="c1 ">Ngân hàng
                ...
                thông báo để người nộp thuế biết, thực hiện./.</span>
            </p>
          </div>
