...
<xsl:include href="../common/common.xsl"/>
	...
	<xsl:variable name="NGAY_NOP"   select="THONGBAO/NGAY_NOP_GNT" />
		...
		<xsl:variable name="TEN_THONGBAO" select="$NDUNG_TBAO/THONGBAO_HDR/TEN_THONGBAO" />
        ...
        <div style=" float: left; margin: auto; position: relative; width: 100%;">
                ...
                <tr>
                 ...
                 <span>Số tham chiếu</span>
                  ...
                  <td style="height:23px;text-align: left; padding-left:12px;  border-style: solid; border-color: #000000; border-width: 0.5pt;">
                    ...
                    <span class="contenms19">
                      <xsl:if test="$NNhanTBaoThue/MA_THAMCHIEU !=''">
                        <xsl:value-of select="$NNhanTBaoThue/MA_THAMCHIEU"/>
                      </xsl:if>
                    </span>
                  </td>
                  </tr>
          ...
          <p  >
            <span  > &#160; &#160; &#160;Để tra cứu thông tin đã nộp thuế điện tử nói trên, xin vui lòng truy cập theo đường dẫn:&#160;</span>
            <span >
		...
		<br/>
		<p style="font-size:14px">Để tra cứu thông tin đã nộp nói trên, xin vui lòng truy cập theo đường dẫn: http://thuedientu.gdt.gov.vn. hoặc http://nopthue.gdt.gov.vn</p>
		<br/>
		<table style="page-break-inside: avoid;" >
			<tr>
				<td>
