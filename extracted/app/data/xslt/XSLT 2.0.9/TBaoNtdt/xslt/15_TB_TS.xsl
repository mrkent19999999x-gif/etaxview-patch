...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" exclude-result-prefixes="xsl xsi ihtkk">
            ...
            <tbody id="msthongbao09">
              <tr>
                ...
                <td style="text-align: center !important;  width: 47.7pt; border-style: solid; border-color: #000000; border-width: 0.5pt; padding: 2px;">
                  <span class="tb_strong">Số tham chiếu/Số giấy nộp tiền/Số chứng từ</span>
                </td>
  ...
  <p   style="margin-left: 62px; font-size:15px;">
              ...
              <span >
                <a style="font-size:15px; font-style: italic" href="https://thuedientu.gdt.gov.vn">https://thuedientu.gdt.gov.vn</a> hoặc <a style="font-size:15px; font-style: italic" href="https://nopthue.gdt.gov.vn">https://nopthue.gdt.gov.vn</a>
              </span>
              <span >.</span>
            </p>
