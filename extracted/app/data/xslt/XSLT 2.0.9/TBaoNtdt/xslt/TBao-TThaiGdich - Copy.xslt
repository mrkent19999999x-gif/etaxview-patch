...
<xsl:include href="../common/common.xsl"/>
    ...
    <xsl:choose>
          ...
          <div id="headermct1">
            <p class="c2">&#160;</p>
				<div align="center" style="border: 1px solid; float: right; min-height: 19px; padding: 10px; position: relative; top: -14px; width: 285px;">
					...
					Mẫu số: <b>  <xsl:if test="MAU_THONGBAO !=''">
                  <span>
		...
		<div>
			...
			<tbody>
			<tr align="center">
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Số GNT</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Mã hiệu chứng từ</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Số chứng từ</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">MST thụ hưởng</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Tên người thụ hưởng</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Tài khoản trích nợ</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Nộp cho KBNN</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Ngày nộp thuế điện tử</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Tổng số khoản</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Tổng số tiền nộp NSNN</strong></td>
			<td style="height:23px; width:47px; ext-align: center;"><strong class="tb_strong">Trạng thái</strong></td>
			</tr>
			<tr>
