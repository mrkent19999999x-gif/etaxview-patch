	...
	<div class="footer_div">
		<table width="100%">
			<tr>
				<td></td>
				<td></td>
				<td align="center"><i>Ngày <xsl:value-of select="ihtkk:stringDatetime($kskthue/ngayKy,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($kskthue/ngayKy,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($kskthue/ngayKy,'yyyy')"/></i></td>
			</tr>
			<tr>
				<td width="30%">
				<br/>
...
<!--start Footer tờ khai NTNN - TT80-->		
   ...
   <xsl:template name="tkhaiFooter_Pluc02-TBVMT-TT80">
	...
	<xsl:template name="tkhaiFooter_05DK_TH_CBT">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<xsl:variable name="tkchinh" select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh"/>
	...
	<!--start Footer tkhaiFooter_TB_Chuyen_LN_ra_NN-->	
	 <!--start Footer  to khai thong bao chuyen loi nhuan ra nuoc ngoai -->	
	<xsl:template name="tkhaiFooter_TB_Chuyen_LN_ra_NN">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<xsl:variable name="tkchinh" select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh"/>

	<br/><span>Tôi cam đoan những nội dung kê khai trên là đúng và xin chịu hoàn toàn trách nhiệm trước pháp luật về những thông tin đã thông báo.</span>
	<div class="footer_div">
		<table>
			<tr>
				<td width="35%" class="align-c">
					<br/>
					<b>NHÀ ĐẦU TƯ NƯỚC NGOÀI</b>
				</td>
				<td colspan="1" width="30%">
				</td>
				<td width="35%" class="align-c">
			...
			<tr>
				...
				<td width="35%" class="align-c">
					Ký tên, đóng dấu (ghi rõ chức vụ)<br/> <br/>
					(Trường hợp ủy viên cho Doanh nghiệp thì không cần ký)
				</td>
				<td colspan="1" width="20%">
					<xsl:value-of select="$kskthue/DLyThue/NVienDLy/tenNVienDLyThue"/>
					 <br/> <br/>
				...
				<xsl:if test="$kskthue/TKhaiThue/ngayKy ">
					<td width="35%" class="align-c">
					<b>ĐẠI DIỆN HỢP PHÁP CỦA DOANH NGHIỆP</b>
					<br/>
					<i>Ký tên, đóng dấu (ghi rõ chức vụ)</i>
					</td>
				</xsl:if>
				<xsl:if test="not($kskthue/TKhaiThue/ngayKy)">
					<td width="35%" style="text-align:center">
