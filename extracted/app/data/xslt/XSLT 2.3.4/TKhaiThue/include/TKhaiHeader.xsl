...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/1999/XSL/Transform" xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" exclude-result-prefixes="xsl xsi ihtkk">
	...
	<xsl:template name="BieuNguDatNuoc">
		...
		<xsl:template name="BieuNguDatNuoc05TNDN">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
	...
	<!-- start tkhai header -->
		<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư  năm-->
		<xsl:template name="BieuNguDatNuoc_BCTC133_B01a">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
	...
	<!-- hết header 02TNDN-->
		...
		<!-- start header 05TNDN-->
	<xsl:template name="tkhaiHeader-05TNDN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc05TNDN">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
				...
				<table>
				<tr>
                    <td class="align-c"><b>CỘNG HOÀ XÃ HỘI CHỦ NGHĨA VIỆT NAM</b></td>	
                </tr>
                <tr>
                    <td class="align-c"><b><u>Độc lập - Tự do - Hạnh phúc</u></b></td>	
                </tr>
                <tr>
                    <td class="align-c"><b><u></u></b></td>	
                </tr>
                <tr>
                    <td class="align-c"><br/><b>TỜ KHAI THUẾ THU NHẬP DOANH NGHIỆP</b></td>	
                </tr>
                <tr>
                    <td class="align-c"><b>ĐỐI VỚI THU NHẬP TỪ CHUYỂN NHƯỢNG VỐN</b></td>	
                </tr>
                <tr>
                    <td class="align-c"><i>(của tổ chức nước ngoài kinh doanh tại Việt Nam hoặc có thu nhập tại Việt Nam </i></td>	
                </tr>
                <tr>
                    <td class="align-c"><i>không hoạt động theo Luật Đầu tư, Luật Doanh nghiệp)</i></td>	
                </tr>
                <tr>
					<td class="align-c">
						<b>[01]</b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							<tr>
								<td colspan="3"><b>Bên chuyển nhượng vốn:</b></td>
							<tr/>
							</tr>
							<tr>
								<td colspan="3">[04] Tên tổ chức có vốn chuyển nhượng: <xsl:value-of select="$tkchinh/BenCNVon/ct04"/></td>
							</tr>
							<tr>
								<td colspan="3">[05] Địa chỉ trụ sở chính: <xsl:value-of select="$tkchinh/BenCNVon/ct05"/></td>
							</tr>
							<tr>
								<td colspan="3"><b>Bên nhận chuyển nhượng vốn:</b></td>
							<tr/>
							</tr>
							<tr>
								<td colspan="3">[06] Tên tổ chức hoặc cá nhân nhận vốn chuyển nhượng: <xsl:value-of select="$tkchinh/BenNhanCNVon/ct06"/></td>
							</tr>
							<tr>
								<td colspan="3">[07] Quốc tịch: <xsl:value-of select="$tkchinh/BenNhanCNVon/ct07"/></td>
							</tr>
							<tr>
								<td colspan="3">[08] Địa chỉ trụ sở chính: <xsl:value-of select="$tkchinh/BenNhanCNVon/ct08"/></td>
							</tr>
                            <tr>
								<td colspan="3">[09] Mã số thuế (đối với doanh nghiệp) hoặc số chứng minh nhân dân, số hộ chiếu  (đối với cá nhân): <xsl:value-of select="$tkchinh/BenNhanCNVon/ct09"/></td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
								...
								<tr>
									<td colspan="3">[11] Mã số thuế: <xsl:value-of select="$ttkthue/DLyThue/mstDLyThue"/></td>
								</tr>
								<tr colspan="3">
									<td>[12] Địa chỉ: <xsl:value-of select="$ttkthue/DLyThue/dchiDLyThue"/></td>
								</tr>
								<tr>
									<td>[13] Quận/Huyện: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/></td>
									<td colspan="2">[14] Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/></td>
								</tr>
								<tr>
									<td>[15] Điện thoại: <xsl:value-of select="$ttkthue/DLyThue/dthoaiDLyThue"/></td>
									<td>[16] Fax: <xsl:value-of select="$ttkthue/DLyThue/faxDLyThue"/></td>
									<td>[17] E-mail: <xsl:value-of select="$ttkthue/DLyThue/emailDLyThue"/></td>
								</tr>
								<tr>
									<td>[18] Hợp đồng đại lý thuế: Số  <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/></td>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								...
								<tr>
									<td>[13] Quận/Huyện: </td>
									<td colspan="2">[14] Tỉnh/Thành phố: </td>
								</tr>
								<tr>
									<td>[15] Điện thoại: </td>
									<td>[16] Fax:</td>
								...
								<tr>
									<td>[18] Hợp đồng đại lý thuế: Số  </td>
									<td colspan="2"> Ngày:</td>
								</tr>
							</xsl:if>
                            <tr>
								<td colspan="3"><b>[19] Tên doanh nghiệp có vốn được chuyển nhượng: </b> <xsl:value-of select="$tkchinh/DNCoVonDuocCN/ct19"/></td>
							<tr/>
							</tr>
							<tr>
								<td colspan="3">[20] Mã số thuế: <xsl:value-of select="$tkchinh/DNCoVonDuocCN/ct20"/></td>
							</tr>
							<tr>
									<td>[21] Hợp đồng chuyển nhượng: số  <xsl:value-of select="$tkchinh/DNCoVonDuocCN/ct21_so"/>
									</td>
									<td colspan="2"> Ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/DNCoVonDuocCN/ct21_ngay,'dd/mm/yyyy')"/>
									</td>
						    </tr>
						</table>
					</td>
...
<!-- Start Header BCTC_TT49 Năm-->
	<xsl:template name="tkhaiHeader-BCTC133_B01a">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC133_B01a">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
...
-->
	...
	<xsl:template name="tkhaiHeader-plucBCTC133">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c" colspan="3">
						<b><xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/></b>
					</td>
				</tr>
				<tr>
					<td class="align-l">
	...
	<xsl:template name="tkhaiHeader-BienLaiTT303">
		<div class="header_div">

		<div align="center"><b><xsl:value-of select="$ttkthue/TKhaiThue/tenTKhai"/></b></div>
		<br></br>
		<br></br>
		<div align="left"><b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;1.	Tên cơ quan thu phí, lệ phí: </b><xsl:value-of select="$ttkthue/TKhaiThue/tenCQTNoiNop"/></div>
		<div align="left"><b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;2.	Mã số thuế (nếu có): </b><xsl:value-of select="$ttkthue/NNT/mst"/></div>
			<div align="left"><b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;3.	Các loại biên lai chưa sử dụng:</b></div>
	
	</div>			
		</xsl:template>	 
		
					
<xsl:template name="tkhaiHeader-BienLaiTT303_1">
		<div class="header_div">
		<div align="center"><b>THÔNG BÁO</b></div>
		<div align="center"><b><xsl:value-of select="$ttkthue/TKhaiThue/tenTKhai"/></b></div>
		<br></br>
		<br></br>
		<div align="left"><b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;1.	Tên cơ quan phát hành biên lai: </b><xsl:value-of select="$ttkthue/NNT/tenNNT"/></div>
		<div align="left"><b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;2.	Mã số thuế (nếu có): </b><xsl:value-of select="$ttkthue/NNT/mst"/></div>
		<div align="left"> <b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;3.	Địa chỉ trụ sở chính:  </b><xsl:value-of select="$ttkthue/NNT/dchiNNT"/></div>
		
		</div>
	</xsl:template>	          
	
	<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 334  năm-->
		<xsl:template name="BieuNguDatNuoc_BCTC334_Nam">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b> BÁO CÁO TÌNH HÌNH TÀI CHÍNH RIÊNG (NĂM)</b></td>
		</tr>
	...
	<!-- Start Header BCTC_TT334 Năm-->
	<xsl:template name="tkhaiHeader-BCTC334_Nam">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>

		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC334_Nam">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
				</xsl:call-template>
		<tr>
							...
							<tr>
								...
								<td>
									...
									<xsl:value-of select="$ttkthue/NNT/emailNNT"/>
												...
												<br></br>
          <div> <b>BCTC đã được kiểm toán: </b> [<xsl:if test="$tkchinh/bctcDaKiemToan = 'true' or $tkchinh/bctcDaKiemToan = '1'" >x</xsl:if>]        </div>	

			<div><b>Ý kiến kiểm toán: </b> <xsl:value-of select="$tkchinh/tenYKienKiemToan"/></div>	
...
<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 334 giữa niên độ-->
		<xsl:template name="BieuNguDatNuoc_BCTC334_GiuaNienDo">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b>BÁO CÁO TÌNH HÌNH TÀI CHÍNH GIỮA NIÊN ĐỘ</b></td>
		</tr>
	...
	<!-- Start Header BCTC_TT334 Giữa niên độ-->
	<xsl:template name="tkhaiHeader-BCTC334_GiuaNienDo">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC334_GiuaNienDo">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
...
<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 334 hợp nhất-->
		<xsl:template name="BieuNguDatNuoc_BCTC334_HopNhat">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b>BÁO CÁO TÌNH HÌNH TÀI CHÍNH HỢP NHẤT</b></td>
		</tr>
	...
	<!-- Start Header BCTC_TT334 Hợp nhát-->
	<xsl:template name="tkhaiHeader-BCTC334_HopNhat">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC334_HopNhat">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
	...
	<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 200 năm-->
		...
		<tr>
			<td class="align-c"><b> BẢNG CÂN ĐỐI KẾ TOÁN (NĂM)</b></td>
		</tr>
		<!--
...
<tr>
  ...
  <tr>
	...
	<xsl:template name="tkhaiHeader-plucBCTC200">
		...
		<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 107 năm-->
		<xsl:template name="BieuNguDatNuoc_BCTC107">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b> BẢNG CÂN ĐỐI KẾ TOÁN</b></td>
		</tr>
		<!--
		...
		<!-- Start tkhai header BCTC_TT107-->
	<xsl:template name="tkhaiHeader-BCTC107">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
        ...
        <tr>
            <td class="tentkhai"> BẢNG CÂN ĐỐI KẾ TOÁN </td>
        </tr>
...
<tr>
	...
	<!-- start header Phuluc BCTC 107-->
	<xsl:template name="tkhaiHeader-plucBCTC107">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<xsl:template name="tkhaiHeader-plucBCTC334">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
