 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'Ban hành theo Thông tư số 334/2016/TT-BTC ngày 27/12/2016 của Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader-BCTC334_Nam">
...
<!-- Tai san -->
       ...
       <tr>  
           ...
           <tr>  
            ...
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoDauNam/ct240)"/></b></td>
                   ...
                   <tr>  
               <td><b>V. Tài sản dài hạn khác (250=251+…+255)</b></td>
   ...
   <tr>  
		...
		<tr>  
                  <td>II. Nợ phải trả dài hạn</td>
            <td class="align-c">340</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ThuyetMinh/ct340"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoCuoiNam/ct340)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoDauNam/ct340)"/></td>
        </tr>            
            <tr>
        ...
        <tr>
				<td colspan="5"><b>CÁC CHỈ TIÊU NGOÀI BÁO CÁO TÌNH HÌNH TÀI CHÍNH RIÊNG</b></td>
		</tr>
 ...
 <tr> 
        ...
        <tr>
            ...
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct021"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct021)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct021)"/></td>
        </tr>    
           <tr>  
                          <td>a. Tài sản tài chính giao dịch tự do chuyển nhượng</td>
            <td class="align-c">021.1</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct021_1"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct021_1)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct021_1)"/></td>
        </tr>      
   <tr>
                  <td>b. Tài sản tài chính hạn chế chuyển nhượng</td>
            <td class="align-c">021.2</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct021_2"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct021_2)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct021_2)"/></td>
        </tr>      
   <tr>
                  <td>c. Tài sản tài chính giao dịch cầm cố</td>
            <td class="align-c">021.3</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct021_3"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct021_3)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct021_3)"/></td>
        </tr>      

            <tr>         <td>d. Tài sản tài chính phong tỏa, tạm giữ</td>
            <td class="align-c">021.4</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct021_4"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct021_4)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct021_4)"/></td>
        </tr>      
        <tr>
                  <td>e. Tài sản tài chính chờ thanh toán</td>
            <td class="align-c">021.5</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct021_5"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct021_5)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct021_5)"/></td>
        </tr>   
           <tr>
                  <td>f. Tài sản tài chính chờ cho vay</td>
            <td class="align-c">021.6</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct021_6"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct021_6)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct021_6)"/></td>
        </tr>   
           <tr>
                  <td>2. Tài sản tài chính đã lưu ký tại VSD và chưa giao dịch của Nhà đầu tư (022=022.1+…+022.4)</td>
            <td class="align-c">022</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct022"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct022)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct022)"/></td>
        </tr>   
           <tr>

                  <td>a. Tài sản tài chính đã lưu ký tại VSD và chưa giao dịch, tự do chuyển nhượng</td>
            <td class="align-c">022.1</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct022_1"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct022_1)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct022_1)"/></td>
        </tr>   
   <tr>
                  <td>b. Tài sản tài chính đã lưu ký tại VSD và chưa giao dịch, hạn chế chuyển nhượng</td>
            <td class="align-c">022.2</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct022_2"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct022_2)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct022_2)"/></td>
        </tr>   
           <tr>
                  <td>c. Tài sản tài chính đã lưu ký tại VSD và chưa giao dịch, cầm cố</td>
            <td class="align-c">022.3</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct022_3"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct022_3)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct022_3)"/></td>
        </tr>   
        <tr>   
                  <td>d. Tài sản tài chính đã lưu ký tại VSD và chưa giao dịch, phong tỏa, tạm giữ</td>
            <td class="align-c">022.4</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct022_4"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct022_4)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct022_4)"/></td>
        </tr>   
          <tr> 
                  <td>3. Tài sản tài chính chờ về của Nhà đầu tư</td>
            <td class="align-c">023</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct023"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct023)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct023)"/></td>
        </tr>  
           <tr>
                    <td>4. Tài sản tài chính sửa lỗi giao dịch của Nhà đầu tư</td>
            <td class="align-c">024a</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct024a"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct024a)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct024a)"/></td>
        </tr>
           <tr>
                          <td>5. Tài sản tài chính chưa lưu ký tại VSD của Nhà đầu tư</td>
            <td class="align-c">024b</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct024b"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct024b)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct024b)"/></td>
        </tr>
           <tr>
                          <td>6. Tài sản tài chính được hưởng quyền của Nhà đầu tư</td>
            <td class="align-c">025</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct025"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct025)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct025)"/></td>
        </tr> <tr> 
                          <td>7. Tiền gửi của khách hàng</td>
            <td class="align-c">026</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct026"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct026)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct026)"/></td>
        </tr>
           <tr>
                          <td>7.1. Tiền gửi của Nhà đầu tư về giao dịch chứng khoán theo phương thức CTCK quản lý</td>
            <td class="align-c">027</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct027"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct027)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct027)"/></td>
        </tr>
           <tr>
                          <td>7.2. Tiền gửi tổng hợp giao dịch chứng khoán cho khách hàng</td>
            <td class="align-c">028</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct028"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct028)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct028)"/></td>
        </tr>
           <tr>
                          <td>7.3. Tiền gửi bù trừ và thanh toán giao dịch chứng khoán</td>
            <td class="align-c">029</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct029"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct029)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct029)"/></td>
        </tr>
      
                <tr>
                          <td>a. Tiền gửi bù trừ và thanh toán giao dịch chứng khoán Nhà đầu tư trong nước</td>
            <td class="align-c">029.1</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct029_1"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct029_1)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct029_1)"/></td>
        </tr>
      
                 <tr>
                          <td>b. Tiền gửi bù trừ và thanh toán giao dịch chứng khoán Nhà đầu tư nước ngoài</td>
            <td class="align-c">029.2</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct029_2"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct029_2)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct029_2)"/></td>
        </tr>
           ...
           <tr>
            ...
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct031_1"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct031_1)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct031_1)"/></td>
        </tr>
            ...
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct031_2"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct031_2)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct031_2)"/></td>
        </tr>
           ...
           <tr>
            ...
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct033"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct033)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct033)"/></td>
        </tr>
      
                 <tr>
                          <td>11. Phải trả của khách hàng về lỗi giao dịch các tài sản tài chính</td>
            <td class="align-c">034</td>
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct034"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct034)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct034)"/></td>
        </tr>
           ...
           <tr>
            ...
            <td class="align-l"><xsl:value-of select="$tkchinh/ChiTieuNgoaiBang/ThuyetMinh/ct035"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoCuoiNam/ct035)"/></td>
            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ChiTieuNgoaiBang/SoDauNam/ct035)"/></td>
        </tr>
