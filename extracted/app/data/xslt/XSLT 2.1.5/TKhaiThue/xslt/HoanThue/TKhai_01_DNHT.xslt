...
6/11/2013 của Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader_01DNHT">
            ...
            <div class="content">
				...
				<xsl:for-each select="$tkchinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT">
							...
							<tr>
								...
								<td class="align-l"><xsl:value-of select="ct3_KyKeKhai"/></td>
			 ...
			 <table class="tkhai_table">
                        <tr>
							...
							<td class="align-c" rowspan="2"><b>Khoản phải nộp NSNN (loại thuế, khoản phạt)</b></td>
							<td class="align-c" colspan="3"><b>Cơ quan thu</b></td>
							<td class="align-c" rowspan="2"><b>Thời gian phát sinh khoản phải nộp (Kỳ tính thuế)</b></td>
	...
	<div>Tổng số tiền nộp NSNN ghi bằng chữ: <b><i><xsl:value-of select="ihtkk:DocTienBangChu($tkchinh/NoiDungDNHT/HThucDNHT/BuTruChoKhoanPNop/tongCot11)"/></i></b></div> <br/>
                <tr>
					<td><b><i>2.2. Hoàn trả trực tiếp: </i></b> </td> 
				</tr> <br/>
				<tr>Số tiền hoàn trả: Bằng số: <td><b><i><xsl:value-of select="ihtkk:formatNumber($hoantratructiep/soTienHoanTra)"/></i></b></td>          Bằng chữ: <b><i><xsl:value-of select="ihtkk:DocTienBangChu($hoantratructiep/soTienHoanTra)"/></i></b></tr> <br/>
				<tr>Hình thức hoàn trả: </tr> <br/>
				<tr><td>[<xsl:if test="$hoantratructiep/HinhThucHoanTra/chuyenKhoan='true'">x</xsl:if>] Chuyển khoản:  </td>  Tài khoản số: <td><xsl:value-of select="$hoantratructiep/HinhThucHoanTra/taiKhoanSo"/> Tại Ngân hàng (KBNN): <xsl:value-of select="$hoantratructiep/HinhThucHoanTra/taiNganHang"/></td> </tr>  <br/>           
			     <tr>  <td> [<xsl:if test="$hoantratructiep/HinhThucHoanTra/tienMat='true'">x</xsl:if>] Tiền mặt: Nơi nhận tiền hoàn thuế: Kho bạc Nhà nước: <xsl:value-of select="$hoantratructiep/HinhThucHoanTra/noiNhanTien"/></td>  </tr>
			     <tr>
			  <td></td> </tr>
