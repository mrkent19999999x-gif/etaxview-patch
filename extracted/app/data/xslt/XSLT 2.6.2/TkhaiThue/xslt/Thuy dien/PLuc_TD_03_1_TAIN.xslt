			...
			<div class="content">
				...
				<table class="tkhai_table">
                        <tr>
							...
							<td class="align-c"><b>Số kê khai trong năm</b></td>
							<td class="align-c"><b>Chênh lệch giữa số kê khai trong năm và số phải nộp quyết toán</b></td>
						</tr>
						<tr>
                        ...
                        <xsl:for-each select="$pl03_1TD/BKePBoThueTNChoDPhuong/CTietBKePBoThueTNChoDPhuong">
							...
							<tr>
								...
								<td class="align-r"><xsl:value-of select="ihtkk:formatNumber(soDaKeKhai_NhaMay)"/></td>
								<td class="align-r"><xsl:value-of select="ihtkk:formatNumber(chenhLech_NhaMay)"/></td>
							</tr>
								<xsl:for-each select="CQTDiaPhuong/ChiTietCQTDiaPhuong">
							         <tr>
										 ...
										 <td class="align-r"><xsl:value-of select="ihtkk:formatNumber(soDaKeKhai)"/></td>
						...
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl03_1TD/tongCong_SoKK)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl03_1TD/tongCong_ChenhLech)"/></b></td>
						</tr>
			      </table>
			</div>
			</div>
