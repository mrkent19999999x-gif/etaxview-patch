...
<!--start phu luc PL03_3A_TNDN-->
       ...
       <xsl:with-param name="tenPL1"   select="'Đối với cơ sở kinh doanh thành lập mới  từ dự án đầu tư và 
		             ...
		             <div class="content">	
		             	<table>
		             	  <xsl:for-each select="$pl03-3a_tndn/NoiDungPL03_3A">
					        ...
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai2 = 'true' "> x </xsl:if>] Doanh nghiệp di chuyển địa điểm ra khỏi đô thị theo quy hoạch đã được cơ quan có thẩm quyền phê duyệt.<br/></td>
			                </tr>
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai3 = 'true' "> x </xsl:if>]Doanh nghiệp mới thành lập từ dự án đầu tư vào ngành nghề, lĩnh vực ưu đãi đầu tư.  <br/></td>
			                </tr>
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai4 = 'true' "> x </xsl:if>] Doanh nghiệp mới thành lập từ dự án đầu tư vào ngành nghề, lĩnh vực đặc biệt ưu đãi đầu tư. <br/></td>
			                </tr>
			               <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai5 = 'true' "> x </xsl:if>] Doanh nghiệp mới thành lập từ dự án đầu tư vào nghành nghề, lĩnh vực ưu đãi đầu tư theo quy định tại Nghị định số 124/2008/NĐ-CP. <br/></td>
			                </tr>
			                
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai6 = 'true' "> x </xsl:if>]Doanh nghiệp mới thành lập từ dự án đầu tư vào địa bàn thuộc Danh mục địa bàn có điều kiện kinh tế - xã hội khó khăn. <br/></td>
			                </tr>
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai7 = 'true' "> x </xsl:if>]Doanh nghiệp mới thành lập từ dự án đầu tư vào địa bàn thuộc Danh mục địa bàn có điều kiện kinh tế - xã hội đặc biệt khó khăn, khu kinh tế, khu công nghệ cao. <br/></td>
			                </tr>
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai8 = 'true' "> x </xsl:if>] Doanh nghiệp thành lập mới trong lĩnh vực xã hội hoá hoặc có thu nhập từ hoạt động xã hội hoá. <br/></td>
			                </tr>
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai9 = 'true' "> x </xsl:if>] Hợp tác xã dịch vụ nông nghiệp; Quỹ tín dụng nhân dân<br/></td>
			                </tr>
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai10 = 'true' "> x </xsl:if>] Ưu đãi theo Giấy phép đầu tư, Giấy chứng nhận ưu đãi đầu tư. <br/></td>
			                </tr>
					        <tr>
             				  <td class="align-l">[<xsl:if test="dieuKienUuDai11 = 'true' "> x </xsl:if>] Ưu đãi khác <br/></td>
			                </tr>
			                <tr>
						    ...
						    <tr>
						      <td class="align-l">2.2- Thời hạn áp dụng thuế suất ưu đãi <span class="number"><xsl:value-of select="thoiHanUuDai"/></span> năm, kể từ năm <xsl:value-of select="namBatDauUuDai"/></td>
						    </tr>
						    <tr>
					    ...
					    <table class="tkhai_table">
						   ...
						   <tr>
							   ...
							   <td class="align-l">Thuế TNDN tính theo thuế suất phổ thông (25%)</td>
							   <td class="align-c">[3]</td>
						   ...
						   <tr>
							   ...
							   <td class="align-l"><b>Thuế TNDN được miễn, giảm </b></td>
