...
<!--start phu luc PL03_2A_TNDN-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL03_2A_TNDN">	
			<xsl:variable name="pl03-2_tndn" select='HSoThueDTu/HSoKhaiThue/PLuc/PL03_2A_TNDN' />
			<xsl:call-template name="tkhaiHeader-pluc">
		<xsl:with-param name="mauTKhai"   select="'03-2A/TNDN'"/>
