...
<xsl:with-param name="tenPL1"   select="'Đối với doanh nghiệp sử dụng lao động là người dân tộc thiểu số hoặc doanh nghiệp hoạt động sản xuất, xây dựng, vận tải sử dụng nhiều lao động nữ theo quy định tại Điều 17 Nghị định số 124/2008/NĐ-CP của Chính Phủ'"/>
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo tờ khai quyết toán thuế thu nhập doanh nghiệp số 03/TNDN)'"/>
	  </xsl:call-template>				
					<div class="ndungtkhai_div">	
		             <div class="content">	
		             	<table>
		             	  <xsl:for-each select="$pl03-3c_tndn/NoiDungPL3_03C">
        			        ...
        			        <tr>
             				  <td class="align-l"> [<xsl:if test="mucDoUuDai1 = 'true' "> x </xsl:if>] Giảm thuế thu nhập doanh nghiệp tương ứng mức chi cho lao động nữ. </td>
			                </tr>
			                 <tr>
						   ...
						   <tr>
							   ...
							   <td class="align-l"><b>Xác định số thuế TNDN được giảm trong kỳ tính thuế:</b></td>
							   <td></td>
							   <td></td>							   
						   </tr>
						   <tr>
