...
<!--start phu luc PL03_5_TNDN-->
		...
		<xsl:with-param name="tenPL"   select="'THUẾ TNDN ĐỐI VỚI HOẠT ĐỘNG CHUYỂN NHƯỢNG BẤT ĐỘNG SẢN'"/>
						...
						<div class="content">	
							...
							<table class="tkhai_table">
								 ...
								 <tr>
								   ...
								   <td class="align-l">Thuế suất thuế TNDN (25%)</td>
								   <td class="align-c">[14]</td>
								   <td class="number align-r"><xsl:value-of select="$pl03-5_tndn/ct14"/></td>
								 </tr>  
								 <tr>
								   <td class="align-c">9</td>
								   <td class="align-l">Thuế TNDN phải nộp ([15]=[13] x [14])</td>
								   <td class="align-c">[15]</td>
								   <td class="number align-r"><xsl:value-of select="$pl03-5_tndn/ct15"/></td>
								 </tr>  
								 <tr>
								   <td class="align-c">10</td>
								   <td class="align-l">Thuế TNDN đã nộp ở địa phương khác</td>
								   <td class="align-c">[16]</td>
								   <td class="number align-r"><xsl:value-of select="$pl03-5_tndn/ct16"/></td>
								 </tr>  
								 <tr>
								   <td class="align-c">11</td>
								   <td class="align-l">Thuế TNDN đã tạm nộp kê khai theo tiến độ</td>
								   <td class="align-c">[17]</td>
								   <td class="number align-r"><xsl:value-of select="$pl03-5_tndn/ct17"/></td>
								 </tr>  
								 <tr>
								   <td class="align-c">12</td>
								   <td class="align-l">Thuế TNDN còn phải nộp 
([18] = [15] - [16] - [17])</td>
								   <td class="align-c">[18]</td>
								   <td class="number align-r"><xsl:value-of select="$pl03-5_tndn/ct18"/></td>
								 </tr>  
							   </table>
					</div>
				</div>
