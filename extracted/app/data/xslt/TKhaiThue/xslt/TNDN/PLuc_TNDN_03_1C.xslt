			...
			<div class="content">
							...
							<table class="tkhai_table">
								 ...
								 <tr>
								   ...
								   <td class="number align-r"><b><xsl:value-of select="$pl03-1c_tndn/ct11"/></b></td>
								 </tr>  
								 <tr>
								   <td class="align-c">a</td>
								 ...
								 <tr>
								   ...
								   <td class="align-r"><b><xsl:value-of select="$pl03-1c_tndn/ct26"/></b></td>
								 </tr>  
								 <tr>
								 ...
								 <tr>
								   ...
								   <td class="align-l"><b class="number">Tổng lợi nhuận kế toán trước thuế thu nhập doanh nghiệp ([28] = [24] + [27])</b></td>
...
<td>						
			<xsl:call-template name="tkhaiFooter"/>	
				<div><b><u>Ghi chú:</u></b>  Số liệu tại chỉ tiêu  [28] của Phụ lục này được ghi vào chỉ tiêu A1 của Tờ khai quyết toán thuế TNDN của cùng kỳ tính thuế.  </div>
<div id="sigDiv"></div>
</td>
</tr>
</table>				
