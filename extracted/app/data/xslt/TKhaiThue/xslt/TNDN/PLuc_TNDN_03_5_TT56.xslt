						...
						<div class="content">	
							...
							<table class="tkhai_table">
								 ...
								 <tr>
								   ...
								   <td class="align-l">Thuế TNDN phải nộp của bất động sản bàn giao trong năm ([15]=[13] x [14])</td>
								   <td class="align-c">[15]</td>
								   <td class="number align-r"><xsl:value-of select="$pl03-5_tndn/ct15"/></td>
								 </tr>  
								 <tr>
								   <td class="align-c">10</td>
								   <td class="align-l">Thuế TNDN đã kê khai theo tiến độ thu tiền của khách hàng</td>
								   <td class="align-c">[16]</td>
								   <td class="number align-r"><xsl:value-of select="$pl03-5_tndn/ct16"/></td>
								 </tr>  
								 <tr>
								   <td class="align-c">11</td>
								   <td class="align-l">Thuế TNDN phải nộp bổ sung khi bàn giao bất động sản ([17]=[15] - [16])</td>
