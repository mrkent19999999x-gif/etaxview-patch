...
<xsl:with-param name="tenPL1"   select="'Đối với cơ sở kinh doanh đầu tư xây dựng dây chuyền sản xuất mới, mở rộng quy mô, đổi mới công nghệ, cải thiện môi trường sinh thái, nâng cao năng lực sản xuất theo quy định tại Điều 38 Nghị định số 164/2003/NĐ-CP hoặc Điều 36 Nghị định số 24/2007/NĐ-CP của Chính phủ'"/>
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo tờ khai quyết toán thuế thu nhập doanh nghiệp số 03/TNDN)'"/>
	  </xsl:call-template>				
					<div class="ndungtkhai_div">	
		             <div class="content">	
		             	<table>
		             	  <xsl:for-each select="$pl03-3b_tndn/NoiDungPL3_03B">
					        ...
					        <tr>
             				  <td class="align-l"> [<xsl:if test="dieuKienUuDaiNN2 = 'true' "> x </xsl:if>] Đầu tư vào ngành nghề, lĩnh vực thuộc Danh mục lĩnh vực ưu đãi đầu tư do Chính phủ ban hành theo qui định của Luật đầu tư.</td>
			                </tr>
					        <tr>
             				  <td class="align-l"> [<xsl:if test="dieuKienUuDaiNN3 = 'true' "> x </xsl:if>] Đầu tư vào ngành nghề, lĩnh vực thuộc Danh mục lĩnh vực đặc biệt ưu đãi đầu tư do Chính phủ ban hành theo qui định của Luật đầu tư. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"> [<xsl:if test="dieuKienUuDaiNN4 = 'true' "> x </xsl:if>] Đầu tư vào địa bàn thuộc Danh mục địa bàn có điều kiện kinh tế - xã hội khó khăn do Chính phủ ban hành theo qui định của Luật đầu tư. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"> [<xsl:if test="dieuKienUuDaiNN5 = 'true' "> x </xsl:if>] Đầu tư vào địa bàn thuộc Danh mục địa bàn có điều kiện kinh tế - xã hội đặc biệt khó khăn do Chính phủ ban hành theo qui định của Luật đầu tư.   </td>
			                </tr>
    						<tr>
						   ...
						   <tr>
							   ...
							   <td class="align-l">Thu nhập tăng thêm do đầu tư mang lại được miễn hoặc giảm</td>
