							...
							<table class="tkhai_table">
							    <tr>
								 ...
								 <tr>
								   ...
								   <td class="align-r"><b class="number"><xsl:value-of select="$pl03-1b_tndn/ct06"/></b></td>
								 </tr>  
								 <tr>
								 ...
								 <tr>
								   ...
								   <td class="align-r"><b class="number"><xsl:value-of select="$pl03-1b_tndn/ct08"/></b></td>
								 </tr>  
								 <tr>
								   <td class="align-c"><b>9</b></td>
								   <td class="align-l"><b>Lãi / lỗ thuần từ mua bán chứng khoán đầu tư </b></td>
								   <td class="align-c"><b>[09]</b></td>
								   <td class="align-r"><b class="number"><xsl:value-of select="$pl03-1b_tndn/ct09"/></b></td>
								 </tr>  
								 <tr>
								 ...
								 <tr>
								   ...
								   <td class="align-c"><b>[12]</b></td>
								   <td class="align-r"><b class="number"><xsl:value-of select="$pl03-1b_tndn/ct12"/></b></td>
								 </tr>  
								 <tr>
								   <td class="align-c"><b>13</b></td>
								   <td class="align-l"><b>Thu nhập từ góp vốn, mua cổ phần</b></td>
								   <td class="align-c"><b>[13]</b></td>
								   <td class="align-r"><b class="number"><xsl:value-of select="$pl03-1b_tndn/ct13"/></b></td>
								 </tr>  
								 <tr>
								 ...
								 <tr>
								   ...
								   <td class="align-c"><b>[15]</b></td>
								   <td class="align-r"><b class="number"><xsl:value-of select="$pl03-1b_tndn/ct15"/></b></td>
								 </tr>  
								 <tr>
								   <td class="align-c"><b>16</b></td>
								   <td class="align-l"><b>Tổng lợi nhuận trước thuế ([16] = [3]+[6]+[7]+[8]+[9]+[12]+[13]-[14]-[15])</b></td>
								   <td class="align-c"><b>[16]</b></td>
								   <td class="align-r"><b class="number"><xsl:value-of select="$pl03-1b_tndn/ct16"/></b></td>
								 </tr>  
							   </table>
                        </div>
					</div>
