 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="''"/>
	 <xsl:call-template name="tkhaiHeader-03TNDN">
		   ...
		   <div class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table">
						 ...
						 <tr >
						   ...
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctB1)"/></td>
						 </tr>  
						 <tr>
						 ...
						 <tr>
						   <td class="align-c">2</td>
						   <td class="align-l">Điều chỉnh giảm tổng lợi nhuận trước thuế thu nhập doanh nghiệp (B7=B8+B9+B10+B11)  </td>
						   <td class="align-c">B7</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctB7)"/></td>
						 </tr>  
						 <tr>
						   <td class="align-c">2.1</td>
						   <td class="align-l">Lợi nhuận từ hoạt động không thuộc diện chịu thuế thu nhập doanh nghiệp</td>
						   <td class="align-c">B8</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctB8)"/></td>
						 </tr>  
						 <tr>
						 ...
						 <tr>
						   <td class="align-c">3</td>
						   <td class="align-l">Tổng thu nhập chịu thuế (B12=A1+B1-B7)</td>
						   <td class="align-c">B12</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctB12)"/></td>
						 </tr>  
						 <tr>
						   <td class="align-c">3.1</td>
						   <td class="align-l">Thu nhập chịu thuế từ hoạt động sản xuất kinh doanh
(B13=B12-B14)</td>
						   <td class="align-c">B13</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctB13)"/></td>
						 </tr>  
						 <tr>
						   <td class="align-c">3.2</td>
						   <td class="align-l">Thu nhập chịu thuế từ hoạt động chuyển nhượng bất động sản</td>
						   <td class="align-c">B14</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctB14)"/></td>
						 </tr>  
						 <tr>
						   <td class="align-c"><b>C</b></td>
						   <td class="align-l"><b>Xác định thuế TNDN phải nộp từ hoạt động sản xuất kinh doanh</b></td>
						   <td></td>
						   <td></td>
						 </tr>  
						 <tr>
						 ...
						 <tr>
						   <td class="align-c">3</td>
						   <td class="align-l">Lỗ từ các năm trước được chuyển sang </td>
						   <td class="align-c">C3</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctC3)"/></td>
						 </tr>  
						 <tr>
						   <td class="align-c">4</td>
						   <td class="align-l">Thu nhập tính thuế (C4=C1-C2-C3)</td>
						 ...
						 <tr >
						   ...
						   <td class="align-l">Thu nhập tính thuế sau khi đã trích lập quỹ khoa học công nghệ
(C6=C4-C5)</td>
						   ...
						   <td class="align-l">Thuế TNDN từ hoạt động SXKD tính theo thuế suất phổ thông 
(C7=C6 x 25%)</td>
						   <td class="align-c">C7</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctC7)"/></td>
						 </tr> 
						 <tr >
						   <td class="align-c">8</td>
						   <td class="align-l">Thuế TNDN chênh lệch do áp dụng mức thuế suất khác mức thuế suất 25% </td>
						   <td class="align-c">C8</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctC8)"/></td>
						 </tr> 
						 <tr >
						 ...
						 <tr >
						   ...
						   <td class="align-l">Thuế thu nhập doanh nghiệp của hoạt động sản xuất kinh doanh
(C11=C7-C8-C9-C10)</td>
						   <td class="align-c">C11</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctC11)"/></td>
						 </tr> 
						 <tr>
						   <td class="align-c"><b>D</b></td>
						   <td class="align-l"><b>Thuế TNDN từ hoạt động chuyển nhượng bất động sản còn phải nộp sau khi trừ thuế TNDN đã nộp ở địa phương khác</b></td>
						   <td></td>
						   <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/ctD)"/></b></td>
						 </tr>  
						 <tr>
						 ...
						 <tr>
						   <td class="align-c">1</td>
						   <td class="align-l">Thuế thu nhập doanh nghiệp của hoạt động sản xuất kinh doanh</td>
			    ...
			    <div></div>
 		        ...
 		        <div class="align-l"><b>D. Ngoài các Phụ lục của  tờ khai này, chúng tôi gửi kèm theo các tài liệu sau:</b></div>
 		          <table>
 		           <tr>
 		             <td class="align-c"><b>STT</b></td>
 		           ...
 		           <xsl:for-each select="$tkchinh/TaiLieu_Guikem/Tailieuguikem">
							...
							<tr>
								...
								<td class="align-l"><xsl:value-of select="tenDocument"/></td>
							</tr>
 				  </xsl:for-each>
				</table>					   
		 </div>		
...
<td>		  
		...
		<div class="align-l">
		   ...
		   <br/>
		   Hạch toán chỉ tiêu [E] vào mục 1050 tiểu mục <xsl:value-of select="$tkchinh/tieuMucHachToan"/>
		</div>
<div id="sigDiv"></div>
</td>
</tr>
