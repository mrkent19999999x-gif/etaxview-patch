...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
	    ...
	    <xsl:with-param name="mauTKhai" select="'07-GD/T-VAN-ĐLT'"/>
	  </xsl:call-template>
    ...
    <div>Mã giao dịch: <xsl:value-of select="$noidungtb/GDich/maGDich"/></div>
     ...
     <div style="padding-left:70px">Mã số thuế đại lý thuế: <xsl:value-of select="$noidungtb/CTietGDich/mstDLyThue"/></div>
     <div style="padding-left:70px">Tên đại lý thuế: <xsl:value-of select="$noidungtb/CTietGDich/tenDLyThue"/></div>
     ...
     <div style="padding-left:70px">Mô tả lỗi giao dịch: <xsl:value-of select="$noidungtb/CTietGDich/mtaLoiCTietGDich"/></div>
     <div style="padding-left:70px">MGD: <xsl:value-of select="$noidungtb/CTietGDich/maGDC"/></div>
