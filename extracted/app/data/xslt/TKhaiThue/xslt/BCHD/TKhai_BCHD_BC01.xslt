...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 ...
 <xsl:include href="../../common/common.xsl"/> 
    ...
    <div class="content">
	        <div>Kỳ báo cáo cuối cùng [<xsl:if test="$tkchinh/kyBaoCaoCuoiCung = 'true' "> X </xsl:if>]</div>
	        <table>
				<tr>
            ...
            <table class="tkhai_table">
                        <tr>
							...
							<td class="align-c" colspan="3"><b>Tổ chức, cá nhân đặt in/sử dụng phần mềm tự in hoá đơn</b></td>
