 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="''"/>
		 <xsl:call-template name="tkhaiHeader-03Atain">
		<xsl:with-param name="mauTKhai"   select="'03A/TĐ-TAIN'"/>
		...
		<div class="align-r"><i>Đơn vị tiền: đồng Việt Nam</i></div><br/>
		 <table class="tkhai_table">
                        <tr>
							...
							<td class="align-c"><b>Thuế tài nguyên phát sinh trong kỳ tính thuế</b></td>
							<td class="align-c"><b>Thuế tài nguyên dự kiến được miễn giảm trong kỳ tính thuế</b></td>
							<td class="align-c"><b>Thuế tài nguyên phát sinh phải nộp trong kỳ tính thuế</b></td>
							<td class="align-c"><b>Số thuế tài nguyên đã khai trong kỳ tính thuế</b></td>
							<td class="align-c"><b>Số thuế chênh lệch so với số quyết toán</b></td>
						</tr>
						<tr>
							...
							<td class="align-c"><b>[31]=[29] - [30]</b></td>
						</tr>
                        <xsl:for-each select="$tkchinh/BKeThueTAIN/chiTietThueTAIN">
						...
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/tong_ct30)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/tong_ct31)"/></b></td>
						</tr>
			      </table>
	   </div>
       </div>	
