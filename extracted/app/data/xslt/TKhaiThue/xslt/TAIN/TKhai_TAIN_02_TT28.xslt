		   ...
		   <div class="donvitien"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table"  >
						 ...
						 <tr>
						    ...
						    <td class="align-l" colspan="9"><b>Tài nguyên khai thác:</b></td>
						
          				 </tr>
							<xsl:for-each select="$tkchinh/TaiNguyenKhaiThac/NoiDungTAIN">
					     ...
					     <tr>
						    ...
						    <td class="align-l" colspan="9"><b>Tài nguyên thu mua gom:</b></td>
  						
          				 </tr>
							<xsl:for-each select="$tkchinh/TaiNguyenThuMuaGom/NoiDungTAIN">
									<xsl:variable name="currentRows" select='position()' />
							<tr>
							  <td class="align-c"><xsl:value-of select="$currentRows" /></td>
							  <td class="align-l"><xsl:value-of select="ct2"/></td>
							...
							<tr>
							    ...
							    <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/tongThueTNPSinh)"/></b></td>
   							    <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/tongThueMienGiam)"/></b></td>
  							    <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/tongThuePNop)"/></b></td>
							</tr>
 			 </table>
		 </div>		
      </div>	
