...
số 28/2011/TT-BTC ngày 28/02/2011 của Bộ Tài chính'" />	
		...
		<xsl:with-param name="ghuchuTK"   select="'(Dành cho cơ sở giao đại lý xổ số trả thu nhập cho đại lý xổ số)'"/>
	  </xsl:call-template>
			...
			<div class="donvitien"><i>Đơn vị tiền: Đồng Việt Nam</i>	</div>
					<table class="tkhai_table">
						 ...
						 <tr>
						   ...
						   <td class="align-l">Tổng số đại lý xổ số thuộc diện khấu trừ 5% thuế thu nhập cá nhân</td>
						 ...
						 <tr>
						   ...
						   <td class="align-l">Tổng thu nhập trả cho đại lý xổ số thuộc diện khấu trừ 5% thuế thu nhập cá nhân</td>
