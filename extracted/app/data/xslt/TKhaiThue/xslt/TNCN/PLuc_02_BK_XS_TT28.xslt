...
số 28/2011/TT-BTC ngày 28/02/2011 của Bộ Tài chính'" />
	...
	<!--start phu luc 02/BK-XS-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL02BK_XS">	
		<xsl:variable name="pl02" select='HSoThueDTu/HSoKhaiThue/PLuc/PL02BK_XS' />
			<xsl:call-template name="tkhaiHeader-pluc">
		<xsl:with-param name="mauTKhai"   select="'02/BK-XS'"/>
