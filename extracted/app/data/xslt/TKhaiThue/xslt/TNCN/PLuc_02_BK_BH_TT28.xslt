...
số 28/2011/TT-BTC ngày 28/02/2011 của Bộ Tài chính'" />
	...
	<!--start phu luc 02/BK-BH-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PhuLuc02BK-BH">	
		<xsl:variable name="pl02" select='HSoThueDTu/HSoKhaiThue/PLuc/PhuLuc02BK-BH' />
			<xsl:call-template name="tkhaiHeader-pluc">
		<xsl:with-param name="mauTKhai"   select="'02/BK-BH'"/>
...
ĐÃ KHẤU TRỪ ĐỐI VỚI THU NHẬP CỦA ĐẠI LÝ BẢO HIỂM'"/>
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo Tờ khai quyết toán thuế thu nhập cá nhân mẫu số 02/KK-BH)'"/>
	  </xsl:call-template>
				...
				<table class="tkhai_table">
                        ...
                        <xsl:for-each select="$pl02/BangThuNhapDLyBaoHiem/chiTietTNhapDLyBHiem">
							...
							<tr>
								...
								<td class="align-c"><xsl:value-of select="ct09"/></td>     								                            <td class="align-r"><xsl:value-of select="ihtkk:formatNumber(ct10)"/></td>
