	...
	<xsl:variable name="danhmuc" select='DanhMuc/TTGDichChung' />
		...
		<div class="header_div">
		 ...
		 <table>
						...
						<tr/>
						<tr>
							<td class="align-c"><b>Danh Sách Tờ Khai Qua Mạng</b></td>
						</tr>
				</table><br/>	
				<table class="tkhai_table">
						<tr>
							<td class="align-c"><b>STT</b></td>
							<td class="align-c"><b>Mã Tờ Khai</b></td>
     						<td class="align-c"><b>Tên Tờ Khai</b></td>
						</tr>
                       <xsl:for-each select="DanhMuc/CTietDanhMuc/NoiDungDanhMuc">
							...
							<td class="align-l"><xsl:value-of select="tenTKhai"/></td>				
							</tr>
				         </xsl:for-each>
         		</table>	
		 </div>
