	...
	<xsl:variable name="danhmuc" select='DanhMuc/TTGDichChung' />
		...
		<div class="header_div">
		 ...
		 <table>
						...
						<tr/>
						<tr>
							<td class="align-c"><b>Danh Mục Tài Nguyên</b></td>
						</tr>
				</table><br/>	
				<table class="tkhai_table">
						<tr>
							<td class="align-c"><b>STT</b></td>
							<td class="align-c"><b>Mã Tài Nguyên</b></td>
     						<td class="align-c"><b>Tên Tài Nguyên</b></td>
                       ...
                       <xsl:for-each select="DanhMuc/CTietDanhMuc/NoiDungDanhMuc">
							...
							<td class="align-c"><xsl:value-of select="maTaiNguyen"/></td>
							<td class="align-l"><xsl:value-of select="tenTaiNguyen"/></td>
							<td class="align-c"><xsl:value-of select="thueSuat"/></td>
