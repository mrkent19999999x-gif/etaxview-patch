	...
	<xsl:variable name="danhmuc" select='DanhMuc/TTGDichChung' />
		...
		<div class="header_div">
		 ...
		 <table>
						...
						<tr/>
						<tr>
							<td class="align-c"><b>Danh Mục Bậc Muôn Bài</b></td>
						</tr>
				</table><br/>	
				<table class="tkhai_table">
						<tr class="tkhaiheader">
							<td>STT</td>
							<td>Bậc Muôn Bài</td>
     						<td>Gia Hạn Vốn Trên</td>
     						<td>Gia Hạn Vốn Dưới</td>
     						<td>Mức Thuế</td>
						</tr>
                       <xsl:for-each select="DanhMuc/CTietDanhMuc/NoiDungDanhMuc">
							...
							<td class="align-c"><xsl:value-of select="bacMonBai"/></td>
							<td class="align-l"><xsl:value-of select="giaHanVonTren"/></td>
							<td class="align-l"><xsl:value-of select="giaHanVonDuoi"/></td>
							<td class="align-l"><xsl:value-of select="mucThue"/></td>							
							</tr>
				         </xsl:for-each>
         		</table>	
		 </div>
