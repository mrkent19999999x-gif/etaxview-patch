	...
	<xsl:variable name="danhmuc" select='DanhMuc/TTGDichChung' />
		...
		<div class="header_div">
		 ...
		 <table>
						...
						<tr/>
						<tr>
							<td class="align-c"><b>Danh Mục Khoáng Sản</b></td>
						</tr>
				</table><br/>	
				<table class="tkhai_table">
						<tr>
							<td class="align-c"><b>STT</b></td>
							<td class="align-c"><b>Mã Khoáng Sản</b></td>
     						<td class="align-c"><b>Tên Khoáng Sản</b></td>
							<td class="align-c"><b>Đơn Vị tính</b></td>
     						<td class="align-c"><b>Mức Phí</b></td>
                       ...
                       <xsl:for-each select="DanhMuc/CTietDanhMuc/NoiDungDanhMuc">
							...
							<td class="align-c"><xsl:value-of select="maKhoangSan"/></td>
							<td class="align-l"><xsl:value-of select="tenKhoangSan"/></td>
							<td class="align-c"><xsl:value-of select="dViTinh"/></td>
							<td class="align-r"><xsl:value-of select="mucPhi"/></td>							
							</tr>
				         </xsl:for-each>
         		</table>	
		 </div>
