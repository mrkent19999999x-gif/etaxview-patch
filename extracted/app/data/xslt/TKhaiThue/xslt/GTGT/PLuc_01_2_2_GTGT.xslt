...
<!-- Phụ lục 01-2-2/GTGT -->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL01_2_2_GTGT">	
		<xsl:variable name="pl02" select='HSoThueDTu/HSoKhaiThue/PLuc/PL01_2_2_GTGT' />
						   ...
						   <xsl:for-each select="$pl02/HHDVDauTuKTru/ChiTietHHDVDauTuKTru/HDonMVao">
							...
							<tr>
							 ...
							 <tr>
							   ...
							   <td></td>
		<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl02/HHDVDauTuKTru/tThueGTGT_HHDVMuaVao)
							   "/></b></td>
							   <td></td>
							 </tr>   
						</table>
