...
<!-- Phụ lục 01-2-3/GTGT -->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL01_2_3_GTGT">	
		<xsl:variable name="pl02" select='HSoThueDTu/HSoKhaiThue/PLuc/PL01_2_3_GTGT' />
...
<div class="ghichu">							
				<div><b>Tổng giá trị hàng hoá, dịch vụ mua vào: <xsl:value-of select="ihtkk:formatNumber($pl02/tongCongGTriHHDVMuaVao
				)"/></b></div>
				<div><b>Tổng số thuế GTGT của hàng hoá, dịch vụ mua vào: <xsl:value-of select="ihtkk:formatNumber($pl02/tongCongThueGTGTHHDVMuaVao
				)"/></b></div>
</div>				
			  </div>
			</div>
