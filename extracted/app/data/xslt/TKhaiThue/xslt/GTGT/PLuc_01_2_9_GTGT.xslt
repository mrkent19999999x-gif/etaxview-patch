...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<!-- Phụ lục 01-2-9/GTGT -->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL01_2_9_GTGT">	
		<xsl:variable name="pl02" select='HSoThueDTu/HSoKhaiThue/PLuc/PL01_2_9_GTGT' />
						   ...
						   <xsl:for-each select="$pl02/HHDVDauTuKTru/ChiTietHHDVDauTuKTru/HDonMVao">
							...
							<tr>
							 ...
							 <tr>
							   ...
							   <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl02/HHDVDauTuKTru/tongGTriHHDVMuaVao
							   )"/></b></td>
							   <td></td>
