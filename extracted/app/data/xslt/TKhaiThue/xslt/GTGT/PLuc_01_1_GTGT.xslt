					...
					<div class="donvitien"><i>Đơn vị tiền: đồng Việt Nam</i></div>
						<table class="tkhai_table"  >
							<tr>
							 ...
							 <td class="align-c" rowspan="2"><b>Doanh số bán chưa có thuế GTGT</b></td>
							...
							<tr>
								<td colspan="11"><i>1. Hàng hóa, dịch vụ không chịu thuế giá trị gia tăng (GTGT):</i></td>
							</tr>
						   <xsl:for-each select="$pl01/HHDVKChiuThue/ChiTietHHDVKChiuThue/HDonBRa">
							...
							<tr>
								<td colspan="11"><i>2. Hàng hóa, dịch vụ chịu thuế suất thuế GTGT 0% (*):</i></td>
							</tr>
						   <xsl:for-each select="$pl01/HHDVThue0/ChiTietHHDVThue0/HDonBRa">
							...
							<tr>
								<td colspan="11"><i>3. Hàng hóa, dịch vụ chịu thuế suất thuế GTGT 5%:</i></td>
							</tr>
						   <xsl:for-each select="$pl01/HHDVThue5/ChiTietHHDVThue5/HDonBRa">
							...
							<tr>
								<td colspan="11"><i>4. Hàng hóa, dịch vụ chịu thuế suất thuế GTGT 10%:</i></td>
							</tr>
						   <xsl:for-each select="$pl01/HHDVThue10/ChiTietHHDVThue10/HDonBRa">
							...
							<tr>
								<td colspan="11"><i>5. Hàng hóa, dịch vụ không phải tổng hợp trên tờ khai 01/GTGT:</i></td>
							</tr>
						   <xsl:for-each select="$pl01/HHDVBRaKhongTHop/ChiTietHHDVBRaKhongTHop/HDonBRa">
									<xsl:variable name="currentRows" select='position()' />
							<tr>
							  <td class="align-c"><xsl:value-of select="$currentRows" /></td>
							  <td class="align-c"><xsl:value-of select="kyHieuMauHDon" /></td>
							...
							<tr>
							  <td colspan="8" class="align-l"><b>Tổng Cộng</b></td>
							  <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01/HHDVBRaKhongTHop/tongDThuBRaKoKKhai)"/></b></td>
							  <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01/HHDVBRaKhongTHop/tongThueBRaKoKKhai)"/></b></td>
							  <td></td>
							</tr>
						</table>  
<div class="ghichu">						
				<div><b>Tổng doanh thu hàng hóa, dịch vụ bán ra (**): <xsl:value-of select="ihtkk:formatNumber($pl01/tongDThuBRa)"/></b></div>
				...
				<div><b>Tổng thuế GTGT của hàng hóa, dịch vụ bán ra (****): <xsl:value-of select="ihtkk:formatNumber($pl01/tongThueBRa)"/></b></div>
			</div>
	</div>		
			</div>
...
<div class="ghichu">
		...
		<div><i>(*) Trường hợp phát sinh hàng hóa, dịch vụ chịu thuế suất thuế GTGT 0% thì lập gửi kèm theo Bảng kê hàng hóa, dich vụ được áp dụng thuế suất thuế GTGT 0%- mẫu số 01-3/GTGT</i></div>
		<div><i>(**) Tổng doanh thu hàng hóa, dịch vụ bán ra là tổng cộng số liệu tại cột 8 của dòng tổng của các chỉ tiêu 1, 2, 3, 4.</i></div>
		<div><i>(***) Tổng doanh thu hàng hóa, dịch vụ bán ra chịu thuế GTGT là tổng cộng số liệu tại cột 9 của  dòng tổng của các chỉ tiêu 2, 3, 4.</i></div>
