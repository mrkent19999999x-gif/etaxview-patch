...
của <xsl:choose>
         <xsl:when test="$khbs/NOIDUNGGIAITHICH/ten_CCT">
          <xsl:value-of select="$khbs/NOIDUNGGIAITHICH/ten_CCT"/> 
         </xsl:when>
		 <xsl:when test="$khbs/NOIDUNGGIAITHICH/ten_CT">
          <xsl:value-of select="$khbs/NOIDUNGGIAITHICH/ten_CT"/>
         </xsl:when>
         <xsl:otherwise>
            <xsl:value-of select="''"/>
         </xsl:otherwise>
