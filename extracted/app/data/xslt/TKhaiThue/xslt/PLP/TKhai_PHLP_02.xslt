  ...
  <xsl:include href="../../common/common.xsl"/>   
	<xsl:template match="/">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		 <xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Thông tư số 156 /TT-BTC ngày 06/11/2013 của  Bộ Tài chính'" />
				...
				<div class="donvitien"><i>Đơn vị tiền: Đồng Việt Nam </i></div>
					<table class="tkhai_table"  >
						<tr class="tkhaiheader"> 
							  ...
							  <td>Số tiền phí, lệ phí phải nộp Ngân sách Nhà nước</td>
							  <td>Số tiền phí, lệ phí đã kê khai trong kỳ</td>
