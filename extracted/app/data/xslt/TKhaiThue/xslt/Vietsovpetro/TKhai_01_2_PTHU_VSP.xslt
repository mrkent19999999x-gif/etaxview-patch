 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="''"/>
		...
		<xsl:with-param name="mauTKhai"   select="'01-2/PTHU-VSP'"/>
					...
					<table class="tkhai_table" >
						 ...
						 <tr>
						  ...
						  <tr>
							...
							<td class="align-l">Số tiền chi phí sử dụng không hết.</td>
					     ...
					     <tr>
							...
							<td class="align-l">Sản lượng dầu lãi từ chi phí sử dụng không hết [26] = [24]/[25]</td>
...
<td>		  
		...
		<div class="ghichu">
		<div><i><u><b>Ghi chú:</b></u> - Chỉ tiêu số [01]- Kỳ tính thuế là ngày, tháng, năm Hội đồng Liên doanh ra quyết nghị khoản chi phí sử dụng không hết tại Văn kiện kỳ họp Hội đồng Liên doanh. </i></div><br/>
        <div><i> - Chỉ tiêu số [02]- Kỳ kết dư là khoảng thời gian Vietsovpetro xác định khoản chi phí sử dụng không hết để báo cáo Hội đồng Liên doanh phê duyệt.</i></div>		<br/>
