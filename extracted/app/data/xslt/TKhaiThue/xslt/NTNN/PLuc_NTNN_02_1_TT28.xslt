  ...
  <xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL02_1_NTNN">	
	...
	<div class="ndungtkhai_div">
		    ...
		    <table class="tkhai_table">
				        ...
				        <xsl:for-each select="$pluc01/BKCacNTNN/CacNTNN">
							...
							<tr>
							  <td class="align-c"><xsl:value-of select="$currentRows" /></td>
								...
								<td class="align-l"><xsl:value-of select="ct9"/></td>										       <td class="align-l"><xsl:value-of select="ct10a"/></td>			
...
<td></td>
							    <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/tongct11b)"/></b></td>
							    <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/tongct12)"/></b></td>
						</tr>	  
			      </table>	
</div>
</div>
