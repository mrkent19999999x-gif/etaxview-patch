...
<!--start phu luc 02-1/PL-DK-->
		...
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL_02_1TAIN_DK">	
		<xsl:variable name="pl01" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_02_1TAIN_DK' />
		...
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo Tờ khai quyết toán thuế tài nguyên đối với dầu khí)'"/>
	  </xsl:call-template>
