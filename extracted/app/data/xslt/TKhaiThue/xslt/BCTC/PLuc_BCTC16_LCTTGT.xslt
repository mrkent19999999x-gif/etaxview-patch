...
<!-- LƯU CHUYỂN TIỀN TỆ GIÁN TIẾP  -->
    ...
    <table class="tkhai_table">
        ...
        <tr>
            ...
            <td class="number align-r"><b class="number"><xsl:value-of select="$pluc03/SoNamNgoai/ctIII_nNgoai"/></b></td>
            </b>
        </tr>
        <tr>
            <b>
            ...
            <td class="number align-r"><b class="number"><xsl:value-of select="$pluc03/SoNamNgoai/ctIV_nNgoai"/></b></td>
            </b>
        </tr>   
        <tr>
