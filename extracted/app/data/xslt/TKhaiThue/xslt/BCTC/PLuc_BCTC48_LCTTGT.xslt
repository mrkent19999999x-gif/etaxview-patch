...
<!-- LƯU CHUYỂN TIỀN TỆ GIÁN TIẾP  -->
    ...
    <table class="tkhai_table">
        ...
        <tr>
            ...
            <td class="align-c"><b></b></td>
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc03/SoNamNay/ct60_nNay"/></b></td>
            <td class="align-r"><b class="number"><xsl:value-of select="$pluc03/SoNamNgoai/ct60_nNgoai"/></b></td>
        </tr>
        <tr>
            <td class="align-c"></td>
