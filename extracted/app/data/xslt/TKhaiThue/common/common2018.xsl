...
'21502154':'Phí kiểm nghiệm dư lượng thuốc bảo vệ thực vật và sản phẩm thực vật',
...
'22502255':'Phí thẩm định dự án đầu tư xây dựng (gồm: thẩm định phần thuyết minh và thiết kế cơ sở); thẩm định thiết kế kỹ thuật và các đồ án qui hoạch',
...
'23002321':'Phí sử dụng lề đường, bến, bãi, mặt nước, các công trình kết cấu hạ tầng, công trình dịch vụ và tiện ích công cộng khác trong khu kinh tế cửa khẩu',
'23002322':'Phí kiểm định an toàn kỹ thuật và chất lượng thiết bị, vật tư, phương tiện giao thông vận tải, phương tiện đánh bắt thủy sản',
...
'24002411':'Phí thẩm định cấp phép hoạt động hóa chất nguy hiểm, thẩm định báo cáo đánh giá rủi ro hóa chất mới sản xuất, sử dụng ở Việt Nam, đánh giá điều kiện hoạt động theo quy định của pháp luật',
...
'24502452':'Phí tham quan danh lam thắng cảnh, di tích lịch sử, công trình văn hoá',
'24502453':'Phí thẩm định nội dung văn hoá phẩm xuất khẩu, nhập khẩu; kịch bản phim và phim; chương trình nghệ thuật biểu diễn; nội dung xuất bản phẩm; chương trình trên băng, đĩa, phần mềm và trên các vật liệu khác',
...
'25502555':'Phí kiểm nghiệm mẫu thuốc, nguyên liệu làm thuốc, thuốc, mỹ phẩm',
...
'27002703':'Phí cung cấp thông tin về cầm cố, thế chấp, bảo lãnh tài sản đăng ký giao dịch bảo đảm',
...
'27002707':'Phí tống đạt, uỷ thác tư pháp theo yêu cầu của cơ quan có thẩm quyền của nước ngoài',
...
'27502754':'Lệ phí áp dụng tại cơ quan đại diện ngoại giao, cơ quan lãnh sự Việt Nam ở nước ngoài',
...
'28502853':'Lệ phí về cấp chứng nhận, cấp chứng chỉ, cấp phép, cấp giấy phép, cấp thẻ, đăng ký, kiểm tra đối với các hoạt động, các ngành nghề kinh doanh theo quy định của pháp luật',
'28502854':'Lệ phí đặt chi nhánh, văn phòng đại diện của các tổ chức kinh tế nước ngoài tại Việt Nam',
...
'28502859':'Lệ phí về cấp chứng nhận, cấp chứng chỉ, cấp phép, cấp giấy phép, cấp thẻ, đăng ký, kiểm tra đối với các hoạt động, các ngành nghề kinh doanh theo quy định của pháp luật',
...
'30003009':'Lệ phí cấp giấy phép cho các đối tượng liên quan hoạt động tàu, thuyền nước ngoài',
...
'30503057':'Lệ phí cấp bản sao, chứng thực theo yêu cầu hoặc theo quy định của pháp luật',
