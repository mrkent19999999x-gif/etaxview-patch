	...
	<!--20DK-TCT-->
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>4. Nơi đăng ký giảm trừ người phụ thuộc (tổ chức, cá nhân trả thu nhập/cơ quan quản lý): <xsl:value-of select="$tkchinh/tenCQTQuanLy"/>
					</td>
				</tr>
				<tr>
...
<!--03-DK-TCT-->
<xsl:template name="tkhaiHeader_03_DK">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
...
<xsl:template name="tkhaiHeader_03_DK_TCT_BK01">
		...
		<div class="header_div">
			<table class="ttinnnt_table">
				<tr>
					<td class="align-c"><b>BẢNG KÊ <br/>Cửa hàng, cửa hiệu trực thuộc</b> 
