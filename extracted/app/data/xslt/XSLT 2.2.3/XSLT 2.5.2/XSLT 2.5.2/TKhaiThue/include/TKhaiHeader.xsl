	...
	<xsl:template name="tkhaiHeader_04_GTGT_TT80">
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c"><xsl:if test="$tkchinh/Header/khaiRiengThuHo= 'true' ">[x]</xsl:if> 
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[21] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT21/donViUyQuyen = 'true' or $tkchinh/Header/CT21/donViUyQuyen = '1' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT21/daiLyThue = 'true' or $tkchinh/CT21/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT21/donViUyQuyen = 'true' or $tkchinh/CT21/donViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT21/daiLyThue = 'true'  or $tkchinh/CT21/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<br/>
										<b>[21] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/CT21/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT21/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT21/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/tendonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/CT21/daiLyThue = 'true' "> </xsl:if>
										</b>
									</td>
								</tr>
								<tr>
