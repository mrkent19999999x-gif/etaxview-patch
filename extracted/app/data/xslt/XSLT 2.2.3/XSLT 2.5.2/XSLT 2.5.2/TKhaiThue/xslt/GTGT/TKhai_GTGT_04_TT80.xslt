...
([25]=[24]x5%)
			...
			<tr>
				...
				<td class="align-c">Doanh thu và số thuế phải nộp ([30]=[22]+[24]+[26]+[28]; [31]=[23]+[25]+[27]+[29])</td>
...
<div class="ghichu">			
   ...
   <div> <b>B. Khai riêng đối với khoản thu hộ do cơ quan nhà nước có thẩm quyền giao:</b> </div>	<br/>
					<table class="tkhai_table">
				        ...
				        <xsl:for-each select="$tkchinh/KhaiRiengĐoiVoiKhoanThuHo/KhoanThuHoCTGTGT">
							...
							<td class="align-r"><b>[36]</b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KhaiRiengĐoiVoiKhoanThuHo/DoanhThuVaSoThuePhaiNop/ct36)"/></td>
								<td></td>
							<td class="align-r"><b>[37]</b><xsl:value-of select="ihtkk:formatNumber($tkchinh/KhaiRiengĐoiVoiKhoanThuHo/DoanhThuVaSoThuePhaiNop/ct37)"/></td>
	         				</tr>	
