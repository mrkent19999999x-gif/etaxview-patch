 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="' '"/>
		...
		<div class="content">
		<div>[09] Khai cho địa điểm kinh doanh mới thành lập trong năm  [<xsl:if test="$tkchinh/ct09 = 'true' ">X</xsl:if> <xsl:if test="$tkchinh/ct21 = '1' "> X </xsl:if>]</div><br/>
		<div class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div><br/>
		 <table class="tkhai_table">
             <tr>
				...
				<td class="align-c"><b>Quận/Huyện</b></td>
			 ...
			 <tr>
				...
				<td class="align-l"><xsl:value-of select="$tkchinh/NguoiNopLPMB/ct3_ten"/></td>
