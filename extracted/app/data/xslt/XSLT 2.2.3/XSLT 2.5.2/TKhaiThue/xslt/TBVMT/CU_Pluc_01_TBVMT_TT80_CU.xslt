            ...
            <div class="content">
					<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
                      <table class="tkhai_table">
						...
						<tr>
						   ...
						   <td class="align-l" colspan="12"><b><xsl:value-of select="$pl01/DonViTieuThu/CTietDonViTieuThu/ct2"/></b></td>
						   <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01/DonViTieuThu/tong)"/></b></td>
						 </tr>
						<xsl:for-each select="$pl01/DonViTieuThu/CTietDonViTieuThu">
					...
					<tr>
						...
						<xsl:for-each select="$pl01/CoSoKhaiThac/CTietCoSoKhaiThac">
						   ...
						   <td class="align-l" colspan="12"><i><xsl:value-of select="ct2"/></i></td>
