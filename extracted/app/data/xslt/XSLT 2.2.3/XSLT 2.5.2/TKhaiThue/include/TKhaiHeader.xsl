	...
	<xsl:template name="tkhaiHeader_01_LNCL_PSC_TT80">
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<b>(Hợp đồng dầu khí Lô</b>:<xsl:value-of select="$tkchinh/Header/hopDongDauKhiLo"/>)
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="align-c">
						<b>[04]</b> Kỳ tính thuế: Lần phát sinh <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
			...
			<table width="100%" >
				...
				<xsl:if test="$ttkthue/DLyThue">
					<tr>
						<td colspan="3">
							<br/>
							<b>[17] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT17/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
						...
						<b>[19]</b> E-mail: <xsl:value-of select="$tkchinh/Header/ct19"/>
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[20] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT20/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT20/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT20/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT20/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
								...
								<tr>
									<td colspan="3">
										...
										<b>[20] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT20/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT20/daiLyThue = 'true' "> X </xsl:if>]:
											...
											<xsl:if test="$tkchinh/Header/CT20/daiLyThue = 'true' "> </xsl:if>
										</b>
									</td>
								</tr>
								<tr>
...
<tr>
				...
				<tr>
					<td class="align-l">
						<b>[09]</b> Số thuế phải nộp: <xsl:value-of select="ihtkk:formatNumber(HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_DK/ct09)"/> USD
					</td>
				</tr>
			</table>
		</div>
