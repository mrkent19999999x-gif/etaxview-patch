	...
	<xsl:template name="tkhaiHeader-03TNDN">
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
                        [<xsl:if test="$tkchinh/doanhNghiepCoCSoHToanPThuoc = 'true' ">x</xsl:if><xsl:if test="$tkchinh/doanhNghiepCoCSoHToanPThuoc = '1' ">x</xsl:if>]  Doanh nghiệp có cơ sở sản xuất hạch toán phụ thuộc
                    </td>
				</tr>
				<tr>
					<td>
	...
	<xsl:template name="tkhaiHeader-03TNDN_TT56">
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
                        [<xsl:if test="$tkchinh/doanhNghiepCoQuyMoVuaVaNho = 'true' ">x</xsl:if><xsl:if test="$tkchinh/doanhNghiepCoQuyMoVuaVaNho = '1' ">x</xsl:if>]  Doanh nghiệp có quy mô vừa và nhỏ
                    </td>
				</tr>
				<tr>
					<td class="align-c">
				...
				<tr>
					<td class="align-c">
                        [<xsl:if test="$tkchinh/doanhNghiepKeKhaiTTinLienKet = 'true'  ">x</xsl:if><xsl:if test="$tkchinh/doanhNghiepKeKhaiTTinLienKet = '1'  ">x</xsl:if>]  Doanh nghiệp thuộc đối tượng kê khai thông tin giao dịch liên kết
                    </td>
				</tr>
				<tr>
					<td class="align-c">
						<b>[04]</b> Ngành nghề có tỷ lệ doanh thu cao nhất: <xsl:value-of select="$tkchinh/ct_04_ten"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
...
ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct20_ngay,'dd/mm/yyyy')" /> Do Bộ KH&amp;ĐT cấp
		...
		<div class="giahan_div">
	    	...
	    	<!-- start tkhai header DAU LAI  -->
	<xsl:template name="tkhaiHeader-03TNS">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[16] </b> Giấy phép đầu tư số: <xsl:value-of select="$tkchinh/Header/ct20_so"/>
ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct20_ngay,'dd/mm/yyyy')" /> Do Bộ KH&amp;ĐT cấp
								</td>
							</tr>
						   <tr>
								<td colspan="3">
									<b>[17]</b>Tài khoản tiền gửi số: <xsl:value-of select="$tkchinh/Header/ct21_so"/>  mở tại NH: <xsl:value-of select="$tkchinh/Header/ct21_ten"/>
								</td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[18] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT22/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT22/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT22/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tendonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT22/daiLyThue = 'true' ">
...
ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct13_ngay,'dd/mm/yyyy')" /> Do Bộ KH&amp;ĐT cấp
	...
	<xsl:template name="tkhaiHeader_TemRuou">
		...
		<!-- start header Phuluc 02/tndn cua to 03/tndn-->
	<xsl:template name="tkhaiHeader-pluc_02">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- Start tkhai header Tem ruou-->
	<xsl:template name="tkhaiHeader_06TemRuou">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<xsl:param name="ttkthue_" select="$ttkthue"/>
