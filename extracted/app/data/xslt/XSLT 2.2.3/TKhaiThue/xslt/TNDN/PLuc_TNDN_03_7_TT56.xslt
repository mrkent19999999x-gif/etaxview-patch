						...
						<div class="align-l"><b>PHẦN A. THÔNG TIN VỀ CÁC BÊN LIÊN KẾT.</b></div>
							...
							<table class="tkhai_table">
								   ...
								   <tr>
									 ...
									 <td class="align-c"><xsl:if test="ctA_GCN = 'true' ">[x]</xsl:if> <xsl:if test="ctA_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctA_GCN = '1'"> [x]</xsl:if> <xsl:if test="ctA_GCN = '0'">[]</xsl:if> </td>
									 <td class="align-c"><xsl:if test="ctB_GCN = 'true' ">[x]</xsl:if> <xsl:if test="ctB_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctB_GCN = '1'"> [x]</xsl:if> <xsl:if test="ctB_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctC_GCN = 'true' ">[x]</xsl:if>  <xsl:if test="ctC_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctC_GCN = '1'"> [x]</xsl:if> <xsl:if test="ctC_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctD_GCN = 'true' ">[x]</xsl:if> <xsl:if test="ctD_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctD_GCN = '1'"> [x]</xsl:if> <xsl:if test="ctD_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctE_GCN = 'true' ">[x]</xsl:if>  <xsl:if test="ctE_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctE_GCN = '1'"> [x]</xsl:if> <xsl:if test="ctE_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctF_GCN = 'true' ">[x]</xsl:if>  <xsl:if test="ctF_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctF_GCN = '1'"> [x]</xsl:if> <xsl:if test="ctF_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctG_GCN = 'true' ">[x]</xsl:if>  <xsl:if test="ctG_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctG_GCN= '1'"> [x]</xsl:if> <xsl:if test="ctG_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctH_GCN = 'true' ">[x]</xsl:if>  <xsl:if test="ctH_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctH_GCN= '1'"> [x]</xsl:if> <xsl:if test="ctH_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctI_GCN = 'true' ">[x]</xsl:if>  <xsl:if test="ctI_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctI_GCN= '1'"> [x]</xsl:if> <xsl:if test="ctI_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctJ_GCN = 'true' ">[x]</xsl:if> <xsl:if test="ctJ_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctJ_GCN= '1'"> [x]</xsl:if> <xsl:if test="ctJ_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctK_GCN = 'true' ">[x]</xsl:if> <xsl:if test="ctK_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctK_GCN= '1'"> [x]</xsl:if> <xsl:if test="ctK_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctL_GCN = 'true' ">[x]</xsl:if> <xsl:if test="ctL_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctL_GCN= '1'"> [x]</xsl:if> <xsl:if test="ctL_GCN = '0'">[]</xsl:if></td>
									 <td class="align-c"><xsl:if test="ctM_GCN = 'true' ">[x]</xsl:if> <xsl:if test="ctM_GCN = 'false'">[]</xsl:if>	<xsl:if test="ctM_GCN= '1'"> [x]</xsl:if> <xsl:if test="ctM_GCN = '0'">[]</xsl:if></td>
									</tr>
									</xsl:for-each>
							   </table>
							   <br/>
