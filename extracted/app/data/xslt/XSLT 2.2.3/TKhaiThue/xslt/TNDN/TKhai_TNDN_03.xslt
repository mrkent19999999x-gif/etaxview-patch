		 ...
		 <div class="content">
		   <div class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table">
						 ...
						 <tr >
						   <td class="align-c">1</td>
						   <td class="align-l">Điều chỉnh tăng tổng lợi nhuận trước thuế thu nhập doanh nghiệp 
(B1= B2+B3+B4+B5+B6 +B7)</td>
						 ...
						 <tr>
						   <td class="align-c">3.1</td>
						   <td class="align-l">Lỗ từ hoạt động SXKD được chuyển trong kỳ </td>
						   <td class="align-c">C3a</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctC3a"/></td>
						 </tr>  
						 	<tr>
						   <td class="align-c">3.2</td>
						   <td class="align-l">Lỗ từ chuyển nhượng BĐS được bù trừ với lãi của hoạt động SXKD</td>
						   <td class="align-c">C3b</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctC3b"/></td>
						 </tr>  					 
						 <tr>
						   <td class="align-c">4</td>
						   <td class="align-l">Thu nhập tính thuế (TNTT) (C4=C1-C2-C3a-C3b)</td>
						 ...
						 <tr>
						   ...
						   <td class="align-l"><b>Tổng số thuế TNDN phải nộp  (D=D1+D2+D3)</b></td>
						   <td class="align-c"><b>D</b></td>
						   <td class="number align-r"><b><xsl:value-of select="$tkchinh/ctD"/></b></td>
						 </tr> 
						 <tr>
						   <td class="align-c">1</td>
						   <td class="align-l">Thuế TNDN của hoạt động sản xuất kinh doanh (D1=C16)</td>
						   <td class="align-c">D1</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctD1"/></td>
						 </tr> 
						  ...
						  <tr>
						   ...
						   <td class="number align-r"><b><xsl:value-of select="$tkchinh/ctD2"/></b></td>
						 </tr> 
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctD3"/></td>
						 </tr> 
						 <tr>
						   <td class="align-c"><b>E</b></td>
						   <td class="align-l"><b>Số thuế TNDN đã tạm nộp trong năm (E = E1+E2+E3)</b></td>
						   <td class="align-c"><b>E</b></td>
						 ...
						 <tr>
						   ...
						   <td class="align-l"><b>Tổng số thuế TNDN còn phải nộp (G = G1+G2+G3)</b></td>
						   <td class="align-c"><b>G</b></td>
						   <td class="align-r"><b class="number"><xsl:value-of select="$tkchinh/ctG"/></b></td>
						 </tr>  
						 <tr>
						   <td class="align-c">1</td>
						   <td class="align-l">Thuế TNDN của hoạt động sản xuất kinh doanh (G1 = D1-E1)</td>
						   <td class="align-c">G1</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctG1"/></td>
						 </tr>  
						 <tr>
						   <td class="align-c">2</td>
						   <td class="align-l">Thuế TNDN từ hoạt động chuyển nhượng bất động sản (G2 = D2-E2)</td>
						   <td class="align-c">2</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctG2"/></td>
						 </tr>  	
						 <tr>
						   <td class="align-c">3</td>
						   <td class="align-l">Thuế TNDN phải nộp khác (nếu có) (G3 = D3-E3)</td>
						   <td class="align-c">G3</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctG3"/></td>
						 </tr>
						 <tr>
						   <td class="align-c"><b>H</b></td>
						   <td class="align-l"><b>20% số thuế TNDN phải nộp (H = D*20%)</b></td>
						   <td class="align-c"><b>H</b></td>
						   <td class="align-r"><b class="number"><xsl:value-of select="$tkchinh/ctH"/></b></td>
						 </tr>  	
						 <tr>
						   <td class="align-c"><b>I</b></td>
						   <td class="align-l"><b>Chênh lệch giữa số thuế TNDN còn phải nộp với 20% số thuế TNDN phải nộp (I = G-H)</b></td>
						   <td class="align-c"><b>I</b></td>
						   <td class="align-r"><b class="number"><xsl:value-of select="$tkchinh/ctI"/></b></td>
						 </tr>						   						 					 						 
					   </table>
			    <div></div>
			    <div class="align-l"><b>L. Gia hạn nộp thuế (nếu có)</b></div>
 				<div class="align-l">[L1] Đối tượng được gia hạn <xsl:if test="$tkchinh/GiaHanNopThue/ctL1 = 'true'"> [x] </xsl:if>  <xsl:if test="$tkchinh/GiaHanNopThue/ctL1 = 'false'">[]</xsl:if>	<xsl:if test="$tkchinh/GiaHanNopThue/ctL1 = '1'"> [x]</xsl:if> <xsl:if test="$tkchinh/GiaHanNopThue/ctL1 = '0'">[]</xsl:if></div>	 
 				<div class="align-l">[L2] Trường hợp được gia hạn nộp thuế TNDN theo:   <xsl:value-of select="$tkchinh/GiaHanNopThue/ctL2_ten"/></div>	 
 				<div class="align-l">[L3] Thời hạn được gia hạn: <xsl:value-of select="$tkchinh/GiaHanNopThue/ctL3"/></div>	 
 				<div class="align-l">[L4] Số thuế TNDN được gia hạn:  <xsl:value-of select="ihtkk:formatNumber($tkchinh/GiaHanNopThue/ctL4)"/></div>	 
 				<div class="align-l">[L5] Số thuế TNDN không được gia hạn:  <xsl:value-of select="ihtkk:formatNumber($tkchinh/GiaHanNopThue/ctL5)"/></div>	  
		        <div></div>
			    <div class="align-l"><b>M.Tiền chậm nộp của khoản chênh lệch từ 20% trở lên đến ngày hết hạn nộp hồ sơ quyết toán thuế TNDN
(trường hợp kê khai quyết toán và nộp thuế theo quyết toán trước thời hạn thì tính đến ngày nộp thuế)</b></div>
 				<div class="align-l">[M1] Số ngày chậm nộp: <xsl:value-of select="$tkchinh/TienChamNop/CTM1/soNgay"/> ngày, từ ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/TienChamNop/CTM1/tuNgay, 'dd/mm/yyyy')"/> đến ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/TienChamNop/CTM1/denNgay, 'dd/mm/yyyy')"/></div>	 
 				<div class="align-l">[M2]  Số tiền chậm nộp: <xsl:value-of select="$tkchinh/TienChamNop/ctM2"/>  </div>	 
 			     <div></div>
