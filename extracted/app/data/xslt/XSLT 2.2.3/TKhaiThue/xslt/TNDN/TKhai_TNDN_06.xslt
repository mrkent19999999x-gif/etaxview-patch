 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="''"/>
		 <xsl:call-template name="tkhaiHeader-061TNDN">
		<xsl:with-param name="mauTKhai"   select="'06/TNDN'"/>
		<xsl:with-param name="moTaBieuMau"   select="$moTaBieuMau"/>
		<xsl:with-param name="ghuchuTK"   select="'(Dùng cho doanh nghiệp kê khai thuế TNDN từ hoạt động bán toàn bộ Công ty TNHH một thành viên do tổ chức làm chủ sở hữu dưới hình thức chuyển nhượng vốn có gắn với bất động sản)'"/>
	  </xsl:call-template>
		 ...
		 <div class="content">
			   <div class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table" >
					 ...
					 <tr>
						   <td class="align-c">1</td>
						   <td class="align-l">Doanh thu của hoạt động bán toàn bộ Công ty có gắn với chuyển nhượng bất động sản</td>
						   <td class="align-c">[25]</td>
						   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct25)"/></td>
						 </tr>  
						 <tr>
						   <td class="align-c">2</td>
						   <td class="align-l">Chi phí của hoạt động bán toàn bộ Công ty có gắn với chuyển nhượng bất động sản</td>
						...
						<tr>
						 ...
						 <tr>
						   <td class="align-c">3</td>
						   <td class="align-l">Thu nhập từ hoạt động bán toàn bộ Công ty có gắn với chuyển nhượng bất động sản ([33]=[25]-[26])</td>
						 ...
						 <tr>
						   ...
						   <td class="align-l">Thu nhập tính thuế thu nhập doanh nghiệp (TNDN) từ hoạt động  bán toàn bộ Công ty có gắn với chuyển nhượng bất động sản ([35]=[33]-[34])</td>
