 ...
 <xsl:include href="../common/common.xsl"/> 
   ...
   <xsl:template name="tkhaiFooter_DK_TVAN">
	...
	<xsl:template name="tkhaiFooter-tb01ac">
		...
		<!--start Footer  TB01/AC Hoá đơn điện tử -->	
	<xsl:template name="tkhaiFooter-tb01ac-hddt">
<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<br/>
        <table>
	        <colgroup>
			...
			<!--start Footer  Quyết định áp dụng Hoá đơn điện tử -->	
	<xsl:template name="tkhaiFooter-QDAD-HDDT">
<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<xsl:variable name="tkchinh" select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh"/>
		<br/>
        <table>
	        <colgroup>
				...
				<tr>
                    <td>- Cơ quan thuế trực tiếp quản lý (Cục, Chi cục…);</td>
					<td class="align-c"><b>GIÁM ĐỐC</b></td>
				</tr>
				<tr>
                    <td>- Như Điều 4 (để thực hiện);</td>
					<td class="align-c"><i>(Ký, đóng dấu và ghi rõ họ tên)</i></td>
				</tr>
				<tr>
