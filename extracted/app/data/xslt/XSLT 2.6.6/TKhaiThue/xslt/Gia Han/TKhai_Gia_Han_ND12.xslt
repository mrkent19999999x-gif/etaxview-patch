...
<div>d) [<xsl:if test="$tkchinh/CT07/ct_d = 'true' or $tkchinh/CT07/ct_d = '1'" >x</xsl:if>] Tiền thuê đất (kê chi tiết địa chỉ từng khu đất thuê thuộc đối tượng gia hạn tiền thuê đất) </div>
    <table class="tkhai_table">
        <tr>
			...
			<td class="align-c" colspan="2"><b>Số thông báo</b></td>
		 ...
		 <tr>
			...
			<xsl:for-each select="$tkchinh/CT07/KhuDat/CTietKhuDat">
					    ...
					    <tr>
							...
							<td class="align-c"><xsl:value-of select="kiHieuThongBao"/></td>
							<td class="align-c"><xsl:value-of select="soQuyetDinh"/></td>
...
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_29 = 'true' or $tkchinh/CT08/CT_II/ct_29 = '1'" >x</xsl:if>] 29) Hoạt động xuất bản;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_30 = 'true' or $tkchinh/CT08/CT_II/ct_30 = '1'" >x</xsl:if>] 30) Hoạt động điện ảnh, sản xuất chương trình truyền hình, ghi âm và xuất bản âm nhạc;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_31 = 'true' or $tkchinh/CT08/CT_II/ct_31 = '1'" >x</xsl:if>] 31) Hoạt động phát thanh, truyền hình;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_32 = 'true' or $tkchinh/CT08/CT_II/ct_32 = '1'" >x</xsl:if>] 32) Lập trình máy vi tính, dịch vụ tư vấn và các hoạt động khác liên quan đến máy vi tính;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_33 = 'true' or $tkchinh/CT08/CT_II/ct_33 = '1'" >x</xsl:if>] 33) Hoạt động dịch vụ thông tin;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_34 = 'true' or $tkchinh/CT08/CT_II/ct_34 = '1'" >x</xsl:if>] 34) Khai thác dầu thô và khí đốt tự nhiên (không gia hạn đối với thuế thu nhập doanh nghiệp của dầu thô, condensate, khí thiên nhiên thu theo hiệp định, hợp đồng);</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_35 = 'true' or $tkchinh/CT08/CT_II/ct_35 = '1'" >x</xsl:if>] 35) Hoạt động dịch vụ hỗ trợ khai khoáng;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_36 = 'true' or $tkchinh/CT08/CT_II/ct_36 = '1'" >x</xsl:if>] 36) Sản xuất đồ uống;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_37 = 'true' or $tkchinh/CT08/CT_II/ct_37 = '1'" >x</xsl:if>] 37) In, sao chép bản ghi các loại;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_38 = 'true' or $tkchinh/CT08/CT_II/ct_38 = '1'" >x</xsl:if>] 38) Sản xuất than cốc, sản phẩm dầu mỏ tinh chế;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_39 = 'true' or $tkchinh/CT08/CT_II/ct_39 = '1'" >x</xsl:if>] 39) Sản xuất hóa chất và sản phẩm hóa chất;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_40 = 'true' or $tkchinh/CT08/CT_II/ct_40 = '1'" >x</xsl:if>] 40) Sản xuất sản phẩm từ kim loại đúc sẵn (trừ máy móc, thiết bị);</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_41 = 'true' or $tkchinh/CT08/CT_II/ct_41 = '1'" >x</xsl:if>] 41) Sản xuất mô tô, xe máy;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_42 = 'true' or $tkchinh/CT08/CT_II/ct_42 = '1'" >x</xsl:if>] 42) Sửa chữa, bảo dưỡng và lắp đặt máy móc và thiết bị;</div>
<div>[<xsl:if test="$tkchinh/CT08/CT_II/ct_43 = 'true' or $tkchinh/CT08/CT_II/ct_43 = '1'" >x</xsl:if>] 43) Thoát nước và xử lý nước thải;</div>
  </div>	
 </div>
