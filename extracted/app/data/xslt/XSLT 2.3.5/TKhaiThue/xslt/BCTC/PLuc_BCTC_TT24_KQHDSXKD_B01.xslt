...
<tr>
        ...
        <tr>        
         ...
         <tr>        
            ...
            <tr>          
            <td><b>13. Doanh thu hoạt động tín dụng nội bộ</b></td>
            <td class="align-c"><b>41</b></td>
            <td class="align-l"><b><xsl:value-of select="$pluc01/ThuyetMinh/ct41"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/NamNay/ct41)"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/NamTruoc/ct41)"/></b></td>
            </tr>
            <tr> 
            <td><b>14. Chi phí hoạt động tín dụng nội bộ</b></td>
            <td class="align-c"><b>42</b></td>
            <td class="align-l"><b><xsl:value-of select="$pluc01/ThuyetMinh/ct42"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/NamNay/ct42)"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/NamTruoc/ct42)"/></b></td>
            </tr>
            <tr> 
            <td><b>15. Lợi nhuận từ hoạt động tín dụng nội bộ (45=41 - 42)</b></td>
            <td class="align-c"><b>45</b></td>
            <td class="align-l"><b><xsl:value-of select="$pluc01/ThuyetMinh/ct45"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/NamNay/ct45)"/></b></td>
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/NamTruoc/ct45)"/></b></td>
            </tr>
              <tr>        
            <td><b>16. Tổng lợi nhuận kế toán trước thuế (50 = 30 + 40+ 45)</b></td>
            ...
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/NamTruoc/ct50)"/></b></td>
              ...
              <tr>        
            <td><b>17. Chi phí thuế TNDN</b></td>
            ...
            <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pluc01/NamTruoc/ct51)"/></b></td>
              ...
              <tr>        
            <td><b>18. Lợi nhuận sau thuế thu nhập doanh nghiệp (60=50 - 51)</b></td>
