...
<!--start Footer DNKHT -->	
	...
	<!--start Footer tờ khai 01_TKTT_QDMTT-->	
	<xsl:template name="tkhaiFooter_01_TKTT_QDMTT">
		<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
		<br/>
		<div class="footer_div">
			<table>
				<tr>
					...
					<xsl:if test="$kskthue/TKhaiThue/ngayKy">
						...
						tháng <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'mm')"/> 
						năm <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'yyyy')"/></i><br/>
						<b>ĐƠN VỊ CHỊU TRÁCH NHIỆM KÊ KHAI</b><br/>
						<b>hoặc ĐẠI DIỆN HỢP PHÁP CỦA</b><br/>
						<b>ĐƠN VỊ CHỊU TRÁCH NHIỆM KÊ KHAI</b><br/>
						<i>(Chữ ký, ghi rõ họ tên; chức vụ và đóng dấu (nếu có)/Ký điện tử)</i>
						</td>
					</xsl:if>
	...
	<!--start Footer tờ khai 01_TM-->	
	<xsl:template name="tkhaiFooter_01_TM">
		<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
		<br/>
		<div class="footer_div">
			<table>
	...
	<!--start Footer tờ khai 03/TB-DVHT-->	
	<xsl:template name="tkhaiFooter_03_TB_DVHT">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
		<br/>
		<div class="footer_div">
			<table>
				<tr>
					...
					<xsl:if test="$kskthue/TKhaiThue/ngayKy">
						<td style="width:50%;text-align:center">
						<b>ĐƠN VỊ HỢP THÀNH CHỊU TRÁCH NHIỆM KÊ KHAI<br/>hoặc ĐẠI DIỆN HỢP PHÁP CỦA ĐƠN VỊ HỢP THÀNH
						<br/>CHỊU TRÁCH NHIỆM KÊ KHAI</b><br/>
						<i>(Ký, ghi rõ họ tên và đóng dấu (nếu có))</i>
						</td>
					</xsl:if>
					<xsl:if test="not($kskthue/TKhaiThue/ngayKy)">
	...
	<!--start Footer to khai 02/TEM TT31 -->	
	<xsl:template name="tkhaiFooter_02_TEM_TT31">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	...
	<!--start Footer to khai 04/TEM TT23 -->	
