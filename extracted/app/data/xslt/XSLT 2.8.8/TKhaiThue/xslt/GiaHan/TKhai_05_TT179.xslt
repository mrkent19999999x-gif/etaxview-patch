...
xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt">
 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		Khoản 3 và Khoản 4 Điều 3 Thông tư số 179/2013/TT-BTC (ghi cụ thể từng điều kiện và trích dẫn tài liệu chứng minh).</div>
		<div style="padding-top: 4pt;text-align:justify">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- <xsl:value-of select="$tkchinh/ten_LyDoDeNghiXoaNo"/></div>
