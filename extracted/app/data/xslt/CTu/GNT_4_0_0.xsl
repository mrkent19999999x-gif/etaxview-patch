...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" exclude-result-prefixes="xsl xsi ihtkk">
  <xsl:decimal-format name="us" decimal-separator="." grouping-separator=","/>
	 <xsl:include href="../CTu/common/common.xsl"/> 
  <xsl:template match="/">
   ...
   <div style="right: 0;text-align: center;">
            ...
            (ban hành kèm theo Thông tư số 119/2014/TT-BTC ngày 25/08/2014<br/>
            của Bộ Tài Chính)<br/>
		...
		<tr>
		<td colspan="2">hoặc thu tiền mặt để:</td>
		</tr>
		<tr>
		<td colspan="2" style="font-size: 15px;">Nộp vào cho NSNN <xsl:if test="STK_THU = 7111">[X]</xsl:if><xsl:if test="STK_THU != 7111">[&#32;]</xsl:if> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
		&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;TK tạm thu(1) [&#32;]
		&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;TK thu hồi quỹ hoàn thuế GTGT(2) <xsl:if test="STK_THU = 8991 or STK_THU = 3121 or STK_THU =8993 or STK_THU =3397">[X]</xsl:if><xsl:if test="STK_THU != 8991 and STK_THU != 3121 and STK_THU != 8993 and STK_THU != 3397">[&#32;]</xsl:if>
		</td>
		</tr>
		<tr>
		<td>Tại KBNN: <xsl:if test="TEN_KBAC !=''"><span class="ttnt_18"> <xsl:value-of select="TEN_KBAC"/></span></xsl:if></td>
		<td>Tỉnh, TP: <xsl:if test="TEN_TINH_KBAC !=''"><span class="ttnt_20"> <xsl:value-of select="TEN_TINH_KBAC"/></span></xsl:if></td>
		</tr>
		<tr>
		<td colspan="2">
		Mở tại NHTM ủy nhiệm thu: <xsl:if test="LOAI_TK_THU = 02"><xsl:value-of select="STK_THU"/></xsl:if>
		</td>
		</tr>
		<tr>
		<td colspan="2">Trường hợp nộp theo kết luận của CQ có thẩm quyền(3): </td>
		</tr>
		<tr>
		<td colspan="2">Kiểm toán NN &#160;<xsl:if test="ID_TK_KNGHI = 1">[X]</xsl:if><xsl:if test="ID_TK_KNGHI != 1">[&#32;]</xsl:if>
		&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Thanh tra TC <xsl:if test="ID_TK_KNGHI = 2">[X]</xsl:if><xsl:if test="ID_TK_KNGHI != 2">[&#32;]</xsl:if></td>
		</tr>
		<tr>
		<td colspan="2">Thanh tra CP &#160;&#160;&#160;<xsl:if test="ID_TK_KNGHI = 3">[X]</xsl:if><xsl:if test="ID_TK_KNGHI != 3">[&#32;]</xsl:if>
		&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;CQ có thẩm quyền khác <xsl:if test="ID_TK_KNGHI = 4">[X]</xsl:if><xsl:if test="ID_TK_KNGHI != 4">[&#32;]</xsl:if></td>
		</tr>
		<tr>
		...
		<tr>
		<td colspan="2" >Tờ khai HQ số(1):&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;ngày:&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Loại hình XNK(1):</td>
		</tr>
		</table>
		<br/>
          </xsl:for-each>
          <div id="conten_table">
            <table cellpadding="0" cellspacing="0" border="1" id="chungtu_ctiet">
              <tbody >
			  <tr align="center">
				<td colspan="3"><strong class="tb_strong">Phần dành cho NNT ghi khi nộp tiền vào NSNN</strong></td>
				<td colspan="2" style="margin-left:15px;margin-right:15px;"><strong class="tb_strong">Phần dành cho NH ủy nhiệm thu/KBNN ghi khi thu tiền(*)</strong>
				</td>
			  </tr>
                <tr align="center">
                ...
                <tr >
                  <td align="center"><span class="ttnt_27" id="stt" ><countNo><xsl:value-of select="position()"/></countNo></span></td>
                  <td style="height:23px; width:277px;text-align: left;"><span class="ttnt_27"><xsl:value-of select="NDUNG_NOP"/>; Kỳ:
				  <xsl:value-of select="KY_THUE"/>
				  <xsl:if test="GHI_CHU ='' ">.<xsl:value-of select="GHI_CHU"/></xsl:if>
				  <xsl:if test="GHI_CHU !='' ">; Ghi chú:<xsl:value-of select="GHI_CHU"/>.</xsl:if></span></td>
				  <td style="text-align: right;"><span class="ttnt_27" id="sotien"><xsl:value-of select="ihtkk:formatNumber(TIEN_PNOP)"/></span></td>
                  <td style="text-align: center;"><span class="ttnt_27"><xsl:value-of select="MA_NDKT"/></span></td>
                  <td style="text-align: center;"><span class="ttnt_27"><xsl:value-of select="MA_CHUONG"/></span></td>
                ...
                <tr>                 
                  ...
                  <td colspan="2" style="text-align: right;"><strong class="tb_strong">Tổng tiền</strong></td>
                  </xsl:if>
            ...
            <p><i>Tổng số tiền ghi bằng chữ:</i>&#160;&#160;<xsl:value-of select="ihtkk:DocTienBangChu($NDUNG_CTU/CHUNGTU_HDR/TONG_TIEN)"/>&#160;đồng</p>
