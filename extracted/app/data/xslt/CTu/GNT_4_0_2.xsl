...
xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt">
  ...
  <xsl:template match="/">
   ...
   <div style="right: 0;text-align: center;">
			<strong>Mẫu số 02</strong><br/>
            <strong>Ký hiệu: C1-02/NS</strong><br/>
          ...
          <div id="conten_table">
            <table cellpadding="0" cellspacing="0" border="1" id="chungtu_ctiet">
			  ...
			  <tr align="center">
				...
				<td colspan="3" style="margin-left:15px;margin-right:15px;">      <strong class="tb_strong">
	  ...
	  <td style="height:23px; width:40px; text-align: center; vertical-align: middle;">
                    ...
                    <strong class="tb_strong">Số tờ khai/ Số quyết định/ Số thông báo/ Mã định danh hồ sơ (ID)</strong>
                  </td>
				     <td style="height:23px; width:80px; text-align: center;">
                  ...
                  <td style="height:23px; width:75px; text-align: center;">
                    <strong class="tb_strong">Mã NDKT (TM)</strong>
                  </td>
				  <td style="height:23px; width:75px; text-align: center;">
                    <strong class="tb_strong">Mã ĐBHC</strong>
                  </td>
                </tr>
                ...
                <tr >
                 <td align="center" style="vertical-align: middle;">
					...
					<td style="text-align: left;">
                      <span class="ttnt_27">
						<xsl:choose>
							<xsl:when test="SO_TK_TB_QD != '' and ID_KNOP != ''">
								<xsl:value-of select="SO_TK_TB_QD" />/ <xsl:value-of select="ID_KNOP" />
							</xsl:when>
							<xsl:when test="SO_TK_TB_QD != ''">
								<xsl:value-of select="SO_TK_TB_QD" />
							</xsl:when>
							<xsl:when test="ID_KNOP != ''">
...
<!-- 			 <xsl:value-of select="format-number(TIEN_PNOP, '###,###.00','us')"/>  --> 
					...
					<td style="text-align: center;">
                      <span class="ttnt_27">
                        <xsl:value-of select="MA_DBHC_THU"/>
                      </span>
                    </td>
                </tr>
				</xsl:for-each>
