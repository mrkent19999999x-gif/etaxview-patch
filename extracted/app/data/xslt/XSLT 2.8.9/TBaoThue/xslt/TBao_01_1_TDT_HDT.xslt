...
<xsl:include href="../common/common.xsl"/>
	...
	<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Mã số thuế: <xsl:value-of select="$NNhanTBaoThue/maNNhan"/> </div> <br/>-->
				...
				<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ Giấy đề nghị hoàn trả khoản thu Ngân sách Nhà nước số <xsl:value-of select="$ndungTBao/soDeNghiHoan"/> ngày <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'yyyy')"/> và các tài liệu kèm theo của <xsl:value-of select="$NNhanTBaoThue/tenNNhan"/>, mã số thuế <xsl:value-of select="$NNhanTBaoThue/maNNhan"/> gửi đến cơ quan thuế lúc <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'hh')"/> giờ <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'mi')"/> phút <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'ii')"/> giây ngày <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'yyyy')"/>,cơ quan thuế thông báo về việc tiếp nhận hồ sơ đề nghị hoàn thuế của người nộp thuế như sau: </div>
				<br></br>
					...
					<br></br>
					<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Mã giao dịch điện tử của hồ sơ (nếu có): <xsl:value-of select="$ndungTBao/maGiaoDichDTu"/></div>
					<br></br>
