...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Thông tư số 26/2015/TT-BTC ngày 27/02/2015 của Bộ Tài chính'" />
	<xsl:variable name="ghiChuPL" select="''"/>
		 <xsl:call-template name="tkhaiHeader_01GTGT">
		...
		<div class="content">
				<div>Gia hạn [<xsl:if test="HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/GiaHan/maLyDoGiaHan != '' "> X </xsl:if>]</div>
		<div>Lý do gia hạn: <xsl:value-of select="HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/GiaHan/lyDoGiaHan"/></div>
		 ...
		 <table class="tkhai_table">
			 ...
			 <tr>
				...
				<td class="align-c" colspan="2">
							 ...
							 <xsl:if test="$tkchinh/ct21 = '0'">[]</xsl:if>	</td>
			 </tr>
			 <tr>
			 ...
			 <tr>
				<td class="align-c"><b>2</b></td>
				<td class="align-l" colspan="2">Hàng hóa, dịch vụ bán ra chịu thuế GTGT ([27]=[29]+[30]+[32]+[32a]; [28]=[31]+[33])</td>
			 ...
			 <tr>
			  ...
			  <tr>
				...
				<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/HHDVBRaKhongTinhThue/ct32a)"/></td>
     		 </tr>
			 <tr>
			 ...
			 <tr>
				<td class="align-c"><b>2</b></td>
				<td class="align-l" colspan="4"><b>Thuế GTGT mua vào của dự án đầu tư được bù trừ với thuế GTGT còn phải nộp của hoạt động sản xuất kinh doanh cùng kỳ tính thuế</b></td>
