				...
				<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table">
						...
						<xsl:for-each select="$KHBS01/Muc_A/Muc_I/Muc_1/ChiTiet">
					        ...
					        <tr>
								<td></td>
								<td class="align-c"><b>Tổng cộng: [10]</b></td>
				...
				<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table">
						...
						<xsl:for-each select="$KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc">
							...
							<tr>
								...
								<xsl:for-each select="CTietPLuc/ChiTiet">
									<tr>
										<td class="align-l"></td>
										<td class="align-l">
											<xsl:if test="$KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='009601'  
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='006601'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='006602'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='002602'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='002603'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='002605'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='004301'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='009701'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='010101'
											
											">					
												<xsl:value-of select='substring-before(ct2_ten,"-")'/>- <xsl:value-of select="ct2_ma"/> -<xsl:value-of select='substring-after(ct2_ten,"-")'/>
											</xsl:if>
											<xsl:if test="$KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='006603'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='002606'
											or $KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc/ma_PLuc ='003502'
											
											">
												<xsl:value-of select="ct2_ma"/> - <xsl:value-of select="ct2_ten"/>
											</xsl:if>
										</td>
										<xsl:if test="$KHBS01/Header/maTKhai!='914'">
											<td class="align-l">
										...
										<xsl:if test="$KHBS01/Header/maTKhai='914'">
											<td class="align-l">
												<xsl:value-of select="ct3_ma"/> - <xsl:value-of select="ct3_ten"/>
											</td>
										</xsl:if>
					        ...
					        <tr>
								<td class="align-c" colspan="6"><b>Tổng cộng: [11]</b></td>
					...
					<div  class="align-l">3. Xác định số tiền chậm nộp điều chỉnh tăng/giảm (tăng ghi (+), giảm ghi (-)):</div>
							...
							<div  class="align-l">a) Số ngày chậm nộp tính đến ngày 
							<xsl:value-of select="ihtkk:stringDatetime($KHBS01/Muc_A/Muc_I/Muc_3/ct3a_1,'dd/mm/yyyy')"/>: <xsl:value-of select="$KHBS01/Muc_A/Muc_I/Muc_3/ct3a_2"/></div>
				...
				<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table">
						...
						<xsl:for-each select="$KHBS01/Muc_A/Muc_II/ChiTiet">
					        ...
					        <tr>
								<td></td>
								<td class="align-c"><b>Tổng cộng: [12]</b></td>
								<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($KHBS01/Muc_A/Muc_II/tongCong_ct12)"/></b></td>
	         		        </tr>
					</table>
				...
				<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam </i></div>
					<table class="tkhai_table">
                        <tr>
							<td class="align-c"><b>STT</b></td>
							<td class="align-c"><b>Tên Tiểu mục</b></td>
							<td class="align-c"><b>Tăng/giảm số thuế đề nghị hoàn (tăng ghi (+), giảm ghi (-))</b></td>
						</tr>
						<tr>
							<td class="align-c">(1)</td>
							<td class="align-c">(2)</td>
						...
						<xsl:for-each select="$KHBS01/Muc_A/Muc_III/ChiTiet">
					        ...
					        <tr>
								<td></td>
								<td class="align-c"><b>Tổng cộng: [13]</b></td>
