  ...
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="''"/>
      ...
      <!-- Phụ lục PL_NQ101_GTGT -->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL_NQ101_GTGT">	
		<xsl:variable name="pl_nq101" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_NQ101_GTGT'/>
			
		<xsl:call-template name="tkhaiHeader-pluc101GTGT">
		<xsl:with-param name="mauTKhai"   select="''"/>
		<xsl:with-param name="moTaBieuMau"   select="$moTaBieuMau"/>
		<xsl:with-param name="tenPL"   select="'GIẢM THUẾ GIÁ TRỊ GIA TĂNG THEO NGHỊ QUYẾT SỐ 101/2023/QH15'"/>
		     	...
		     	<div class="donvitien"> <i>Đơn vị tiền: đồng Việt Nam</i></div>
						<table class="tkhai_table"  >
							<tr>
							   ...
							   <td class="align-c"><b>Doanh thu hàng hoá, dịch vụ chịu thuế</b></td>
							   <td class="align-c"><b>Tỷ lệ tính thuế GTGT theo quy định</b></td>
							   <td class="align-c"><b>Tỷ lệ tính thuế GTGT sau giảm</b></td>
							...
							<xsl:for-each select="$pl_nq101/BangKeTenHHDV">
                           ...
                           <tr>
                               ...
                               <td class="align-r"> <b><xsl:value-of select="ihtkk:formatNumber($pl_nq101/tongCongGiaTriHHDV)"/></b></td>
                               <td></td>
                                <td></td>
                               <td class="align-r"> <b><xsl:value-of select="ihtkk:formatNumber($pl_nq101/tongCongThueGTGTDuocGiam )"/></b></td>
