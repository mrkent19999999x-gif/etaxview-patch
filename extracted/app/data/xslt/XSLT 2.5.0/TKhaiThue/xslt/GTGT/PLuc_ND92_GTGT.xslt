 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="ghiChuPL" select="''"/>
      ...
      <!-- Phụ lục PL_ND92_GTGT -->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL_ND92_GTGT">	
		<xsl:variable name="pl_nd92" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_ND92_GTGT'/>
			
		<xsl:call-template name="tkhaiHeader-pluc92GTGT">
		<xsl:with-param name="mauTKhai"   select="''"/>
		<xsl:with-param name="moTaBieuMau"   select="$moTaBieuMau"/>
		<xsl:with-param name="tenPL"   select="'GIẢM THUẾ GIÁ TRỊ GIA TĂNG THEO NGHỊ QUYẾT SỐ 406/NQ-UBTVQH15'"/>
		     	...
		     	<div class="donvitien"> <i>Đơn vị tiền: đồng Việt Nam</i></div>
						<table class="tkhai_table"  >
                            ...
                            <tr>
								...
								<td class="align-c">(5)=(4)x70%</td>
								<td class="align-c">(6)=(3)x[(4)-(5)]</td>
							</tr>
							<xsl:for-each select="$pl_nd92/BangKeTenHHDV">
                           ...
                           <tr>
                               ...
                               <td class="align-r"> <b><xsl:value-of select="ihtkk:formatNumber($pl_nd92/tongCongGiaTriHHDV)"/></b></td>
                               <td></td>
                                <td></td>
                               <td class="align-r"> <b><xsl:value-of select="ihtkk:formatNumber($pl_nd92/tongCongThueGTGTDuocGiam )"/></b></td>
