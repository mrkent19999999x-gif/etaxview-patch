...
<xsl:include href="../common/common.xsl"/>
	...
	<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Mã số thuế: <xsl:value-of select="$NNhanTBaoThue/maNNhan"/></div> <br/>
						...
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ hồ sơ đề nghị hoàn thuế điện tử của người nộp thuế gửi tới cơ quan thuế lúc <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'hh')"/> giờ <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'mi')"/> phút <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'ii')"/> giây ngày <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/ngayHoSo,'yyyy')"/>, cơ quan thuế xác nhận việc nộp hồ sơ đề nghị hoàn thuế điện tử của người nộp thuế, cụ thể như sau:</div><br/>
				...
				<tr>
				 ...
				 <xsl:for-each select="$ndungTBao/HoSoHoanThue/CTietHoSoThue">
						...
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;+ Thời gian hẹn trả kết quả giải quyết: <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/thoiGianHenTraKQ,'dd/mm/yyyy')"/></div> 
	<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Trường hợp hồ sơ của người nộp thuế đã gửi thuộc diện hoàn thuế trước, kiểm tra sau nhưng sau khi Cơ quan thuế phân loại hồ sơ của người nộp thuế sang diện kiểm tra trước, hoàn thuế sau thì Cơ quan thuế sẽ có thông báo gửi người nộp thuế ngay sau khi có kết quả phân loại hồ sơ. </div> 
	<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Người nộp thuế cần biết thêm chi tiết, xin vui lòng liên hệ với Cơ quan thuế quản lý để được hỗ trợ trực tiếp.  </div>
