...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<!--start phu luc PL_GDLK2_04-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL_GDLK2-04">	
		<xsl:variable name="PL04_ND132" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_GDLK2-04'/>
			
		<xsl:call-template name="tkhaiHeader-pluc04-132">
	...
	<div class="content">
		<div><b>MỤC I. TỔNG QUAN VỀ HOẠT ĐỘNG PHÂN BỔ THU NHẬP, THUẾ VÀ HOẠT ĐỘNG KINH DOANH THEO QUỐC GIA CƯ TRÚ</b></div>
		    <table class="tkhai_table">
							...
							<xsl:for-each select="$PL04_ND132/Muc_I/CTiet">
	    ...
	    <div><b>MỤC II. DANH MỤC CÁC CÔNG TY CON CỦA TẬP ĐOÀN THEO QUỐC GIA CƯ TRÚ</b></div>
		 <table class="tkhai_table">
							 ...
							 <tr>
							   ...
							   <td class="align-c"><b>Tài chính nội bộ tập đoàn</b></td>
							...
							<xsl:for-each select="$PL04_ND132/Muc_II/CTiet">
									<xsl:variable name="currentRows" select='position()' />
						<tr>
							  <td class="align-l"><xsl:value-of select="ct1_ten"/></td>
