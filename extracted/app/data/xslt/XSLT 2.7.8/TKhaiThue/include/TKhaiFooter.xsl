...
<!--start Footer tờ khai NTNN - TT80-->		
   ...
   <xsl:template name="tkhaiFooter_Pluc02-TBVMT-TT80">
	...
	<div class="footer_div">
	   ...
	   <!--start Footer  -->	
	<xsl:template name="tkhaiFooter_DS_TNCN">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<!--<br/><span>&#160;&#160;Tôi cam đoan số liệu khai trên là đúng và chịu trách nhiệm trước pháp luật về số liệu đã khai./...
	</span>-->
	<div class="footer_div">
		<table >
		<tr>
		    ...
		    <xsl:value-of select="$tkchinh/nguoiNopTien"/> <br/> <br/>	
				<!--<td  width="15%"> </td>-->
		    ...
		    <xsl:value-of select="$tkchinh/keToanTruong"/> <br/> <br/>	
				<!--<td  width="15%"> </td>-->
		    ...
		    <xsl:value-of select="$kskthue/TKhaiThue/nguoiKy"/> <br/> <br/>	
				<!--<td  width="15%"> </td>-->
