	...
	<xsl:template name="tkhaiHeader_DS_TNCN">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table"  width="100%">
				...
				<tr>
					<td class="align-c"><b>DANH SÁCH CHI TIẾT SỐ TIỀN NỘP THUẾ TNCN ÐÃ NỘP THAY CHO TỪNG CÁ NHÂN</b> 
					</td>
				</tr>
					<td class="align-c"><i> (Kèm theo chứng từ nộp NSNN: Số: </i> <xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/soChungTu"/>, <i>số tham chiếu: </i><xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/soThamChieu"/>, <i>ngày </i> <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ngay,'dd/mm/yyyy')"/> <i>) </i> 
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3">
						<b>[03] Tên người nộp thuế (khấu trừ, nộp thay): </b><xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
