					...
					<table class="tkhai_table" >
						 ...
						 <tr>
						  ...
						  <tr>
							...
							<td class="align-c">Tấn/MMBTU/GJ</td>
					     ...
					     <tr>
						   ...
						   <td class="align-c">Thùng/tấn; m3/MMBTU; m3/GJ</td>
							...
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct43)"/></td>
   						  ...
   						  <tr>
							<td class="align-c">18.1</td>
							<td class="align-l">Tỷ lệ (%) nộp ngân sách</td>
							<td class="align-c">[44]</td>
								<td class="align-c">%</td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct44)"/></td>
   						  </tr>
   						  <tr>
							<td class="align-c">18.2</td>
							<td class="align-l">Tỷ lệ (%) để lại Công ty mẹ - PVN</td>
							<td class="align-c">[45]</td>
								<td class="align-c">%</td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct45)"/></td>
   						  </tr>
   						   <tr>
							<td class="align-c">18.3</td>
							<td class="align-l">Số tiền nộp trực tiếp vào ngân sách [46] = [43] x [44]</td>
							<td class="align-c">[46]</td>
							<td class="align-c"><xsl:value-of select="($tkchinh/ten_DonVi)"/></td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct46)"/></td>
   						  </tr>
   						    <tr>
							<td class="align-c">18.4</td>
							<td class="align-l">Số tiền nộp về Công ty mẹ - PVN [47] = [43] x [45]</td>
