...
'" />
	<xsl:variable name="ghiChuPL" select="' '"/>
		...
		<xsl:with-param name="mauTKhai"   select="'02/LNCN-PSC'"/>
					...
					<table class="tkhai_table" >
					     ...
					     <tr>
						   ...
						   <td class="align-c"><xsl:value-of select="($tkchinh/CT28/ten_donvitinh)"/></td>
							...
							<td class="align-l">Lãi dầu, khí sau thuế [39]=[36]-[38]</td>
							...
							<td class="align-l">Lãi dầu, khí nước chủ nhà còn lại theo quyết toán [43]=[41] - [42]</td>
							...
							<td class="align-l"><i>Số tiền lãi phải nộp ngân sách theo quyết toán [46]=[43] x [44]</i></td>
							...
							<td class="align-l">Số tiền lãi dầu, khí tạm tính đã kê khai trong kỳ tính thuế</td>
							...
							<td class="align-l">Chênh lệch giữa số tiền còn phải nộp theo quyết toán với số đã kê khai trong kỳ tính thuế [49]=[46] - [48]</td>
