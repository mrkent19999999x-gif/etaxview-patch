...
80/2021/TT-BTC ngày 29 tháng 9 năm 2021 của Bộ trưởng Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader_BCTL_DK">
		 ...
		 <table class="tkhai_table">
			...
			<tr>
			 ...
			 <tr>
				...
				<td class="align-l">Sản lượng dầu khí dự kiến khai thác trong kỳ tính thuế</td>
				<td class="align-c"></td>
				<td class="align-r"></td>
				<td class="align-r"></td>
				<td class="align-r"></td>
			 ...
			 <tr>
				...
				<td class="align-l"> Tổng số ngày khai thác dầu khí trong kỳ tính thuế</td>
			 ...
			 <tr>
				...
				<td class="align-l">Tỷ lệ lãi nước chủ nhà nộp NSNN</td>
				<td class="align-c">%</td>
				<td class="number align-r"><xsl:value-of select="$tkchinh/CT8/dauTho_8"/></td>
				<td class="number align-r"><xsl:value-of select="$tkchinh/CT8/condensate_8"/></td>
				<td class="number align-r"><xsl:value-of select="$tkchinh/CT8/khiThienNhien_8"/></td>
				<td class="align-l"><xsl:value-of select="$tkchinh/CT7/ghiChu_8"/></td>
			 </tr>
		</table>	 
			</div>
			</div>
...
<td>	  			
			...
			<div class="ghichu">
						<div><i><b><u>Ghi chú:</u></b></i></div><br/>
							<i>- Chỉ tiêu [04]: Tên người nộp thuế là tên người điều hành, doanh nghiệp liên doanh, công ty điều hành chung. </i><br/>
