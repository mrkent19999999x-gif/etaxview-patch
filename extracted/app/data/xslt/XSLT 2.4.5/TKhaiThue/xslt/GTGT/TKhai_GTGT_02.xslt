...
'" />
	<xsl:variable name="ghiChuPL" select="''"/>
		 <xsl:call-template name="tkhaiHeader_02GTGT">
					...
					<table class="tkhai_table"  >
							...
							<tr>
							 ...
							 <tr>
							   ...
							   <td class="align-l">Thông tin dự án đầu tư nhận bàn giao</td>
							   <td class="align-l"></td>
							 </tr>  
							 <tr>
							   <td class="align-c">4.1</td>
							   <td class="align-l">MST nhận bàn giao</td>
							   <td class="align-l"><xsl:value-of select="$tkchinh/TTDADTNhanBanGiao/maSoThueDaBanGiao"/></td>
							 </tr>  
							 <tr>
							   <td class="align-c">4.2</td>
							   <td class="align-l">Tên NNT nhận bàn giao</td>
							   <td class="align-l"><xsl:value-of select="$tkchinh/TTDADTNhanBanGiao/tenNNTDaBanGiao"/></td>
							 </tr>  
							  <tr>
							   <td class="align-c">4.3</td>
							   <td class="align-l">Mã hồ sơ dự án đầu tư nhận bàn giao</td>
							   <td class="align-l"><xsl:value-of select="$tkchinh/TTDADTNhanBanGiao/maHoSoDADTDaBanGiao"/></td>
							 </tr>  
							 <tr>
							   <td class="align-c">4.4</td>
							   <td class="align-l">Tên dự án đầu tư nhận bàn giao</td>
							   <td class="align-l"><xsl:value-of select="$tkchinh/TTDADTNhanBanGiao/tenDuAnDauTuDaBanGiao"/></td>
							 </tr>  
						   </table>		
