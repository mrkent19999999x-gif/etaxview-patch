				...
				<tr>
					<td class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/KyKKhaiThue/kieuKy='Y'">
							<b>[01]</b> Kỳ tính thuế: <b>[01a] </b> <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/> (từ tháng <xsl:value-of select="HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/KyKKhaiThue/kyKKhaiTuThang"/> &#160;đến tháng <xsl:value-of select="HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/KyKKhaiThue/kyKKhaiDenThang"/>)   
                        </xsl:if>
...
Doanh nghiệp, tổ chức kinh tế khai thuế thay, nộp thuế thay theo pháp luật thuế<xsl:if test="$tkchinh/Header/khaiTheoPLuatThue= 'true' ">[x]</xsl:if> 
			...
			<table width="100%" >
				...
				<tr>
					...
					<tr>
						...
						<td colspan="3">
						<b>[12a]</b>Ngày sinh: <xsl:value-of select="$tkchinh/Header/CNKDChuaDangKyThue/ct12a_ngaySinh"/><xsl:value-of select="ihtkk:stringDatetime(ct12a_ngaySinh,'dd/mm/yyyy')" />&#160;&#160;
						
						<b>[12b]</b> Quốc tịch: <xsl:value-of select="$tkchinh/Header/CNKDChuaDangKyThue/ct12b_tenQuocTich"/>
						</td>
					</tr>
					<tr>
						<td colspan="3">
						<b>[12c]</b> Số CMND/CCCD: <xsl:value-of select="$tkchinh/Header/CNKDChuaDangKyThue/ct12c_soCMND_CCCD"/>&#160;&#160;
					
						<b>[12c.1]</b> Ngày cấp: <xsl:value-of select="$tkchinh/Header/CNKDChuaDangKyThue/ct12c_1_ngayCap"/><xsl:value-of select="ihtkk:stringDatetime(ct12c_1_ngayCap,'dd/mm/yyyy')" />&#160;&#160;
						
						<b>[12c.2]</b> Nơi cấp: <xsl:value-of select="$tkchinh/Header/CNKDChuaDangKyThue/ct12c_2_noiCap_ten"/>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td colspan="3">
						<b>[12d]</b> Số hộ chiếu: <xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12d_soHoChieu"/>&#160;&#160;
						
						<b>[12d.1]</b> Ngày cấp: <xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12d_1_ngayCap"/><xsl:value-of select="ihtkk:stringDatetime(ct12d_1_ngayCap,'dd/mm/yyyy')" />&#160;&#160;&#160;&#160;
						
						<b>[12d.2]</b> Nơi cấp: <xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12d_2_noiCap_ten"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12đ]</b> Số giấy thông hành (đối với thương nhân nước ngoài):  <xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12dd_soGiayThongHanh"/>
						</td>
					</tr>
					<tr>
						<td colspan="3">
						<b>[12đ.1]</b>Ngày cấp: <xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12dd_1_ngayCap"/><xsl:value-of select="ihtkk:stringDatetime(ct12dd_1_ngayCap,'dd/mm/yyyy')" />&#160;&#160;
						
						<b>[12đ.2]</b>Nơicấp: <xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12dd_2_noiCap_ten"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12e]</b>Số CMND biên giới (đối với thương nhân nước ngoài): <xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12e_soCMNDBienGioi"/>
						</td>
					</tr>
					<tr>
						<td colspan="3">
						<b>[12e.1]</b>Ngày cấp:<xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12e_1_ngayCap"/><xsl:value-of select="ihtkk:stringDatetime(ct12e_1_ngayCap,'dd/mm/yyyy')" />&#160;&#160;
						
						<b>[12e.2]</b>Nơi cấp:<xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12e_2_noiCap_ten"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12f]</b>Số Giấy tờ chứng thực cá nhân khác:<xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12f_soGiayToKhac"/>
						</td>
					</tr>
					<tr>
						<td colspan="3">
						<b>[12f.1]</b>Ngày cấp:<xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12f_1_ngayCap"/><xsl:value-of select="ihtkk:stringDatetime(ct12f_1_ngayCap,'dd/mm/yyyy')" />&#160;&#160;
						
						<b>[12f.2]</b>Nơi cấp:<xsl:value-of select="$tkchinh/Header/CNKDKhongCoCMND_CCCD/ct12f_2_noiCap_ten"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12g]</b>Nơi đăng ký thường trú:
						</td>
					</tr>
					<tr>
						<td>
						<b>[12g.1]</b>Số nhà, đường phố/xóm/ấp/thôn: <xsl:value-of select="$tkchinh/Header/CT12g/ct12g_soNha"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12g.2]</b>Phường/xã/Thị trấn: <xsl:value-of select="$tkchinh/Header/CT12g/ct12g_tenPhuong"/>
						</td>
					</tr>
						<tr>
						<td>
						<b>[12g.3]</b>Quận/Huyện/Thị xã/Thành phố thuộc tỉnh: <xsl:value-of select="$tkchinh/Header/CT12g/ct12g_tenQuan"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12g.4]</b>Tỉnh/ Thành phố: <xsl:value-of select="$tkchinh/Header/CT12g/ct12g_tenTinh"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12h]</b>Chỗ ở hiện tại:
						</td>
					</tr>
					<tr>
						<td>
						<b>[12h.1]</b>Số nhà, đường phố/xóm/ấp/thôn: <xsl:value-of select="$tkchinh/Header/CT12h/ct12h_soNha"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12h.2]</b>Phường/xã/Thị trấn: <xsl:value-of select="$tkchinh/Header/CT12h/ct12h_tenPhuong"/>
						</td>
					</tr>
						<tr>
						<td>
						<b>[12h.3]</b>Quận/Huyện/Thị xã/Thành phố thuộc tỉnh: <xsl:value-of select="$tkchinh/Header/CT12h/ct12h_tenQuan"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12h.4]</b>Tỉnh/Thành phố: <xsl:value-of select="$tkchinh/Header/CT12h/ct12h_tenTinh"/>
						</td>
					</tr>
					<tr>
						<td>
						<b>[12i]</b>Giấy chứng nhận đăng ký hộ kinh doanh (nếu có): Số<xsl:value-of select="$tkchinh/Header/CT12i/ct12i_soGiayTo"/>
						</td>
					</tr>
					<tr>
					<td colspan="3">
						<b>[12i.1]</b>Ngày cấp: <xsl:value-of select="$tkchinh/Header/CT12i/ct12i_ngayCap"/><xsl:value-of select="ihtkk:stringDatetime(ct12i_ngayCap,'dd/mm/yyyy')" />&#160;&#160;
						
						<b>[12i.2]</b>Cơ quan cấp: <xsl:value-of select="$tkchinh/Header/CT12i/ct12i_coQuanCap"/>
						</td>
					</tr>
					<tr>
					<td>
						<b>[12k]</b>Vốn kinh doanh (đồng) <xsl:value-of select="$tkchinh/Header/ct12k"/>
						</td>
					</tr>
				<xsl:if test="$ttkthue/DLyThue">
					<tr>
	...
	<!-- start header Phuluc 02BK_TTS (TT40/2021)-->
