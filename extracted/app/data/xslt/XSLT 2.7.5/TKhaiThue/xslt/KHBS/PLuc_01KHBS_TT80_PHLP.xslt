		...
		<div class="ndungtkhai_div">
            <div class="content">
				...
				<div  class="align-l">1. Số thuế phải nộp trên tờ khai điều chỉnh tăng/giảm:</div>
					...
					<table class="tkhai_table">
                        <tr>
							...
							<td colspan="2" class="align-c"><b>Tăng/giảm số thuế phải nộp (tăng ghi (+), giảm ghi (-))</b></td>
						</tr>
						<tr>
							<td class="align-c">(1)</td>
							<td class="align-c">(2)</td>
							<td class="align-c">(3a) Số tiền</td>
							<td class="align-c">(3b) Đơn vị tiền</td>
						</tr>
						...
						<xsl:for-each select="$KHBS01/Muc_A/Muc_I/Muc_1/TongCong10">
					        <tr>
								<td></td>
								<td></td>
				...
				<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table">
						...
						<xsl:for-each select="$KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/BKePLuc">
							...
							<tr>
								...
								<xsl:for-each select="CTietPLuc/ChiTiet">
									<tr>
										<td class="align-l"></td>
										<td class="align-l"><xsl:value-of select="ct2_ma"/>   <xsl:value-of select="ct2_ten"/></td>
										<td class="align-l"><xsl:value-of select="ct3_ma"/>   <xsl:value-of select="ct3_ten"/></td>
					        ...
					        <tr>
								...
								<td class="align-c"><b><xsl:value-of select="ihtkk:formatNumber($KHBS01/Muc_A/Muc_I/Muc_2/DSachPLuc/tongCong_ct11)"/></b></td>
	         		        </tr>
					</table>
					<br/>
					...
					<div  class="align-l">b) Số tiền chậm nộp tăng/giảm: 
						<xsl:for-each select="$KHBS01/Muc_A/Muc_I/Muc_3/ChiTietSoTienChamNop">
						<div>Số tiền &#160;<xsl:value-of select="ma_DonViTien"/> chậm nộp tăng/ giảm: &#160;<xsl:value-of select="ct3b"/>
						</div>
						</xsl:for-each>
					</div>
					...
					<table class="tkhai_table">
						...
						<xsl:for-each select="$KHBS01/Muc_A/Muc_II/ChiTiet">
					        ...
					        <tr>
								...
								<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($KHBS01/Muc_A/Muc_I/Muc_II/tongCong_ct12)"/></b></td>
	         		        </tr>
					</table>
