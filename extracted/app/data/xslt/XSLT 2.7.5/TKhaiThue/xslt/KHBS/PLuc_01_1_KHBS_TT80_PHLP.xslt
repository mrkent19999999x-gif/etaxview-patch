				...
				<div  class="align-l"><b>A. Thông tin khai bổ sung:</b></div>
					...
					<table class="tkhai_table">
                        <tr>
							...
							<td colspan="2"  class="align-c"><b>Điều chỉnh tăng/giảm nghĩa vụ thuế</b></td>
						...
						<tr>
							...
							<td class="align-c">(7a) Số tiền</td>
							<td class="align-c">(7b) Đơn vị tiền</td>
						...
						<xsl:for-each select="$KHBS01_1/Muc_A/DSachHSo/BKeHSo">
					        ...
					        <xsl:for-each select="$KHBS01_1/Muc_A/DSachHSo/TongCong/TongCong_7">
					        <tr>
								<td></td>
								<td class="align-l" colspan="4"><b>Tổng cộng (tăng +, giảm -) phải nộp: </b></td>
								<td class="align-c"><b>[7a]</b></td>
								<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber(ct7)"/></b></td>
								<td class="align-c"><b><xsl:value-of select="ma_DonViTien"/></b></td>
								<td class="align-c">\</td>
	         		        </tr>
	         		        </xsl:for-each>
							 <xsl:for-each select="$KHBS01_1/Muc_A/DSachHSo/TongCong/TongCong_8">
							<tr>
								<td></td>
								<td class="align-l" colspan="4"><b>Tổng cộng (tăng +, giảm -) khấu trừ: </b></td>
								<td class="align-c"><b>[08]</b></td>
								<td class="align-r"><b> <xsl:value-of select="ihtkk:formatNumber(ct8)"/></b></td>
								<td class="align-c"><b><xsl:value-of select="ma_DonViTien"/></b></td>
								<td class="align-c">\</td>
	         		        </tr>
	         		        </xsl:for-each>
	         		        <xsl:for-each select="$KHBS01_1/Muc_A/DSachHSo/TongCong/TongCong_9">
							<tr>
								<td></td>
								<td class="align-l" colspan="4"><b>Tổng cộng (tăng +, giảm -) đề nghị hoàn:</b></td>
								<td class="align-c"><b>[09]</b></td>
								<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber(ct9)"/></b></td>
								<td class="align-r"><b><xsl:value-of select="ma_DonViTien"/></b></td>
								<td class="align-c">\</td>
	         		        </tr>
	         		        </xsl:for-each>
					</table>
