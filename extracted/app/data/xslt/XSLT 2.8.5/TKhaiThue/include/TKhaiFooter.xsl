...
<xsl:template name="tkhaiFooter_pluc_32">
   ...
   <xsl:template name="tkhaiFooter_Pluc02-TBVMT-TT80">
	...
	<!--start Footer  -->	
	<xsl:template name="tkhaiFooter_02HT">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>Tôi cam kết các thông tin và tài liệu đã cung cấp là trung thực và đầy đủ và xin chịu trách nhiệm trước pháp luật về các thông tin và tài liệu này./.</span>
		...
		<table style="margin-bottom: 100px">
			<tr>
				<td style="width: 45%" align="top">
					<br/>
					<b>NHÂN VIÊN ĐẠI LÝ THUẾ</b>
					<br/>Họ và tên: <xsl:value-of select="$kskthue/DLyThue/NVienDLy/tenNVienDLyThue"/>
					<br/>Chứng chỉ hành nghề số: <xsl:value-of select="$kskthue/DLyThue/NVienDLy/cchiHNghe"/>
				</td>
				<td style="width: 10%"></td>
				<td style="width: 45%" class="align-c" align="top">
					<br/>
					<i><xsl:value-of select="$tkchinh/TT_ToChucCaNhanDHT/DiaChiVN/ten_tinh_tp"/>, 
					...
					năm <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'yyyy')"/></i>
				
					<xsl:if test="$kskthue/TKhaiThue/ngayKy ">
						<div width="35%" class="align-c">
						<b>NGƯỜI NỘP THUẾ hoặc  <br/> ĐẠI DIỆN HỢP PHÁP CỦA NGƯỜI NỘP THUẾ  </b>
						<br/>
						<i> (Chữ ký, ghi rõ họ tên; chức vụ và đóng dấu (nếu có)/Ký điện tử)</i>
						</div>
					...
					<xsl:if test="not($kskthue/TKhaiThue/ngayKy)">
						<div width="35%" style="text-align:center">
	...
	<!--start Footer phu luc PL_02_1_HT -->		
   <xsl:template name="tkhaiFooter_02TNDN_TT80">
	<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />

	<span>Tôi cam đoan số liệu khai trên là đúng và chịu trách nhiệm trước pháp luật về số liệu đã khai./.</span>
	<div class="footer_div">
		<table style="margin-bottom: 100px">
			<tr>
				<td style="width: 45%" align="top">
	...
	<!--start Footer  -->	
	<xsl:template name="tkhaiFooter_03HTQT">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>Tôi cam kết các thông tin và tài liệu đã cung cấp là trung thực và đầy đủ và xin chịu trách nhiệm trước pháp luật về các thông tin và tài liệu này./.</span>
		...
		<table style="margin-bottom: 100px">
			<tr>
				...
				<td style="width: 45%" class="align-c" align="top">
					<br/>
					<i><xsl:value-of select="$tkchinh/CT_I/CTI_1_NNT/CT1_3a/ten_tinh_tp"/>, 
					Ngày <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'dd')"/> 
					tháng <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'mm')"/> 
					năm <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'yyyy')"/></i>
	...
	<!--start Footer  -->	
	<xsl:template name="tkhaiFooter_06HTQT">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>Tôi cam kết các thông tin và tài liệu đã cung cấp là trung thực và đầy đủ và xin chịu trách nhiệm trước pháp luật về các thông tin và tài liệu này./.</span>
	...
	<!--start Footer 01/DTA-MAP - Đề nghị thủ tục thỏa thuận song phương (MAP)  -->	
	<xsl:template name="tkhaiFooter_01DTA">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>Tôi xin cam đoan tất cả thông tin đã khai trong Đề nghị này và các tài liệu gửi kèm là đúng và chịu trách nhiệm trước pháp luật về thông tin đã khai./.</span>
	 ...
	 <!--start Footer  -->	
	<xsl:template name="tkhaiFooter_01_HTQT_TT80">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>Tôi cam kết các thông tin và tài liệu đã cung cấp là trung thực và đầy đủ và xin chịu trách nhiệm trước pháp luật về các thông tin và tài liệu này./.</span>
	...
	<!--start Footer  -->	
	<xsl:template name="tkhaiFooter_02_HTQT_TT80">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>Tôi cam kết các thông tin và tài liệu đã cung cấp là trung thực và đầy đủ và xin chịu trách nhiệm trước pháp luật về các thông tin và tài liệu này./.</span>
	...
	<!--start Footer  -->	
	<xsl:template name="tkhaiFooter_01_TBH_TB_TT80">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>Tôi cam kết các thông tin và tài liệu đã cung cấp là trung thực và đầy đủ và xin chịu trách nhiệm trước pháp luật về các thông tin và tài liệu này./.</span>
	...
	<!--start Footer  -->	
	<xsl:template name="tkhaiFooter_02_TBH_TB_TT80">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>Tôi cam kết các thông tin và tài liệu đã cung cấp là trung thực và đầy đủ và xin chịu trách nhiệm trước pháp luật về các thông tin và tài liệu này./.</span>
