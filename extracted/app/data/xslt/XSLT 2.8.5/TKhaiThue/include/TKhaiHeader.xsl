...
<tr>
	...
	<!-- start tkhai header 02/HT-->
	<xsl:template name="tkhaiHeader_02HT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBMau"/>
		<div class="header_div">
		<table class="ttinnnt_table" > 
			<tr>
					<td></td>					
					<td style="width:70%;text-align:center"></td>
					<td style="width:100% ; vertical-align: top;" rowSpan="5" align="top">
						<div class="bieu_mau_div">
							<div>Mẫu số: <b>
								<xsl:value-of select="$mauTKhai"/></b><br/>
								<span class="mtatentkhai" style="font-size:9pt">
									<xsl:value-of select="$moTaBMau"/>
								</span>
							</div>
						</div>
					</td>
	...
	<!-- start tkhai header 02_1_HT: Bảng kê chứng từ -->
	<xsl:template name="tkhaiHeader-plucTT02_1_HT">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				<tr>
					<td class="align-c" colspan="3" style="width:80%">
						<br></br><b>BẢNG KÊ CHỨNG TỪ NỘP THUẾ  </b>
					</td>
					</tr>
					<tr>
						<td class="align-c" colspan="3" style="width:80%">
							<i>(Áp dụng đối với trường hợp đề nghị hoàn thuế theo Hiệp định
								tránh đánh thuế hai lần và Điều ước quốc tế khác/trường hợp tổ chức, cá nhân trả thu nhập hoàn thuế TNCN khi quyết toán.<br></br>
								Kèm theo Giấy đề nghị hoàn trả khoản thu NSNN số <xsl:value-of select="$tkchinh/Header/so_GiayDNH"/> 
								ngày <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'dd')"/> 
								tháng <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'mm')"/> 
								năm <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'yyyy')"/>)
							</i>
						</td>
					</tr>
	...
	<!-- start tkhai header 03/HTQT-->
	<xsl:template name="tkhaiHeader_03HTQT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBMau"/>
		<div class="header_div">
		<table class="ttinnnt_table" > 
	...
	<!-- start tkhai header 06/HTQT-->
	<xsl:template name="tkhaiHeader_06HTQT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBMau"/>		
		<div class="header_div">
		<table class="ttinnnt_table" > 
...
<table class="ttinnnt_table"  style="width:100%;text-align:center" > 
			<tr>
					<td>
	...
	<!-- start tkhai header 01/DTA-MAP -->
	<xsl:template name="tkhaiHeader_01DTA">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBMau"/>		
		<div class="header_div">
		<table class="ttinnnt_table" > 
	...
	<!-- start phụ lục tkhai header 01/HTTQ_TT80-->
	<xsl:template name="tkhaiHeader_01_HTQT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c"><b>VĂN BẢN ĐỀ NGHỊ</b> 
					</td>
				</tr>
				<tr>
					<td class="mtatentkhai">
				...
				<tr>
				     <td class="align-c">NNT nộp hồ sơ theo ủy quyền [<xsl:if test="$tkchinh/uyQuyen = 'true' or $tkchinh/uyQuyen = '1'" >x</xsl:if>] 
				     </td>
				</tr>
				<tr>
				     <td class="align-c">
						 <br>Áp dụng miễn, giảm thuế theo Hiệp định thuế giữa Việt Nam và <xsl:value-of select="$tkchinh/tenNuocKKet"/> đối với </br>
						 <xsl:if test="$tkchinh/caNhan = 'true' or $tkchinh/caNhan = '1'" >[&#32;]Tổ chức&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;[x] Cá nhân </xsl:if>
						 <xsl:if test="$tkchinh/toChuc = 'true' or $tkchinh/toChuc = '1'" >[x] Tổ chức&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;[&#32;] Cá nhân</xsl:if>
				     </td>
				</tr>
	...
	<xsl:template name="tkhaiHeader_01_TBH_TB_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c"><b>VĂN BẢN ĐỀ NGHỊ DỰ KIẾN</b> 
					</td>
				</tr>
				<tr>
					<td class="mtatentkhai">
				...
				<tr>
				     <td class="align-c"> <i>Áp dụng miễn, giảm thuế theo Hiệp định tránh đánh thuế hai lần giữa Việt Nam và <xsl:value-of select="$tkchinh/tenNuocKKet"/> đối với các tổ chức nhận tái bảo hiểm nước ngoài có thu nhập từ kinh doanh, không thực hiện chế độ kế toán Việt Nam</i> 
				     </td>
				</tr>
				<tr>
				     <td class="align-c">NNT nộp hồ sơ theo ủy quyền [<xsl:if test="$tkchinh/uyQuyen = 'true' or $tkchinh/uyQuyen = '1'" >x</xsl:if>] 
	...
	<xsl:template name="tkhaiHeader_02_TBH_TB_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c"><b>VĂN BẢN ĐỀ NGHỊ CHÍNH THỨC</b> 
					</td>
				</tr>
				<tr>
					<td class="mtatentkhai">
				...
				<tr>
				     <td class="align-c"> <i>Tiếp theo Văn bản đề nghị dự kiến ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayVanBan,'dd/mm/yyyy')"/></i> 
				     </td>
				</tr>
				<tr>
				     <td class="align-c"> <i>Áp dụng miễn, giảm thuế theo Hiệp định tránh đánh thuế hai lần giữa Việt Nam và <xsl:value-of select="$tkchinh/tenNuocKKet"/> đối với các tổ chức nhận tái bảo hiểm nước ngoài có thu nhập từ kinh doanh, không thực hiện chế độ kế toán Việt Nam</i> 
	...
	<xsl:template name="tkhaiHeader_02_HTQT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c"><b>GIẤY ĐỀ NGHỊ<br/>KHẤU TRỪ THUẾ NƯỚC NGOÀI VÀO THUẾ PHẢI NỘP TẠI VIỆT NAM THEO HIỆP ĐỊNH THUẾ GIỮA VIỆT NAM VÀ <xsl:value-of select="$tkchinh/tenNuocKKet"/></b> 
					</td>
				</tr>
				<tr>
					<td class="mtatentkhai">
				...
				<tr>
				     <td class="align-c"> <i>(Áp dụng cho các tổ chức, cá nhân là đối tượng cư trú của Việt Nam)</i> 
				     </td>
				</tr>
				<tr>
				     <td class="align-c">NNT nộp hồ sơ theo ủy quyền [<xsl:if test="$tkchinh/uyQuyen = 'true' or $tkchinh/uyQuyen = '1'" >x</xsl:if>] 
				...
				<tr>
				     <td class="align-c">Áp dụng cho tổ chức [<xsl:if test="$tkchinh/toChuc = 'true' or $tkchinh/toChuc = '1'" >x</xsl:if>] &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Áp dụng cho cá nhân [<xsl:if test="$tkchinh/caNhan = 'true' or $tkchinh/caNhan = '1'" >x</xsl:if>]
				     </td>
				</tr>
			</table>
			<br/>
