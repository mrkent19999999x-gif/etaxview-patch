 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'(Ban hành kèm theo Thông tư số 80/2021/TT-BTC ngày 29/9/2021 của Bộ trưởng Bộ Tài chính)'" />
		 <xsl:call-template name="tkhaiHeader_01_TBH_TB_TT80">
            ...
            <div class="content">
				...
				<table class="tkhai_table">
					<tr>
						...
						<td class="align-l" colspan = "4">
							...
							<p><i>A. CMND/CCCD</i>[<xsl:if test="$tkchinh/CT2/ct2_1/canCuoc = 'true' or $tkchinh/CT2/ct2_1/canCuoc = '1'" >x</xsl:if>]</p>
			   ...
			   <div class="align-l"><p><b>3. Đối tượng chi trả thu nhập:</b></p>
			    ...
			    <div class="align-l">
					...
					<p>4.1. Số thuế dự kiến đề nghị miễn, giảm <i>(nếu có)</i> <xsl:value-of select="$tkchinh/CT4/ct4_1_soThue"/></p>
	 ...
	 <xsl:call-template name="tkhaiFooter_01_TBH_TB_TT80"></xsl:call-template>
