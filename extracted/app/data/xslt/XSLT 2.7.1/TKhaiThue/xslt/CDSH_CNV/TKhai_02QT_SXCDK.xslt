...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/1999/XSL/Transform file:///C:/Users/DUNGBN/Desktop/111.xml">
	...
	<xsl:template match="/">
		...
		<xsl:call-template name="tkhaiHeader_02QT_SXCDK">
			<xsl:with-param name="mauTKhai" select="'02/QT-SXCDK'"/>
		...
		<div class="ndungtkhai_div">
			<div class="content">
				...
				<td class="align-l" colspan="4"><b>Số thu từ hình thức sắp xếp, chuyển đổi khác phải nộp ngân sách nhà nước</b></td>
				<td class="align-c"><b>[09]</b></td>
				<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct09)"/></b></td>
			    </tr>
				 <tr>
				<td class="align-c"><b>II</b></td>
				<td class="align-l" colspan="4"><b>Số thu từ hình thức sắp xếp, chuyển đổi khác đã nộp ngân sách nhà nước</b></td>
				<td class="align-c"><b>[10]</b></td>
				<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct10)"/></b></td>
			    </tr>
			    	 <tr>
				<td class="align-c"><b>III</b></td>
				<td class="align-l" colspan="4"><b>Số thu từ hình thức sắp xếp, chuyển đổi khác còn phải nộp ngân sách nhà nước</b></td>
				<td class="align-c"><b>[11]</b></td>
				<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct11)"/></b></td>
			    </tr>
				</table>
				<br/>
