...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/1999/XSL/Transform file:///C:/Users/DUNGBN/Desktop/111.xml">
	...
	<xsl:template match="/">
		...
		<xsl:call-template name="tkhaiHeader_01CPH">
			<xsl:with-param name="mauTKhai" select="'01/CPH'"/>
		...
		<div class="ndungtkhai_div">
			<div class="content">
				...
				<td class="align-l" colspan="4">Các khoản thu khác theo quy định tại điểm h khoản 1 Điều 7 Thông tư này, gồm:</td>
				<td class="align-c"><b>[15]</b></td>
				<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct15)"/></td>
			    </tr>
                <tr> 
                 <td class="align-c">a</td>
				<td class="align-l" colspan="4">Tiền thu từ số dư dự phòng bảo hành sản phẩm, hàng hóa, công trình xây dựng không chi hết</td>
				<td class="align-c"><b>[16]</b></td>
				<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct16)"/></td>
			    </tr>
			    <tr> 
                 <td class="align-c">b</td>
				<td class="align-l" colspan="4">Tiền thu từ thu hồi, xử lý nợ và tài sản DATC có trách nhiệm khai, nộp vào ngân sách nhà nước</td>
				<td class="align-c"><b>[17]</b></td>
				<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct17)"/></td>
			    </tr>
			     <tr> 
                 <td class="align-c">c</td>
				<td class="align-l" colspan="4">Tiền thu từ khoản công nợ không tính vào giá trị doanh nghiệp cổ phần hóa của các ngân hàng thương mại và doanh nghiệp viễn thông</td>
				...
				<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/tongCong)"/></td>
			    </tr>
				</table>
				<br/>
