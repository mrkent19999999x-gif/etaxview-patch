	...
	<xsl:template name="tkhaiHeader_02_XD_PNTT">
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_GTGT = 'true'">
							 Loại thuế: Giá trị gia tăng [X]<b> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;  </b>Thu nhập cá nhân: [&#32;]    
                        </xsl:if>
						<xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_GTGT = '1'">
							 Loại thuế: Giá trị gia tăng [X]<b>  &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </b>Thu nhập cá nhân: [&#32;]    
                        </xsl:if>
						<xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_TNCN = 'true'">
							 Loại thuế: Giá trị gia tăng [&#32;]<b>  &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; </b>Thu nhập cá nhân: [x]    
                        </xsl:if>
						<xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_TNCN = '1'">
							 Loại thuế: Giá trị gia tăng [&#32;]<b> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;  </b>Thu nhập cá nhân: [x]    
                        </xsl:if>
					</td>
				</tr>
...
<tr>
	...
	<!-- start tkhai header 02_1_HT-->
<xsl:template name="tkhaiHeader-plucTT02_1_HT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table class="ttinnnt_table">
					<!--<tr>
					<td class="align-c" colspan="3" style="width:80%">
						<b>BẢNG KÊ CHỨNG TỪ NỘP THUẾ </b>
					</td>
					</tr>
					<tr>
					<td class="align-c" colspan="3" style="width:80%">
						<i>(Áp dụng đối với trường hợp đề nghị hoàn thuế theo Hiệp định
 tránh đánh thuế hai lần và Điều ước quốc tế khác/trường hợp tổ chức, cá nhân trả thu nhập hoàn thuế TNCN khi quyết toán.
Kèm theo Giấy đề nghị hoàn trả khoản thu NSNN số ... ngày ... tháng... năm...)</i>
					</td>
					</tr>-->
					<tr>
					<td class="align-c" colspan="3" style="width:80%">
				...
				<tr>
				<td class="align-c" colspan="3">
							<div style="width:90%;text-align:center"><b>[01]</b> Kỳ đề nghị hoàn: Từ kỳ <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PL02_1_HT/tuKy"/> đến kỳ <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PL02_1_HT/denKy"/> </div>
					</td>
				</tr>
				<!--<tr>
					<td class="align-c">
				...
				<tr>
					<td class="align-l">
						[03] Mã số thuế: <xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
					...
					<tr>
						<td class="align-l">
							[05] Mã số thuế: <xsl:value-of select="$ttkthue/DLyThue/mstDLyThue"/>
						</td>
					</tr>
				</xsl:if>
				<xsl:if test="not($ttkthue/DLyThue)">
	...
	<!-- start header 01_DS_DK (TT80/2021)-->
	<xsl:template name="tkhaiHeader_01_DS_TK">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table"  width="100%">
				...
				<tr>
					<td colspan="3">
						<b>1. Tên ngân hàng thương mại: </b><xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
				...
				<tr>
					<td>
						<b>3. Địa chỉ: </b>  <xsl:value-of select="$ttkthue/NNT/dchiNNT"/>
					</td>
				</tr>
				<tr>
					<td>
						<b></b> Quận/Huyện: <xsl:value-of select="$ttkthue/NNT/tenHuyenNNT"/>
					</td>
					<tr>
					</tr>
					<td>
						<b></b> Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/>
					</td>
				</tr>
			</table>
		</div>
	</xsl:template>
	<!-- start tkhai header 01/DNHUY-->
	<xsl:template name="tkhaiHeader_01DNHUY">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	...
	<!-- start header Phuluc 01-1/HKNN-->
	<xsl:template name="tkhaiHeaderPL01_1_HKNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start header Phuluc 01-2/HKNN-->
	<xsl:template name="tkhaiHeaderPL01_2_HKNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- end header Phuluc 01-1/HKNN-->
		<!-- start tkhai header 01a/ĐNHT -->
	<xsl:template name="tkhaiHeader_01aDNHT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>
						<b>[04]</b> CMND/Hộ chiếu số: <xsl:value-of select="$tkchinh/Header/soCMND_HoChieu"/>
					</td>
					<td>
						Ngày cấp: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ngayCap,'dd/mm/yyyy')"/>
					</td>
						</tr>
					<tr>
					<td>
						Nơi cấp: <xsl:value-of select="$tkchinh/Header/noiCap"/>
					</td>
					<td>
						Quốc tịch: <xsl:value-of select="$tkchinh/Header/quocTich_ten"/>
					</td>
					</tr>
	...
	<!-- start header Thong bao chuyen loi nhuan ra NN (TT80/2021)-->
	<xsl:template name="tkhaiHeader_TB_chuyen_LN_ra_NN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<br/>
						Năm: <xsl:value-of select="$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhai"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
	...
	<!-- start tkhai header plucNQ101GTGT -->
	<xsl:template name="tkhaiHeader-pluc101GTGT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start tkhai header 01/CPH-->
	<xsl:template name="tkhaiHeader_01CPH">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
						...
						<td class="align-c"> Doanh nghiệp [ <xsl:if test="$tkchinh/Header/DoiTuong/doanhNghiep = 'true' or $tkchinh/Header/DoiTuong/doanhNghiep= '1' "> X </xsl:if>]     
                        Đơn vị sự nghiệp công lập : [<xsl:if test="$tkchinh/Header/DoiTuong/donViSuNghiep = 'true' or $tkchinh/Header/DoiTuong/donViSuNghiep = '1' "> X </xsl:if>]      
</td>  
				</tr>
				<tr>
				</tr>
				...
				<tr>
					 <td colspan="4">
						Tại doanh nghiệp, đơn vị sự nghiệp: <xsl:value-of select="$tkchinh/Header/ten_DN_DVi"/>
					</td>
				</tr>
					<tr>
					<td colspan="4">
						 Mã số thuế: <xsl:value-of select="$tkchinh/Header/maSoThue"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
                ...
                <tr>
					<td class="align-c">
						 Từ <xsl:value-of select="$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay"/>
                         đến <xsl:value-of select="$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay"/>
						 </td>
				</tr>
				<tr>
					<td class="align-c">
	...
	<!-- start tkhai header 02/QT-CNV -->
	<xsl:template name="tkhaiHeader_02_QT_CNV">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
						...
						<td class="align-c"> Chuyển nhượng vốn [ <xsl:if test="$tkchinh/Header/DoiTuong/chuyenNhuongVon= 'true' or $tkchinh/Header/DoiTuong/chuyenNhuongVon= '1' "> X </xsl:if>]     
                       Chuyển nhượng quyền mua cổ phần [<xsl:if test="$tkchinh/Header/DoiTuong/muaCoPhan = 'true' or $tkchinh/Header/DoiTuong/muaCoPhan= '1' "> X </xsl:if>]   
                        Chuyển nhượng quyền góp vốn [<xsl:if test="$tkchinh/Header/DoiTuong/gopVon = 'true' or $tkchinh/Header/DoiTuong/gopVon= '1' "> X </xsl:if>]
</td>  
				</tr>
                <tr>
				</tr>
				...
				<tr>
					 <td colspan="4">
						Tại doanh nghiệp: <xsl:value-of select="$tkchinh/Header/ten_DN_DVi"/>
					</td>
				</tr>
					<tr>
					<td colspan="4">
...
<!-- start tkhai header 01/CNV -->
	<xsl:template name="tkhaiHeader_01CNV">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
						...
						<td class="align-c"> Chuyển nhượng vốn [ <xsl:if test="$tkchinh/Header/DoiTuong/nhuongVon/chuyenNhuongVon= 'true' or $tkchinh/Header/DoiTuong/nhuongVon/chuyenNhuongVon= '1' "> X </xsl:if>]     
                        Chuyển nhượng quyền mua cổ phần [<xsl:if test="$tkchinh/Header/DoiTuong/muaCoPhan = 'true' or $tkchinh/Header/DoiTuong/muaCoPhan= '1' "> X </xsl:if>]   
                        Chuyển nhượng quyền góp vốn [<xsl:if test="$tkchinh/Header/DoiTuong/gopVon = 'true' or $tkchinh/Header/DoiTuong/gopVon= '1' "> X </xsl:if>]
</td>  
				</tr>
	...
	<!-- start tkhai header 02_QT/SXCDK-->
	<xsl:template name="tkhaiHeader_02QT_SXCDK">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- start tkhai header 01CLVCSH_VDL TT57-->
	<xsl:template name="tkhaiHeader_01CLVCSH_VDL">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
