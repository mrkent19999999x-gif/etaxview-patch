...
<!--start phu luc PL03_3B_TNDN-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_03_3B_TNDN">	
			<xsl:variable name="pl03-3b-tndn" select='HSoThueDTu/HSoKhaiThue/PLuc/PLuc_03_3B_TNDN' />
       ...
       <xsl:with-param name="tenPL1"   select="'Đối với cơ sở kinh doanh đầu tư mở rộng quy mô, nâng cao công suất, đổi mới công nghệ sản xuất (dự án đầu tư mở rộng)'"/>
...
đồng thời nộp Phụ lục này kèm tờ khai quyết toán thuế thu nhập doanh nghiệp số 03/TNDN tại trụ sở chính)'"/>
		...
		<xsl:for-each select="$pl03-3b-tndn/NoiDungPL03_3B">
		            ...
		            <table>	
					    <table class="tkhai_table">
						   <tr>
							   ...
							   <td colspan='5' class="align-c">Thông tin dự án đầu tư</td>
						   ...
						   <tr>
							   <td rowspan='2' class="align-c">Điều kiện được hưởng ưu đãi thuế</td>
							   <td rowspan='2' class="align-c">Tên dự án đầu tư</td>
							   <td rowspan='2' class="align-c">Mã dự án đầu tư (nếu có)</td>
							   <td rowspan='2' class="align-c">Tiêu chí đáp ứng dự án đầu tư mở rộng</td>
						   ...
						   <tr>
							   ...
							   <td class="align-c"><i>(25)</i></td>
							   <td class="align-c"><i>(26)=(22)+ (24)+(25)</i></td>
						    </tr>
						    <xsl:for-each select="thueTNDN_uuDai/ChiTiet_Pluc">
							   ...
							   <tr>
								   ...
								   <td class="align-c"><xsl:value-of select="ct9_ten"/></td>
								   ...
								   <td class="align-r"><xsl:value-of select="ct13"/></td>
