		   ...
		   <div class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					<table class="tkhai_table">
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><b><xsl:value-of select="$tkchinh/ctB1"/></b></td>
						 </tr>  
						 <tr>
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><b><xsl:value-of select="$tkchinh/ctB8"/></b></td>
						 </tr>  
						 <tr>
						...
						<tr>
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><b><xsl:value-of select="$tkchinh/ctB13"/></b></td>
						 </tr>  
						 <tr>
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctB15"/></td>
						 </tr> 
						 <tr>
						...
						<tr>
						   <td class="align-c"></td>
						   <td class="align-l">Loại thu nhập miễn thuế <xsl:value-of select="$tkchinh/ten_loaiMien"/></td>
						   <td class="align-c"></td>
						   <td class="align-c"></td>
						 </tr>
						 <tr>
						...
						<tr>
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><i><xsl:value-of select="$tkchinh/ctC3a"/></i></td>
						 </tr>  
						 	<tr>
						   <td class="align-c">3.2</td>
						   <td class="align-l"><i>+ Lỗ từ chuyển nhượng BĐS được bù trừ với lãi của hoạt động SXKD</i></td>
						   <td class="align-c"><i>C3b</i></td>
						   <td class="number align-r"><i><xsl:value-of select="$tkchinh/ctC3b"/></i></td>
						 </tr>  					 
						 <tr>
						 ...
						 <tr>
						   ...
						   <td class="align-l"><i>+ Thu nhập tính thuế áp dụng thuế suất 20%</i></td>
						   <td class="align-c"><i>C7</i></td>
						   <td class="number align-r"><i><xsl:value-of select="$tkchinh/ctC7"/></i></td>
						 </tr>  
						 <tr>
						   ...
						   <td class="number align-r"><i><xsl:value-of select="$tkchinh/ctC8"/></i></td>
						 </tr>  
						 <tr>
						   <td class="align-c"><i>6.3</i></td>
						   <td class="align-l"><i>+ Thuế suất không ưu đãi khác (%)</i></td>
						   <td class="align-c"><i>C8a</i></td>
						   <td class="number align-r"><i><xsl:value-of select="$tkchinh/ctC8a"/></i></td>
						 </tr>  
						 <tr>
						   <td class="align-c">7</td>
						   <td class="align-l">Thuế TNDN từ hoạt động SXKD tính theo thuế suất không ưu đãi(C9 =(C7 x 20%) + (C8 x C8a))</td>
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctC17"/></td>
						 </tr> 						  						 						 						 						 						 						  
						 <tr>
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctD7"/></td>
						 </tr>
						 <tr>
						   <td class="align-c">8</td>
						   <td class="align-l">Thuế TNDN của hoạt động chuyển nhượng BĐS còn phải nộp kỳ này (D8=D6-D7)</td>
						   <td class="align-c">D8</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctD8"/></td>
						 </tr>
						 <tr>
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><i><xsl:value-of select="$tkchinh/ctE3"/></i></td>
						 </tr>
						 <tr>
						   ...
						   <td class="number align-r"><i><xsl:value-of select="$tkchinh/ctE4"/></i></td>
						 </tr>
						 <tr>
						   <td class="align-c">3</td>
						   <td class="align-l">Thuế TNDN phải nộp khác (nếu có) </td>
						   <td class="align-c">E5</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctE5"/></td>
						 </tr>	
						<tr>
						   ...
						   <td class="number align-r"><i><xsl:value-of select="$tkchinh/ctE6"/></i></td>
						 </tr>
						 <tr>
						   <td class="align-c"><b>G</b></td>
						   <td class="align-l"><b>Số thuế TNDN đã tạm nộp (G=G1+G2+G3+G4+G5)</b></td>
						   <td class="align-c"><b>G</b></td>
						   <td class="number align-r"><b><xsl:value-of select="$tkchinh/ctG"/></b></td>
						 </tr>  
						 <tr>
						   <td class="align-c"><b><i>1</i></b></td>
						   <td class="align-l"><b><i>Thuế TNDN đã tạm nộp của hoạt động sản xuất kinh doanh</i></b></td>
						   <td class="align-c"></td>
						   <td class="number align-r"><b><i><xsl:value-of select="$tkchinh/thueTNDN_tamnop_sxkd"/></i></b></td>
						 </tr>  
						 <tr>
						   <td class="align-c">1.1</td>
						 ...
						 <tr>
						   ...
						   <td class="align-c"></td>
						   <td class="number align-r"><b><i><xsl:value-of select="$tkchinh/thueTNDN_tamnop_cnbds"/></i></b></td>
						 </tr>  
						 <tr>
						   <td class="align-c">2.1</td>
						 ...
						 <tr>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctG4"/></td>
						 </tr>
						 <tr>
						   <td class="align-c">2.3</td>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctG5"/></td>
						 </tr>
						 <tr>
						...
						<tr>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctH1"/></td>
						 </tr>
						 <tr>
						   <td class="align-c">2</td>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctH2"/></td>
						 </tr>
						 <tr>
						   <td class="align-c">3</td>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctH3"/></td>
						 </tr>
						 <tr>
						...
						<tr>
						   ...
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctI1"/></td>
						 </tr>
						 <tr>
						   <td class="align-c">2</td>
						   <td class="align-l">Thuế TNDN còn phải nộp của hoạt động chuyển nhượng BĐS</td>
						   <td class="align-c">I2=E2-G3-G4-G5</td>
						   <td class="number align-r"><xsl:value-of select="$tkchinh/ctI2"/></td>
						 </tr>
					   </table>	 
		 </div>		
      </div>	
