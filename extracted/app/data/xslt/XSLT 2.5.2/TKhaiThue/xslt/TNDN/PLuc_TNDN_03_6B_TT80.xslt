...
<!--start phu luc PL03_6B_TNDN-->
	<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_03_6B_TNDN">	
	<xsl:variable name="pl03-6b-tndn" select='HSoThueDTu/HSoKhaiThue/PLuc/PLuc_03_6B_TNDN' />
		...
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo tờ khai quyết toán thuế thu nhập doanh nghiệp số 03/TNDN)'"/>
					...
					<div class="content">
						...
						<table class="tkhai_table">
						   ...
						   <xsl:for-each select="$pl03-6b-tndn/xuLyQuy">
						...
						<tr >
							 ...
							 <td></td>
							 <td></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6b-tndn/tong06"/></b></td>
							</tr>
						   </table>			
                       </div>
					</div>
