...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<!--start phu luc PL_ND92-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL_ND92">	
		<xsl:variable name="pl_nd92" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_ND92'/>
			
		<xsl:call-template name="tkhaiHeader-pluc92">
		<xsl:with-param name="mauTKhai"   select="''"/>
		<xsl:with-param name="moTaBieuMau"   select="$moTaBieuMau"/>
		<xsl:with-param name="tenPL"   select="'THUẾ THU NHẬP DOANH NGHIỆP ĐƯỢC GIẢM THEO NGHỊ QUYẾT SỐ 406/NQ-UBTVQH15'"/>
		...
		<div class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div><br/>
		    <table class="tkhai_table">
						...
						<tr>
							 ...
							 <td class="number align-r"><xsl:value-of select="$pl_nd92/ct10"/></td>
						</tr>
						<tr>
							 <td></td>
						...
						<tr>
							 ...
							 <td class="number align-r"><xsl:value-of select="$pl_nd92/ct15"/></td>
						</tr>
						<tr>
							 ...
							 <td class="number align-r"><xsl:value-of select="$pl_nd92/ct16"/></td>
						</tr>
						<tr>
							 <td class="align-c">2.3</td>
							 <td class="align-l">Thuế TNDN được giảm khác</td>
							 <td class="align-c">[17]</td>
							 <td class="number align-r"><xsl:value-of select="$pl_nd92/ct17"/></td>
						</tr>
				   </table>
	</div>	
   </div>
