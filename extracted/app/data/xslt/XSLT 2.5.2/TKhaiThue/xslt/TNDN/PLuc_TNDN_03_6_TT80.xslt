...
<!--start phu luc PL03_6A_TNDN-->
	<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_03_6_TNDN">	
	<xsl:variable name="pl03-6-tndn" select='HSoThueDTu/HSoKhaiThue/PLuc/PLuc_03_6_TNDN' />
	<xsl:call-template name="tkhaiHeader-pluc-03-1a-tndn-tt80">
		...
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo tờ khai quyết toán thuế thu nhập doanh nghiệp số 03/TNDN)'"/>
					...
					<div class="content">
							...
							<div class="align-l"><b>[04]</b> Mức trích lập (%): <xsl:value-of select="ihtkk:formatNumber($pl03-6-tndn/ct04)"/></div>
							<div class="align-l"><b>[05]</b> Số tiền trích lập: <xsl:value-of select="ihtkk:formatNumber($pl03-6-tndn/ct05)"/> Đồng Việt Nam</div>
						...
						<table class="tkhai_table">
						   ...
						   <xsl:for-each select="$pl03-6-tndn/theoDoiQuy">
						...
						<tr >
							 ...
							 <td></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong4"/></b></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong5"/></b></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong6"/></b></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong7"/></b></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong8"/></b></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong9"/></b></td>
							</tr>
						   </table>
							
							<div class="align-l"><b>III. Xử lý Quỹ khi doanh nghiệp không sử dụng, sử dụng không hết và sử dụng không đúng mục đích</b></div>          
  							<!-- <div class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div> -->
						<table class="tkhai_table">
						    <tr>
						       <td class="align-c" rowspan='2'><b>STT</b></td>
							   <td class="align-c" rowspan='2'><b>Năm trích lập</b></td>
							   <td class="align-c" rowspan='2'><b>Mức trích lập trong kỳ tính thuế</b></td>
							   <td class="align-c" rowspan='2'><b>Số tiền trích lập trong kỳ tính thuế</b></td>
							   <td class="align-c" rowspan='2'><b>Số nhận điều chuyển trong kỳ tính thuế</b></td>
							   <td class="align-c" rowspan='2'><b>Số điều chuyển trong kỳ tính thuế</b></td>     
							   <td class="align-c" rowspan='2'><b>Số tiền đã sử dụng</b></td>
							   <td class="align-c" rowspan='2'><b>Số tiền đã nộp về Quỹ phát triển KHCN</b></td>
							   <td class="align-c" colspan='2'><b>Xử lý Quỹ khi doanh nghiệp không sử dụng, sử dụng không hết và sử dụng không đúng mục đích </b></td>
							   <td class="align-c" rowspan='2'><b>Thuế suất thuế TNDN (%)</b></td>
							   <td class="align-c" rowspan='2'><b>Thuế TNDN phải nộp</b></td>
							   <td class="align-c" colspan='2'><b>Tiền lãi phải nộp</b></td>
							   <td class="align-c" rowspan='2'><b>Tổng số tiền phải nộp</b></td>
						   </tr>
						   <tr>
						      <td class="align-c"><b>Số tiền Quỹ còn lại do sử dụng không hết 70% số quỹ đã trích lập</b></td>
						      <td class="align-c"><b>Số tiền Quỹ sử dụng không đúng mục đích</b></td>
							  <td class="align-c"><b>Do sử dụng không hết 70% số quỹ đã trích lập</b></td>
							  <td class="align-c"><b>Do sử dụng không đúng mục đích</b></td>
						   </tr>
						   <tr>
						      <td class="align-c"><i>(1)</i></td>
						      <td class="align-c"><i>(2)</i></td>
						   ...
						   <xsl:for-each select="$pl03-6-tndn/xuLyQuy">
						   	    <xsl:variable name="currentRows" select='position()' />
						<tr>
						     <td class="align-c"><xsl:value-of select="$currentRows" /></td>
							 <td class="align-c"><xsl:value-of select="ct2"/></td>
						...
						<tr >
							 ...
							 <td></td>
							 <td></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong_13"/></b></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong_14"/></b></td>
							 <td class="align-r"><b class="number"><xsl:value-of select="$pl03-6-tndn/tong06"/></b></td>
							</tr>
						   </table>
                       </div>
					</div>
