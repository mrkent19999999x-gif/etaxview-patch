  ...
  <xsl:include href="../../common/common.xsl"/>
	...
	<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Thông tư số 80/2021/TT-BTC ngày 29 tháng 9 năm 2021 của Bộ trưởng Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader_02_NTNN_TT80">
					...
					<table class="tkhai_table"  >
							<tr class="tkhaiheader">
							 ...
							 <tr>
							   ...
							   <td>Số thuế còn phải nộp (7=5-6 &gt;0)</td>
							 ...
							 <tr>
							   ...
							   <td>Thuế giá trị gia tăng (7a=5a-6a &gt;0)</td>
							 ...
							 <tr>
							   ...
							   <td>Thuế thu nhập doanh nghiệp (7b=5b-6b &gt;0)</td>
							 ...
							 <tr>
							   ...
							   <td>Số thuế nộp thừa (8=trị tuyệt đối của 5-6 nếu 5-6&lt;0)</td>
							   
							   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/SoThueNopThua/quyetToan)"/></td>
							   
							   <td class="align-l"><xsl:value-of select="$tkchinh/SoThueNopThua/ghiChu"/></td>
							 </tr>
							 <tr>
							   <td class="align-c">8a</td>
							   <td>Thuế giá trị gia tăng (8a=trị tuyệt đối của 5a-6a nếu 5a-6a&lt;0)</td>
							   
							   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ThueGTGTNopThua/quyetToan)"/></td>
							  
							   <td class="align-l"><xsl:value-of select="$tkchinh/ThueGTGTNopThua/ghiChu"/></td>
							 </tr>
							 <tr>
							   <td class="align-c">8b</td>
							   <td>Thuế thu nhập doanh nghiệp (8b=trị tuyệt đối của 5b-6b nếu 5b-6b&lt;0)</td>
							   
							   <td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ThueTNDNNopThua/quyetToan)"/></td>
							   
							   <td class="align-l"><xsl:value-of select="$tkchinh/ThueTNDNNopThua/ghiChu"/></td>
							 </tr>
					</table>
      </div>	
      </div>
