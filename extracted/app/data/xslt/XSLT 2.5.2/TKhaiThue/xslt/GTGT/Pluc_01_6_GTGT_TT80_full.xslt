 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
	  ...
	  <!-- Phụ lục 01-6/GTGT TT80 -->
		...
		<xsl:variable name="pl01_6" select='HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT'/>
		<xsl:call-template name="tkhaiHeader_PL_01_6_GTGT_TT80">
            ...
            <div class="content">
				<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
					...
					<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT/ct10a_csxs = '1'"> 
						<tr>
							<td class="align-l" colspan="9"><b>Số thuế phải nộp của cơ sở sản xuất</b></td>
							<td class="align-c"><b>[06]</b></td>
							<td class="align-r"><b><xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT/ct06"/></b></td>
						</tr>
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT/ct07"/></b></td>
						</tr>
						<tr>
							...
							<td class="align-c" colspan="3"><b>Doanh thu sản phẩm sản xuất của cơ sở sản xuất (chưa có thuế giá trị gia tăng)</b></td>
							<td class="align-c" rowspan="2"><b>Số thuế phải nộp cho từng tỉnh nơi có cơ sở sản xuất</b></td>
						...
						<tr>
							<xsl:for-each select="$pl01_6/cong_ct18">
								<xsl:variable name="currentRows" select='position()'/>
								<tr>
						...
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01_6/CongCacTinh/ct19)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01_6/CongCacTinh/ct23)"/></b></td>
						</tr>
						<tr>
							<td class="align-l" colspan="9"><b>Số thuế phải nộp cho nơi NNT đóng trụ sở chính <br></br>([20]=[06]-[19] hoặc [24]=[06]-[23])</b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01_6/SoThuePhaiNop/ct20)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01_6/SoThuePhaiNop/ct20)"/></b></td>
						</tr>
					</xsl:if>
					<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT/ct10a_csxs = 'true'"> 
						<tr>
							<td class="align-l" colspan="9"><b>Số thuế phải nộp của cơ sở sản xuất</b></td>
							<td class="align-c"><b>[06]</b></td>
							<td class="align-r"><b><xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT/ct06"/></b></td>
					...
					<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT/ct10a_dvvt = '1'"> 
						<tr>
					...
					<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT/ct10a_dvvt = 'true'"> 
						<tr>
							<td class="align-l" colspan="9"><b>Số thuế phải nộp của dịch vụ viễn thông cước trả sau</b></td>
							<td class="align-c"><b>[06]</b></td>
							<td class="align-r"><b><xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT/ct06"/></b></td>
