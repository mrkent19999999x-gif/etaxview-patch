 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
	  ...
	  <!-- Phụ lục 01-6/GTGT TT80 -->
		...
		<xsl:variable name="pl01_6_1" select='HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_CSSX'/>
		<xsl:call-template name="tkhaiHeader_PL_01_6_1_GTGT_TT80">
				...
				<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>
                    <table class="tkhai_table">
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber(HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_CSSX/ct06)" /></b></td>
						</tr>
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber(HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_CSSX/ct07)" /></b></td>
						</tr>
						<tr>
							...
							<td class="align-c" colspan="3"><b>Doanh thu sản phẩm sản xuất của cơ sở sản xuất</b></td>
						...
						<xsl:for-each select="$pl01_6_1/NoiDungBangPhanBo">
						...
						<tr>
							<xsl:for-each select="$pl01_6_1/cong_ct18">
								<xsl:variable name="currentRows" select='position()'/>
								<tr>
						...
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01_6_1/CongCacTinh/ct19)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01_6_1/CongCacTinh/ct23)"/></b></td>
						</tr>
						<tr>
							<td class="align-l" colspan="9"><b>Số thuế phải nộp cho nơi NNT đóng trụ sở chính <br></br>([20]=[06]-[19] hoặc [24]=[06]-[23])</b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01_6_1/SoThuePhaiNop/ct20)"/></b></td>
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl01_6_1/SoThuePhaiNop/ct24)"/></b></td>
						</tr>
					</table>
			</div>
