	...
	<xsl:template match="/">
		...
		<div class="ndungtkhai_div">
			<div class="content">
				...
				<tr>
					<td>
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Hiện nay, cơ sở chúng tôi đang thực hiện khai thuế: <xsl:value-of select="$tkchinh/ten_loai_thue_GTGT"/>, <xsl:value-of select="$tkchinh/ten_loai_thue_TNCN"/>
						 theo kỳ tính thuế Tháng, đủ điều kiện khai thuế theo kỳ tính thuế Quý và lựa chọn khai thuế theo kỳ tính thuế Quý.
					</td>
				</tr>
				<tr>
					<td>
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Cơ sở chúng tôi đề nghị được áp dụng kỳ tính thuế:  <xsl:value-of select="$tkchinh/ten_loai_thue_GTGT"/>, <xsl:value-of select="$tkchinh/ten_loai_thue_TNCN"/> theo Quý kể từ kỳ tính thuế Quý I năm <xsl:value-of select="$tkchinh/nam"/>
					</td>
				</tr>
				<tr>
					<td>
