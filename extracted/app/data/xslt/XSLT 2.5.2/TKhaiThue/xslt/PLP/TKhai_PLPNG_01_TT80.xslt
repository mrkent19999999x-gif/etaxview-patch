 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>   
	<xsl:template match="/">
		...
		<xsl:with-param name="mauTKhai"   select="'01/PHLPNG'"/>
				...
				<td>
					<table class="tkhai_table"  >
							<thead>
							 ...
							 <xsl:for-each select="$tkchinh/NoiDung01PLPNG/ChiTietPhiLePhiKhoanThuKhac">
									<xsl:variable name="currentRows" select='position()' />
							  <tr>
							   <td class="align-c"><xsl:value-of select="$currentRows" /></td>
							   <td class="align-l"><xsl:value-of select="ten_LoaiPLPKhoanThuKhac"/></td>
							   <td class="align-c"><xsl:value-of select="ten_DonViTien"/></td>
							  ...
							  <xsl:for-each select="$tkchinh/TongCong01PLPNG/ChiTietTongCongTheoLoaiTien">
									<xsl:variable name="currentRows" select='position()' />
							  <tr>
							   <td colspan="2">
							   <b>Tổng cộng &#160;</b></td>
