		...
		<xsl:with-param name="ghuchuTK"   select="'(Áp dụng cho cá nhân cư trú có thu nhập từ tiền lương, tiền công)'"/>
			  ...
			  <div class="ndungtkhai_div">
					<div class="content">
							...
							<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;[<xsl:if test="$tkchinh/TTinHoanThue/HinhThucHoanTra/chuyenKhoan='true' or $tkchinh/TTinHoanThue/HinhThucHoanTra/chuyenKhoan='1'">x</xsl:if>]Chuyển khoản: Tên chủ tài khoản: &#160;&#160;<xsl:value-of select="$tkchinh/TTinHoanThue/HinhThucHoanTra/tenChuTaiKhoan" /></div>
