   ...
   <xsl:template name="tkhaiFooter_DK_TVAN">
	...
	<xsl:template name="tkhaiFooter-BCTC200-KoLienTuc">
		...
		<table width = "100%">
			...
			<!-- Footer Bao cao tai chinh TT200-->
	<xsl:template name="tkhaiFooter-BCTC200">
		...
		<table width = "100%">
            <td class="align-c" width = "33%">								
									...
									<br/><xsl:value-of select="$pluc01/PhanKy/nguoiLapBieu"/>
									<br/>
			</td>       
			<td class="align-c" width = "33%">								
                                    <b>Kế toán trưởng </b><br/>(Ký, họ tên) 
									
									<br/><xsl:value-of select="$pluc01/PhanKy/keToanTruong"/>
									<br/>
			</td>       
            <td class="align-c" width = "33%">								
                                    <i>Lập, ngày <xsl:value-of select="ihtkk:stringDatetime($pluc01/PhanKy/ngayLap,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($pluc01/PhanKy/ngayLap,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($pluc01/PhanKy/ngayLap,'yyyy')"/></i><br/>
									<b>Giám đốc </b><br/><i>(Ký, họ tên, đóng dấu) </i>
								
									<br/><xsl:value-of select="$pluc01/PhanKy/giamDoc"/>
									<br/>
			</td>
	    </table>		
	...
	<!--start Footer  Tem Ruou  -->	
	<xsl:template name="tkhaiFooter_TemRuou">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<div class="footer_div">
	<br/>
	...
	<br/>
		...
		<tr>
			<td width="10%"></td>
				<td width="40%" class="align-c"><b></b></td>
				<td class="align-c"><i><xsl:value-of select="$tkchinh/diaDiem"/>Ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayBCao,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayBCao,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayBCao,'yyyy')"/></i></td>
		</tr>
			<tr>
			    <td width="10%"></td>
				<td width="40%" class="align-c"><b>Người lập biểu </b></td>
				<td class="align-c"><b>NGƯỜI ĐẠI DIỆN THEO PHÁP LUẬT</b></td>
			</tr>
			<tr>
		      	<td width="10%"></td>
				<td width="40%" class="align-c"><i>(Ký, ghi rõ họ tên): </i><br/> <br/></td>
				<td class="align-c"><i>(Ký, đóng dấu và ghi rõ họ, tên)</i></td>
			</tr>
			<tr> <td width="10%"></td>
				<td class="align-c" width="40%"><xsl:value-of select="$tkchinh/nguoiLapBieu"/></td>
				<td class="align-c"><xsl:value-of select="$tkchinh/nguoiDaiDien"/></td>
			</tr>
		...
		<!--start Footer  Tem Ruou 03-->	
	<xsl:template name="tkhaiFooter_TemRuou_03">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<div class="footer_div">
		<table>
		    <tr>
			...
			<tr>
			     <td width="10%"></td>
				<td width="40%" class="align-c"><br/> <br/></td>
				<td class="align-c"><i>(Ký, đóng dấu và ghi rõ họ, tên)</i></td>
			</tr>
			<tr> 
			<td width="10%"></td>
				<td class="align-c" width="50%"></td>
				<td class="align-c"><xsl:value-of select="$tkchinh/nguoiDaiDien"/></td>
			</tr>
		...
		<!--start Footer  BIÊN LAI TT303-->	
	<xsl:template name="tkhaiFooter_BienLaiTT303">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<div class="footer_div">
	  <br></br>
		<table>
		   <tr>
		    <td width="10%"></td>
		    <td width="40%"></td>
			<td class="align-c"><i> Ngày <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'yyyy')"/></i></td>
		    </tr> 
		    
			<tr>
				<td width="10%"></td>
				<td width="40%" class="align-c"><b> </b></td>
				<td class="align-c"><b>THỦ TRƯỞNG ĐƠN VỊ</b></td>
			</tr>
			<tr>
			     <td width="10%"></td>
				<td width="40%" class="align-c"><br/> <br/></td>
...
<tr><td></td></tr>
			<tr>
			     <td width="10%"></td>
				<td width="40%" class="align-c"><br/> <br/></td>
				<td class="align-c"><xsl:value-of select="$kskthue/TKhaiThue/nguoiKy"/></td>
			</tr>
		...
		<br/>
					...
					<!-- Footer Bao cao tai chinh TT107/2017, TT24 -->
	<xsl:template name="tkhaiFooter-BCTC107-24">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
            ...
            <td class="align-c" width = "33%">								
                                    <i>Lập ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayLap,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayLap,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayLap,'yyyy')"/></i><br/>
									<b>NGƯỜI ĐẠI DIỆN THEO PHÁP LUẬT</b><br/><i>(Ký, Ghi rõ họ tên, Đóng dấu) </i>
								
									<br/><xsl:value-of select="$tkchinh/thuTruongDonVi"/>
									<br/>
			</td>
	    </table>		
	...
	<!-- Footer Bao cao tai chinh TT107 đơn giản -->
	<xsl:template name="tkhaiFooter-BCTC107-DG">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
            ...
            <td class="align-c" width = "33%">								
				...
				<!-- Footer Bao cao tai chinh -->
	<xsl:template name="tkhaiFooter-BCTC133">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
            ...
            <td class="align-c" width = "33%">								
									...
									<br/><xsl:value-of select="$tkchinh/nguoiDaiDienTheoPhapLuat"/>
									<br/>
			</td>
	    </table>		
		...
		<!-- Footer Bao cao tai chinh TT107-->
	<xsl:template name="tkhaiFooter-BCTC107">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
									...
									<br/><br/><br/><xsl:value-of select="$tkchinh/PhanKy/nguoiLapBieu"/>
									<br/>
			</td>       
			<td class="align-c" width = "33%">								
                                    <b>Kế toán trưởng </b><br/>(Ký, họ tên) 
									
									<br/><br/><br/><xsl:value-of select="$tkchinh/PhanKy/keToanTruong"/>
									<br/>
			</td>       
            <td class="align-c" width = "33%">								
                                    <i>Lập, ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/PhanKy/ngayLap,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/PhanKy/ngayLap,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/PhanKy/ngayLap,'yyyy')"/></i><br/>
									<b>Người đại diện theo pháp luật</b><br/><i>(Ký, họ tên, đóng dấu) </i>
								
									<br/><br/><br/><xsl:value-of select="$tkchinh/PhanKy/giamDoc"/>
									<br/>
			</td>
	    </table>		
	...
	<!-- Footer Bao cao tai chinh TT334-->
	<xsl:template name="tkhaiFooter-BCTC334">
		<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
		<div class="footer_div">
		<table width = "100%">
            <td class="align-c" width = "33%">								
            ...
            <td class="align-c" width = "33%">								
									...
									<br/><br/><br/><xsl:value-of select="$tkchinh/PhanKy/nguoiDaiDienPL"/>
									<br/>
			</td>
	    </table>		
