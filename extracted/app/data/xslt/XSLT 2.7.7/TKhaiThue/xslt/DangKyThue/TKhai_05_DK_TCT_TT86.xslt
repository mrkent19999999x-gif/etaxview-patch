				...
				<div class="col-md-12">
				  <table>
				   <tr>
					...
					<tr>
						<td>							
							<i>(Dùng cho người nộp thuế là cá nhân không kinh doanh trực tiếp đăng ký thuế)</i>
						</td>
					</tr>
				  </table>
				  <br></br>
...
<div class="col-md-12 lbl-full-name parent-ctrl-2">
				...
				<div class="form-ctl-2 dv-lvl15" style="padding: 3px 0px !important">
					...
					<label class="lbl-title-ctrl-2">3. Thông tin đăng ký thuế của cá nhân:&#160;&#160; </label>	
					<br/>
					<label class="lbl-title-ctrl-2"> &lt;Trường hợp cá nhân đăng ký thuế là người Việt Nam:&gt;</label>
				</div>
				
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<div class="col-md-2 list-cbx" style="width: 40%">
							<label>3.1 Ngày, tháng, năm sinh của cá nhân:&#160;&#160; </label>
							<xsl:if test="$tkchinh/CT6/TTinGiayTo/ct6_ma = '2080'">
				...
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<div class="col-md-2 list-cbx" style="width: 40%">
							<label>3.2 Số định danh cá nhân:&#160;&#160; </label>
							<xsl:value-of select="$tkchinh/ct3_SoDinhDanh"/>
				...
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<div class="col-md-2 list-cbx" style="width: 40%">
							<label>3.3. Điện thoại liên hệ:&#160;&#160; </label>
							<xsl:if test="$tkchinh/CT6/TTinGiayTo/ct6_ma = '2080'">
				...
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<div class="col-md-2 list-cbx" style="width: 60%">
							<label>3.4. Email:&#160;&#160; </label>
							<xsl:if test="$tkchinh/CT6/TTinGiayTo/ct6_ma = '2080'">
				...
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<div class="col-md-2 list-cbx" style="width: 100%">
							<label>3.5. Số định danh cá nhân đã cấp trước đó (trong trường hợp cá nhân được xác lập lại số định danh cá nhân):&#160;&#160; </label>
							<xsl:value-of select="$tkchinh/ct3_SoDinhDanhCu"/>
				...
				<div class="form-ctl-2 dv-lvl15" style="padding: 3px 0px !important">
					...
					<label class="lbl-title-ctrl-2"> &lt;Trường hợp cá nhân là người có quốc tịch nước ngoài hoặc là người có quốc tịch Việt Nam đang sống tại nước ngoài không có số định danh cá nhân:&gt;</label>
				</div>
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<div class="col-md-2 list-cbx" style="width: 40%">
							<label>3.1. Ngày, tháng, năm sinh của cá nhân:&#160;&#160; </label>
							<xsl:if test="$tkchinh/CT6/TTinGiayTo/ct6_ma = '1020'">
							<xsl:value-of select="ihtkk:stringDatetime($tkchinh/ct3_namSinh,'dd/mm/yyyy')"/>
							</xsl:if>
...
<!--<div class="form-ctl-2 dv-lvl15" style="padding: 3px 0px !important"> -->
				...
				<div class="form-ctl-2 dv-lvl15" style="padding: 3px 0px !important">
					...
					<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<div class="col-md-2 list-cbx" style="width: 40%">
							<label>3.4. Số hộ chiếu: &#160;&#160; </label>
							<xsl:if test="$tkchinh/CT6/TTinGiayTo/ct6_ma = '1020'">
							<xsl:value-of select="$tkchinh/CT6/TTinGiayTo/ct6_soGiayTo" />
							</xsl:if>
						...
						<div class="col-md-2 list-cbx" style="width: 25%">
							...
							<xsl:value-of select="ihtkk:stringDatetime($tkchinh/CT6/TTinGiayTo/ct6_ngayCap,'dd/mm/yyyy')"/>
						</div>
						<div class="col-md-2 list-cbx" style="width: 35%">
							<label>Nơi cấp:&#160;&#160; </label>
							<xsl:value-of select="$tkchinh/CT6/TTinGiayTo/ct6_noiCap_ten" />
						</div>
					</div>
				...
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
					<label>3.5. Địa chỉ thường trú:
					</label>
					<br></br>
					<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<label>&#160;&#160;&#160;&#160;Số nhà, ngách, hẻm, ngõ, đường/phố, tổ/xóm/ấp/thôn:&#160;&#160;  </label>
						<xsl:value-of select="$tkchinh/CT7/ct7a_soNha" />
					</div>
					<xsl:choose>
					<xsl:when
									test="$tkchinh/CT7/ct7d_maQuocGia = ''">
					<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
					   <br></br>
						<label style="width: 25%">&#160;&#160;&#160;&#160;Phường/Xã/Thị trấn: </label>
						<xsl:value-of select="$tkchinh/CT7/ct7b_tenPhuong" />
					</div>
					<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<label style="width: 25%">&#160;&#160;&#160;&#160;Quận/Huyện/Thị xã/Thành phố thuộc tỉnh/Thành phố thuộc thành phố trực thuộc trung ương: </label>
						<xsl:value-of select="$tkchinh/CT7/ct7c_tenQuan" />

					</div>
					<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<label style="width: 25%">&#160;&#160;&#160;&#160;Tỉnh/Thành phố trực thuộc trung ương:</label>
				...
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
					<label>3.6. Địa chỉ hiện tại:</label>
					<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
						<label>&#160;&#160;&#160;&#160;Số nhà, ngách, hẻm, ngõ, đường/phố, tổ/xóm/ấp/thôn:&#160;&#160;  </label>
				...
				<div class="col-md-12" style="padding: 0px 0px 0px 10px !important;">
					<label>3.7. Điện thoại liên hệ:&#160;&#160;  </label>
					<xsl:if test="$tkchinh/CT6/TTinGiayTo/ct6_ma = '1020'">
					<xsl:value-of select="$tkchinh/CT9/ct9_dienThoai" />&#160;&#160;&#160;&#160;
					</xsl:if>
				</div>
