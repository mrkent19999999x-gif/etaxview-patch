...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
		...
		<xsl:variable name="moTaBieuMau" select="'Ban hành kèm theo Thông tư số 95/2016/TT-BTC ngày
28/6/2016 của Bộ Tài chính'" />
		 <xsl:call-template name="tkhaiHeader_05DK">
		...
		<div class="ndungtkhai_div">
            ...
            <xsl:if test="$tkchinh/dangKyThue='true' or $tkchinh/dangKyThue='1'">
				...
				<table class="tkhai_table">
					<tr>
						<td class="align-c" rowspan="2"> <b>STT</b></td>
						<td class="align-c" rowspan="2"><b>Mã số thuế người nộp thuế</b></td>
						<td class="align-c" rowspan="2"><b>Họ và tên người nộp thuế</b></td>
						<td class="align-c" rowspan="2"><b>Ngày sinh</b></td>
						<td class="align-c" rowspan="2"><b>Giới tính</b></td>
						<td class="align-c" rowspan="2"><b>Quốc tịch</b></td>
...
<tr>
<td>	   
	 <xsl:call-template name="tkhaiFooter_05DK"/>
	<br/>
<div id="sigDiv"></div>
</td>
</tr>
