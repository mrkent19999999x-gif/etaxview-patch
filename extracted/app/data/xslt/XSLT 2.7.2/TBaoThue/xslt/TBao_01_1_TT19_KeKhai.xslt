...
table.center {
  ...
  margin-right: auto;
		...
		<xsl:call-template name="tbaoHeader_01_1TDKTT">
		...
		<br/>
			...
			<xsl:if test="$ndungTBao/trangThai='Y' or $ndungTBao/trangThai='0'">
						...
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Tên tờ khai: <xsl:value-of select="$ndungTBao/HoSoThue/CTietHoSoThue/tokhai-phuluc"/></div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Loại tờ khai: Chính thức</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Kỳ tính thuế: <xsl:value-of select="$ndungTBao/HoSoThue/CTietHoSoThue/kyTinhThue"/></div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;- Lần nộp: <xsl:value-of select="$ndungTBao/HoSoThue/CTietHoSoThue/lanNop"/></div>
						...
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Cơ quan thuế sẽ tiếp tục xem xét điều kiện chuyển kỳ tính thuế từ tháng sang quý theo quy định và trả Thông báo về việc không chấp nhận mẫu số 01-2/TB-TĐT ban hành kèm theo Thông tư số 19/2021/TT-BTC trong trường hợp người nộp thuế kê khai không đầy đủ, chính xác các chỉ tiêu trên Văn bản đề nghị thay đổi kỳ tính thuế từ tháng sang quý mẫu số 01/ĐK-TĐKTT hoặc nộp không đúng thời hạn theo quy định.</div>
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Đối với Văn bản đề nghị thay đổi kỳ tính thuế từ tháng sang quý mẫu số 01/ĐK-TĐKTT của người nộp thuế được chấp nhận, CỤC THUẾ không trả Thông báo chấp nhận mẫu số 01-2/TB-TĐT. CỤC THUẾ sẽ thông báo về nghĩa vụ kê khai cho người nộp thuế trên Cổng thông tin điện tử của CỤC THUẾ sau khi cập nhật kỳ tính thuế. Người nộp thuế có trách nhiệm tra cứu thông tin nghĩa vụ kê khai (kỳ tính thuế) trên Cổng thông tin điện tử của CỤC THUẾ để nộp tờ khai thuế theo kỳ tính thuế mới đã đăng ký</div>
			</xsl:if>	
