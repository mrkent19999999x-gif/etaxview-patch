		...
		<tbody>
			...
			<tr>
				<td colspan="2" align="center">
					<br/>
					<b>THÔNG BÁO</b><br/>
					<b>Về việc tiếp nhận hồ sơ đề nghị hoàn thuế</b>
					<!--<b><xsl:value-of select="$motaTBao" /></b>-->
				</td>
			</tr>
		</tbody>
...
<!-- thông báo bước 1 tờ khai thay doi ky tinh thue-->

<xsl:template name="tbaoHeader_01_1TDKTT">	
	<xsl:param name="mauTBao" />
	<xsl:param name="soTBao" />
	<xsl:param name="ngayTBao" />
	<xsl:param name="motaTBao" />
		...
		<tbody>
			...
			<tr>
				<td colspan="2" align="center">
					<br/><br/><br/>
					<b>THÔNG BÁO</b><br/>
					<b>V/v: Tiếp nhận Văn bản đề nghị thay đổi kỳ tính thuế từ tháng sang quý mẫu số 01/ĐK-TĐKTT</b>
				</td>
			</tr>
		</tbody>
	</table>
...
<!-- thông báo bước 2 tờ khai thay doi ky tinh thue-->
<xsl:template name="tbaoHeader_02_TDKTT">	
	<xsl:param name="mauTBao" />
	<xsl:param name="soTBao" />
	<xsl:param name="ngayTBao" />
	<xsl:param name="motaTBao" />
		...
		<tbody>
			...
			<tr>
				<td colspan="2" align="center">
					<br/><br/><br/>
					<b>THÔNG BÁO</b><br/>
				<xsl:if test="TBaoThueDTu/TBaoThue/NDungTBao/trangThai='Y'"> 	<b>V/v: Chấp nhận việc nộp Văn bản đề nghị thay đổi kỳ tính thuế từ tháng sang quý mẫu số 01/ĐK-TĐKTT</b>
						</xsl:if>
				<xsl:if test="TBaoThueDTu/TBaoThue/NDungTBao/trangThai='N'"> 	<b>V/v: Không chấp nhận việc nộp Văn bản đề nghị thay đổi kỳ tính thuế từ tháng sang quý mẫu số 01/ĐK-TĐKTT</b>
						</xsl:if>
				</td>
			</tr>
		</tbody>
