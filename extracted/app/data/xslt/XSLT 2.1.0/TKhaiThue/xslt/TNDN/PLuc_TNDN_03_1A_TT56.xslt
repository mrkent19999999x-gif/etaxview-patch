					...
					<div class="content">
						...
						<table class="tkhai_table">
							 ...
							 <tr>
							   ...
							   <td class="number align-r"><b><xsl:value-of select="$pl03-1a_tndn/ct01"/></b></td>
							 </tr>  
							 <tr>
							   <td></td>
							   <td class="align-l">Trong đó: - Doanh thu bán hàng hoá, dịch vụ xuất khẩu</td>
							   <td class="align-c">[02]</td>
							   <td class="number align-r"><xsl:value-of select="$pl03-1a_tndn/ct02"/></td>
							 </tr>  
							 <tr>
							   <td class="align-c"><b>2</b></td>
							   <td class="align-l"><b>Các khoản giảm trừ doanh thu ([03]=[04]+[05]+[06]+[07])</b></td>
							   <td class="align-c"><b>[03]</b></td>
							   <td class="number align-r"><b><xsl:value-of select="$pl03-1a_tndn/ct03"/></b></td>
							 </tr>  
							 <tr>
							 ...
							 <tr>
							   ...
							   <td class="number align-r"><b><xsl:value-of select="$pl03-1a_tndn/ct08"/></b></td>
							 </tr>  
							 <tr>
							 ...
							 <tr>
							   ...
							   <td class="number align-r"><b><xsl:value-of select="$pl03-1a_tndn/ct13"/></b></td>
							 </tr>  
							 <tr>
							   <td class="align-c"></td>
							 ...
							 <tr>
							   ...
							   <td class="number align-r"><b><xsl:value-of select="$pl03-1a_tndn/ct17"/></b></td>
							 </tr>  
							 <tr>
