            ...
            <div class="content">
				<table class="tkhai_table">
                        <tr>
							...
							<td class="align-c" rowspan="4"><b>Số lượng</b></td>
							<td class="align-c" rowspan="4"><b>Từ số</b></td>
							<td class="align-c" colspan="5"><b>Đến số</b></td>
						</tr>						
                        <xsl:for-each select="$tkchinh/PLuc_3.10/ChiTietHoaDon">
							...
							<tr>
								...
								<td class="align-l"><xsl:value-of select="kyHieuHD"/></td>
				  ...
				  <table style="page-break-inside: avoid;width:100%" >
					<tr>
					<td>	  
				  <div class='ghichu'>Đơn vị cam kết: Việc khai báo trên là đúng sự thật, nếu phát hiện khai sai đơn vị xin chịu trách nhiệm trước pháp luật./.</div>
					<br/>
