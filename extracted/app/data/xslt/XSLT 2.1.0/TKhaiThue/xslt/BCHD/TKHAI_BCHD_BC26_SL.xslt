		...
		<div class="ndungtkhai_div">
            ...
            <table class="tkhai_table">
                        <tr>
							...
							<td class="align-c" rowspan="4"><b>Hình thức hóa đơn</b></td>
							<td class="align-c" rowspan="4"><b>Số lượng tồn đầu kỳ</b></td>
							<td class="align-c" rowspan="4"><b>Số lượng mua, phát hành trong kỳ</b></td>
							<td class="align-c" colspan="5"><b>Sử dụng trong kỳ</b></td>
							<td class="align-c" rowspan="4"><b>Tồn cuối kỳ</b></td>
                        ...
                        <xsl:for-each select="$tkchinh/HoaDon/ChiTiet">
							...
							<tr>
								...
								<td class="align-l"><xsl:value-of select="maHoaDon"/></td>
