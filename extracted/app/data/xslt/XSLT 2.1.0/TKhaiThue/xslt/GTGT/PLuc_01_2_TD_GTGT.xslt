 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<!--start phu luc 01-2/TĐ-GTGT-->
		...
		<xsl:variable name="pl02td" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_01_2_TD_GTGT' />
		...
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo tờ khai thuế GTGT mẫu số 01/GTGT hoặc mẫu số 01/TĐ-GTGT)'"/>
			...
			<div class="content">
				...
				<table class="tkhai_table">
                        ...
                        <xsl:for-each select="$pl02td/BangPBoThueGTGTChoDPhuong/ChiTietPBoThueGTGTChoDPhuong">
							...
							<tr>
								...
								<td></td>     
								<td class="align-r"><xsl:value-of select="ihtkk:formatNumber(tyLePhanBoNhaMay)"/></td>
								...
								<xsl:for-each select="PhanBoChoCQTDiaPhuong/tyLePBoThueChoTungCQT">
							         <tr>
                                         <td></td>				
                                         <td class="align-l"><xsl:value-of select="tenCoSo"/></td>
                                         <td class="align-c"><xsl:value-of select="mstCoSo"/></td>				         
								         <td><xsl:value-of select="tenCQTPBo"/></td>
								         <td class="align-r"><xsl:value-of select="ihtkk:formatNumber(tyLePBo)"/></td>
						...
						<tr>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl02td/tongCong)"/></b></td>
						</tr>
			      </table>
			</div>
			</div>
