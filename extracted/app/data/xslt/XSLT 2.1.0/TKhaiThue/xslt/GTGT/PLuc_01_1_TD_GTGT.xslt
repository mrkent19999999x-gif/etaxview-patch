		     	...
		     	<div class="donvitien"> <i>Đơn vị tiền: đồng Việt Nam</i></div>
						<table class="tkhai_table"  >
                           ...
                           <tr>
                               ...
                               <td></td>
                               <td class="align-r"> <b><xsl:value-of select="ihtkk:formatNumber($pl01td/tongThueDauRa)"/></b></td>
                               <td class="align-r"> <b><xsl:value-of select="ihtkk:formatNumber($pl01td/tongThueDauVao
                               )"/></b></td>
