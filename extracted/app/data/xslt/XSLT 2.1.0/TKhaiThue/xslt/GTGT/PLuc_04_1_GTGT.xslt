	...
	<!-- Phụ lục 04-1/GTGT -->
		...
		<xsl:with-param name="ghiChuPL"   select="'(Kèm theo tờ khai thuế GTGT mẫu số 04/GTGT)'"/>
			...
			<div class="content">
					<div class="donvitien"><i>Đơn vị tiền: đồng Việt Nam</i></div>
						<table class="tkhai_table"  >
							<tr>
							 ...
							 <td class="align-c" rowspan="2"><b>Doanh thu</b></td>
							...
							<tr>
								<td colspan="7"><i>1. Hàng hóa, dịch vụ không chịu thuế GTGT hoặc hàng hoá, dịch vụ áp dụng thuế suất 0%:</i></td>
							</tr>
						   <xsl:for-each select="$pl04/HHDVKChiuThue/ChiTietHHDVKChiuThue/HDonBRa">
							...
							<tr>
							  <td colspan="5" class="align-l"><b>Tổng</b></td>
							  <td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl04/HHDVKChiuThue/tongDoanhSoBan_1)"/></b></td>
							  <td></td>
							</tr>   
							<tr>
								<td colspan="7"><i>2.  Phân phối, cung cấp hàng hóa áp dụng thuế suất  1%:</i></td>
							</tr>
						   <xsl:for-each select="$pl04/HHDVThue1/ChiTietHHDVThue1/HDonBRa">
							...
							<tr>
								<td colspan="7"><i>3. Dịch vụ, xây dựng không bao thầu nguyên vật liệu áp dụng thuế suất 5%:</i></td>
							</tr>
						   <xsl:for-each select="$pl04/HHDVThue5/ChiTietHHDVThue5/HDonBRa">
							...
							<tr>
								<td colspan="7"><i>4. Sản xuất, vận tải, dịch vụ có gắn với hàng hóa, xây dựng có bao thầu nguyên vật liệu áp dụng thuế suất 3%:</i></td>
							</tr>
						   <xsl:for-each select="$pl04/HHDVThue3/ChiTietHHDVThue3/HDonBRa">
							...
							<tr>
								<td colspan="7"><i>5. Hoạt động kinh doanh khác áp dụng thuế suất 2%:</i></td>
							</tr>
				...
				<div><b>Tổng doanh thu hàng hóa, dịch vụ không chịu thuế GTGT và áp dụng thuế suất 0% (**):  <xsl:value-of select="ihtkk:formatNumber($pl04/tongDThuBRaChiuThue)"/></b></div>
...
<div class="ghichu">
		<div><i>(*) Tổng doanh thu hàng hóa, dịch vụ bán ra là tổng cộng số liệu tại cột 6 của dòng tổng của các chỉ tiêu 1, 2, 3, 4, 5.</i></div>
		<div><i>(**) Tổng doanh thu hàng hóa, dịch vụ không chịu thuế GTGT và áp dụng thuế suất 0% là số liệu tại cột 6 của dòng tổng của chỉ tiêu 1.</i></div>
		<div><i>(***)Tổng doanh thu hàng hóa, dịch vụ bán áp dụng tỷ lệ thuế/doanh thu là tổng cộng số liệu tại cột 6 của dòng tổng của của các chỉ tiêu  2, 3, 4, 5.</i></div>
