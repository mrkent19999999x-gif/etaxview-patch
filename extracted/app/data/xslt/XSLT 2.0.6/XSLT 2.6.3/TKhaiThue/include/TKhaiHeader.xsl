...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3.org/1999/XSL/Transform" xmlns:ihtkk="http://www.nhantokhai.gdt.gov.vn/xslt" exclude-result-prefixes="xsl xsi ihtkk">
	...
	<xsl:variable name="ttpluc" select="HSoThueDTu/HSoKhaiThue/PLuc"/>
	...
	<xsl:variable name="ttchunghddt" select="TKhai/DLTKhai/TTChung"/>
	<xsl:param name="kyKKhaihddt" select="$ttchunghddt/KTThue"/>
	<xsl:param name="kieuKyhddt" select="$ttchunghddt/LKTThue"/>
	...
	<!-- Biểu ngữ đất nước + Tên tờ khai BCTC thông tư 200 hợp nhất-->
		<xsl:template name="BieuNguDatNuoc_BCTC200_HN">
		<xsl:param name="mauTKhai_"/>
		<xsl:param name="moTaBieuMau_"/>
		<xsl:param name="ttkthue_"/>
		<xsl:param name="ghuchuTK_"/>
		...
		<tr>
			<td class="align-c"><b> BẢNG CÂN ĐỐI KẾ TOÁN HỢP NHẤT</b></td>
		</tr>
		<!--
		<tr>
	...
	<xsl:template name="BieuNguPhuLuc">
		...
		<tr>
			<td class="align-c" colspan="3">
				<i>
					<xsl:value-of select="$ghiChuPL1_"/>
				</i>
			</td>
		</tr>
	</xsl:template>
	...
	<!-- start tkhai header -->
	<xsl:template name="tkhaiHeader_02qtt">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
	...
	<!-- start tkhai header pluc92GTGT -->
	<xsl:template name="tkhaiHeader-pluc92GTGT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c" colspan="3">
						(Kèm theo Tờ khai thuế GTGT kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>)
					</td>
				</tr>
	...
	<!-- start header Phuluc-->
	<xsl:template name="tkhaiHeader-pluc-05QTT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			...
			<div><b> [<xsl:if test="$ttpluc/PLuc_05_1_BK_QTT/LuaChonMienThue = 'true' or $ttpluc/PLuc_05_1_BK_QTT/LuaChonMienThue  = '1'" >x </xsl:if>] Lựa chọn miễn thuế đối với cá nhân ủy quyền quyết toán có số thuế phải nộp thêm sau quyết từ 50.000 trở xuống </b></div>
		</div>
	</xsl:template>	
	<!--tkhaiHeader-plucTT03-->
<xsl:template name="tkhaiHeader-plucTT03">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
				<td class="align-c" colspan="3">
						<b>[01] Kỳ tính thuế: Từ <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,'dd/mm/yyyy')"/> đến <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'dd/mm/yyyy')"/></b>
					</td>
				</tr>
				...
				<!--<tr>
					<td class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							[02] Lần đầu: [X] <b>[03] </b>Bổ sung: [&#32;]    lần thứ: [&#32;]
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							[02] Lần đầu: [&#32;] <b>[03] </b>Bổ sung: [X] lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
				</tr>-->
				<tr>
				...
				<tr>
					<td>
						[04] Quận/Huyện: <xsl:value-of select="$ttkthue/NNT/tenHuyenNNT"/>
					</td>
					<td colspan="2">
						[05] Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/>
					</td>
				</tr>
				<tr>
					<td>
						[06] Điện thoại: <xsl:value-of select="$ttkthue/NNT/dthoaiNNT"/>
					</td>
					<td>
						[07] Fax: <xsl:value-of select="$ttkthue/NNT/faxNNT"/>
					</td>
					<td>
						[08] E-mail: <xsl:value-of select="$ttkthue/NNT/emailNNT"/>
					</td>
				</tr>-->
				<xsl:if test="$ttkthue/DLyThue">
					<tr>
					...
					<tr>
						<td class="align-l">
							[10] Mã số thuế: <xsl:value-of select="$ttkthue/DLyThue/mstDLyThue"/>
						</td>
					</tr>
				</xsl:if>
				<xsl:if test="not($ttkthue/DLyThue)">
	...
	<!-- end tkhai header BVMT_01 -->
		<!-- start tkhai header 02/GTGT-->
	<xsl:template name="tkhaiHeader_02GTGT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c"> Mã hồ sơ khai DAĐT: <xsl:value-of select="$tkchinh/maHoSoKhaiDuAnDauTu"/> </td>
				</tr>
				<tr>
					<td class="align-c">
						<b>[01]</b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
	...
	<!-- start tkhai header 01/MTCN ND92-->
			...
			<table class="ttinnnt_table">
				<tr>
					...
					<div align="center" style="margin:0; padding:0;">
						<b><xsl:value-of select="HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/NNT/tenNNT"/></b><br/>
						 __________<br/>
				...
				<tr>
					<td colspan="3">
						Địa chỉ nhận thông báo: <xsl:value-of select="HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/NNT/dchiNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
	...
	<xsl:template name="tkhaiHeader_01_CNKD">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table" width="100%" border="0" cellpadding="0" cellspacing="0" style="width:1100px;">
				...
				<tr>
					<td colspan="3"><b>[12c]</b> Phường/Xã/Thị trấn: <xsl:value-of select="$tkchinh/Header/CT12/ct12c_tenPhuong"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3"><b>[13b]</b> Phường/Xã/Thị trấn: <xsl:value-of select="$tkchinh/Header/CT13/ct13b_tenPhuong"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3"><b>[18g.2]</b> Phường/xã/Thị trấn: <xsl:value-of select="$tkchinh/Header/CT18g/ct18g_tenPhuong"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3"><b>[18h.2]</b> Phường/xã/Thị trấn: <xsl:value-of select="$tkchinh/Header/CT18h/ct18h_tenPhuong"/></td>
				</tr>
				<tr>
	...
	<!-- Start tkhai header BCTC_TT200_ Hợp nhất-->
	<xsl:template name="tkhaiHeader-BCTC200_HN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc_BCTC200_HN">
					<xsl:with-param name="mauTKhai_" select="$mauTKhai"/>
					<xsl:with-param name="moTaBieuMau_" select="$moTaBieuMau"/>
					<xsl:with-param name="ttkthue_" select="$ttkthue"/>
					<xsl:with-param name="ghuchuTK_" select="$ghuchuTK"/>
...
<tr>
	 ...
	 <tr>
				<td colspan="3"><b>BCTC đã được kiểm toán:</b> [<xsl:if test="$tkchinh/bctcDaKiemToan = 'true' or $tkchinh/bctcDaKiemToan = '1'" >x</xsl:if>] </td>

				</tr>
				
	                     <tr>
				<td colspan="3"><b>Ý kiến kiểm toán:</b> <xsl:value-of select="$tkchinh/tenYKienKToan"/> </td>
	...
	<xsl:template name="tkhaiHeader_01TTSTT40">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
                 ...
                 <tr>
					<td class="align-c">
Cá nhân cho thuê tài sản trực tiếp khai thuế/ Tổ chức, cá nhân khai thuế thay, nộp thuế thay cho cá nhân ủy quyền theo quy định của pháp luật dân sự<xsl:if test="$tkchinh/Header/khaiTheoPLuatDanSu= 'true' ">[x]</xsl:if> 
                        </td>
                </tr>
                
                 <tr>
					<td class="align-c">
Doanh nghiệp, tổ chức kinh tế khai thuế thay, nộp thuế thay theo pháp luật thuế<xsl:if test="$tkchinh/Header/khaiTheoPLuatThue= 'true' ">[x]</xsl:if> 
                        </td>
                </tr>
				...
				<tr>
				   <td class="align-c" >
					...
					<xsl:if test="$kieuKy='Q'">  <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>  <br/> </xsl:if>
					
					<xsl:if test="$kieuKy='D'"> Kỳ thanh toán: Từ ngày: <xsl:value-of select="$tuNgay"/> 	
              &#160;	
              &#160;	
              &#160;	
             &#160; Đến ngày: <xsl:value-of select="$denNgay"/>
			...
			<table class="ttinnnt_table">
				...
				<tr>
					...
					<tr>
						<td>
						<b>[12g.2]</b>Phường/xã/Thị trấn<xsl:value-of select="$tkchinh/Header/TruongHopCNKDThuocDoiTuongKhongCoCMNDCCCDTaiVietNam/ct12g_2"/>
						</td>
					</tr>
						<tr>
						<td>
					...
					<tr>
						<td>
						<b>[12h.2]</b>Phường/xã/Thị trấn <xsl:value-of select="$tkchinh/Header/TruongHopCNKDThuocDoiTuongKhongCoCMNDCCCDTaiVietNam/ct12h_2"/>
						</td>
					</tr>
						<tr>
						<td>
	...
	<xsl:template name="tkhaiHeader-pluc02">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start header Phuluc114-->
	<xsl:template name="tkhaiHeader-pluc114">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c" colspan="3">
						[01] Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
				...
				<tr>
					<td class="align-l">
						[05] Mã số thuế: <xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<tr>
					<td>
						[06] Địa chỉ: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/>
					</td>
				</tr>
				<tr>
				<td>
						[07] Điện thoại: <xsl:value-of select="$ttkthue/NNT/dthoaiNNT"/>
					</td>
				</tr>
				<xsl:if test="$ttkthue/DLyThue">
					<tr>
					...
					<tr>
						<td class="align-l">
							[09] Mã số thuế: <xsl:value-of select="$ttkthue/DLyThue/mstDLyThue"/>
						</td>
					</tr>
				</xsl:if>
				<xsl:if test="not($ttkthue/DLyThue)">
	...
	<!-- start header Phuluc92-->
	<xsl:template name="tkhaiHeader-pluc92">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start tkhai header 03_DL_HDDT -->
	<xsl:template name="tkhaiHeader_03_DL_HDDT">
		<xsl:param name="MSo"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="tentkhai">
						<xsl:value-of select="translate($ttchunghddt/Ten,$smallcase,$uppercase)"/>
					</td>
				</tr>
			...
			<table class="ttinnnt_table">
			    <tr>
					<td>
						[01] Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhaihddt,$kieuKyhddt,$ttchunghddt/NLap,$ttchunghddt/NLap)"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						[02] Tên người nộp thuế: <xsl:value-of select="TKhai/DLTKhai/TTChung/TNNT"/>
					</td>
				</tr>
				<tr>
					<td>
						[03] Mã số thuế: <xsl:value-of select="TKhai/DLTKhai/TTChung/MST"/>
					</td>
				</tr>
				<tr>
					<td>
						[04] Tên đại lý thuế (nếu có): <xsl:value-of select="TKhai/DLTKhai/TTChung/TDLThue"/>
					</td>
				</tr>
				<tr>
					<td>
						[05]  Mã số thuế<xsl:value-of select="TKhai/DLTKhai/TTChung/MSTDLThue"/>
					</td>
				</tr>
			</table>
		</div>
	...
	<xsl:template name="tkhaiHeader_05_GTGT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_04_GTGT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
...
Khai riêng đối với khoản thu hộ do cơ quan nhà nước có thẩm quyền giao
		...
		<!-- start tkhai header Vietsopevtro 01-TNDN-VSP-->
	<xsl:template name="tkhaiHeader_01_1TNDN_VSP_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
						...
						<td colspan="3" class="align-c"><b>[01]</b> Dầu thô: [ <xsl:if test="$tkchinh/Header/LoaiDauKhi/ct01 = 'true' "> X </xsl:if>]     
                       <b> [02]</b> Condensate: [<xsl:if test="$tkchinh/Header/LoaiDauKhi/ct02 = 'true' "> X </xsl:if>]      
                       <b>  [03]</b> Khí thiên nhiên: [<xsl:if test="$tkchinh/Header/LoaiDauKhi/ct03 = 'true' "> X </xsl:if>]  </td>  
				</tr>
				<tr>
					<td class="align-c">
						<b>[04]</b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
				...
				<tr>
					<td class="align-c">
						<b>[05]</b> Kỳ kết dư: từ ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct05_tuNgay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct05_tuNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct05_tuNgay,'yyyy')"/>
						đến ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct05_denNgay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct05_denNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct05_denNgay,'yyyy')"/>
					</td>
				</tr>
					<tr>
					<td colspan="3" class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b>[06]</b> Khai lần đầu: [X] <b>[07] </b>Khai bổ sung lần thứ: [&#32;]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[06]</b>Khai lần đầu: [&#32;] <b>[07] </b>Khai bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td colspan="3"><b>[16]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct16"/></td>
				</tr>
				<tr>
					<td colspan="3"><b>[17] </b> Mã số thuế nhà điều hành hợp đồng dầu khí: <xsl:value-of select="$tkchinh/Header/ct17"/></td>
				</tr>
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[18] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT18/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT18/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT18/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT18/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
								...
								<tr>
									<td>
										<b>[26] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
									</td>
									<td colspan="2"> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'yyyy')"/>
									</td>
								</tr>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										...
										<b>[18] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT18/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT18/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT18/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/tenNguoiNopThueThay"/>
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT18/daiLyThue = 'true' "> </xsl:if>
										</b>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										<b>[26] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: 
                                    </td>
									<td colspan="2"> ngày  tháng  năm 
                                    </td>
								</tr>
	...
	<!-- start tkhai header 03TNDN-DK Theo TT80 -->
		
		<xsl:template name="tkhaiHeader-DK_03TNDN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
...
<tr>
			...
			<tr>
					<td class="align-l">
						<b>[04]</b> Mã số thuế thực hiện kê khai nộp thuế: <xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
			<!-- Bên chuyển nhượng quyền lợi: -->
			
				<tr>
					<td><b> Bên chuyển nhượng quyền lợi:</b></td>
				</tr>
				<tr>
					<td><b>[05]</b>Tên tổ chức chuyển nhượng: <xsl:value-of select="$tkchinh/Header/BenChuyenNhuong/ct05"/> </td>
				</tr>
				<tr>
					<td colspan="3">[06] Mã số thuế (nếu có):<xsl:value-of select="$tkchinh/Header/BenChuyenNhuong/ct06"/></td>
				</tr>
				<tr>
					<td>
						<b>[07] </b> Địa chỉ trụ sở chính: <xsl:value-of select="$tkchinh/Header/BenChuyenNhuong/ct07"/>
					</td>
				</tr>
				<tr>
					<td><b>[08]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/BenChuyenNhuong/ct08"/>   </td>
				</tr>
				<tr>
					<td><b>[09] </b> Hợp đồng chuyển nhượng số:  <xsl:value-of select="$tkchinh/Header/BenChuyenNhuong/ct09_so"/></td>
					<td colspan="2"> Ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/BenChuyenNhuong/ct09_ngay,'dd/mm/yyyy')"/></td>
				</tr>
				
				<!-- Bên nhận chuyển nhượng:: -->
				<tr>
					<td><b>Bên nhận chuyển nhượng:</b></td>
				</tr>
				<tr>
					<td><b>[10]</b>Tên tổ chức hoặc cá nhân nhận chuyển nhượng: <xsl:value-of select="$tkchinh/Header/BenNhanChuyenNhuong/ct10"/> </td>
				</tr>
				<tr>
					<td>
						<b>[11] </b> Địa chỉ trụ sở chính: <xsl:value-of select="$tkchinh/Header/BenNhanChuyenNhuong/ct11"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">[12] Mã số thuế (đối với doanh nghiệp):<xsl:value-of select="$tkchinh/Header/BenNhanChuyenNhuong/ct12"/></td>
				</tr>
				
				<tr>
					<td><b>[13]</b> Mã số thuế hoặc số chứng minh nhân dân, số hộ chiếu (đối với cá nhân): <xsl:value-of select="$tkchinh/Header/BenNhanChuyenNhuong/ct13"/></td>
				</tr>
				
				
				<!-- ĐẠI LÝ THUẾ HOẶC ĐƠN VỊ ỦY QUYỀN: -->
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										[14] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT14/donViUyQuyen = 'true' "> X </xsl:if>] hoặc <b> Đại lý thuế</b> [<xsl:if test="$tkchinh/Header/CT14/daiLyThue = 'true' "> X </xsl:if>]: 
                                            <xsl:if test="$tkchinh/Header/CT14/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tendonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT14/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
									</td>
								</tr>
								...
								<tr>
									<td>
										<b>[22] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số:  <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
									</td>
									<td colspan="2"> Ngày: <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd/mm/yyyy')"/>
									</td>
								</tr>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<br/>
										<b>[14] Tên đơn vị được uỷ quyền</b> [<xsl:if test="$tkchinh/Header/CT14/donViUyQuyen = 'true' "> X </xsl:if>] hoặc <b>Đại lý thuế </b>[<xsl:if test="$tkchinh/Header/CT14/daiLyThue = 'true' "> X </xsl:if>]: 
                                            <xsl:if test="$tkchinh/Header/CT14/donViUyQuyen = 'true' = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tendonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT14/daiLyThue = 'true' "> </xsl:if>
								...
								<tr>
									<td>
										<b>[22] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số:  
                                    </td>
									<td colspan="2"> Ngày:
                                    </td>
								</tr>
								...
								<tr>
									<td><b>[23]</b> Tên tổ chức bị chuyển nhượng tại Việt Nam: <xsl:value-of select="$tkchinh/Header/ct23"/></td>
								</tr>
								<tr>
									<td>[24] Mã số thuế:<xsl:value-of select="$tkchinh/Header/ct24"/></td>
								</tr>
								<tr>
									<td><b>[25]</b> Địa chỉ trụ sở chính: <xsl:value-of select="$tkchinh/Header/ct25"/></td>
								</tr>
								<tr>
									<td><b>[26]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct26"/></td>
								</tr>
								</table></div>
	</xsl:template>
  ...
  <xsl:template name="tkhaiHeader_CTLNDC_01">
		...
		<div class="header_div">
			<table>
				<xsl:call-template name="BieuNguDatNuoc">
				 ...
				 <tr>   
                    <td class="align-c">
                     [01] Ngày thông báo chia cổ tức, lợi nhuận: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ct01,'dd/mm/yyyy') "/>		
                    </td>   	 
           	   </tr>	
           	   <tr>
					<td class="align-c">
           	   ...
           	   <tr>
					<td class="align-c">
				  [04] Kỳ: Cổ tức, lợi nhuận được chia của năm <xsl:value-of select="$tkchinh/Header/CT04/nam"/>, theo Nghị quyết/Quyết định số <xsl:value-of select="$tkchinh/Header/CT04/nghiQuyetQDSo"/>
					</td>
				</tr>	
                <tr>   
                    <td class="align-c">          	   
                       	   
                  [05] Cổ tức được chia  [<xsl:if test="$tkchinh/Header/ct05 = 'true' ">x</xsl:if>]  [06] Lợi nhuận được chia [<xsl:if test="$tkchinh/Header/ct06 = 'true' ">x</xsl:if>]
                   </td>                       
               </tr>
	...
	<!-- start tkhai header Vietsopevtro 01-LNCL_PSC_TT80-->
	<xsl:template name="tkhaiHeader_01_LNCL_PSC_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<b>(Hợp đồng dầu khí Lô <xsl:value-of select="$tkchinh/Header/hopDongDauKhiLo"/>)</b>
					</td>
				</tr>
				<tr>
				        
						<td class="align-c"><b>[01]</b> Dầu thô: [ <xsl:if test="$tkchinh/Header/LoaiDauKhi/ct01 = 'true' "> X </xsl:if>]     
                       <b> [02]</b> Condensate: [<xsl:if test="$tkchinh/Header/LoaiDauKhi/ct02 = 'true' "> X </xsl:if>]      
                       <b>  [03]</b> Khí thiên nhiên: [<xsl:if test="$tkchinh/Header/LoaiDauKhi/ct03 = 'true' "> X </xsl:if>]  </td>  
				</tr>
			...
			<table width="100%" >
				<tr>
					<td colspan="3" style="width:100%;text-align:left">
						<b>[07]</b> Tên người nộp thuế: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
				...
				<tr>
					<td colspan="3">
						<b>[09]</b> Hợp đồng dầu khí (PSC) lô: <xsl:value-of select="$tkchinh/Header/ct09"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[10]</b> Mã số thuế hợp đồng dầu khí: <xsl:value-of select="$tkchinh/Header/ct10"/>
					</td>
					</tr>
				<tr>
					<td colspan="3">
						<b>[11]</b> Địa chỉ nhà điều hành PSC: <xsl:value-of select="$tkchinh/Header/ct11"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[12] </b> Quận/huyện: <xsl:value-of select="$tkchinh/Header/ct12_ten_quanHuyen"/>&#160;&#160;
					
						<b>[13] </b>Tỉnh/Thành phố:  <xsl:value-of select="$tkchinh/Header/ct13_ten_tinhThanhPho"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[14]</b> Điện thoại: <xsl:value-of select="$tkchinh/Header/ct14"/>&#160;&#160;
					
						<b>[15]</b> Fax: <xsl:value-of select="$tkchinh/Header/ct15"/>&#160;&#160;
					
						<b>[16]</b> E-mail: <xsl:value-of select="$tkchinh/Header/ct16"/>
					</td>
				</tr>
				<xsl:if test="$ttkthue/DLyThue">
					<tr>
						<td colspan="3">
							<br/>
							<b>[17] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT17/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
					...
					<tr>
						<td colspan="3">
							<b>[25] </b> Hợp đồng đại lý thuế: Số  <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>&#160;&#160;
						
						 Ngày: <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd/mm/yyyy')"/>
						</td>
					</tr>
				 </xsl:if>
				<xsl:if test="not($ttkthue/DLyThue)">
					<tr>
						<td colspan="3">
							<br/>
							<b>[17]</b> Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT17/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
								<xsl:if test="$tkchinh/Header/CT17/donViUyQuyen = 'true' ">
									<xsl:value-of select="$tkchinh/Header/tenDonViUyQuyen"/>
								</xsl:if>
					...
					<tr>
						<td colspan="3">
							<b>[18]</b> Mã số thuế đơn vị được uỷ quyền/đại lý thuế: 
						</td>
					</tr>
					<tr >
						<td colspan="3">
					...
					<tr>
						<td colspan="3">
							<b>[25] </b> Hợp đồng đại lý thuế: Số  &#160;&#160;
	...
	<!-- start tkhai header Vietsopevtro 01-TNS_DK_TT80-->
	<xsl:template name="tkhaiHeader_01_TNS_DK_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					...
					<td class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b>[02]</b> Khai lần đầu: [X] <b>[03] </b>Khai bổ sung lần thứ: [&#32;]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[02]</b>Khai lần đầu: [&#32;] <b>[03] </b>Khai bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>
						<b>[06]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct06"/>
					</td>
				</tr>
				<tr>
					<td>
						<b>[07]</b> Mã số thuế hợp đồng dầu khí: <xsl:value-of select="$tkchinh/Header/ct07"/>
					</td>
					</tr>
				<tr>
					<td>
						<b>[08]</b> Địa chỉ nhà điều hành PSC: <xsl:value-of select="$tkchinh/Header/ct08"/>
					</td>
				</tr>
				<tr>
					<td>
						<b>[09] </b> Quận/huyện: <xsl:value-of select="$tkchinh/Header/ct09_ten"/>
					</td>
					<td>
				...
				<tr>
									<td colspan="3">
										<b>[11]</b> Điện thoại: <xsl:value-of select="$tkchinh/Header/ct11"/>&#160;&#160; 
									
										<b>[12]</b> Fax: <xsl:value-of select="$tkchinh/Header/ct12"/>&#160;&#160; 
									
										<b>[13]</b> E-mail: <xsl:value-of select="$tkchinh/Header/ct13"/>
									</td>
								</tr>
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[14] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT14/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT14/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT14/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT14/daiLyThue = 'true' ">
	...
	<!-- start tkhai header 01/TAIN-DK-TT80  -->
	<xsl:template name="tkhaiHeader-01TAIN-DK">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									...
									<td colspan="2"><b>[29]</b> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="not($ttkthue/DLyThue)">
	...
	<!-- start tkhai header 01/TNDN_DK-TT80  -->
	<xsl:template name="tkhaiHeader-01TNDN-DK">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- start tkhai header 01/TK_VSP-TT80  -->
	<xsl:template name="tkhaiHeader-01TK-VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[20]</b>Mã số thuế nhà điều hành hợp đồng dầu khí <xsl:value-of select="$tkchinh/Header/ct20"/>
								</td>
							</tr>
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[21] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT21/nguoiNopThueThay = 'true' or $tkchinh/Header/CT21/nguoiNopThueThay = '1' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT21/daiLyThue = 'true' or $tkchinh/Header/CT21/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT21/nguoiNopThueThay = 'true' or $tkchinh/Header/CT21/nguoiNopThueThay = '1'">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT21/daiLyThue = 'true'  or $tkchinh/Header/CT21/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/Header/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
								</tr>
								...
								<tr colspan="3">
									<td>
										<b>[23]</b> Địa chỉ: <xsl:value-of select="$ttkthue/DLyThue/dchiDLyThue"/>
									</td>
								</tr>
								<tr>
									<td>
										<b>[24]</b> Quận/Huyện: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
										<b>[25] </b>Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
									</td>
								</tr>
								<tr>
									<td>
										<b>[26]</b> Điện thoại: <xsl:value-of select="$ttkthue/DLyThue/dthoaiDLyThue"/>
									</td>
									<td>
										<b>[27]</b> Fax: <xsl:value-of select="$ttkthue/DLyThue/faxDLyThue"/>
									</td>
									<td>
										<b>[28]</b> E-mail: <xsl:value-of select="$ttkthue/DLyThue/emailDLyThue"/>
									</td>
								</tr>
								<tr>
									<td>
										<b>[29] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
									</td>
									<td colspan="2"> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'yyyy')"/>
									</td>
								</tr>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<br/>
										<b>[21] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT21/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT21/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT21/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/>
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT21/daiLyThue = 'true' "> </xsl:if>
										</b>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										<b>[29] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: 
                                    </td>
									<td colspan="2"> ngày  tháng  năm 
                                    </td>
								</tr>
	...
	<!-- start tkhai header 01-1/PTHU_VSP-TT80  -->
	<xsl:template name="tkhaiHeader-01-1-PTHU-VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
						...
						<td class="align-c"><b>[01]</b> Dầu thô: [ <xsl:if test="$tkchinh/Header/LoaiDauKhi/ct01 = 'true' or $tkchinh/Header/LoaiDauKhi/ct01 = '1' "> X </xsl:if>]     
                       <b> [02]</b> Condensate: [<xsl:if test="$tkchinh/Header/LoaiDauKhi/ct02 = 'true' or $tkchinh/Header/LoaiDauKhi/ct02 = '1' "> X </xsl:if>]      </td>  
				</tr>
				<tr>
					<td class="align-c">
				...
				<tr>
					<td class="align-c">
						<b>[04]</b> Kỳ kết dư: từ ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/CT04/tuNgay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/CT04/tuNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/CT04/tuNgay,'yyyy')"/>
						đến ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/CT04/denNgay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/CT04/denNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/CT04/denNgay,'yyyy')"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b>[05]</b> Lần đầu: [x] <b>[07] </b>Bổ sung lần thứ: [&#32;]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[05]</b> Lần đầu: [&#32;] <b>[06] </b>Bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table" >
							...
							<tr>
								<td colspan="3">
									<b>[15]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct15"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[16]</b>Mã số thuế nhà điều hành hợp đồng dầu khí <xsl:value-of select="$tkchinh/Header/ct16"/>
								</td>
							</tr>
						<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[17] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT17/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT17/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
								...
								<tr>
									<td>
										<b>[25] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
									</td>
									<td colspan="2"> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'yyyy')"/>
									</td>
								</tr>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								...
								<tr>
									<td>
										<b>[25] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: 
                                    </td>
									<td colspan="2"> ngày  tháng  năm 
                                    </td>
								</tr>
	...
	<xsl:template name="tkhaiHeader-01-LNCL-VSP">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>
						<b>[15]</b> Quận/Huyện: <xsl:value-of select="$tkchinh/Header/ct15"/>
					</td>
					<td colspan="2">
...
<tr>
				...
				<tr>
					<td class="align-l">
						<b>[09]</b> Số thuế phải nộp: <xsl:value-of select="ihtkk:formatNumber(HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_DK/ct09)"/> &#160; <xsl:value-of select="($tkchinh/ma_DonVi)"/>
					</td>
				</tr>
			</table>
		</div>
	...
	<xsl:template name="tkhaiHeader_01_PBVMT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
...
<!-- start header 01-1/KHBS TT80-->
	...
	<!-- hết header phụ lục 01-1KHBS-->
		<!-- start tkhai header 04/GTGT-->
	<xsl:template name="tkhaiHeader_04GTGT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c"> [<xsl:if test="$tkchinh/hoatDongThuHo = 'true' or $tkchinh/hoatDongThuHo = '1'" >X</xsl:if>]   Hoạt động thu hộ CQNN có thẩm quyền giao</td>
				</tr>
				<tr>
					<td class="align-c">
						<b>[01]</b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
	...
	<xsl:template name="tkhaiHeader_01_TAIN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
...
<!-- start header phụ luc 01-3/TTDB(TT80/2021)-->
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									...
									<xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_3_TTDB/BangPhanBoDoiVoiHDKDXSDT/ct06"/> đồng
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[07]</b> Tổng doanh thu thực tế:
									<xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_3_TTDB/BangPhanBoDoiVoiHDKDXSDT/ct07"/> đồng
								</td>
							</tr>
						</table>
					</td>
	...
	<xsl:template name="tkhaiHeader_02_TTDB_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- start header 04_CNV_TNCN (TT80/2021)-->
	<xsl:template name="tkhaiHeader_04_CNV_TNCN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
...
<!-- start header 04_DTV_TNCN (TT80/2021)-->
	<xsl:template name="tkhaiHeader_04_DTV_TNCN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_04_TKQT_TNCN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_04_NNG_TNCN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table"  width="100%">
				...
				<tr>
					<td>
						<b>[18]</b> Quận/Huyện: 
							<xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct18_tenQuanHuyen"/>
					</td>
					<td colspan="2">
						<b>[18]</b> Tỉnh/Thành phố: 
	...
	<!-- start header Phuluc 01-1/PL-CNKD-->
	<xsl:template name="tkhaiHeader-pluc_01_1_PL_CNKD">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
            ...
            <td style="width:10% vertical-align: top;"  align="top">
						<div class="bieu_mau_div">
							<div>Mẫu số: <b><br>
									<xsl:value-of select="$mauTKhai"/>
									</br>
				...
				<tr>
					<td class="align-c" colspan="3">
						...
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[02]</b> Lần đầu: [&#32;] <b>[03] </b>Bổ sung: [X] lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
				</tr>
				<tr>
					<td class="align-l">
						[04] <b>Tên người nộp thuế </b>
						<xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
					<!--style:height="25"-->
				</tr>
				<tr>
					<td class="align-l">[05] Mã số thuế: <xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<tr>
                    <td>
                ...
                <tr>
                    <td>
                        [07] Số điện thoại: <xsl:value-of select="$ttkthue/NNT/dthoaiNNT"/>
                    </td>
                </tr>
				<tr>
							<td>[08]<b> Tên Tổ chức khai thuế thay (nếu có):</b>
						</td>
				</tr>
				<tr>
						<td class="align-l">
...
<!-- start tkhai 02SDDPNN TT80 header -->
	<xsl:template name="tkhaiHeader_02TK_SDDPNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					...
					<td><b>[06.4]</b> Phường/xã/thị trấn: <xsl:value-of select="$ttkthue/NNT/phuongXa"/>	</td>
				</tr>
				<tr>
...
<!-- start header phụ luc 01-02/SDDPNN TT80-->
	<xsl:template name="tkhaiHeader-Pluc01-SDDPNN-TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- hết header bảng kê nhiều vị trí TT80-->
	
	<!-- start header KHBS01 của tờ khai 02/SDDPNN-->
	<xsl:template name="tkhaiHeader-KHBS01-PNN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		   <!-- Phụ lục 01KHBS tờ khai 02/TK-SDDPNN TT80 -->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL01_KHBS"/>	
		<xsl:variable name="KHBS01" select='HSoThueDTu/HSoKhaiThue/PLuc/PL01_KHBS' />
		<div class="header_div">
			<table class="ttinnnt_table" style="width:100%">
			...
			<br/>
			<!-- <div class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div> -->
			<div><b>[01] </b>Mẫu tờ khai: <xsl:value-of select="$KHBS01/Header/tenTKhai"/></div>
			<table class="ttinnnt_table">
				<tr>
					<td>	<b>[02]</b> Mã giao dịch điện tử: <xsl:value-of select="$KHBS01/Header/maGiaoDich"/></td>
				</tr>
				<tr>
					<td class="align-l">
						<b>[03]</b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
				...
				<tr>
					<td> <b>[04] </b>Bổ sung lần thứ:  <xsl:value-of select="$KHBS01/Header/soLan"/></td>
				</tr>
				<tr>
					<td>
						<b>[05]</b> Tên người nộp thuế: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>
...
<!-- start header 02/TNDN TT80-->
	<xsl:template name="tkhaiHeader-02TNDN-TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- start header 04TNDN TT80-->
	<xsl:template name="tkhaiHeader-04TNDN-TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- hết header 04TNDN TT80-->
	
	<!-- start header 05/TNDN TT80-->
	<xsl:template name="tkhaiHeader-05TNDN-TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
					...
					<td>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								...
								<tr>
									<td colspan="3">
										<b>[13] </b> Hợp đồng đại lý thuế: Số  
                                    </td>
									<td> Ngày:
                                    </td>
								</tr>
	...
	<!-- hết header 06TNDN TT80-->
<!-- start tkhai header 01/NTNN TT80 -->
	<xsl:template name="tkhaiHeader01_NTNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[05]</b> Mã số thuế nộp thay của Bên Việt Nam:
                                    <xsl:value-of select="$ttkthue/NNT/mst"/>
								</td>
							</tr>
							<!-- <tr>
	...
	<!-- start tkhai header BCTL-DK Theo TT36_TT80-->
	<xsl:template name="tkhaiHeader_BCTL_DK">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td><b>[12]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/ct12"/>   </td>
				</tr>
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[13] Tên đơn vị được uỷ quyền</b> [<xsl:if test="$tkchinh/LoaiHinhUyQuyen/donViUyQuyen = 'true' "> X </xsl:if>] hoặc <b> Đại lý thuế</b> [<xsl:if test="$tkchinh/LoaiHinhUyQuyen/daiLyThue = 'true' "> X </xsl:if>]: 
                                            <xsl:if test="$tkchinh/LoaiHinhUyQuyen/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/tenDonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/LoaiHinhUyQuyen/daiLyThue = 'true' ">
	...
	<!-- start header 03_GTGT_TT80-->
	<xsl:template name="tkhaiHeader_03_GTGT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- start header 01_KTTSBD_TT80-->
	<xsl:template name="tkhaiHeader_01_KTTSBD_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td class="align-c">
						...
						<table class="ttinnnt_table"  width="100%">
							...
							<tr>
								<td colspan="3">
									<b>[04] Tổ chức, doanh nghiệp khai thay, nộp thay: </b><xsl:value-of select="$ttkthue/NNT/tenNNT"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[05] </b>Mã số thuế của tổ chức, doanh nghiệp khai thay, nộp thay:
									<xsl:value-of select="$ttkthue/NNT/mst"/>
								</td>
							</tr>
								<tr>
		...
		<!-- start header Phuluc 01_KTTSBD TT80-->
	<xsl:template name="tkhaiHeader-pluc01-KTTSBD">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start tkhai header 03/NTNN TT80 -->
	<xsl:template name="tkhaiHeader03_NTNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_02GTGT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table>
				...
				<tr>
					<td ><b>[07]</b> Địa chỉ thực hiện dự án đầu tư: <xsl:value-of select="$tkchinh/Header/ct07"/> &#160;&#160; &#160;&#160;&#160;&#160; &#160;&#160;<b>[08]</b> Xã/phường: <xsl:value-of select="$tkchinh/Header/ct08_ten"/></td>
		...
		<!-- start tkhai header 01/PTHU-DK_TT80-->
	<xsl:template name="tkhaiHeader_01_PTHU_DK_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b>[03a]</b> Lần đầu: [X]   &#160;&#160;<b>[03b] </b>Bổ sung lần thứ: [&#32;]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[03a]</b> Lần đầu: [&#32;]   &#160;&#160;<b>[03b] </b>Bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
				</tr>
				<tr/>
			...
			<table width="100%" >
				...
				<tr>
					<td colspan="3">
						<b>[09]</b> Điện thoại: <xsl:value-of select="$tkchinh/NNT/dthoaiNNT"/>&#160;&#160;
					
						<b>[10]</b> Fax: <xsl:value-of select="$tkchinh/NNT/faxNNT"/>&#160;&#160;
					
						<b>[11]</b> E-mail: <xsl:value-of select="$tkchinh/NNT/emailNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[12]</b> Hợp đồng dầu khí lô: 
						<xsl:value-of select="$ttkthue/Header/ct12"/>
					</td>
				</tr>
				<xsl:if test="$ttkthue/DLyThue">
					<tr>
						<td colspan="3">
							<br/>
							<b>[13] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT13/donViDuocUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT13/daiLyThue = 'true' "> X </xsl:if>]:
								<xsl:if test="$tkchinh/Header/CT13/donViDuocUyQuyen = 'true' ">
									<xsl:value-of select="$tkchinh/Header/tenDonViDuocUyQuyen"/> 
								</xsl:if>
								<xsl:if test="$tkchinh/Header/CT13/daiLyThue = 'true' ">
									<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
								</xsl:if>
							</b>
						</td>
					...
					<tr>
						<td colspan="3">
						 ...
						 <b>[22] </b> Ngày: <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd/mm/yyyy')"/>
						</td>
					</tr>
				 </xsl:if>
				<xsl:if test="not($ttkthue/DLyThue)">
					<tr>
						<td colspan="3">
							...
							<b>[13] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT13/donViDuocUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT13/daiLyThue = 'true' "> X </xsl:if>]:
								...
								<xsl:if test="$tkchinh/Header/CT13/daiLyThue = 'true' "> </xsl:if>
							</b>
						</td>
					</tr>
					<tr>
	...
	<!-- start tkhai 01/SDDNN TT80 header -->
	<xsl:template name="tkhaiHeader_01SDDNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				<tr>
					<td>	<b>[04]</b> Tên tổ chức: <xsl:value-of select="$ttkthue/NNT/tenNNT"/></td>
				</tr>
				<tr>
					<td> <b>[05]</b> Mã số thuế: <xsl:value-of select="$ttkthue/NNT/mst"/></td>
				</tr>
				<tr>
					<td> <b>[06]</b> Địa chỉ trụ sở:</td>
				</tr>
				<tr>
					<td><b>[06.1]</b> Số nhà: <xsl:value-of select="$tkchinh/DiaChiTruSo/ct06_1"/></td>
					<td><b>[06.2]</b> Đường/phố: <xsl:value-of select="$tkchinh/DiaChiTruSo/ct06_2"/></td>
				</tr>
				<tr>
					<td><b>[06.3]</b> Tổ/thôn: <xsl:value-of select="$tkchinh/DiaChiTruSo/ct06_3"/></td>
					<td><b>[06.4]</b> Phường/xã/thị trấn: <xsl:value-of select="$tkchinh/DiaChiTruSo/ct06_4_ten"/>	</td>
				</tr>
				<tr>
					<td><b>[06.5]</b>Quận/Huyện: <xsl:value-of select="$ttkthue/NNT/tenHuyenNNT"/>				</td>
					<td><b>[06.6]</b>  Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/>					</td>
	...
	<xsl:template name="tkhaiHeader_03SDDNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<div><b>1. Người nộp thuế </b></div>
				...
				<b>[10.4]</b> Phường/xã/thị trấn: <xsl:value-of select="$tkchinh/NguoiNopThue/DiaChi/ct10_4_ten"/>
				<br/>
	...
	<xsl:template name="tkhaiHeader_01TMDN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					...
					<td><b>[10.4]</b> Phường/xã/thị trấn: <xsl:value-of select="$tkchinh/NguoiNopThue/DiaChi/ct10_4_ten"/></td>
				</tr>
				<tr>
	...
	<!-- start tkhai header 01/HKNN TT80-->
	<xsl:template name="tkhaiHeader-01HKNN-TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[05]</b> Nước cư trú: <xsl:value-of select="$tkchinh/ct05_ten"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[06]</b> Địa chỉ trụ sở chính tại nước ngoài: <xsl:value-of select="$tkchinh/ct06"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
	...
	<!-- start tkhai header 01/TBH TT80-->
	<xsl:template name="tkhaiHeader-01TBH-TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[[06] Tên Tổ chức nhận tái bảo hiểm nước ngoài</b>: <xsl:value-of select="$tkchinh/ToChucNhanTBHNN/ct6"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[07] </b>Nước cư trú:
									<xsl:value-of select="$tkchinh/ToChucNhanTBHNN/ct7_ten"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[08] </b>Địa chỉ trụ sở chính tại nước ngoài:
									<xsl:value-of select="$tkchinh/ToChucNhanTBHNN/ct8"/>
								</td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
	...
	<!-- start phụ lục tkhai header 01-1/TBH (TT80/2021)-->
<xsl:template name="tkhaiHeader-Pluc01-TBH-TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							<tr>
								<td colspan="3">
									<b>[04] Tên tổ chức nhận tái bảo hiểm nước ngoài hoặc tổ chức được uỷ quyền: <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PL_01-1_TBH_TB/Header/ct4_ten"/></b>
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[05]</b> Mã số thuế: <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PL_01-1_TBH_TB/Header/ct5_mst"/>
								</td>
							</tr>
						</table> 
					...
					<td>
						...
						<tr>
							...
							<tr>
								...
								<td>
									<b>[11b]</b> Phường/xã <xsl:value-of select="$tkchinh/Header/DiaChiHDSXKD/ct11b_ten"/>
								</td>
							</tr>
							<tr>
								<td colspan="2"> 
									<b>[11c]</b> Quận/Huyện: <xsl:value-of select="$tkchinh/Header/DiaChiHDSXKD/ct11c_ten"/>
								</td>
								<td>
...
<xsl:template name="tkhaiHeader-Pluc02-TBVMT-TT80">
	...
	<xsl:template name="tkhaiHeader_02_KK_TNCN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table"  width="100%">
				...
				<tr>
					<td>
						<b>[15]</b> Quận/Huyện: <xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct15_tenHuyen"/>
					</td>
					<td colspan="2">
						<b>[16]</b> Tỉnh/Thành phố: <xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct16_tenTinh"/>
					</td>
	...
	<xsl:template name="tkhaiHeader_06_TNCN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_05_KK_TNCN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_01_GTGT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
...
<!-- start header phụ luc 01-6/GTGT (TT80/2021)-->
	<xsl:template name="tkhaiHeader_PL_01_6_GTGT_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
			...
			<table>
				...
				<tr>
					<td class="align-l"><b>[01a]</b> Hoạt động phân bổ: 
						<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_CSSX/ct10a_csxs = 'true'"> [X] Đơn vị phụ thuộc, địa điểm kinh doanh là cơ sở sản xuất.
						</xsl:if>
						<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_CSSX/ct10a_csxs = '1'"> [X] Đơn vị phụ thuộc, địa điểm kinh doanh là cơ sở sản xuất.
						</xsl:if>
						<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_CSSX/ct10a_csxs = 'false'"> [&#32;&#32;] Đơn vị phụ thuộc, địa điểm kinh doanh là cơ sở sản xuất.
						</xsl:if>
						<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_CSSX/ct10a_csxs = '0'"> [&#32;&#32;] Đơn vị phụ thuộc, địa điểm kinh doanh là cơ sở sản xuất.
						</xsl:if>
						<br></br>
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_DVVT/ct10a_dvvt= 'true'">[X] Đơn vị phụ thuộc kinh doanh dịch vụ viễn thông cước trả sau.
						</xsl:if>
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_DVVT/ct10a_dvvt= '1'">[X] Đơn vị phụ thuộc kinh doanh dịch vụ viễn thông cước trả sau.
						</xsl:if>
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_DVVT/ct10a_dvvt= 'false'">[&#32;&#32;] Đơn vị phụ thuộc kinh doanh dịch vụ viễn thông cước trả sau.
						</xsl:if>
						&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/Pluc_01_6_GTGT_DVVT/ct10a_dvvt= '0'">[&#32;&#32;] Đơn vị phụ thuộc kinh doanh dịch vụ viễn thông cước trả sau.
						</xsl:if>
	...
	<!-- start header 04_NCCNN (TT80/2021)-->
	<xsl:template name="tkhaiHeader_04_NCCNN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<b>[01]</b><xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
					</td>
				</tr>				
			</table>
			<table class="ttinnnt_table"  width="100%">
				...
				<tr>
					<td colspan="3">
						<b>[02] Ngân hàng thương mại, tổ chức trung gian thanh toán:  </b><xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				<tr>
					<td>
	...
	<!-- start header 03_NCCNN (TT80/2021)-->
	<xsl:template name="tkhaiHeader_03_NCCNN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table"  width="100%">
				...
				<tr>
					<td colspan="3">
						<b>[04] Ngân hàng thương mại, tổ chức trung gian thanh toán: </b><xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[05] </b>Mã số thuế nộp thay: 
							<xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<tr>
	...
	<!-- start header 01/ĐK-TĐKTT (TT80/2021)-->
	<xsl:template name="tkhaiHeader_01_DK_TDKTT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						Kính gửi: <xsl:value-of select="$tkchinh/cqt_ten"/>
					</td>
				</tr>				
			</table>
		</div>
	...
	<!-- start header 02_XĐ_PNTT (TT80/2021)-->
	<xsl:template name="tkhaiHeader_02_XD_PNTT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<b>[01]</b> Loại thuế: 
						Giá trị gia tăng <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_GTGT = 'true'"> [X] 
						</xsl:if>
						Giá trị gia tăng <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_GTGT = '1'"> [X] 
						</xsl:if>
						Giá trị gia tăng <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_GTGT = 'false'"> [&#32;&#32;] 
						</xsl:if>
						Giá trị gia tăng <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_GTGT = '0'"> [&#32;&#32;] 
						</xsl:if>
					</td>
				</tr>				
				<tr>
					<td class="align-c">
						Thu nhập cá nhân <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_TNCN = 'true'"> [X] 
						</xsl:if>
						Thu nhập cá nhân <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh//Header/ct01_TNCN = '1'"> [X] 
						</xsl:if>
						Thu nhập cá nhân <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_TNCNT = 'false'"> [&#32;&#32;] 
						</xsl:if>
						Thu nhập cá nhân <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_TNCN = '0'"> [&#32;&#32;] 
						</xsl:if>
						Thu nhập cá nhân <xsl:if test="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct01_TNCN = '0'"> [&#32;&#32;] 
						</xsl:if>
					</td>
	...
	<!-- start tkhai header 02/LNCN_VSP-TT80  -->
	
	<xsl:template name="tkhaiHeader-02-LNCN-VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td colspan="3">
						<b>[08]</b> Mã số thuế người nộp thuế: 
						<xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[09]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct09"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
	...
	<!-- start header Phuluc 02_1_PL_DK_TT80-->
	<xsl:template name="tkhaiHeader-pl02-1dk">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c" colspan="3">
						<i>(Đối với dầu thô và condensate là ngày...tháng...năm/năm; Khí thiên nhiên là tháng/năm)</i>
					</td>
				</tr>
				<tr>
					<td class="align-c" colspan="3">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b>[04a]</b> Lần đầu: [X] &#160;&#160;&#160;&#160;<b>[04b] </b>Bổ sung lần thứ: [&#32;]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[04a]</b> Lần đầu: [&#32;] &#160;&#160;&#160;&#160;<b>[04b] </b>Bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
				</tr>
				<tr>
				...
				<xsl:if test="$ttkthue/DLyThue">
					<tr>
						<td colspan="3">
										...
										<b>[07]</b> Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT17/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT17/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenDonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> </xsl:if>
	...
	<!-- start tkhai header pluc43GTGT -->
	<xsl:template name="tkhaiHeader-pluc43GTGT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start tkhai header Vietsopevtro 01-ĐCĐB-VSP-->
	<xsl:template name="tkhaiHeader_01_DCDB_VSP_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					...
					<td colspan="3" class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b>[01a]</b> Khai lần đầu: [X] <b>[07] </b>Khai bổ sung lần thứ: [&#32;]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[01b]</b>Khai lần đầu: [&#32;] <b>[07] </b>Khai bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>
						<b>[04] </b> Địa chỉ: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/>
					</td>
				</tr>
				<tr>
					<td>
						<b>[05]</b> Quận/Huyện: <xsl:value-of select="$ttkthue/NNT/tenHuyenNNT"/>
					</td>
					<td colspan="2">
						<b>[06]</b> Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td colspan="3"><b>[10]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct10"/></td>
				</tr>
				<tr>
					<td colspan="3"><b>[11] </b> Mã số thuế nhà điều hành hợp đồng dầu khí: <xsl:value-of select="$tkchinh/Header/ct11"/></td>
				</tr>
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[12] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT12/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT18/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT12/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT12/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
								...
								<tr>
									<td>
										<b>[20] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
									</td>
									<td colspan="2"> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'yyyy')"/>
									</td>
								</tr>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<br/>
										<b>[12] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT12/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT12/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT12/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/tenDonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT12/daiLyThue = 'true' "> </xsl:if>
										</b>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										<b>[20] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: 
                                    </td>
									<td colspan="2"> ngày  tháng  năm 
                                    </td>
								</tr>
	...
	<!-- start tkhai header 02/TAIN-VSP-TT80  -->
	<xsl:template name="tkhaiHeader-02TAIN-VSP_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[15]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct19"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[17] </b>Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT17/donViUyQuyen = 'true' or $tkchinh/Header/CT17/donViUyQuyen = '1' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT17/daiLyThue = 'true' or $tkchinh/CT17/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT17/donViUyQuyen = 'true' or $tkchinh/CT17/donViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT17/daiLyThue = 'true'  or $tkchinh/CT17/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="2"><b>[25]</b> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<br/>
										<b>[17] </b>Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/CT17/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT17/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT17/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/tendonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/CT17/daiLyThue = 'true' "> </xsl:if>
									</td>
								</tr>
								<tr>
									<td colspan="3">
								...
								<tr>
									<td colspan="3">
										<b>[25] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: &#160;&#160; ngày
                                    </td>
								</tr>
							</xsl:if>
						</table>
		...
		<!-- start header Phuluc Vietsovpetro 02-1TAIN-->
	<xsl:template name="tkhaiHeader-pluc_02_1TAIN_VSP_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-l">
						<b>[05] </b>Tên người nộp thuế: 
						<xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
					<!--style:height="25"-->
				</tr>
				<tr>
					<td class="align-l"><b>[06] </b>Mã số thuế: <xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<b>[07] </b>Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT17/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT17/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT17/daiLyThue = 'true' ">
	...
	<!-- start tkhai header  02PTHU_VSP gói XML 2.5.2-->
	
	<xsl:template name="tkhaiHeader-02PTHU_VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b>[04]</b> Lần đầu: [x] <b>[05] </b>Bổ sung lần thứ: [&#32;]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b>[04]</b> Lần đầu: [&#32;] <b>[05] </b>Bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
				</tr>
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[14]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct14"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
									<b>[15]</b> Mã số thuế nhà điều hành hợp đồng dầu khí <xsl:value-of select="$tkchinh/Header/ct15"/>
								</td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[16] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT16/donViUyQuyen = 'true' or $tkchinh/Header/CT16/donViUyQuyen = '1' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT16/daiLyThue = 'true' or $tkchinh/CT16/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT16/donViUyQuyen = 'true' or $tkchinh/CT16/donViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT16/daiLyThue = 'true'  or $tkchinh/CT16/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
								...
								<tr>
									...
									<td colspan="2"> ngày <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd')"/>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="not($ttkthue/DLyThue)">
								...
								<tr>
									<td colspan="3">
										<b>[24] </b> Hợp đồng uỷ quyền hoặc Hợp đồng đại lý thuế, số: &#160;&#160; ngày
                                    </td>
								</tr>
							</xsl:if>
						</table>
		...
		<div class="giahan_div">
			...
			<!-- start header phụ luc 01-6/GTGT (TT80/2021)-->
	<xsl:template name="tkhaiHeader-pluc_02_1PTHU_VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[06] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT16/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT16/nguoiNopThueThay = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenNguoiNopThueThay"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
								...
								<tr>
									<td colspan="3">
										...
										<b>[06] Tên Người nộp thuế thay [<xsl:if test="$tkchinh/Header/CT16/nguoiNopThueThay = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' "> X </xsl:if>]:
											...
											<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' "> </xsl:if>
										</b>
									</td>
								</tr>
								<tr>
  ...
  <xsl:template name="tkhaiHeader_QT_LNCL_01">
	...
	<xsl:template name="tkhaiHeader_02PH">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c">
						<b>[01] Kỳ tính thuế</b>: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
			...
			<table class="ttinnnt_table">
				<tr>
					<td colspan="3">
						<b>[04] Người nộp thuế</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
	...
	<!-- start tkhai header 02/TNDN_VSP-TT80  -->
	<xsl:template name="tkhaiHeader-02TNDN-VSP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[20] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT17/donViUyQuyen = 'true' or $tkchinh/Header/CT17/donViUyQuyen = '1' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT17/daiLyThue = 'true' or $tkchinh/CT17/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT17/donViUyQuyen = 'true' or $tkchinh/CT17/donViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT17/daiLyThue = 'true'  or $tkchinh/CT17/daiLyThue = '1' ">
						 ...
						 Ngày: <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd/mm/yyyy')"/>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<br/>
										<b>[17] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/CT17/donViUyQuyen = 'true' "> X </xsl:if>] &#160;&#160;&#160;hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT17/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT17/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/tendonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/CT17/daiLyThue = 'true' "> </xsl:if>
	...
	<!-- start tkhai header 02/PTHU_DK-TT80  -->
	<xsl:template name="tkhaiHeader-02PTHU-DK">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							...
							<tr>
								<td colspan="3">
									<b>[12]</b> Hợp đồng dầu khí lô: <xsl:value-of select="$tkchinh/Header/ct12"/>
								</td>
							</tr>
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[13] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT13/donViUyQuyen = 'true' or $tkchinh/Header/CT13/donViUyQuyen = '1' "> X </xsl:if>]&#160;&#160; hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT13/daiLyThue = 'true' or $tkchinh/Header/CT13/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT13/donViUyQuyen = 'true' or $tkchinh/Header/CT13/donViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/Header/tenDonViDuocUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT13/daiLyThue = 'true'  or $tkchinh/Header/CT13/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
						 ...
						 <b>[22] </b> Ngày: <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd/mm/yyyy')"/>
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<br/>
										<b>[06] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT13/donViUyQuyen = 'true' or $tkchinh/Header/CT13/donViUyQuyen = '1' "> X </xsl:if>]&#160;&#160; hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT13/daiLyThue = 'true' or $tkchinh/CT13/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT13/donViUyQuyen = 'true' or $tkchinh/Header/CT13/donViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/Header/tenDonViDuocUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT13/daiLyThue = 'true'  or $tkchinh/CT13/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
	...
	<!-- start tkhai header phu luc 04/PTHU_DK-TT80  -->
	<xsl:template name="tkhaiHeader-pl04-pthu-dk">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c"><b>Phụ lục</b> 
					<br/><b>BẢNG KÊ SẢN LƯỢNG VÀ GIÁ BÁN DẦU THÔ KHAI THÁC</b> 
					<br/><i>(Kèm theo Tờ khai quyết toán phụ thu mẫu số 02/PTHU-DK, 03/PTHU-DK)</i>
					</td>
				</tr>
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							<tr>
								<td colspan="3">
									<b>[04] Người nộp phụ thu</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[06] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT13/donViUyQuyen = 'true' or $tkchinh/Header/CT13/donViUyQuyen = '1' "> X </xsl:if>]&#160;&#160; hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT17/daiLyThue = 'true' or $tkchinh/CT17/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT13/donViUyQuyen = 'true' or $tkchinh/Header/CT13/donViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/Header/tenDonViDuocUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT13/daiLyThue = 'true'  or $tkchinh/CT13/daiLyThue = '1' ">
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<b>[06] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT13/tenDonViUyQuyen = 'true' or $tkchinh/Header/CT13/tenDonViUyQuyen = '1' "> &#160; X </xsl:if>]&#160;&#160; hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT13/daiLyThue = 'true' or $tkchinh/CT13/daiLyThue = '1' ">&#160;  X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT13/tenDonViUyQuyen = 'true' or $tkchinh/Header/CT13/tenDonViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/Header/tenDonViDuocUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT13/daiLyThue = 'true'  or $tkchinh/CT13/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
	...
	<!-- start tkhai header phu luc 05/PTHU_DK-TT80  -->
	<xsl:template name="tkhaiHeader-pl05-pthu-dk">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c"><b>Phụ lục</b> 
					<br/><b>BẢNG KÊ SỐ PHỤ THU TẠM TÍNH ĐÃ NỘP</b> 
					<br/><i>(Kèm theo Tờ khai quyết toán phụ thu mẫu số 02/PTHU-DK, 03/PTHU-DK)</i>
					</td>
				</tr>
					...
					<td>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<b>[06] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT13/tenDonViDuocUyQuyen = 'true' or $tkchinh/Header/CT13/tenDonViDuocUyQuyen = '1' ">&#160;  X </xsl:if>]&#160;&#160; hoặc Đại lý thuế [<xsl:if test="$tkchinh/CT13/daiLyThue = 'true' or $tkchinh/CT13/daiLyThue = '1' "> &#160; X </xsl:if>]:
                                            <xsl:if test="$tkchinh/CT13/tenDonViDuocUyQuyen = 'true' or $tkchinh/CT13/tenDonViDuocUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/tenDonViDuocUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/CT13/daiLyThue = 'true'  or $tkchinh/CT13/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
	...
	<!-- start tkhai header 01/VTNN (TT80/2021)-->
	<xsl:template name="tkhaiHeader-01VTNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- start header Phuluc 01-1/VTNN-->
	<xsl:template name="tkhaiHeaderPL01-1_VTNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- end header Phuluc 01-1/VTNN-->
	<!-- start header Phuluc 01-2/VTNN-->
	<xsl:template name="tkhaiHeaderPL01-2_VTNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- end header Phuluc 01-2/VTNN-->
	<!-- start header Phuluc 01-3/VTNN-->
	<xsl:template name="tkhaiHeaderPL01-3_VTNN_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
...
<!-- start tkhai header 02/PHLPNG-->
	<xsl:template name="tkhaiHeader_PHLP">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- start header phụ luc 02-1/PHLPNG (TT80/2021)-->
	<xsl:template name="tkhaiHeader_PL_02_1_PHLPNG_TT80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table">
							<tr>
								<td colspan="3">
									<b>[02] Người nộp thuế</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>
								</td>
							</tr>
							<tr>
								<td colspan="3">
...
<!-- start phụ lục tkhai header 02-TAIN-DK (TT80/2021)-->
	<xsl:template name="tkhaiHeader-02TAIN-DK">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
					...
					<td>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								<tr>
									<td colspan="3">
										<br/>
										<b>[16] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT16/donViUyQuyen = 'true' or $tkchinh/Header/CT16/donViUyQuyen = '1' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' or $tkchinh/Header/CT16/daiLyThue = '1' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT16/donViUyQuyen = 'true' or $tkchinh/Header/CT16/donViUyQuyen = '1'">
												<xsl:value-of select="$tkchinh/Header/tenDonViUyQuyen"/> 
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true'  or $tkchinh/Header/CT16/daiLyThue = '1' ">
												<xsl:value-of select="$ttkthue/DLyThue/tenDLyThue"/>
											</xsl:if>
										</b>
									</td>
						...
						<xsl:if test="not($ttkthue/DLyThue)">
								<tr>
									<td colspan="3">
										<br/>
										<b>[16] Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh//Header/CT16/donViUyQuyen = 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' "> X </xsl:if>]:
                                            <xsl:if test="$tkchinh/Header/CT16/donViUyQuyen = 'true' ">
												<xsl:value-of select="$tkchinh/Header/tenDonViUyQuyen"/>
											</xsl:if>
											<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' "> </xsl:if>
										</b>
	...
	<!-- start tkhai header NTNN 02_NTNN_TT80-->
	<xsl:template name="tkhaiHeader_02_NTNN_TT80">
        <xsl:param name="mauTKhai" />
        <xsl:param name="moTaBieuMau" />
        <xsl:param name="ghuchuTK" />
        <xsl:variable  name="kieuKy_">
        ...
        <div class="header_div">			
            <table  class="ttinnnt_table">	
                ...
                <tr>
                    <td class="align-c">
                        <b>[01]</b> Kỳ tính thuế: Quyết toán hợp đồng số <xsl:value-of select="$tkchinh/Header/soHopDong"/> ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ngayHopDong,'dd/mm/yyyy')"/>                     
                    </td> 
				</tr>
				<tr>
					<td class="align-c">
						Từ ngày
                     <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,'dd/mm/yyyy')"/> đến ngày <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'dd/mm/yyyy')"/>
					 </td>
                </tr>
                <tr>
                    <td class="align-c">	
            ...
            <table class="ttinnnt_table">
                ...
                <xsl:if test="not($ttkthue/DLyThue)">	
                    ...
                    <tr>
                        <td>
                            <b>[08] </b> Hợp đồng đại lý thuế: Số  &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Ngày:
                        </td>                        
                    </tr>
                </xsl:if>
                <xsl:if test="$ttkthue/DLyThue">	
	...
	<!-- start header Phuluc 02-1/NTNN-TT80-->
    <xsl:template name="tkhaiHeader_Pluc_02_01_NTNN_TT80">	
        <xsl:param name="mauTKhai" />
        <xsl:param name="moTaBieuMau" />
        <xsl:param name="tKhai" />
        <xsl:param name="tenPL" />
        ...
        <tr>
			...
			<!-- end -->
                ...
                <tr>
                    <td class="align-l">
                        Mã số thuế nộp thay của Bên Việt Nam: <xsl:value-of select="$ttkthue/NNT/mst"/>
                    </td>
                </tr>
	...
	<!-- start header Phuluc 02-2-NTNN-TT80-->
    <xsl:template name="tkhaiHeader-pluc-02-2-NTNN-TT80">	
        <xsl:param name="mauTKhai" />
        <xsl:param name="moTaBieuMau" />
        <xsl:param name="tKhai" />
        <xsl:param name="tenPL" />
	...
	<!-- start header To khai 04_NTNN TT80-->
	<xsl:template name="tkhaiHeader04_NTNN_TT80">
        <xsl:param name="mauTKhai" />
        <xsl:param name="moTaBieuMau" />
        <xsl:param name="ghuchuTK" />
        <xsl:variable  name="kieuKy_">
        ...
        <div class="header_div">			
            ...
            <table class="ttinnnt_table">
                ...
                <xsl:if test="$ttkthue/DLyThue">	
                  ...
                  <tr>
                        <td>
                            <b>[09] </b> Hợp đồng nhà thầu :  Số  <xsl:value-of select="$tkchinh/CT09/soHopDong"/>
                        </td>
                        <td colspan="2"> Ngày: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/CT09/ngayHopDong,'dd/mm/yyyy')"/>
                        </td>
                    </tr>
            </table>
        </div>
	...
	<xsl:template name="tkhaiHeader_tt80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
...
<!-- start tkhai header -->
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					...
					<tr>
						<td colspan="3">
							 <b>[06]</b>Họ và tên vợ (chồng) nếu có:  <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_02_1_BK_QTT_TNCN/Header/ct04"/>
							
						</td>
					</tr>
					<tr>
						<td class="align-l">
							<b>[07]</b> Mã số thuế: <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_02_1_BK_QTT_TNCN/Header/ct05"/>
						</td>
					</tr>
					<tr>
						<td class="align-l">
							<b>[08]</b> Số CMND/ Số hộ chiếu vợ (chồng): <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_02_1_BK_QTT_TNCN/Header/ct06"/></td>
					</tr>
					<xsl:if test="$ttkthue/DLyThue">
					<xsl:if test="$ttkthue/DLyThue">
					<tr>
	...
	<!-- start header Phuluc 03-3B-TNDN (TT80/2021)-->
	<xsl:template name="tkhaiHeader-pluc-03-3b-tndn-tt80">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table>
				...
				<!-- end -->
				<!-- <tr>
             				  <td class="align-c"><xsl:if test="$pl03-3a_tndn/duAn = 'true' "> [x] </xsl:if> 
             				   <xsl:if test="$pl03-3a_tndn/duAn = 'false'">[]</xsl:if>	<xsl:if test="$pl03-3a_tndn/duAn = '1'"> [x]</xsl:if> <xsl:if test="$pl03-3a_tndn/duAn = '0'">[]</xsl:if> Dự án đầu tư - kinh doanh nhà ở xã hội</td>
			    </tr> -->
				<tr>
					<td class="align-c">
						<b>[01]</b> Kỳ tính thuế: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/> Từ <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,'dd/mm/yyyy')"/> &#160;đến <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay,'dd/mm/yyyy')"/>) 
	...
	<xsl:template name="tkhaiHeader_02_TAIN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!--tkhaiHeader-pluc01-132-->
<xsl:template name="tkhaiHeader-pluc01-132">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
...
<!--tkhaiHeader-pluc02-132-->
<xsl:template name="tkhaiHeader-pluc02-132">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
...
<!--PL03_132-->
<xsl:template name="tkhaiHeader-pluc03-132">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
...
<!--PL04_132-->
<xsl:template name="tkhaiHeader-pluc04-132">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start header Phuluc 01/PL-DK Xuan-->
	<xsl:template name="tkhaiHeader-pl01-pl-dk">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
...
<tr>
				...
				<tr>
					...
					<xsl:if test="$ttkthue/DLyThue">					
					<tr><td colspan="3">																				
					<b>[07]</b> Tên đơn vị được uỷ quyền [<xsl:if test="$tkchinh/Header/CT16/donViUyQuyen= 'true' "> X </xsl:if>] hoặc Đại lý thuế [<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' "> X </xsl:if>]:                                 
					<xsl:if test="$tkchinh/Header/CT16/donViUyQuyen = 'true' ">												
					<xsl:value-of select="$tkchinh/Header/tenDonViUyQuyen"/>											
					</xsl:if>											
					<xsl:if test="$tkchinh/Header/CT16/daiLyThue = 'true' ">
				...
				<tr>
					<td class="align-l">
						<b>[09]</b> Số thuế phải nộp: <xsl:value-of select="ihtkk:formatNumber(HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_DK/ct09)"/> 
						 <xsl:if test="$tkchinh/ten_DonVi= 'VND' "> VND</xsl:if>
						 <xsl:if test="$tkchinh/ten_DonVi= 'USD' "> USD</xsl:if>
					</td>
				</tr>
			</table>
		</div>
	</xsl:template>
<!-- start header Phuluc 02-1/PL-DK Xuan-->
	<xsl:template name="tkhaiHeader-pl02-1-dk">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
...
<tr>
		...
		<!-- start tkhai header 01/DNXLNT-->
	<xsl:template name="tkhaiHeader_01DNXLNT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
		<div class="header_div">
			...
			<br/>
			<div style="width:90%;text-align:center">Kính gửi: <xsl:value-of select="$tkchinh/Header/tenCoQuanThue"/></div><br/><br/>
			<div><b>I. THÔNG TIN NGƯỜI NỘP THUẾ: </b></div>
			<table class="ttinnnt_table">
				<tr>
					<td colspan="4">
						<b>[01] Tên người nộp thuế</b>: <xsl:value-of select="$ttkthue/NNT/tenNNT"/>
				...
				<xsl:if test="not($ttkthue/DLyThue)">
					...
					<tr>
						<td colspan="2">
							<b>[05] </b> Hợp đồng đại lý thuế: Số  
                        </td>
						<td colspan="2"> Ngày: 
                        </td><br/>
					</tr>
				...
				<xsl:if test="$ttkthue/DLyThue">
					...
					<tr>
						<td colspan="2">
							<b>[05] </b> Hợp đồng đại lý thuế: Số  <xsl:value-of select="$ttkthue/DLyThue/soHDongDLyThue"/>
						</td>
						<td colspan="2"> Ngày: <xsl:value-of select="ihtkk:stringDatetime($ngayKyHDDLyThue,'dd/mm/yyyy')"/>
						</td>
					</tr>
	...
	<!-- start header 02/TEM (TT23/2021)-->
	<xsl:template name="tkhaiHeader_02_TEM">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				...
				<tr>
					<td class="align-c">
						...
						[<xsl:if test="$tkchinh/Header/dangKyKHLanDau='true' or $tkchinh/Header/dangKyKHLanDau='1' ">x</xsl:if>] Đăng ký kế hoạch lần đầu<br/>
						[<xsl:if test="$tkchinh/Header/dangKyKHBoSung='true' or $tkchinh/Header/dangKyKHBoSung='1'">x</xsl:if>] Đăng ký kế hoạch bổ sung lần thứ: <xsl:value-of select="$tkchinh/Header/lanThu"/><br/>						
					</td>
				</tr>
			</table>
			...
			<table with='100%'>
					...
					<tr>
					<td>
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ Giấy phép sản xuất sản phẩm thuốc lá hoặc Giấy phép sản xuất sản phẩm rượu số <xsl:value-of select="$tkchinh/soGiayPhepSX"/> do <xsl:value-of select="$tkchinh/noiCapGiayPhep"/> cấp ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayGiayPhepSX,'dd/mm/yyyy')"/>,
					...
					<tr>
					<td>
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$ttkthue/NNT/tenNNT"/> lập kế hoạch mua/mua bổ sung tem điện tử thuốc lá hoặc tem điện tử rượu sản xuất để tiêu thụ trong nước như sau:
					</td>
					</tr>
	...
	<!-- start header 04/TEM (TT23/2021)-->
	<xsl:template name="tkhaiHeader_04_TEM">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table class="ttinnnt_table">
				<tr>
					...
					<br/>-------------------
					 <br/>Số: <xsl:value-of select="$tkchinh/so"/>
					</td>
					<td style="width:60%;text-align:center">
						<b>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM<br/>Độc lập - Tự do - Hạnh phúc</b>
						<br/>-------------------
	...
	<!-- start header 07/TEM (TT23/2021)-->
	<xsl:template name="tkhaiHeader_07_TEM">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<!-- start header 01/CCTT-TMĐT-->
	<xsl:template name="tkhaiHeader_01_CCTT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c"><b></b> Kỳ dữ liệu: <xsl:value-of select="ihtkk:kyTinhThue($kyKKhai,$kieuKy,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiTuNgay,$ttkthue/TKhaiThue/KyKKhaiThue/kyKKhaiDenNgay)"/>
					</td>
				</tr>
				<tr>
					<td class="align-c">
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='C'">
							<b></b> Lần đầu: [X] <b></b>Bổ sung lần thứ: [&#32;]<b></b>Thay thế lần thứ: [&#32;]
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='B'">
							<b></b> Lần đầu: [&#32;] <b></b>Bổ sung lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
						<xsl:if test="$ttkthue/TKhaiThue/loaiTKhai='T'">
							<b></b> Lần đầu: [&#32;] <b></b>Thay thế lần thứ: [<xsl:value-of select="$ttkthue/TKhaiThue/soLan"/>]    
                        </xsl:if>
					</td>
				</tr>
			</table>
			...
			<table class="ttinnnt_table"  width="100%">
				<tr>
					<td colspan="3">
						<b>[01] Tên Công ty: </b><xsl:value-of select="$ttkthue/NNT/tenNNT"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[02] Mã số thuế: </b><xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<b>[03] Cơ quan Thuế quản lý: </b><xsl:value-of select="$ttkthue/TKhaiThue/tenCQTNoiNop"/>
					</td>
				</tr>
				<tr>
					
					<td>
						<b>[04] </b>Tổng số lượng nhà cung cấp:
                            <xsl:value-of select="$tkchinh/Header/ct4"/>
					</td>
				</tr>
				<tr>
					
					<td>
						<b>[05] </b>Trong đó số lượng nhà cung cấp đã ủy quyền khai thay:
                            <xsl:value-of select="$tkchinh/Header/ct5"/>
					</td>
				</tr>
			</table>		
		</div>
	</xsl:template>
	<!-- start header Phuluc 02  TMĐT-->
	<xsl:template name="tkhaiHeader-pluc02-TMDT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start header 02_10-->
	<xsl:template name="tkhaiHeader_02_10">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
			<table>
				...
				<tr>
					...
					<br/>-------------------
					 <br/>Số: <xsl:value-of select="$tkchinh/Header/tenNNT_so"/>
					</td>
					<td style="width:60%;text-align:center">
						<b>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM<br/>Độc lập - Tự do - Hạnh phúc</b>
						<br/>-------------------
				...
				<tr>
					...
					<xsl:value-of select="$tkchinh/Header/diaDanh"/>,&#160;ngày <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/ngayKy,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/ngayKy,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ttkthue/TKhaiThue/ngayKy,'yyyy')"/>
					</td>
				</tr>
				<tr>
				<td class="align-c" colspan="2">
		...
		<b>
						THÔNG BÁO
						<br/> VỀ VIỆC THỰC HIỆN HỢP ÐỒNG DỊCH VỤ VỚI ÐẠI LÝ THUẾ </b>
						<br/>-------------------------
					</td>
				</tr>
				<tr>
					...
					Kính gửi: <xsl:value-of select="$tkchinh/Header/kinhGui"/>
					</td>
				</tr>
				<tr>
				<td colspan="2">
				&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ Thông tư số 10/2021/TT-BTC ngày 26/01/2021 của Bộ Tài chính hướng dẫn quản lý hành nghề dịch vụ làm thủ tục về thuế; 
				</td>
				</tr>
				
				<tr>
				<td colspan="2">
				&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ hợp đồng số  <xsl:value-of select="$tkchinh/Header/so"/> ngày  <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ngay_thang_nam,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ngay_thang_nam,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/Header/ngay_thang_nam,'yyyy')"/> ký với <xsl:value-of select="$tkchinh/Header/ten_DaiLyThue"/>, mã số thuế <xsl:value-of select="$tkchinh/Header/mst_DaiLyThue"/>
				</td>
				</tr>
				<tr>
				<td colspan="2">
				&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<xsl:value-of select="$ttkthue/NNT/tenNNT"/>, mã số thuế <xsl:value-of select="$ttkthue/NNT/mst"/>, số điện thoại:<xsl:value-of select="$ttkthue/NNT/dthoaiNNT"/> thông báo cơ quan thuế về việc thực hiện/tạm dừng/chấm dứt hợp đồng/dịch vụ làm thủ tục về thuế như sau:
				</td>
				</tr>
