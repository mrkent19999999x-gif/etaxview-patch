...
<!--start Footer tờ khai NTNN - TT80-->		
   ...
   <xsl:template name="tkhaiFooter_Pluc02-TBVMT-TT80">
	...
	<!--start Footer  -->	
	<xsl:template name="tkhaiFooter-02-10">
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	<br/><span>&#160;&#160;Chúng tôi cam kết các thông tin trên là đúng và xin chịu trách nhiệm trước pháp luật về những nội dung nêu trên./.</span>
	<div class="footer_div">
		<table >
			...
			<tr>
				...
				<xsl:if test="$kskthue/TKhaiThue/ngayKy ">
					<td width="40%" class="align-c">
					<b>NGƯỜI ĐẠI DIỆN THEO PHÁP LUẬT  <br/> CỦA NGƯỜI NỘP THUẾ  </b>
					<br/>
