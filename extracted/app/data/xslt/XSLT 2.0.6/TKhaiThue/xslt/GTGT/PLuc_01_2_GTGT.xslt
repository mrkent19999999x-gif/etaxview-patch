			...
			<div class="content">
					<div class="donvitien"><i>Đơn vị tiền: đồng Việt Nam</i></div>
						<table class="tkhai_table"  >
							...
							<tr>
								<td colspan="8"><i>1. Hàng hoá, dịch vụ dùng riêng cho SXKD chịu thuế GTGT và sử dụng cho các hoạt động cung cấp hàng hoá, dịch vụ không kê khai, nộp thuế GTGT đủ điều kiện khấu trừ thuế: </i></td>
							</tr>
						   <xsl:for-each select="$pl02/HHDVDRieng/ChiTietHHDVDRieng/HDonMVao">
							...
							<tr>
								<td colspan="8"><i>2. Hàng hoá, dịch vụ dùng chung cho SXKD chịu thuế và không chịu thuế đủ điều kiện khấu trừ thuế:</i></td>
							</tr>
						   <xsl:for-each select="$pl02/HHDVDChung/ChiTietHHDVDChung/HDonMVao">
							...
							<tr>
								<td colspan="8"><i>3. Hàng hóa, dịch vụ dùng cho dự án đầu tư đủ điều kiện được khấu trừ thuế (*):</i></td>
							</tr>
...
<div class="ghichu">						
				<div><b>Tổng giá trị HHDV mua vào phục vụ SXKD được khấu trừ thuế GTGT (**): <xsl:value-of select="ihtkk:formatNumber($pl02/tongGTriMVao)"/></b></div>
				<div><b>Tổng số thuế GTGT của HHDV mua vào đủ điều kiện được khấu trừ (***): <xsl:value-of select="ihtkk:formatNumber($pl02/tongThueMVao)"/></b></div>
			  </div>
			</div>
</div>
