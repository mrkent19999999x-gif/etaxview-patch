 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<!--start phu luc PL_01_ND20-->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PL_03_ND20">	
		<xsl:variable name="pl03_nd20" select='HSoThueDTu/HSoKhaiThue/PLuc/PL_03_ND20' />
		...
		<div>Công ty báo cáo các thông tin, tài liệu đã chuẩn bị và lưu trữ theo quy định tại Mẫu số 03, như sau:</div>
		    <table class="tkhai_table">
						...
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_1.1/daLapVaLuu = 'true' or $pl03_nd20/Dong_1.1/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_1.1/ghiChu"/></td>
						</tr>
						...
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_2.1/daLapVaLuu = 'true' or $pl03_nd20/Dong_2.1/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_2.1/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_2.2/daLapVaLuu = 'true' or $pl03_nd20/Dong_2.2/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_2.2/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_2.3/daLapVaLuu = 'true' or $pl03_nd20/Dong_2.3/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_2.3/ghiChu"/></td>
						</tr>
						<tr>
							 <td class="align-c">2.4</td>
							 <td>Mô tả các thị trường địa lý chính của các sản phẩm của tập đoàn nêu tại mục 2.2</td>
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_2.4/daLapVaLuu = 'true' or $pl03_nd20/Dong_2.4/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_2.4/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_2.5/daLapVaLuu = 'true' or $pl03_nd20/Dong_2.5/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_2.5/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_2.6/daLapVaLuu = 'true' or $pl03_nd20/Dong_2.6/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_2.6/ghiChu"/></td>
						</tr>
						...
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_3.1/daLapVaLuu = 'true' or $pl03_nd20/Dong_3.1/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_3.1/ghiChu"/></td>
						</tr>
						<tr>
							 <td class="align-c">3.2</td>
							 <td>Danh mục các TSVH hoặc nhóm các TSVH của tập đoàn có tác động trọng yếu đối với chính sách giá chuyển nhượng và do các công ty con sở hữu về mặt pháp lý</td>
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_3.2/daLapVaLuu = 'true' or $pl03_nd20/Dong_3.2/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_3.2/ghiChu"/></td>
						</tr>
						<tr>
							 <td class="align-c">3.3</td>
							 <td>Danh sách các thỏa thuận quan trọng giữa các bên liên kết liên quan đến TSVH, thỏa thuận đóng góp chi phí, thỏa thuận dịch vụ nghiên cứu cho trụ sở chính và các thỏa thuận cấp giấy phép, nhượng quyền</td>
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_3.3/daLapVaLuu = 'true' or $pl03_nd20/Dong_3.3/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_3.3/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_3.4/daLapVaLuu = 'true' or $pl03_nd20/Dong_3.4/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_3.4/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_3.5/daLapVaLuu = 'true' or $pl03_nd20/Dong_3.5/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_3.5/ghiChu"/></td>
						</tr>
						<tr>
						...
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_4.1/daLapVaLuu = 'true' or $pl03_nd20/Dong_4.1/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_4.1/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_4.2/daLapVaLuu = 'true' or $pl03_nd20/Dong_4.2/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_4.2/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_4.3/daLapVaLuu = 'true' or $pl03_nd20/Dong_4.3/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_4.3/ghiChu"/></td>
						</tr>
						<tr>
						...
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_5.1/daLapVaLuu = 'true' or $pl03_nd20/Dong_5.1/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_5.1/ghiChu"/></td>
						</tr>
						<tr>
							 ...
							 <td class="align-c">[<xsl:if test="$pl03_nd20/Dong_5.2/daLapVaLuu = 'true' or $pl03_nd20/Dong_5.2/daLapVaLuu = '1'" >x</xsl:if>]</td>
							 <td class="align-l"><xsl:value-of select="$pl03_nd20/Dong_5.2/ghiChu"/></td>
						</tr>
