					...
					<div class="ndungtkhai_div">	
		             <div class="content">	
		             	  ...
		             	  <table>
					        ...
					        <tr>
             				  <td class="align-l"> <xsl:if test="dieuKienUuDai1 = 'true' "> [x] </xsl:if>   <xsl:if test="dieuKienUuDai1 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai1 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai1 = '0'">[]</xsl:if>  Doanh nghiệp hoạt động sản xuất, xây dựng, vận tải sử dụng nhiều lao động nữ: </td>
			                </tr>
					        <tr>
					        ...
					        <tr>
             				  <td class="align-l"> <xsl:if test="dieuKienUuDai2 = 'true' "> [x] </xsl:if> <xsl:if test="dieuKienUuDai2 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai2 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai2 = '0'">[]</xsl:if> Doanh nghiệp sử dụng lao động là người dân tộc thiểu số:</td>
			                </tr>
					        <tr>
        			        ...
        			        <tr>
             				  <td class="align-l"> <xsl:if test="mucDoUuDai1 = 'true' "> [x] </xsl:if> <xsl:if test="mucDoUuDai1 = 'false'">[]</xsl:if>	<xsl:if test="mucDoUuDai1 = '1'"> [x]</xsl:if> <xsl:if test="mucDoUuDai1 = '0'">[]</xsl:if> Giảm thuế thu nhập doanh nghiệp (TNDN) tương ứng mức chi cho lao động nữ. </td>
			                </tr>
			                 <tr>
             				  <td class="align-l"> <xsl:if test="mucDoUuDai2 = 'true' "> [x] </xsl:if><xsl:if test="mucDoUuDai2 = 'false'">[]</xsl:if>	<xsl:if test="mucDoUuDai2 = '1'"> [x]</xsl:if> <xsl:if test="mucDoUuDai2 = '0'">[]</xsl:if> Giảm thuế thu nhập doanh nghiệp tương ứng mức chi cho lao động là người dân tộc thiểu số. </td>
			                </tr>		                
   						    <tr>
