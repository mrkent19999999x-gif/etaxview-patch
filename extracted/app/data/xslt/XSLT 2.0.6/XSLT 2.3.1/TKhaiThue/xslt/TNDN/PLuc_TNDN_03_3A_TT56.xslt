					...
					<div class="ndungtkhai_div">	
		             <div class="content">	
		             	  ...
		             	  <table>
					        ...
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai1 = 'true' "> [x] </xsl:if> 
             				   <xsl:if test="dieuKienUuDai1 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai1 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai1 = '0'">[]</xsl:if> Doanh nghiệp sản xuất mới thành lập từ dự án đầu tư.</td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai2 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai2 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai2 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai2 = '0'">[]</xsl:if> Doanh nghiệp di chuyển địa điểm ra khỏi đô thị theo quy hoạch đã được cơ quan có thẩm quyền phê duyệt.</td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai3 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai3 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai3 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai3 = '0'">[]</xsl:if> Doanh nghiệp mới thành lập từ dự án đầu tư hoặc dự án đầu tư mới  vào ngành nghề, lĩnh vực ưu đãi đầu tư. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai4 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai4 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai4 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai4 = '0'">[]</xsl:if> Doanh nghiệp mới thành lập từ dự án đầu tư hoặc dự án đầu tư mới  vào ngành nghề, lĩnh vực đặc biệt ưu đãi đầu tư. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai5 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai5 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai5 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai5 = '0'">[]</xsl:if> Doanh nghiệp mới thành lập từ dự án đầu tư hoặc dự án đầu tư mới vào địa bàn thuộc Danh mục địa bàn có điều kiện kinh tế - xã hội khó khăn. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai6 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai6 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai6 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai6 = '0'">[]</xsl:if> Doanh nghiệp mới thành lập từ dự án đầu tư hoặc dự án đầu tư mới  vào địa bàn thuộc Danh mục địa bàn có điều kiện kinh tế - xã hội đặc biệt khó khăn, khu kinh tế, khu công nghệ cao. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai7 = 'true' "> [x]  </xsl:if>  <xsl:if test="dieuKienUuDai7 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai7 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai7 = '0'">[]</xsl:if> Doanh nghiệp thành lập mới trong lĩnh vực xã hội hoá hoặc có thu nhập từ hoạt động xã hội hoá. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai8 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai8 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai8 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai8 = '0'">[]</xsl:if> Dự án đầu tư đặc biệt quan trọng. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai9 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai9 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai9 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai9 = '0'">[]</xsl:if> Hợp tác xã dịch vụ nông nghiệp; Quỹ tín dụng nhân dân; Tổ chức tài chính vi mô; Cơ quan xuất bản. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai10 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai10 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai10 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai10 = '0'">[]</xsl:if> Ưu đãi theo Giấy phép đầu tư, Giấy chứng nhận ưu đãi đầu tư. </td>
			                </tr>
					        <tr>
             				  <td class="align-l"><xsl:if test="dieuKienUuDai11 = 'true' "> [x] </xsl:if>  <xsl:if test="dieuKienUuDai11 = 'false'">[]</xsl:if>	<xsl:if test="dieuKienUuDai11 = '1'"> [x]</xsl:if> <xsl:if test="dieuKienUuDai11 = '0'">[]</xsl:if> Ưu đãi khác </td>
			                </tr>
			                <tr>
