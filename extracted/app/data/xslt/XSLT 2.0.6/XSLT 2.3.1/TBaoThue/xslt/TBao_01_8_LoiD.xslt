...
<xsl:include href="../common/common.xsl"/>
    ...
    <div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ quy định tại Điều 9 Thông tư số 19/2021/TT-BTC ngày 18/3/2021 của Bộ trưởng Bộ Tài chính hướng dẫn về giao dịch điện tử trong lĩnh vực thuế.</div><br/>

	
	<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Do sự cố kỹ thuật của Cổng thông tin điện tử Tổng cục Thuế, Tổng cục Thuế thông báo tạm dừng việc nhận chứng từ nộp thuế điện tử của người nộp thuế từ ngày <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/LoiKyThuat/ngayTBao,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/LoiKyThuat/ngayTBao,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($ndungTBao/LoiKyThuat/ngayTBao,'yyyy')"/> 
