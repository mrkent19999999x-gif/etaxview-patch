                    ...
                    <table class="tkhai_table">
						...
						<xsl:for-each select="$pl01_3/BangPhanBoDoiVoiHDKDXSDT/NoiDungBangPhanBo">
							...
							<tr>
							  ...
							  <td class="align-l"><xsl:value-of select="DiaBanHDSXKD/ten_xa"/></td>
						...
						<tr>
							<xsl:for-each select="$pl01_3/BangPhanBoDoiVoiHDKDXSDT/cong_ct17">
								<xsl:variable name="currentRows" select='position()'/>
								<tr>
									<td></td>
									<td class="align-l" colspan="3"><b>Cộng theo từng tỉnh </b></td>
									<td class="align-l"><xsl:value-of select="ct17_tinh_ten"/></td>
									<td></td>
									<td></td>
									<td></td>
