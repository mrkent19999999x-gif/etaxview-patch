...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 ...
 <xsl:include href="../../common/common.xsl"/> 
  ...
  15/6/2015 của Bộ Tài chính)'" />
		 <xsl:call-template name="tkhaiHeader_05_KK_TNCN_TT80_283">
            ...
            <div class="content">
					...
					<table class="tkhai_table">
						...
						<tr>
							...
							<td><b>Thu nhập miễn thuế, thu nhập cá nhân theo nghị quyết</b></td>
							<td class="align-c"><b>[25.1]</b></td>
							<td class="align-c">VNĐ</td>
							<td class="align-r"><xsl:value-of select="ihtkk:formatNumber($tkchinh/ct25_1)"/></td>
						</tr>
						<tr>
