			...
			<div class="content">
					...
					<table class="tkhai_table">
						<tr>
							...
							<td class="align-c" rowspan="2"><b>Thu nhập miễn thuế thu nhập cá nhân theo các Nghị quyết</b></td>
					...
					<xsl:for-each select="$pl02/BKeCTietCNhan">
							...
							<tr>
							  ...
							  <td class="align-r"><xsl:value-of select="ihtkk:formatNumber(ct14.1)" /></td>
							...
							<tr>
								...
								<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($pl02/ct20.1)" /></b></td>
