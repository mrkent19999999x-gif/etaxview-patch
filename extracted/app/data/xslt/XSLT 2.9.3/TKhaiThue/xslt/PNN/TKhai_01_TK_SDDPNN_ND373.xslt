 ...
 <xsl:include href="../../common/common.xsl"/> 
	<xsl:template match="/">
	  <xsl:variable name="ttkthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
		...
		<xsl:variable name="moTaBieuMau" select="'(Ban hành kèm theo Nghị định số 373/2025/NĐ-CP ngày 31/12/2025 của Chính phủ)'" />
	  <xsl:call-template name="tkhaiHeader_01_TK_SDDPNN_ND373">
		<xsl:with-param name="mauTKhai"   select="'01/TK_SDDPNN'"/>
	...
	<div class="ndungtkhai_div">
            <div class="content">
				<div class="align-l">
				   ...
				   <p><b>[08]</b> Ngày cấp: <xsl:value-of select="ihtkk:stringDatetime($tkchinh/TTinNNT/ngayCap,'dd/mm/yyyy')"/>.</p>
                    <p><b>[09]</b> Nơi cấp: <xsl:value-of select="$tkchinh/TTinNNT/noiCap"/></p>
				   <p><b>[10]</b> Địa chỉ cư trú:</p>
				   <p>&#160;&#160;&#160;&#160;&#160;<b>[10.1]</b> Số nhà: <xsl:value-of select="$tkchinh/TTinNNT/diaChiCuTru/soNha"/>. <b>[10.2]</b> Đường/phố: <xsl:value-of select="$tkchinh/TTinNNT/diaChiCuTru/duongPho"/></p>
				   <p>&#160;&#160;&#160;&#160;&#160;<b>[10.3]</b> Tổ/thôn: <xsl:value-of select="$tkchinh/TTinNNT/diaChiCuTru/toThon"/>. <b>[10.4]</b> Xã/phường/đặc khu: <xsl:value-of select="$tkchinh/TTinNNT/diaChiCuTru/tenPhuong"/></p>
				   <p>&#160;&#160;&#160;&#160;&#160;<b>[10.5]</b> Tỉnh/Thành phố: <xsl:value-of select="$tkchinh/TTinNNT/diaChiCuTru/tenTinh"/></p>
				   ...
				   <p>&#160;&#160;&#160;&#160;&#160;<b>[17.3]</b> Tổ/thôn: <xsl:value-of select="$tkchinh/TTinThuaDat/DiaChiThuaDat/toThon"/>. <b>[17.4]</b> Xã/phường/đặc khu: <xsl:value-of select="$tkchinh/TTinThuaDat/DiaChiThuaDat/tenPhuong"/></p>
				   <p>&#160;&#160;&#160;&#160;&#160;<b>[17.5]</b> Tỉnh/Thành phố: <xsl:value-of select="$tkchinh/TTinThuaDat/DiaChiThuaDat/tenTinh"/></p>
				   ...
				   <p>&#160;&#160;&#160;&#160;&#160;<b>[21.2]</b> Diện tích đất sử dụng sai mục đích/chưa sử dụng theo đúng quy định: <xsl:value-of select="$tkchinh/TTinThuaDat/DienTichThucTe/dienTichSai"/></p>
					...
					<p><b>5. Miễn, giảm thuế [26]</b></p>
					<p>&#160;&#160;&#160;&#160;&#160;<b>[26.1]</b> Trường hợp miễn, giảm <i>(ghi rõ trường hợp thuộc diện được miễn, giảm thuế như: thương binh, gia đình thương binh liệt sỹ, đối tượng chính sách, ...)</i>: <xsl:value-of select="$tkchinh/MienGiam/ten_MG"/></p>
					<p>&#160;&#160;&#160;&#160;&#160;<b>[26.2]</b> Kỳ tính thuế/Khoảng thời gian đề nghị miễn, giảm: Từ năm <xsl:value-of select="$tkchinh/MienGiam/kytinhthue/tuKy"/>  Đến năm <xsl:value-of select="$tkchinh/MienGiam/kytinhthue/denKy"/></p>
				    <p>&#160;&#160;&#160;&#160;&#160;<b>[26.3]</b> Số tiền đề nghị miễn (giảm): <xsl:value-of select="$tkchinh/MienGiam/soTienMG"/></p>
					<p>&#160;&#160;&#160;&#160;&#160;<b>[26.4]</b> Số tiền đã nộp (nếu có): <xsl:value-of select="$tkchinh/MienGiam/soTienDaNop"/></p>
			   </div>
		</div>
      </div>

		<!-- <xsl:call-template name="tkhaiFooter_01_TK_SDDPNN_ND373">
			<xsl:with-param name="mauTKhai"   select="'01/TK_SDDPNN'"/>
			<xsl:with-param name="moTaBieuMau"   select="$moTaBieuMau"/>
		</xsl:call-template> -->
	</xsl:template>
