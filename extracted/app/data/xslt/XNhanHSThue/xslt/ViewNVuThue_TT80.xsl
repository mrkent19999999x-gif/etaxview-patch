...
<xsl:stylesheet version="1.0"
	...
	<xsl:if test="//XACNHAN_NVTHUE">
		...
		<xsl:for-each select="XACNHAN_NVTHUE/NOIDUNG_XN">
						...
						<span style="left: 0; display: block;">
							<span style="border: 1px solid; height: 14px; margin: 2px 20px; position: absolute; text-align: center; width: 14px;">
								<xsl:if test="$DTUONG_DN != 'NTNN'">
									<div style="margin-top: 0px;">X</div>
								</xsl:if>
								<xsl:if test="$DTUONG_DN = 'NTNN'">
			...
			<div style="float: left; font-size: 10pt; line-height: 22px; margin: auto; position: relative; width: 100%;top: 17px;padding-left: 15px;">
				<xsl:for-each select="$NOIDUNG_XN/NOIDUNG_XACNHAN_HDR">
					...
					<p style="line-height: 25px;">
						&#160;&#160;&#160;&#160;&#160;&#160;1. Thời gian đề nghị xác nhận (năm dương lịch): Từ ngày
						...
						<tbody>
							<tr align="center"
								...
								<td
									style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height:23px; text-align: center; padding: 5px 6px;">
									<strong
										style="color: #000000 !important; font: 10pt arial, helvetica, sans-serif; font-weight: bold; text-align: center !important;">Số tiền thuế, tiền chậm nộp, tiền phạt phải nộp</strong>
								</td>
								<td
									style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height:23px; text-align: center; padding: 5px 6px;">
									<strong
								...
								<td
									style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height:23px; text-align: center; padding: 5px 6px;">
									<strong
										style="color: #000000 !important; font: 10pt arial, helvetica, sans-serif; font-weight: bold; text-align: center !important;">Số tiền thuế, tiền chậm nộp, tiền phạt còn phải nộp hoặc nộp thừa (+/-)</strong>
								</td>
								<td
									style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height:23px; text-align: center; padding: 5px 6px;">
									<strong
										style="color: #000000 !important; font: 10pt arial, helvetica, sans-serif; font-weight: bold; text-align: center !important;">Số tiền thuế GTGT, TTĐB còn được khấu trừ</strong>
								</td>
								<td
									style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height:23px; text-align: center; padding: 5px 6px;">
									<strong
							...
							<tr align="center" style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt;">
								...
								<xsl:for-each select="$NOIDUNG_XN/NOIDUNG_XACNHAN_CTIET/ROW_CTIET">
									<tr style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt;">
										...
										<td style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height:23px; text-align: left !important; padding: 5px 6px;">
											<span style="font: 10pt arial, helvetica, sans-serif; ;">
												<xsl:if test="MST_NNT !='' ">
													<xsl:value-of select="MST_NNT" />
												</xsl:if>
										...
										<td
											...
											<span style="font: 10pt arial, helvetica, sans-serif; ;">
												<xsl:if test="LOAI_TIEN = 'VND'">
													<xsl:value-of select="format-number(TIEN_PNOP, '###,###')" />
												</xsl:if>
												<xsl:if test="LOAI_TIEN != 'VND'">
													<xsl:value-of select="format-number(TIEN_PNOP, '###,###.##')" />
												</xsl:if>
										...
										<td
											...
											<span style="font: 10pt arial, helvetica, sans-serif; ;">
												<xsl:if test="LOAI_TIEN = 'VND'">
													<xsl:value-of select="format-number(TIEN_CONLAI, '###,###')" />
												</xsl:if>
												<xsl:if test="LOAI_TIEN != 'VND'">
													<xsl:value-of select="format-number(TIEN_CONLAI, '###,###.##')" />
												</xsl:if>
										...
										<td
											...
											<span style="font: 10pt arial, helvetica, sans-serif; ;">
												<xsl:if test="LOAI_TIEN = 'VND'">
													<xsl:value-of select="format-number(TIEN_KHAUTRU, '###,###')" />
												</xsl:if>
												<xsl:if test="LOAI_TIEN != 'VND'">
													<xsl:value-of select="format-number(TIEN_KHAUTRU, '###,###.##')" />
												</xsl:if>
								...
								<xsl:for-each select="$NOIDUNG_XN/NOIDUNG_XACNHAN_CTIET/TONGTIEN/CTIET_TONGTIEN">
								<xsl:variable name="stt" select='position()' />	
									<tr style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt;height: 48px;">
										<xsl:if test="$stt = '1'">
										<td colspan="6" rowspan="14" style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; text-align: center; padding: 5px 6px;">
										...
										<td style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height: 23px; text-align: right; padding: 5px 6px;">
											<span style="font: 10pt arial, helvetica, sans-serif;">
												<xsl:value-of select="format-number(TONGTIEN_DANOP, '###,###.##')" />&#160;<xsl:value-of select="LOAI_TIEN" />
											</span>
										</td>
										<td style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height: 23px; text-align: right; padding: 5px 6px;">
											<span style="font: 10pt arial, helvetica, sans-serif;">
												<xsl:value-of select="format-number(TONGTIEN_CONLAI, '###,###.##')" />&#160;<xsl:value-of select="LOAI_TIEN" />
											</span>
										</td>
										<td style="border-collapse: collapse; border-color: #000000 !important; border-style: solid; border-width: 1pt; height: 23px; text-align: right; padding: 5px 6px;">
											<span style="font: 10pt arial, helvetica, sans-serif;">
												<xsl:value-of select="format-number(TONGTIEN_KHAUTRU, '###,###.##')" />&#160;<xsl:value-of select="LOAI_TIEN" />
											</span>
										</td>
										<xsl:if test="$stt = '1'">
		...
		<xsl:if test="not(//XACNHAN_NVTHUE)">
		  <style type="text/css">#wrapper1 { background: none repeat scroll 0 0 #FFFFFF; min-height: 100%; margin: auto;
                              padding: 20px; position: relative; width: 750px; line-height: 18px; } #headermct { height:
                              160px; width: 100%; position: relative; margin: auto; } #headerlef { border: 1px solid;
                              height: 43px; padding: 18px; position: absolute; text-align: center; width: 98px; top:
