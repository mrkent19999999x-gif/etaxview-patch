 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<!--start phu luc PL_01_1_HT -->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_2_HT">	
		<xsl:variable name="PL01_1" select='HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_2_HT'/>
	...
	<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>		
                   <table class="tkhai_table">
                         <tr>
							...
							<td class="align-c" colspan="8"><b>Tờ khai hàng hoá xuất khẩu</b></td>
						...
						<tr>
							...
							<td class="align-c" colspan="3"><b>Trị giá</b></td>
				...
				<xsl:for-each select="$PL01_1/ToKhaiHangHoaXuatKhau">
							<xsl:variable name="currentRows" select="position()"/>
							<tr>
									<td class="align-c"><xsl:value-of select="$currentRows"/></td>
								<td class="align-l"><xsl:value-of select="maLoaiHinh"/></td>
								<td class="align-l"><xsl:value-of select="toKhaiSo"/></td>
								
								<td class="align-r"><xsl:value-of select="ihtkk:stringDatetime(ngayDangKy,'dd/mm/yyyy')"/></td>
								
								<td class="align-l"><xsl:value-of select="ten_NuocNhapKhau"/></td>
								
								<td class="align-l"><xsl:value-of select="ten_Loaitien"/></td>
								
								<td class="align-r"><xsl:value-of select="ihtkk:formatNumber(ngoaiTe)"/></td>
								<td class="align-r"><xsl:value-of select="ihtkk:formatNumber(dongVietNam)"/></td>
