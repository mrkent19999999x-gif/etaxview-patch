...
<xsl:include href="../../include/TKhaiHeader.xsl"/>
 ...
 <xsl:include href="../../common/common.xsl"/> 
					...
					<table class="tkhai_table"  >
							...
							<tr>
							 ...
							 <tr>
							   ...
							   <td class="align-l">Ngày Dự án đầu tư hoàn thành</td>
							   <td class="align-l"><xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayHoanThanhDuAn,'dd/mm/yyyy')"/></td>
							 </tr>
						   </table>		
	...
	<div>Tổng số tiền nộp NSNN ghi bằng chữ: <b><i><xsl:value-of select="ihtkk:DocTienBangChu($tkchinh/NoiDungDNHT/HThucDNHT/BuTruChoKhoanPNop/tongCot11)"/> đồng</i></b></div> -->
				...
				<div>[<xsl:if test="$hoantratructiep/HinhThucHoanTra/chuyenKhoan='true' or $hoantratructiep/HinhThucHoanTra/chuyenKhoan='1'">x</xsl:if>] Chuyển khoản: Tên chủ tài khoản: <xsl:value-of select="$hoantratructiep/HinhThucHoanTra/tenChuTaiKhoan"/></div>
				...
				<div>Tại Ngân hàng (KBNN): <xsl:value-of select="$hoantratructiep/HinhThucHoanTra/taiNganHang_ten"/> </div>         
			     <div> [<xsl:if test="$hoantratructiep/HinhThucHoanTra/tienMat='true' or $hoantratructiep/HinhThucHoanTra/tienMat='1'">x</xsl:if>] <lable> Tiền mặt</lable></div>
