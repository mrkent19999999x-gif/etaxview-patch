...
function formatVar(inpVar){
	 var strReturn = "";
		var node = inpVar.nextNode();	
	try{
 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>
	...
	<!--start phu luc PL_01_1_HT -->
		<xsl:if test="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_1_HT">	
		<xsl:variable name="PL01_1" select='HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_1_HT'/>
	...
	<div  class="align-r"><i>Đơn vị tiền: Đồng Việt Nam</i></div>		
				...
				<xsl:for-each select="$PL01_1/HoaDonChungTuNopThue">
							...
							<tr>
								...
								<td class="align-l"><xsl:value-of select="tenNguoiBan"/></td>
								...
								<td class="align-r"><xsl:value-of select="ihtkk:formatVar(thueSuat)"/></td>
							...
							<td class="align-r"><b><xsl:value-of select="ihtkk:formatNumber($PL01_1/tongCong)"/></b></td>
							<td></td>
							</tr>
			</table><br/>
