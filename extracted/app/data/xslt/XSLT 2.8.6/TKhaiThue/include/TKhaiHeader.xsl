				...
				<tr>
					<td>
						<b>[18]</b> Xã/phường/đặc khu: 
							<xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/ct18_maXa"/>
					</td>
					<td colspan="2">
						<b>[18]</b> Tỉnh/Thành phố: 
	...
	<xsl:template name="tkhaiHeader_05TT_tt80_283">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>
						<b>[08]</b> Xã/phường/đặc khu: <xsl:value-of select="$ttkthue/NNT/tenXaNNT"/>
					</td>
	...
	<xsl:template name="tkhaiHeader_01_1TNDN_VSP_TT80">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>
						<b>[11]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/NNT/tenXaNNT"/>
					</td>
					<td colspan="2">
						<b>[12]</b> Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/>
					</td>
				...
				<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									<td>
										<b>[21]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
										<b>[22] </b>Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
									</td>
					...
					<td>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									<td>
										<b>[24]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
				...
				<tr>
					<td>
						...
						<table class="ttinnnt_table" >
							...
							<tr>
								<td>
									<b>[10]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/NNT/tenXaNNT"/>
								</td>
								<td colspan="2">
									<b>[11]</b> Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/NNT/tenTinhNNT"/>
								</td>
						...
						<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									<td>
										<b>[20]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
										<b>[21] </b>Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
									</td>
					...
					<td>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									<td>
										<b>[16]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
										<b>[17] </b>Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
									</td>
	...
	<xsl:template name="tkhaiHeader_01_LNCL_PSC_TT80">
		...
		<div class="header_div">
			...
			<table width="100%" >
				...
				<tr>
					<td colspan="3">
						<b>[12] </b> Xã/Phường/Đặc khu: <xsl:value-of select="$tkchinh/Header/ct12_ten_xa"/>&#160;&#160;
...
<tr>
			...
			<!-- Bên chuyển nhượng quyền lợi: -->
				...
				<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									<td>
										<b>[17]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
										<b>[18] </b>Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
									</td>
	...
	<xsl:template name="tkhaiHeader_01_TNS_DK_TT80">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>
						<b>[09] </b> Xã/Phường/Đặc khu: <xsl:value-of select="$tkchinh/Header/ct09_ten"/>
					</td>
					<td>
						<b>[10] </b>Tỉnh/Thành phố:  <xsl:value-of select="$tkchinh/Header/ct10_ten"/>
					</td>
	...
	<xsl:template name="tkhaiHeader_01_DCDB_VSP_TT80">
		...
		<div class="header_div">
			...
			<table class="ttinnnt_table">
				...
				<tr>
					<td>
						<b>[05]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/NNT/tenXaNNT"/>
					</td>
					<td colspan="2">
				...
				<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									<td>
										<b>[15]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
										<b>[16] </b>Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
									</td>
					...
					<td>
						...
						<table class="ttinnnt_table">
							...
							<xsl:if test="$ttkthue/DLyThue">
								...
								<tr>
									<td>
										<b>[19]</b> Xã/Phường/Đặc khu: <xsl:value-of select="$ttkthue/DLyThue/tenHuyenDLyThue"/>
									</td>
									<td colspan="2">
										<b>[20] </b>Tỉnh/Thành phố: <xsl:value-of select="$ttkthue/DLyThue/tenTinhDLyThue"/>
									</td>
	...
	<!-- start header Phuluc 01_1_HT-->
	<xsl:template name="tkhaiHeader-plucTT01_1_HT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
		...
		<div class="header_div">
			<table>
				...
				<tr>
					<td class="align-c" colspan="3">
						<i>
							Kèm theo Giấy đề nghị hoàn trả khoản thu NSNN số <xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/Header/so"/>, ngày <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/ngayKy,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/ngayKy,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime(HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue/TKhaiThue/ngayKy,'yyyy')"/>
						</i>
					</td>
				</tr>
				<!-- end -->
				<tr>
					<td class="align-c" colspan="3">
							...
							<b>[01] Kỳ đề nghị hoàn thuế: Từ kỳ  <xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT/ct3_TuKy_KyKeKhai"/> đến kỳ <xsl:value-of select="HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT/ct4_DenKy_KyKeKhai"/> </b>
	...
	<!-- start header Phuluc 01_4_HT-->
	<xsl:template name="tkhaiHeader-plucTT01_4_HT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
			...
			<table>
				...
				<tr>
					<td class="align-c" colspan="3">
							...
							<b>[01] Kỳ hoàn thuế: từ ngày  <xsl:value-of select="ihtkk:stringDatetime (HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT/ct3_TuKy_kyKKhaiTuNgay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime (HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT/ct3_TuKy_kyKKhaiTuNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime (HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT/ct3_TuKy_kyKKhaiTuNgay,'yyyy')"/>đến ngày  <xsl:value-of select="ihtkk:stringDatetime (HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT/ct3_TuKy_kyKKhaiDenNgay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime (HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT/ct3_TuKy_kyKKhaiDenNgay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime (HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh/NoiDungDNHT/TTinDNHT/CTietTTinDNHT/ct3_TuKy_kyKKhaiDenNgay,'yyyy')"/></b>
	...
	<!-- start header Phuluc 01_3b_HT-->
	<xsl:template name="tkhaiHeader-plucTT01_3b_HT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
	...
	<!-- start header Phuluc 01_3a_HT-->
	<xsl:template name="tkhaiHeader-plucTT01_3a_HT">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="tKhai"/>
		<xsl:param name="tenPL"/>
...
organizations in Vietnam (*)
				...
				<tr>
					<td class="align-l">
						<b> Mã số thuế (tax code)</b> <xsl:value-of select="$ttkthue/NNT/mst"/>
					</td>
				</tr>
				<tr>
					<td>
						<b> Trụ sở tại (address)</b>: <xsl:value-of select="$ttkthue/NNT/dchiNNT"/>
					</td>
				</tr>
				<tr>
					<td>
						Hàng hóa, dịch vụ hoặc xăng xe mua trong quý <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_3a_HT/quy"/>năm <xsl:value-of select="HSoThueDTu/HSoKhaiThue/PLuc/PLuc_01_3a_HT/nam"/>(Goods, services and petrol purchased in Quarter…/ Year….)
					</td>
				</tr>
			</table>
		</div>
...
Kèm theo Giấy đề nghị hoàn trả khoản thu NSNN số ... ngày ... tháng... năm...)</i>
	...
	<xsl:template name="tkhaiHeader_01_TK_SDDPNN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_04_TK_SDDPNN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
	...
	<xsl:template name="tkhaiHeader_03_BDS_TNCN">
		<xsl:param name="mauTKhai"/>
		<xsl:param name="moTaBieuMau"/>
		<xsl:param name="ghuchuTK"/>
		<div class="header_div">
