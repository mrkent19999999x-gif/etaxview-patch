...
<xsl:template name="tkhaiFooter_pluc_32">
   ...
   <xsl:template name="tkhaiFooter_02TNDN_TT80">
	...
	<div class="footer_div">
	 ...
	 <!--start Footer tờ khai 01_3b_HT-->		
   <xsl:template name="tkhaiFooter_01_3b_HT">
	<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	...
	<div class="footer_div">
		<table>
		 <tr>
							<td class="align-c" ><i>Ngày <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($kskthue/TKhaiThue/ngayKy,'yyyy')"/></i>
				<br/>(…, date... month ... year...)<br/><b>TRƯỞNG CƠ QUAN ĐẠI DIỆN hoặc <br/>
 PHÓ TRƯỞNG CƠ QUAN ĐẠI DIỆN KÝ XÁC NHẬN, <br/>
ĐÓNG DẤU<br/>
 (Signed by Head or Deputy Head of Mission and stamp)<xsl:value-of select="$kskthue/TKhaiThue/nguoiKy"/> </b></td>
 <td></td>
 <td></td>
 <td></td>
 <td></td>
 ...
 <td></td>
 <td></td>
							<td class="align-c" >…, ngày… tháng… năm…..<br/>(…, date... month ... year...)<br/><b>Cục trưởng Cục Lễ tân Nhà nước<br/>
 (Director of Protocol Department)</b></td>
			...
			<!-- <tr>
				...
				<br/>
				(…, date... month ... year...)  <br/> 
					<b>TRƯỞNG CƠ QUAN ĐẠI DIỆN hoặc <br/>
PHÓ TRƯỞNG CƠ QUAN ĐẠI DIỆN KÝ XÁC NHẬN, <br/>ĐÓNG DẤU<br/>
(Signed by Head or Deputy Head of Mission and stamp)
			...
			<tr>
				...
				<br/>
				(…, date... month ... year...)  <br/> 
					<b>Cục trưởng Cục Lễ tân Nhà nước<br/> (Director of Protocol Department) </b>
					<br/>
	...
	<!--start Footer tờ khai 02TNDN - TT80-->		
   <xsl:template name="tkhaiFooter_01_3a_HT">
	<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	...
	<div class="footer_div">
		<table>
			...
			<!-- 	<td width="25%">
				...
				<xsl:if test="$kskthue/TKhaiThue/ngayKy ">
					<td width="35%" class="align-c">
					<b>Trưởng cơ quan đại diện hoặc  <br/> Phó trưởng Cơ quan đại diện ký xác nhận, đóng dấu<br/>(Signed by Head or Deputy Head of Mission and stamp)  </b>
					<br/>
	 ...
	 <!--start Footer tờ khai 01/TK_SDDPNN-->	
	<xsl:template name="tkhaiFooter_01_TK_SDDPNN">
	<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	...
	<!--start Footer tờ khai 04/TK_SDDPNN-->	
	<xsl:template name="tkhaiFooter_04_TK_SDDPNN">
	<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
	...
	<div class="footer_div">
	 ...
	 <!--start Footer tờ khai 03/BDS_TNCN-->	
	<xsl:template name="tkhaiFooter_03_BDS_TNCN">
	<xsl:variable name="tkchinh" select='HSoThueDTu/HSoKhaiThue/CTieuTKhaiChinh' />
	<xsl:variable name="kskthue" select='HSoThueDTu/HSoKhaiThue/TTinChung/TTinTKhaiThue' />
