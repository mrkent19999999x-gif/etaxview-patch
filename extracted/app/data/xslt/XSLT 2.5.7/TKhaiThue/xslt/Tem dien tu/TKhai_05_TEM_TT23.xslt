 ...
 <xsl:include href="../../include/TKhaiFooter.xsl"/>    
  <xsl:include href="../../common/common.xsl"/>   
	<xsl:template match="/">
		...
		<xsl:with-param name="mauTKhai"   select="'05/TEM'"/>
		...
		<table width='100%'>
			...
			<tr>
					...
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Ngày <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayMatChay,'dd')"/> tháng <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayMatChay,'mm')"/> năm <xsl:value-of select="ihtkk:stringDatetime($tkchinh/ngayMatChay,'yyyy')"/>,
					<xsl:value-of select="$ttkthue/NNT/tenNNT"/> phát hiện bị mất, cháy tem điện tử thuốc lá hoặc tem điện tử rượu sản xuất để tiêu thụ trong nước như sau:
					</td>
			...
			<tr>
					...
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Lý do mất, cháy tem điện tử thuốc lá hoặc tem điện tử rượu: <xsl:value-of select="$tkchinh/lyDoMatChay"/>
					</td>
			</tr>
			<tr>
					<td>
					&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Nay đơn vị báo cáo với <xsl:value-of select="$tkchinh/tenCQTTiepNhan"/>
					để phối hợp truy tìm, ngăn chặn lợi dụng và thông báo số tem điện tử thuốc lá hoặc tem điện tử rượu trên không còn giá trị sử dụng.
					</td>
			</tr>
