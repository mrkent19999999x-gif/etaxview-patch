		...
		<br/>
			...
			<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Căn cứ quy định tại Thông tư số 19/2021/TT-BTC ngày 18/3/2021 của Bộ trưởng Bộ Tài chính hướng dẫn giao dịch điện tử trong lĩnh vực thuế.</div>
				...
				<xsl:if test="$ndungTBao/trangThai='N'">
						...
						. Cơ quan thuế thông báo về việc không tiếp nhận hồ sơ khai thuế/BCTC/BCAC của người nộp thuế, cụ thể như sau:</div>
			...
			<xsl:if test="$ndungTBao/trangThai='Y' or $ndungTBao/trangThai='0'">
						...
						<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Hồ sơ khai thuế sẽ được cơ quan thuế tiếp tục kiểm tra và trả Thông báo chấp nhận hoặc không chấp nhận hồ sơ trong thời gian 01 (một) ngày làm việc kể từ ngày cơ quan thuế tiếp nhận hồ sơ của người nộp thuế ghi trên Thông báo này.</div>
			</xsl:if>	
						

			<div>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Nếu có vướng mắc, xin vui lòng truy cập theo đường dẫn https://thuedientu.gdt.gov.vn hoặc liên hệ với #tên cơ quan thuế nơi nộp hồ sơ# để được hỗ trợ.</div> 
